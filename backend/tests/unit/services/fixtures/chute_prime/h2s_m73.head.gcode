...
; model printing time: 4h 51m 53s; total estimated time: 4h 57m 7s
; total layer number: 167
; total filament length [mm] : 135528.23
; total filament volume [cm^3] : 325983.59
; total filament weight [g] : 417.26
...
; bed_custom_model = C:/Program Files/Bambu Studio/resources/profiles/BBL/bbl-3dp-O1S.stl
; bed_custom_texture = 
; bed_exclude_area = 
...
; close_additional_fan_first_x_layers = 5
...
; default_filament_profile = "Bambu PLA Basic @BBL H2S 0.6 nozzle"
; default_jerk = 0
...
; detect_thin_wall = 0
; diameter_limit = 50
; different_settings_to_system = bottom_color_penetration_layers;bottom_shell_layers;brim_type;detect_narrow_internal_solid_infill;enable_prime_tower;ensure_vertical_shell_thickness;inner_wall_speed;interface_shells;internal_solid_infill_speed;outer_wall_speed;reduce_crossing_wall;reduce_infill_retraction_mode;skeleton_infill_density;skin_infill_density;sparse_infill_density;sparse_infill_pattern;sparse_infill_speed;top_one_wall_type;top_shell_layers;top_solid_infill_flow_ratio;top_surface_acceleration;top_surface_speed;close_additional_fan_first_x_layers;close_fan_the_first_x_layers;cool_plate_temp;cool_plate_temp_initial_layer;eng_plate_temp;eng_plate_temp_initial_layer;fan_max_speed;fan_min_speed;filament_max_volumetric_speed;filament_retract_when_changing_layer;filament_retraction_length;filament_z_hop;hot_plate_temp;hot_plate_temp_initial_layer;nozzle_temperature;nozzle_temperature_initial_layer;nozzle_temperature_range_low;reduce_fan_stop_start_freq;textured_plate_temp;textured_plate_temp_initial_layer;bed_custom_model;layer_change_gcode;machine_start_gcode
...
; filament_settings_id = "PETG HF @BBL H2S 0.6 nozzle 2nd"
; filament_shrink = 100%
; filament_soluble = 0
...
; inherits_group = "0.30mm Standard @BBL H2S 0.6 nozzle";"Bambu PETG HF @BBL H2S 0.6 nozzle";"Bambu Lab H2S 0.6 nozzle"
...
; internal_solid_infill_speed = 175
...
; print_compatible_printers = "Bambu Lab H2S 0.6 nozzle"
; print_extruder_id = 1
; print_extruder_variant = "Direct Drive High Flow"
; print_flow_ratio = 1
; print_in_clockwise = 0
; print_sequence = by layer
; print_settings_id = PETG 0.30mm Standard @BBL H2S 0.6 nozzle
; printable_area = 0x0,340x0,340x320,0x320
; printable_height = 340
; printer_extruder_id = 1
; printer_extruder_variant = "Direct Drive High Flow"
; printer_model = Bambu Lab H2S
; printer_notes = 
; printer_settings_id = PETG HF - Bambu Lab H2S 0.6 nozzle 2nd
...
; skeleton_infill_density = 5%
; skeleton_infill_line_width = 0.62
; skin_infill_density = 5%
; skin_infill_depth = 2
...
; wipe_tower_x = 165,40,40,40,40
; wipe_tower_y = 250,200,200,200,200
...
M620.10 A0 F997.797 H0.6 T270 P225 S1
M620.10 A1 F997.797 H0.6 T270 P225 S1
...
M622 J0
    M983.3 F20.8333 A0.4 ; cali dynamic extrusion compensation
M623
...
;===== auto extrude cali end =========================
    ...
    M106 P1 S0
    M400 S2
    M109 S265 ; wait tmpr to extrude
    M83
...
M622 J1
    M1002 gcode_claim_action : 1
    G29.20 A3
    G29 A1 O X14.4674 Y51.3035 I312.943 J212.448
    M400
M623
...
M622 J2
    M1002 gcode_claim_action : 1
        ...
        G29.20 A4
        G29 A2 O X14.4674 Y51.3035 I312.943 J212.448
...
;===== for Textured PEI Plate , lower the nozzle as the nozzle was touching topmost of the texture when homing ==
            ...
            G29.1 Z0.15 ; for Textured PEI Plate printing PETG
