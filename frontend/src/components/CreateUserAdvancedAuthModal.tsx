...
export function CreateUserAdvancedAuthModal({
  ...
  // The local-account form. Named because it is the whole dialog body when
  // LDAP is off (no tablist then — a lone tabpanel would be labelled by a tab
  // that does not exist) and the "Local" panel when LDAP is on.
  const localFields = (
