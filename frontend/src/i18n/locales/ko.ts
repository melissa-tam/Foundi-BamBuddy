export default {
  ...
  printers: {
    ...
    quarantine: {
      ...
      clear: '격리 해제',
      cleared: '격리가 해제되었습니다',
      clearTitle: '격리를 해제하시겠습니까?',
      clearMessage: '"{{name}}"의 격리를 해제하시겠습니까? 스케줄러가 이 프린터로의 인쇄 전송을 재개합니다.',
      clearMessageWithReason: '"{{name}}"의 격리를 해제하시겠습니까? 사유: {{reason}}. 스케줄러가 이 프린터로의 인쇄 전송을 재개합니다.',
    },
    plateStatus: {
