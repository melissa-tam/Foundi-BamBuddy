export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      bedDrop: '베드 하강 분리 보조',
      bedDropHelp: '부품 위로 들어 올린 뒤 베드를 장비 최하부 근처까지 내렸다가 다시 올려, 스윕 전에 부품을 흔들어 떼어냅니다.',
    ...
    tooltips: {
      ...
      bedDrop: '들어 올려 부품에서 벗어난 뒤 히트베드가 최저점 근처까지 내려갔다 올라오며, 그 충격으로 스윕 전에 붙어 있는 부품을 떼어냅니다. 모델에 등록된 Z 이동 거리가 필요합니다.',
