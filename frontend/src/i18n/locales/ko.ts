export default {
  ...
  productionRuns: {
    ...
    fields: {
      ...
      noEjectProfile: '없음',
      skuDefault: 'SKU 기본값',
      cooldownOverride: '냉각 재정의 (°C)',
      cooldownPlaceholder: '프로필 기본값 사용',
      cooldownProfileDefault: '프로필 기본값 {{value}}°C를 재정의합니다',
      skuNoFile: '— 연결된 파일 없음',
  ...
  ejectProfiles: {
    ...
    tooltips: {
      ...
      cooldownTemp: '스윕이 시작되기 전에 출력물이 식어야 하는 베드 온도 – 식으면 부품이 플레이트에서 떨어집니다.',
    ...
    geometry: {
      ...
      cooldownAmbientTrap: '냉각 경고 하한({{floor}} °C)보다 낮습니다. 작업장 상온 이하의 임계값에는 결코 도달할 수 없어 배출 대기가 영원히 멈춥니다 — 상온보다 몇 도 높게 설정하세요.',
    ...
    queueHelp: '베드가 프로필 임계값 아래로 식으면 부품이 쓸려 나갑니다.',
  },
  nav: {
    printers: '프린터',
    archives: '아카이브',
  ...
  settings: {
    ...
    farmCooldownWarnFloor: '냉각 경고 하한 (°C)',
    farmCooldownWarnFloorHelp: '배출 프로필의 냉각 임계값이 이보다 낮으면 경고 — 작업장 상온 이하의 임계값은 결코 완료되지 않습니다 (15–50)',
