export default {
  ...
  skus: {
    nav: 'SKU 목록',
    title: 'SKU 카탈로그',
    description: '판매 가능한 부품 코드로, 각 코드는 하나 이상의 라이브러리 파일 플레이트와 생산 실행용 기본 배출 프로필을 연결합니다.',
    newSku: '새 SKU',
    loadError: 'SKU를 불러올 수 없습니다.',
    empty: {
      title: '아직 SKU가 없습니다',
      body: '첫 SKU를 만들어 인쇄 가능한 파일을 연결하고 생산을 추적하세요.',
    },
    columns: {
      files: '파일',
      unitsCompleted: '누적 유닛',
      successRate: '성공률',
    },
    createTitle: 'SKU 만들기',
    editTitle: 'SKU 편집',
    fields: {
      ...
      partNumber: '부품 번호',
      notes: '메모',
      defaultEjectProfile: '기본 배출 프로필',
      noEjectProfile: '없음',
    },
    codeRequired: '코드는 필수입니다.',
    nameRequired: '이름은 필수입니다.',
    created: 'SKU를 만들었습니다',
    updated: 'SKU를 업데이트했습니다',
    deleted: 'SKU를 삭제했습니다',
    saveFailed: 'SKU를 저장하지 못했습니다',
    deleteFailed: 'SKU를 삭제하지 못했습니다',
    deleteTitle: '이 SKU를 삭제하시겠습니까?',
    deleteBody: '"{{code}}"이(가) 영구적으로 삭제됩니다. 이 작업은 취소할 수 없습니다.',
    suggest: {
      appliedFromObjectName: '파일의 부품 이름에서 세부 정보를 채웠습니다',
      appliedFromFilename: '파일 이름에서 세부 정보를 채웠습니다',
      appliedGeneric: '파일에서 정보를 채웠습니다',
      failed: '세부 정보를 제안할 수 없습니다',
    },
    files: {
      title: '연결된 파일',
      ...
      plate: '플레이트',
      unitsPerPlate: '플레이트당 유닛',
      plateUnits: '플레이트 {{plate}} · 플레이트당 {{units}}',
      add: '파일 추가',
      added: '파일을 연결했습니다',
      addFailed: '파일을 연결하지 못했습니다',
      savedButLinkFailed: 'SKU는 저장되었지만 파일 연결에 실패했습니다: {{reason}}',
      remove: '제거',
      removed: '파일 연결을 해제했습니다',
      removeFailed: '연결을 해제하지 못했습니다',
      removeTitle: '이 파일 연결을 해제하시겠습니까?',
      removeBody: '"{{name}}"이(가) 이 SKU에서 연결 해제됩니다.',
    },
  },
  ...
  productionRuns: {
    nav: '생산',
    title: '생산 실행',
    description: '목표 유닛 수에 도달할 때까지 여러 프린터에 SKU 사본을 배정하며, 진행 상황을 실시간으로 표시합니다.',
    loadError: '생산 실행을 불러올 수 없습니다.',
    empty: {
      title: '아직 생산 실행이 없습니다',
      body: '실행을 시작하여 SKU를 목표 유닛 수까지 인쇄하세요.',
      noSkus: '실행을 시작하기 전에 연결된 파일이 하나 이상 있는 SKU를 추가하세요.',
    },
    startTitle: '생산 실행 시작',
    startAction: '실행 시작',
    runAgain: '다시 실행',
    advanced: '고급',
    starting: '시작 중…',
    started: '생산 실행을 시작했습니다',
    startFailed: '실행을 시작하지 못했습니다',
    noFiles: '이 SKU에는 인쇄할 연결된 파일이 없습니다.',
    fileRequired: '인쇄할 파일을 선택하세요.',
    targetRequired: '최소 1개 유닛의 목표를 입력하세요.',
    printerRequired: '프린터를 하나 이상 선택하세요.',
    overProduction: '{{planned}} 유닛({{plates}} 플레이트)을 생산합니다. 목표 {{target}}보다 {{extra}} 더 많습니다.',
    fields: {
      sku: 'SKU',
      file: '파일 / 플레이트',
      filePlaceholder: '파일 선택…',
      plateUnits: '플레이트 {{plate}}, {{units}}/플레이트',
      targetUnits: '목표 유닛',
      printers: '프린터',
      ...
      skuDefault: 'SKU 기본값',
      skuNoFile: '— 연결된 파일 없음',
      skuNoFileHint: 'SKU 페이지에서 SKU에 파일을 연결하면 실행할 수 있습니다.',
    },
    status: {
      active: '실행 중',
      paused: '일시 중지됨',
    ...
    platesProgress: '{{completed}} / {{total}} 플레이트',
    stats: {
      units: '유닛',
      target: '목표',
      failed: '실패',
    ...
    resume: '재개',
    abort: '중단',
    paused: '실행을 일시 중지했습니다',
    resumed: '실행을 재개했습니다',
    aborted: '실행을 중단했습니다',
    actionFailed: '작업에 실패했습니다',
    startNow: '지금 시작',
    startedNow: '실행을 시작했습니다',
    reschedule: '일정 변경',
    rescheduleTitle: '시작 시간 변경',
    rescheduled: '시작 시간이 업데이트되었습니다',
    schedule: {
      sectionTitle: '시작 시간',
      whenToStart: '시작 시점',
      asap: '즉시 시작',
      ...
      time: '시간',
      openCalendar: '캘린더 열기',
      pastError: '미래 시간을 선택하세요.',
      invalidError: '유효한 날짜와 시간을 입력하세요.',
      helpAsap: '사용 가능한 프린터가 비는 즉시 실행을 시작합니다.',
      helpScheduled: '선택한 시간에 프린터가 비어 있으면 실행을 시작하고, 사용 중이면 빌 때까지 기다립니다.',
      startsIn: '{{when}} 시작',
    },
    viewDetails: '런 상세 보기',
    blockedPrinters: '프린터 차단됨',
    pauseReason: {
      operator: '운영자가 일시정지함',
    ...
    detail: {
      back: '모든 생산 런',
      loadError: '이 생산 런을 불러오지 못했습니다.',
      notFound: '생산 런을 찾을 수 없습니다.',
      printersTitle: '프린터',
      noPrinters: '아직 할당된 프린터가 없습니다 — 스케줄러가 유닛마다 유휴 호환 프린터를 선택합니다.',
      unitsTitle: '유닛',
      noUnits: '아직 유닛이 없습니다.',
      unitCol: '유닛',
      statusCol: '상태',
      ...
      waiting: {
        ...
        visionHold: '플레이트 검사에서 일시 정지됨 — 플레이트를 바로잡은 뒤 재개',
        ...
        externalFeedFault: '외부 스풀이 공급되지 않습니다 — 홀더와 PTFE 튜브를 확인한 뒤 프린터에서 재개하세요',
        pinnedTrayUnavailable: '고정한 슬롯이 이 프린터에 장착되어 있지 않습니다 — 장착하거나 고정을 해제하세요',
        ...
        libraryFileMissing: '라이브러리에 원본 파일이 없습니다 — 파일을 복원하거나 다시 업로드하세요',
      ...
      printerState: {
        ...
        stalled: '인쇄 중 오프라인 정체',
        visionHold: '플레이트 검사 보류',
        filamentShort: '필라멘트 부족',
        noUsbDrive: 'USB 드라이브 없음',
      },
      eligibility: {
        title: '참여하지 않는 프린터',
        description: '이 프린터들은 문제가 해결될 때까지 이 런의 유닛을 맡지 않습니다:',
        offline: '오프라인',
        quarantined: '격리됨',
        awaitingPlateClear: '베드 미정리',
        modelMismatch: '모델 불일치',
        filamentShort: '필라멘트 부족',
        noUsbDrive: 'USB 드라이브 없음',
      },
    },
    abortTitle: '이 실행을 중단하시겠습니까?',
    abortBody: '"{{name}}"이(가) 취소됩니다. 진행 중인 플레이트는 완료되지만 새 플레이트는 시작되지 않습니다. 이 작업은 취소할 수 없습니다.',
    delete: '삭제',
    deleted: '실행을 삭제했습니다',
    ...
    firstArticle: {
      ...
      requireHelp: '첫 부품은 자동 배출 없이 인쇄되며, 실행은 승인을 기다리며 보류됩니다.',
      retriesLabel: '플레이트당 재시도',
      escalateLabel: '연속 실패 후 격리',
      printing: '초도품 인쇄 중',
      awaitingTitle: '초도품 승인 대기 중',
      awaitingBody: '첫 부품이 인쇄되었습니다. 확인한 뒤 승인하여 실행을 계속하거나 거부하여 중지하고 수정하세요.',
      approvePhysical: '승인 — 부품을 제거했습니다',
      approveEject: '승인 후 원격 배출',
      reject: '거부…',
      approveConfirm: '승인',
      approvePhysicalTitle: '초도품을 승인하시겠습니까?',
      approvePhysicalBody: '인쇄된 부품을 베드에서 제거했는지 확인하세요. 실행이 계속되어 남은 플레이트를 전송합니다.',
      approveEjectTitle: '승인 후 원격으로 배출하시겠습니까?',
      approveEjectBody: '실행이 계속되기 전에 툴헤드가 부품을 베드에서 밀어냅니다. 베드에 장애물이 없고 아무도 프린터에 손을 넣고 있지 않은지 확인하세요.',
      rejectTitle: '초도품 거부',
      rejectBody: '무엇이 잘못되었는지 설명하세요. 이후 실행을 재개하면 새 초도품이 다시 시작됩니다.',
      rejectReasonLabel: '사유',
      rejectReasonPlaceholder: '예: 모서리 휨, 베드 접착 불량…',
      rejectReasonRequired: '사유가 필요합니다.',
      rejectAction: '초도품 거부',
      rejectedBadge: '초도품 거부됨',
      rejectedReason: '사유: {{reason}}',
      rejectedHint: '재개하면 새 초도품이 시작됩니다.',
      approvedBadge: '초도품 승인됨',
      approved: '초도품이 승인되었습니다',
  ...
  ejectProfiles: {
    nav: '배출 프로필',
    title: '배출 프로필',
    description: '베드가 식으면 완성된 부품을 베드에서 쓸어내는 자동 부품 배출 프로필입니다.',
    newProfile: '새 프로필',
    loadError: '배출 프로필을 불러올 수 없습니다.',
    duplicateAction: '복제',
    copyName: '{{name}} (사본)',
    empty: {
      title: '아직 배출 프로필이 없습니다',
      body: '첫 번째 프로필을 만들어 완성된 부품을 베드에서 자동으로 제거하세요.',
    },
    columns: {
      passes: '패스 수',
      ejectSpeed: '배출 속도',
    ...
    fields: {
      ...
      xPasses: 'X 패스',
      xMargin: 'X 여백 (mm)',
      frontOverhang: '전면 오버행 (mm)',
      backOverhang: '후면 오버행 (mm)',
      ejectSpeed: '배출 속도 (mm/min)',
      skimSpeed: '스킴 속도 (mm/min)',
      finalSkim: '최종 스킴 패스',
      finalSkimHelp: '스윕 후 플레이트 바로 위에서 느린 스킴 패스를 한 번 추가하여 얇은 잔여물을 제거합니다. 정확히 한 번만 밀려면 끄십시오.',
      maxPartHeight: '최대 부품 높이 (mm)',
      sweepStartHeight: '스윕 시작 높이 (%)',
      sweepStartHeightHelp: '부품 높이의 이 비율에서 하강 스윕을 시작합니다 (100% = 부품 상단).',
      sweepBand: 'X 스윕 대역 제한',
      sweepBandHelp: '전체 너비 대신 베드 너비의 일부 대역만 스윕합니다. 전체 너비는 꺼 두세요.',
      sweepXMin: 'X 대역 최소 (mm)',
      sweepXMax: 'X 대역 최대 (mm)',
      bedDrop: '베드 하강 분리 보조',
      bedDropHelp: '베드를 장비 최하부 근처까지 내렸다가 상승 높이로 되돌려, 그 충격으로 스윕 전에 붙어 있는 부품을 떼어냅니다.',
      bedDropClearance: '바닥 간격 (mm)',
      bedDropDwell: '하강 최저점 유지 시간 (초)',
      bedDropDwellHelp: '베드가 상승 높이로 돌아가기 전에 하강 최저점에서 이 시간(초)만큼 유지합니다.',
      bedDropJitter: '하강 최저점에서 흔들기',
      bedDropJitterHelp: '베드가 하강 최저점에서 설정한 거리만큼 올라갔다 돌아오는 동작을 설정한 횟수만큼 반복합니다.',
      bedDropJitterCycles: '흔들기 횟수',
      bedDropJitterMm: '흔들기 이동 거리 (mm)',
    },
    tooltips: {
      name: '이 프로필을 알아보기 위한 짧은 라벨 – 프로필 목록과 선택기에 표시됩니다.',
      clearance: '툴헤드가 위치로 이동할 때 부품 위로 유지하는 높이 – 스윕 전에 출력물에 닿지 않도록 합니다.',
      zOffset: '스윕 경로 높이의 미세 조정 – 노즐이 끌리면 높이고, 부품을 놓치면 낮춥니다.',
      descentSteps: '툴헤드가 부품을 밀어내기 전에 그 뒤로 가기 위해 수행하는 작은 하강 단계 수.',
      xPasses: '부품을 치우기 위해 베드에서 수행하는 좌우 스윕 횟수.',
      xMargin: '툴헤드가 프레임에 부딪히지 않도록 베드 좌우 가장자리에서 유지하는 여백.',
      frontOverhang: '부품을 완전히 밀어내기 위해 스윕이 부품 앞쪽으로 얼마나 더 나아가는지.',
      backOverhang: '툴헤드가 밀기 전에 부품 뒤로 완전히 돌아갈 수 있도록 스윕이 부품 뒤 얼마에서 시작하는지.',
      ejectSpeed: '부품을 플레이트에서 밀어내는 밀기 경로에서 툴헤드가 움직이는 속도.',
      skimSpeed: '남은 조각을 치우는 더 가벼운 스킴 경로에서 툴헤드가 움직이는 속도.',
      finalSkim: '주 스윕 후 플레이트 바로 위에서 느린 추가 패스를 수행하여 얇은 잔여물을 제거합니다. 한 번만 밀려면 끄십시오(예: 높은 부품의 경우 중간 높이 레인 하나).',
      maxPartHeight: '이 프로필이 배출할 수 있는 가장 높은 부품 – 슬라이스된 부품이 더 높으면 디스패치가 차단됩니다.',
      sweepStartHeight: '하강 스윕이 시작되는 부품상의 높이(백분율, 유효 1-100%, 100% = 부품의 맨 위).',
      sweepBand: '전체 폭 대신 베드의 일부 띠만 스윕합니다 – 부품이 항상 같은 자리에 있을 때 유용합니다.',
      sweepXMin: '스윕 띠의 왼쪽 가장자리, 베드 원점에서 mm 단위. 유효 0-340 mm(H2S 베드 폭); 최대값보다 작아야 하며 최소 10 mm 폭의 띠를 남겨야 합니다.',
      sweepXMax: '스윕 띠의 오른쪽 가장자리, 베드 원점에서 mm 단위. 유효 0-340 mm(H2S 베드 폭); 최소값보다 커야 하며 최소 10 mm 폭의 띠를 남겨야 합니다.',
      bedDrop: '히트베드가 최저점 근처까지 내려갔다가 상승 높이로 돌아오며, 그 충격으로 스윕 전에 붙어 있는 부품을 떼어냅니다. 모델에 등록된 Z 이동 거리가 필요합니다.',
      bedDropClearance: '하강 중 베드 최저 위치에서 유지하는 간격 — 50 mm = 바닥보다 5 cm 위에서 정지.',
      bedDropDwell: '하강 최저점에서 몇 초 더 기다리면 붙어 있는 부품이 스윕 전에 완전히 떨어질 시간을 확보합니다.',
      bedDropJitter: '하강 최저점에서의 짧은 상하 동작은 한 번의 충격으로 떨어지지 않은 부품을 떼어냅니다.',
    },
    nameRequired: '이름은 필수입니다.',
    created: '배출 프로필이 생성되었습니다',
    updated: '배출 프로필이 업데이트되었습니다',
    deleted: '배출 프로필이 삭제되었습니다',
    saveFailed: '프로필 저장에 실패했습니다',
    deleteFailed: '프로필 삭제에 실패했습니다',
    deleteTitle: '이 프로필을 삭제하시겠습니까?',
    deleteBody: '"{{name}}"이(가) 영구적으로 제거됩니다. 이 작업은 취소할 수 없습니다.',
    preview: {
      title: '미리보기 및 검증',
      description: '사용 전에 검증할 수 있도록 라이브러리 파일과 플레이트의 배출 G 코드를 생성합니다.',
      file: '라이브러리 파일',
      filePlaceholder: '파일 선택…',
      plate: '플레이트',
      run: '미리보기 생성',
      running: '생성 중…',
      noFiles: '미리 볼 수 있는 라이브러리 파일이 없습니다.',
      ok: '검증 통과',
      errors: '오류',
      warnings: '경고',
      maxZ: '최대 Z 높이: {{value}} mm',
      showGcode: 'G 코드 표시',
      hideGcode: 'G 코드 숨기기',
      gcodeLabel: '생성된 G 코드',
      failed: '미리보기 실패',
    ...
    dryRun: {
      action: '드라이런',
      title: '드라이런 테스트',
      description: '이 프로필의 형상 전용 테스트를 프린터로 보내거나, 검사할 테스트 파일을 다운로드합니다.',
      printer: '프린터',
      printerPlaceholder: '연결된 프린터 선택…',
      loadingPrinters: '프린터 연결 확인 중…',
      noPrinters: '사용 가능한 연결된 프린터가 없습니다.',
      warningTitle: '빈 베드 필요',
      warning: '이 테스트는 베드 중앙으로 원점 복귀한 뒤 훑고 지나가므로 플레이트가 비어 있어야 합니다. 디스패치 후 작업은 프린터에서 플레이트 보류를 해제할 때까지 대기합니다.',
      dispatch: '테스트 보내기',
      dispatching: '보내는 중…',
      download: '파일 다운로드',
      downloading: '준비 중…',
      dispatchFailed: '테스트를 보낼 수 없습니다.',
      downloadFailed: '드라이런 파일을 만들 수 없습니다.',
      allowUnvalidated: '미검증 지오메트리 허용 (하드웨어 래더 전용)',
      allowUnvalidatedWarning: '이 모델의 이동 범위는 하드웨어로 검증되지 않았습니다. 래더에서 감독하에 빈 베드에서만 디스패치하세요.',
    },
    geometry: {
      model: '프린터 모델',
      noModels: '지오메트리 레지스트리 항목이 없습니다',
      unvalidated: '하드웨어 미검증',
      warningsTitle: '지오메트리 경고',
      downloadModel: '다운로드용 지오메트리 모델',
      downloadModelPlaceholder: '선택한 프린터의 모델 사용',
      bandInverted: 'X 밴드 최소값은 최대값보다 작아야 합니다.',
      bandTooNarrow: '스윕 밴드는 최소 {{min}} mm 폭이어야 합니다.',
      bandExceedsBed: 'X 밴드 최대값이 등록된 가장 넓은 베드({{max}} mm)를 초과합니다.',
      heightExceedsCeiling: '등록된 모든 모델의 높이 상한(최대 {{max}} mm)을 초과합니다 — 배출 디스패치가 거부됩니다.',
      bedDropNoTravel: 'Z 이동 거리가 등록되지 않은 모델({{models}})은 이 프로필을 생성할 수 없습니다 — 지오메트리 레지스트리에서 z_travel_mm를 설정하세요.',
      bedDropBedslinger: '베드 하강 보조는 베드 슬링어 모델({{models}})에서 사용할 수 없습니다 — 이 모델의 베드는 Z 방향으로 움직이지 않습니다.',
    },
    geometryManager: {
      title: '모델 지오메트리 레지스트리',
      description: '각 프린터 모델의 베드 크기, 이동 범위, 하드웨어 검증 상태입니다. 행은 서버 시드에서 생성되며 추가 버튼은 없습니다. 모델을 편집하여 지오메트리를 수정하거나 검증 상태를 변경하세요.',
      edit: '지오메트리 편집',
      editTitle: '{{model}} 지오메트리 편집',
      saved: '모델 지오메트리를 저장했습니다',
      saveFailed: '모델 지오메트리를 저장할 수 없습니다',
      zTravelUnset: 'Z 이동 거리가 등록되지 않았습니다 — 이 모델에서는 베드 하강 보조가 안전하게 차단됩니다.',
      validatedBadge: '검증됨',
      notValidatedBadge: '미검증',
      confirmValidateTitle: '모델을 검증됨으로 표시할까요?',
      confirmValidateBody: '{{model}}을(를) 검증됨으로 표시하면 무인 생산 배출이 잠금 해제됩니다. 작업자가 입회한 하드웨어 래더(빈 베드 드라이런 → 감독하의 인쇄→냉각→배출 주기 → 짧은 루프) 이후에만 확인하세요.',
      confirmUnvalidateTitle: '검증을 해제할까요?',
      confirmUnvalidateBody: '{{model}}의 검증을 해제하면 재검증될 때까지 이 모델의 생산 자동 배출이 안전하게 차단됩니다.',
      confirmZReferenceTitle: 'Z 재기준화를 켤까요?',
      confirmZReferenceBody: '{{model}} 에서 Z 재기준화를 켜면 부품이 놓인 상태의 모든 배출 시작에 베드를 하단 스토퍼까지 내리는 보호 동작이 추가됩니다. 분리 보조구를 장착한 상태로 작업자가 입회한 하드웨어 래더를 마친 뒤에만 확인하세요.',
      confirmUnZReferenceTitle: 'Z 재기준화를 끌까요?',
      confirmUnZReferenceBody: 'Z 재기준화를 끄면 {{model}} 의 배출은 유지된 Z 원점을 다시 사용합니다. 이 원점은 전원이 꺼지면 사라집니다.',
      columns: {
        model: '모델',
        bed: '베드 (가로×세로 mm)',
        envelope: '이동 범위 (mm)',
        zTravel: 'Z 이동 거리',
        maxPartHeight: '최대 부품 높이',
        motion: '구동 방식',
        validated: '검증',
        notes: '메모',
        updated: '업데이트',
      ...
      fields: {
        bedX: '베드 폭 X (mm)',
        bedY: '베드 깊이 Y (mm)',
        envXMin: '이동 범위 X 최소 (mm)',
        envXMax: '이동 범위 X 최대 (mm)',
        envYMin: '이동 범위 Y 최소 (mm)',
        envYMax: '이동 범위 Y 최대 (mm)',
        maxPartHeight: '최대 부품 높이 (mm)',
        zTravel: 'Z 이동 거리 (mm)',
        zTravelHelp: '비워 두면 지워집니다. 그러면 이 모델에서 베드 하강 보조가 안전하게 차단됩니다.',
        zReferenceValidated: 'Z 재기준화 검증됨',
        holdLift: '대기 중 베드 상승량 (mm)',
        holdLiftHelp: '베드 점검이 확정된 뒤 프린터가 보류된 동안 베드가 하단 스토퍼에서 얼마나 올라가는지.',
        notes: '메모',
        validated: '하드웨어 검증됨',
      },
    },
    queueLabel: '배출 프로필 (자동 부품 제거)',
    queueHelp: '베드가 배출 라인까지 식으면 부품이 쓸려 나갑니다.',
  },
  nav: {
    printers: '프린터',
    archives: '아카이브',
  ...
  printers: {
    ...
    deactivated: {
      pillLabel: '비활성화됨',
      panelState: '비활성화됨 — 이 프린터에 연결되어 있지 않습니다.',
      activate: '활성화',
      toastActivated: '{{name}} 활성화됨',
      editFieldLabel: '비활성화됨',
      editFieldHelp: 'MQTT 세션 없음. 이 인스턴스에서는 보이지 않습니다(병렬 설치, 폐기).',
    },
    ...
    toast: {
      ...
      recheckUnchanged: '슬롯 {{slot}} 변화 없음. 마지막 확인 이후 롤 교체가 기록되지 않았습니다.',
      recheckMinted: '슬롯 {{slot}}: 새 롤을 기록했습니다. {{grams}} g으로 가정합니다.',
      recheckIdentified: '슬롯 {{slot}}: 태그에서 {{identity}}을(를) 기록했습니다.',
      recheckIdentifiedUnnamed: '슬롯 {{slot}}: 태그를 읽었습니다.',
      recheckIdentifiedNoRead: '슬롯 {{slot}}: {{identity}} 기록됨. 태그 재판독은 보류되었습니다.',
      recheckQueued: '슬롯 {{slot}} 재확인을 대기열에 넣었습니다. 다음 유휴 시점에 태그를 읽고 롤을 기록합니다.',
      recheckEmpty: '슬롯 {{slot}}이(가) 비어 있습니다. 롤을 넣은 뒤 다시 확인하세요.',
      recheckRestored: '슬롯 {{slot}}: 이전 롤을 복원했습니다.',
      recheckFailed: '슬롯 {{slot}}: 재확인 실패.',
      recheckUndoNoOffer: '슬롯 {{slot}}: 취소할 재확인이 없습니다.',
      recheckUndoNoPredecessor: '슬롯 {{slot}}: 이 슬롯에 기록된 이전 롤이 없습니다.',
      recheckUndoMintGone: '슬롯 {{slot}}: 기록된 롤이 존재하지 않습니다.',
      recheckUndoBoundElsewhere: '슬롯 {{slot}}: 이전 롤이 다른 트레이에 장착되어 있습니다. 복원하지 않았습니다.',
      recheckUndoFailed: '슬롯 {{slot}}: 복원 실패. {{detail}}',
    ...
    quarantine: {
      badge: '격리됨',
      recover: '복구 및 재개',
      recoverSuccess: '프린터를 복구했습니다 — {{count}}개의 런을 재개했습니다.',
      recoverError: '프린터 복구에 실패했습니다',
      recoverTitle: '복구 및 재개하시겠습니까?',
      recoverMessage: '"{{name}}"을(를) 복구하시겠습니까? 다음을 수행하는 명시적 재정의입니다:',
    ...
    phase: {
      ...
      coolingToPlateau: '정체 지점까지 냉각 중',
      coolingToPlateauHeld: '정체 지점까지 냉각 중 · 플레이트 상승',
    ...
    ejectNotQualified: '이 모델의 자동 배출은 아직 하드웨어 검증되지 않았습니다 — 무인 사용 전에 하드웨어 래더를 실행하세요.',
    plateStatus: {
      ...
      ejectInFlight: '배출 진행 중. 복구 및 재개로 무시하세요.',
    ...
    eject: {
      ...
      confirmBodyNoLine: '베드가 {{bed}}°C이며 판단할 작업장 공기나 챔버 측정값이 없습니다. 지금 배출하면 이 온도에서 부품을 쓸어냅니다. 계속할까요?',
    ...
    rfid: {
      ...
      recheck: '슬롯 다시 확인',
      recheckPending: '다시 확인 대기 중입니다. 인쇄가 끝나면 완료됩니다.',
      recheckQueuedTooltip: '인쇄가 끝날 때까지 대기열에 있습니다.',
      restorePreviousRoll: '이전 롤 복원'
    },
    ams: {
      load: '로드',
      unload: '언로드'
    ...
    permission: {
      ...
      noAmsRfid: 'AMS 슬롯을 다시 확인할 권한이 없습니다',
    ...
    incidentAction: {
      ...
      plate_vision: '플레이트를 바로잡은 뒤 출력을 재개하세요',
  ...
  archives: {
    ...
    modal: {
      ...
      deleteBlockedByLivePrint: '삭제할 수 없습니다 — 이 아카이브는 진행 중인 인쇄를 기록하고 있습니다. 인쇄를 먼저 중지한 다음 다시 시도하십시오.',
  ...
  queue: {
    ...
    permissions: {
      ...
      noReleaseStaged: '이 항목의 해제는 큐 관리자에게 요청하세요',
  ...
  settings: {
    ...
    spoolSelectionPolicy: '스풀 선택 정책',
    spoolSelectionPolicyDesc: '여러 AMS 슬롯이 일치할 때 디스패처와 수동 인쇄가 스풀을 선택하는 방법.',
    spoolPolicyFirstLoaded: '먼저 장착됨 (FIFO)',
    spoolPolicyLowestRemaining: '잔량 최소',
    spoolPolicySlotOrder: 'AMS 슬롯 순서',
    spoolPolicyBackupNote: '「잔량 최소」는 프린터에서 AMS Filament Backup이 활성화된 경우에만 적용됩니다. 그렇지 않으면 선택한 스풀이 다 떨어졌을 때 두 번째 스풀로 전환할 수 없습니다.',
    minStartSpool: '최소 시작 스풀 중량 (g)',
    ...
    taglessBrand: '브랜드',
    taglessMaterial: '소재',
    taglessSubtype: '하위 유형',
    taglessSubtypeHint: '소재에 대한 Bambu의 변형 코드입니다(예: HF = High Flow). 스풀 라벨에 표시됩니다.',
    taglessColor: '색상',
    taglessSlicerFilament: '슬라이서 필라멘트(선택 사항)',
    taglessSlicerFilamentHint: '슬라이서가 사용하는 필라멘트 프리셋의 정확한 이름으로, 프린트가 올바른 프로필과 일치하도록 합니다.',
    ...
    deleteUserChecking: '이 삭제가 무엇을 지우는지 확인 중...',
    deleteUserImpactUnavailable: '이 삭제가 무엇을 지우는지 확인하지 못했습니다. 그래도 삭제하면 이 사용자의 항목이 미리 보기 없이 제거됩니다.',
    deleteUserArchives_one: '인쇄 아카이브 {{count}}개',
    deleteUserArchives_other: '인쇄 아카이브 {{count}}개',
    deleteUserLibraryFiles_one: '라이브러리 파일 {{count}}개',
    deleteUserLibraryFiles_other: '라이브러리 파일 {{count}}개',
    deleteUserQueueItems_one: '대기열 항목 {{count}}개',
    deleteUserQueueItems_other: '대기열 항목 {{count}}개',
    deleteUserProductionRuns_one: '생산 실행 {{count}}개',
    deleteUserProductionRuns_other: '생산 실행 {{count}}개',
    deleteUserDependentSkus_one: 'SKU {{count}}개가 이 사용자가 업로드한 파일을 사용합니다. 해당 SKU는 파일을 잃게 되며 다시 지정하기 전까지 인쇄할 수 없습니다.',
    deleteUserDependentSkus_other: 'SKU {{count}}개가 이 사용자가 업로드한 파일을 사용합니다. 해당 SKU는 파일을 잃게 되며 다시 지정하기 전까지 인쇄할 수 없습니다.',
    deleteUserPrintingNow_one: '{{count}}개 유닛이 지금 인쇄 중입니다. 완료되거나 중지될 때까지 삭제가 거부됩니다.',
    deleteUserPrintingNow_other: '{{count}}개 유닛이 지금 인쇄 중입니다. 완료되거나 중지될 때까지 삭제가 거부됩니다.',
    deleteUserStillPrinting: '{{printers}}에서 아직 인쇄 중입니다. 해당 인쇄를 중지하거나 끝날 때까지 기다린 후 삭제하세요.',
    ...
    farmProduction: '팜 생산',
    farmProductionDescription: '실행 시작 대화 상자에 미리 채워지는 기본 재시도 및 격리 정책입니다. 실행마다 재정의할 수 있습니다.',
    farmEjectCooldown: '배출 냉각',
    farmEjectCooldownDescription: '완료된 플레이트를 쓸어내기 전에 팜이 베드 냉각을 어떻게 기다리는지, 그리고 식지 않는 프린터를 언제 포기하거나 격리하는지 설정합니다.',
    farmRetryMaxPerUnit: '플레이트당 재시도',
    farmRetryMaxPerUnitHelp: '플레이트가 실패로 표시되기 전 자동 재시도 횟수 (0–10)',
    farmEscalateConsecutiveFailures: '실패 후 격리',
    farmEscalateConsecutiveFailuresHelp: '격리를 발동하는 프린터의 연속 실패 횟수 (1–20)',
    farmCooldownMargin: '작업장 공기 대비 여유 (°C)',
    farmCooldownMarginHelp: '배출 라인과 챔버 팬 감속 지점이 작업장 공기보다 이만큼 위에 놓입니다.',
    shopAir: {
      label: '작업장 공기',
      ejectLine: '배출 라인',
      noReading: '측정값 없음',
      atPlateau: '정체 지점',
      fresh_one: '대기 중인 프린터 {{count}}대 내부에서 {{minutes}}분 전 측정 — 실내 공기보다 약간 높게 나옵니다.',
      fresh_other: '대기 중인 프린터 {{count}}대 내부에서 {{minutes}}분 전 측정 — 실내 공기보다 약간 높게 나옵니다.',
      carried: '{{time}} 값에서 일간 곡선을 따라 추정.',
      unknown: '아직 측정값 없음 — 각 냉각은 베드가 더 이상 식지 않을 때 해제됩니다.',
      readFailed: '작업장 공기를 읽지 못했습니다 — 1분마다 다시 시도합니다.',
    },
    farmOfflineStallMinutes: '오프라인 정체 (분)',
    farmOfflineStallMinutesHelp: '프린터가 이 시간 동안 오프라인 상태인데 아직 인쇄 중인 유닛을 표시 — 종료하지 않고 정체만 표시 (5–720)',
    farmPauseStallMinutes: '일시정지 정체 (분)',
    farmPauseStallMinutesHelp: '인쇄 중인 유닛이 자동 복구 없이 이 시간 동안 일시정지 상태로 있으면 표시하고 알림 — 아무것도 취소하지 않음 (5–720)',
    farmCooldownStallWindow: '냉각 확인 간격 (분)',
    farmCooldownStallWindowHelp: '배출 전에 베드가 계속 식고 있는지 확인하는 주기입니다. 확인이 연속 2회 실패하면 프린터를 격리합니다. 0이면 확인을 끕니다.',
    farmCooldownStallEpsilon: '확인당 최소 냉각 (°C)',
    farmCooldownStallEpsilonHelp: '계속 식고 있다고 인정하려면 베드가 확인과 확인 사이에 최소한 이만큼 내려가야 합니다.',
    farmCooldownMaxHold: '포기 타이머 (분)',
    farmCooldownMaxHoldHelp: '이 시간이 지나도 베드가 배출 온도보다 따뜻하면 그래도 배출합니다. 0 = 계속 대기합니다.',
    farmCooldownPlateauMargin: '허용 여유값 (°C)',
    farmCooldownPlateauMarginHelp: '냉각이 멈춰도 베드가 자체 챔버 공기에서 이 정도 이내이면 식은 것으로 보고 배출합니다. 그보다 더 뜨거운 채로 멈추면 프린터를 격리합니다.',
    farmCooldownAuxFanEnabled: '냉각 중 보조 팬',
    farmCooldownAuxFanEnabledHelp: '인쇄 종료부터 배출이 전송될 때까지 보조 팬을 가동합니다.',
    farmCooldownAuxFan: '보조 팬 속도 (%)',
    farmCooldownAuxFanHelp: '냉각 내내 동일한 속도입니다 (1–100).',
    farmCooldownChamberFanEnabled: '냉각 중 챔버 팬',
    farmCooldownChamberFanEnabledHelp: '에어 덕트를 냉각 모드로 설정하고 인쇄 종료부터 배출이 전송될 때까지 챔버 배기 팬을 가동합니다. 챔버 팬이 없는 기종은 건너뜁니다.',
    farmCooldownChamberFan: '챔버 팬 부스트 속도 (%)',
    farmCooldownChamberFanHelp: '챔버 공기가 아직 배출 온도보다 높을 때의 속도입니다 (1–100).',
    farmCooldownChamberFanSustain: '부스트 후 챔버 팬 속도 (%)',
    farmCooldownChamberFanSustainHelp: '챔버가 배출 온도에 도달한 뒤 배출이 전송될 때까지의 속도입니다. 0이면 팬이 멈춥니다. 프린터 자체의 챔버 냉각 속도는 50입니다.',
    ...
    farmPlateBlowoffEnabled: '인쇄 시작 시 플레이트 블로우',
    farmPlateBlowoffEnabledHelp: '베드 레벨링 전에 보조 팬을 최대 속도로 플레이트에 불어 줍니다.',
    farmPlateBlowoffSeconds: '블로우 시간 (s)',
    farmPlateBlowoffSecondsHelp: '베드 레벨링 전 보조 팬 작동 시간 (3–60).',
    ...
    queueCheckIntervalHelp: '아무 일이 없어도 팜이 대기열을 다시 확인하는 주기입니다. 실시간 이벤트를 놓쳤을 때를 대비한 안전장치로, 낮을수록 빨리 반응하지만 폴링이 늘어납니다(5–300).',
    dispatchKickDebounce: '버스트 정리 지연(초)',
    dispatchKickDebounceHelp: '여러 일이 동시에 발생할 때, 이 짧은 순간을 기다려 여러 번이 아닌 한 번의 디스패치로 묶습니다. 높을수록 더 많이 묶고, 낮을수록 더 빨리 반응합니다(0.2–10).',
    usbPreflightFreshWindow: 'USB 확인 유효 시간(초)',
    usbPreflightFreshWindowHelp: '최근의 "USB 드라이브 있음" 보고를 이 초 이내라면 신뢰하고 다시 확인하지 않습니다. 높을수록 중복 확인을 건너뛰고, 0은 항상 다시 확인합니다(0–120).',
    usbPreflightMaxWait: 'USB 확인 최대 대기(초)',
    usbPreflightMaxWaitHelp: '어쨌든 인쇄를 시작하기 전에 최근의 "USB 있음" 보고를 얼마나 기다릴지입니다. 높을수록 신중하고, 낮을수록 더 빨리 디스패치합니다(0–10).',
    dispatchParallelLimit: '동시 프린터 시작 수',
    dispatchParallelLimitHelp: '한 번의 패스에서 동시에 업로드하고 시작할 수 있는 프린터 수입니다. 높을수록 큰 대기열을 더 빨리 비우고, 낮을수록 네트워크에 부담이 적습니다(1–10).',
    powerStagger: '전력 스태거',
    powerStaggerDescription: '항상 전체 간격을 기다리는 대신, 프린터가 예열 전력을 더 이상 끌지 않는 순간 스태거 슬롯을 해제합니다. 동시 전력 소비를 제한하면서도 다음 프린터를 더 빨리 시작하게 합니다.',
    staggerDynamicRelease: '베드가 뜨거워지면 슬롯 해제',
    staggerDynamicReleaseHelp: '켜면 전체 간격이 지나기를 기다리는 대신 현재 프린터가 베드 예열을 마치는 즉시 다음 프린터가 시작될 수 있습니다. 끄면 모든 슬롯이 전체 간격을 기다립니다.',
    staggerReleaseEpsilon: '도달 온도 여유(°C)',
    staggerReleaseEpsilonHelp: '슬롯을 일찍 해제할 만큼 "충분히 뜨겁다"고 보는 목표 베드 온도와의 근접도입니다. 클수록 다음 프린터를 더 일찍 해제합니다.',
    staggerHeatupGrace: '예열 유예(초)',
    staggerHeatupGraceHelp: '프린터가 아직 베드 예열을 시작하지 않았다면, 유휴 프린터가 배치를 막지 않도록 이 시간만큼 기다린 후 슬롯을 해제합니다.',
    ...
    erp: {
      title: 'ERP 디렉터리 로그인',
      statusActive: 'ERP 로그인: 활성',
      statusInactive: 'ERP 로그인: 구성되지 않음',
      activeDesc: '운영자는 ERP 디렉터리 자격 증명으로 로그인할 수 있습니다.',
      inactiveDesc: 'ERP 로그인을 활성화하려면 아래에 연결 정보를 입력하고 저장하세요.',
      disableHint: 'ERP 로그인을 끄려면 아래의 호스트와 데이터베이스 이름을 지우고 저장하세요.',
      connectionConfig: 'ERP 디렉터리 연결',
      host: '데이터베이스 호스트',
      port: '포트',
      database: '데이터베이스 이름',
      user: '데이터베이스 사용자',
      password: '데이터베이스 비밀번호',
      passwordHint: '저장된 비밀번호를 유지하려면 비워 두세요.',
      ssl: 'TLS로 연결',
      sslHint: 'ERP 데이터베이스에 대한 암호화된 연결을 요구합니다.',
      roleMapping: '역할 매핑',
      roleMappingHint: '각 ERP 역할에 BamBuddy 그룹을 할당합니다.',
      roleMappingNoGroup: '— 그룹 없음 —',
      roleMappingGroupFor: '{{role}}의 BamBuddy 그룹',
      settingsSaved: 'ERP 디렉터리 설정이 저장되었습니다',
      errors: {
        hostRequired: '데이터베이스 호스트가 필요합니다',
        databaseRequired: '데이터베이스 이름이 필요합니다',
      },
    },
    oidc: {
      title: 'SSO / OIDC 제공자',
      ...
      form: {
        ...
        groupsClaim: '그룹 클레임',
        groupsClaimDesc: '사용자의 그룹 또는 역할 값을 담은 토큰 클레임입니다. 이 공급자의 그룹 동기화를 비활성화하려면 비워 두세요.',
        groupsClaimPlaceholder: '그룹',
        groupMapping: '그룹 매핑',
        groupMappingDesc: '각 클레임 값을 BamBuddy 그룹에 매핑합니다. 일치하는 사용자는 로그인 시 매핑된 그룹을 받습니다.',
        groupMappingNone: '구성된 매핑이 없습니다.',
        groupMappingClaimValue: '클레임 값',
        groupMappingGroup: 'BamBuddy 그룹',
        groupMappingSelectGroup: '그룹 선택',
        groupMappingRemove: '매핑 제거',
        groupMappingAdd: '매핑 추가',
        autologin: '자동 로그인',
  ...
  fileManager: {
    ...
    createSkuFromUploadToast: '{{filename}} 업로드됨 — 이 파일로 SKU를 만들까요?',
    createSkuFromUploadAction: '이 파일로 SKU 만들기',
    ...
    deleteFolderConfirm: '이 폴더를 삭제하시겠습니까? 안의 파일은 휴지통으로 이동하며 루트로 복원할 수 있습니다. 폴더 자체는 영구적으로 삭제됩니다.',
    deleteFileConfirm: '이 파일을 삭제하시겠습니까?',
    deleteFilesConfirm: '선택한 {{count}}개 파일을 삭제하시겠습니까? 파일은 휴지통으로 이동하며 복원할 수 있습니다.',
    deleting: '삭제 중...',
  ...
  inventory: {
    ...
    freshRoll: {
      ...
      reviewAction: '검토…',
      title: '이 슬롯에 새 롤인가요?',
      message: '{{location}}의 태그 없는 스풀이 라벨 중량의 대부분을 사용했습니다. 지금 새 롤이 장착되어 있다면 필라멘트 추적이 정확하도록 기록하세요.',
      confirm: '새 롤',
      pending: '기록 중…',
      success: '새 롤을 기록했습니다',
      failed: '새 롤 기록에 실패했습니다',
      dismissFailed: '새 롤 알림을 닫을 수 없습니다',
      remaining: '남은 양으로 {{grams}} g 기록',
      brandLabel: '브랜드',
      brandPlaceholder: '예: Overture',
      weightLabel: '라벨 중량 (g)',
    ...
    respool: {
      title: '이 태그를 재스풀할까요?',
      manualTitle: '이 태그를 새 롤로 옮길까요?',
      manualMessage: '{{location}}의 기록({{grams}} g 사용)을 종료하고 Bambu 태그를 새 전체 롤로 옮깁니다. 실제로 롤을 교체한 뒤에만 실행하세요.',
      message: '{{location}}에서 재사용된 Bambu 태그가 감지되었습니다. 지금 새 타사 스풀에 붙어 있다면 가득 찬 기록으로 재스풀하세요.',
      confirm: '재스풀 완료 — 새 스풀',
      pending: '재스풀 중…',
      success: '새 {{brand}} 스풀로 재스풀했습니다',
      failed: '태그 재스풀에 실패했습니다',
      autoToast: '{{brand}}을(를) {{printer}} 슬롯 {{slot}}에 자동 재스풀했습니다',
      reusedTagToast: '재사용된 태그에 새 롤일 수 있습니다 — {{printer}} 슬롯 {{slot}}',
      ...
      triggerSpent: '이 롤이 필라멘트 소진을 알렸고, 그 이후 슬롯이 조작되었습니다.',
      triggerRemainJump: 'AMS가 이 기록보다 훨씬 많은 필라멘트를 보고합니다 — 태그가 리필된 롤로 옮겨진 것으로 보입니다.',
      sameSpoolAction: '같은 스풀',
      reviewAction: '검토…',
      dismissFailed: '재스풀 알림을 닫을 수 없습니다',
      donorLine: '추적 중인 스풀을 교체합니다(남은 양 {{grams}} g). 이전 기록은 보관됩니다',
      donorRecordTitle: '기록 #{{id}}',
      detailsLabel: '세부 정보',
      tagIdLabel: '태그 ID',
      warning: '도너 롤당 태그는 하나만 사용하세요 — 두 번째 태그는 폐기하세요.',
      brandLabel: '브랜드',
      brandPlaceholder: '예: Overture',
      weightLabel: '라벨 중량 (g)',
      weightPlaceholder: '예: 1000',
    ...
    returnToRotation: '로테이션으로 복귀',
    returnToRotationDone: '스풀을 로테이션으로 복귀했습니다',
    returnToRotationFailed: '스풀을 로테이션으로 복귀하지 못했습니다',
  ...
  ams: {
    ...
    slotDialogLabel: '{{ams}} 슬롯 {{slot}}: {{content}}',
    slotBoundPresenceUnknown: '{{printer}}: {{ams}} 슬롯 {{slot}}이(가) 응답하지 않습니다 — 할당된 스풀이 아직 있는지 확인할 수 없습니다. 슬롯을 확인하세요',
    slotSpentSwapPark: '{{printer}}: {{ams}} 슬롯 {{slot}}이(가) 소진된 스풀에 잡혀 있으며 해제할 근거가 없습니다. 슬롯을 다시 확인하거나 롤을 교체하세요',
    ...
    emptySlotBinding: {
      ...
      unassignAria: '{{spool}}을(를) 이 슬롯에서 할당 해제',
      unassignTitle: '이 스풀 할당을 해제할까요?',
      unassignMessage: '{{spool}}을(를) 이 슬롯에서 해제합니다. 스풀은 기록된 사용량을 유지한 채 재고로 돌아가며 삭제되는 것은 없습니다.',
    },
  },
  printModal: {
    ...
    customSlotMapping: '맞춤 슬롯 매핑',
    reread: '다시 읽기',
    requiredTooltip: '필요: {{type}} - {{color}}',
    manuallySelected: '수동 선택됨',
    autoMatched: '자동 매칭됨',
    externalSlotNote: '외부 스풀 — 무게가 추적되지 않으며, 프린터가 홀더의 필라멘트를 요구합니다.',
    selectSlot: '-- 슬롯 선택 --',
    noActivePrintersAvailable: '사용 가능한 활성 프린터가 없습니다',
    specificPrinter: '특정 프린터',
    anyModel: '모든 {{model}}',
    modelFallback: '모델',
    targetModelLabel: '대상 모델',
    selectModelPlaceholder: '모델 선택...',
    locationFilter: '위치 필터(선택 사항)',
    anyLocation: '모든 위치',
    schedulerAssignHint: '스케줄러가 사용 가능한 첫 번째 유휴 {{model}} 프린터에 할당합니다',
    schedulerAssignHintLocation: '스케줄러가 {{location}}에서 사용 가능한 첫 번째 유휴 {{model}} 프린터에 할당합니다',
    selectPrinters: '프린터 선택',
    printersSelected_one: '{{count}}대 프린터 선택됨',
    printersSelected_other: '{{count}}대 프린터 선택됨',
    selectAll: '모두 선택',
    inactive: '(비활성)',
    ...
    autoButton: '자동',
    hiddenPrinters_one: '{{count}}대의 다른 프린터 숨김(다른 모델) —',
    hiddenPrinters_other: '{{count}}대의 다른 프린터 숨김(다른 모델) —',
    showAll: '모두 표시',
    showOnlyModelPrinters: '{{model}} 프린터만 표시',
    selectAtLeastOnePrinter: '프린터를 하나 이상 선택하세요',
    selectTargetModel: '대상 프린터 모델을 선택하세요',
    typeNotFound: '(유형을 찾을 수 없음)',
    colorMismatch: '(색상 불일치)',
    ready: '(준비됨)',
    clickToChangeSlot: '슬롯 할당을 변경하려면 클릭하세요',
    costNotAvailable: '해당 없음',
    requiredTypeNotFound: '필요한 필라멘트 유형을 프린터에서 찾을 수 없습니다.',
    printJob: '인쇄 작업',
    slicedModelMismatch: '파일은 {{slicedModel}}용으로 슬라이스되었지만 {{printerModel}}에서 인쇄합니다',
    archiveDataUnavailable: '아카이브 데이터를 사용할 수 없습니다. 원본 파일이 삭제되었을 수 있습니다. 필라멘트 매핑이 비활성화되었습니다.',
    failedToComplete: '작업을 완료하지 못했습니다',
    toastQueueItemUpdated: '대기열 항목이 업데이트되었습니다',
    toastUpdateFailed: '대기열 항목을 업데이트하지 못했습니다',
    toastSelectPrinter: '프린터를 하나 이상 선택하세요',
    toastSelectModel: '대상 프린터 모델을 선택하세요',
    toastQueuedForModel: '모든 {{model}}용으로 대기열에 추가됨',
    ejectFromSku: 'SKU {{code}}의 기본값',
    partialFailureTitle: '{{total}}건 중 {{failed}}건의 전송이 실패했습니다:',
    toastPartialSuccess: '{{success}}개 성공, {{failed}}개 실패',
    printerFallback: '프린터 {{id}}',
    slotFallback: '슬롯 {{id}}',
    plateFallback: '플레이트 {{index}}',
  },
  backup: {
  ...
  uploadModal: {
    ...
    libraryHint: 'SKU 및 생산 실행은 대신 파일 관리자에서 업로드하세요.',
    libraryHintLink: '파일 관리자로 이동 →',
    uploaded: '업로드됨',
    failed: '실패',
    uploading: '업로드 중...',
    upload: '업로드',
  ...
  notifications: {
    ...
    printStalled: '인쇄 정체',
    storageLow: 'USB 저장 공간 부족',
    cooldownEscalation: '냉각 지연',
    quietHours: '방해 금지 시간',
  ...
  fleetMetrics: {
    ...
    sections: {
      fleet: '프린터 전체',
      matrix: '프린터 매트릭스',
      stateOverTime: '시간에 따른 프린터 상태',
      printsPerDay: '일별 인쇄 수',
      downtimeByCause: '원인별 중단 시간',
      coolingAndEject: '냉각 및 배출',
      recovery: '복구',
      partsBySku: 'SKU별 부품',
    },
    summary: {
      ...
      rows: {
        avg_printing: '인쇄 중',
        avg_cycle_overhead: '인쇄 사이',
        avg_idle: '대기',
        avg_down: '중단',
        avg_planned: '점검',
        peak_down: '중단 최대',
        printers_in_fleet: '운용 중',
        prints_per_day: '인쇄 수',
        prints_per_printer_per_day: '프린터당 인쇄 수',
        uptime: '가동률',
        time_printing: '인쇄 시간 비율',
      },
      peak: '최대 {{count}}',
      downNow: '현재 중단',
      nothingDown: '중단 없음',
    ...
    matrix: {
      ...
      hideDays: '날짜 숨기기',
      sortBy: '{{column}} 기준 정렬',
      caption: '프린터별 {{lens}}, {{from}}부터 {{to}}까지',
      captionDay: '프린터별 {{lens}}, {{date}}',
      details: '상세',
    ...
    detail: {
      ...
      incidents: '사건',
      openPrinter: '프린터 열기',
      noIntervals: '이 기간에 기록된 구간이 없습니다.',
      noIncidents: '이 기간에 사건이 없습니다.',
      noPrints: '이 기간에 인쇄가 없습니다.',
      ongoing: '진행 중',
    },
    widgets: {
      showData: '데이터 보기',
      showChart: '차트 보기',
      showDataFor: '{{chart}} 데이터 보기',
      showChartFor: '{{chart}} 차트 보기',
      median: '중앙값',
      p90: 'P90',
      overExpected: '예상 초과',
      count: '건수',
    ...
    states: {
      loading: '불러오는 중…',
      loadFailed: '프린터 이력을 불러오지 못했습니다.',
      retry: '다시 시도',
      empty: '이 기간에 데이터가 없습니다.',
      recordingGap: '프린터 상태 기록은 {{date}}에 시작되었습니다. 고장과 점검 이력은 {{earliest}}부터입니다.',
    },
    header: {
    ...
    hints: {
      ...
      cycle_overhead: '인쇄와 인쇄 사이에 팜이 직접 하는 작업입니다. 베드를 식힌 뒤 부품을 쓸어냅니다.',
      planned: '점검 모드입니다. 담당자가 프린터를 자동 흐름에서 제외했습니다.',
      uptime: '집계된 시간 중 프린터가 작업을 받을 수 있었던 비율입니다.',
      time_printing: '집계된 시간 중 프린터가 인쇄한 비율입니다.',
      prints_per_printer: '완료된 인쇄 수를 프린터별 집계 일수로 나눈 값입니다. 집계 일수는 기록된 구간에서만 나오므로 기간 일부가 기록되지 않은 동안에는 「인쇄 수」와 비교할 수 없습니다.',
      unobserved: '이 구간은 아무것도 기록되지 않아 고장과 보류만 알 수 있습니다.',
      not_recorded: '이 프린터에 대해 처음 기록된 상태보다 앞선 기간입니다.',
      incidents_only: '여기서는 프린터 상태가 기록되지 않았고, 고장과 점검 기록만 이 기간을 덮습니다.',
      whileRecorded: '기간 수치는 기록된 시간만 포함합니다.',
      timeframeFleet: '하루는 {{tz}} 기준 자정부터 자정까지입니다.',
      timeframePrints: '하루는 UTC 자정부터 자정까지입니다.',
    },
  },
};
