export default {
  ...
  ejectProfiles: {
    ...
    tooltips: {
      ...
      cooldownRetries: '목표에 도달하기를 기다리는 동안 베드 온도를 다시 확인하는 횟수(초과하면 중단).',
  ...
  printers: {
    ...
    phase: {
      printing: '인쇄 중',
      cooling: '{{threshold}}°C까지 냉각 중(베드 {{bed}}°C) — 배출 스윕은 파일 내에서 실행됩니다',
  ...
  settings: {
    ...
    farmRetryMaxPerUnitHelp: '플레이트가 실패로 표시되기 전 자동 재시도 횟수 (0–5)',
    farmEscalateConsecutiveFailures: '실패 후 격리',
    farmEscalateConsecutiveFailuresHelp: '격리를 발동하는 프린터의 연속 실패 횟수 (1–10)',
