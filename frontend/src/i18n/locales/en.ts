export default {
  ...
  productionRuns: {
    ...
    fields: {
      ...
      cooldownOverride: 'Cooldown override (°C)',
      cooldownPlaceholder: 'Use profile default',
      cooldownProfileDefault: 'Overrides profile default {{value}}°C',
  ...
  ejectProfiles: {
    ...
    fields: {
      name: 'Name',
      cooldownTemp: 'Cooldown temperature (°C)',
    ...
    tooltips: {
      ...
      cooldownTemp: 'Bed temperature the print must cool to before the sweep starts — parts release from the plate when cool.',
    ...
    geometry: {
      ...
      cooldownAmbientTrap: 'Below the cooldown warn floor ({{floor}} °C). A threshold at or below shop ambient can never be reached, so the eject wait would stall forever — set it a couple of degrees above ambient.',
    ...
    queueHelp: 'Part is swept off after bed cools below the profile threshold.',
  },
  ...
  settings: {
    ...
    farmCooldownWarnFloor: 'Cooldown warn floor (°C)',
    farmCooldownWarnFloorHelp: 'Warn when an eject profile cooldown threshold is below this — a threshold at or below shop ambient never completes (15–50)',
