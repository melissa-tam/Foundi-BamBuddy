export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      bedDropHelp: 'After lifting clear of the part, lower the bed almost to the machine bottom and bring it back up to jolt the part loose before the sweep.',
    ...
    tooltips: {
      ...
      bedDrop: 'After the lift clears the part, the heatbed drops almost to its lowest point and returns, jolting a stuck part loose before the sweep. Needs a registered Z travel for the model.',
