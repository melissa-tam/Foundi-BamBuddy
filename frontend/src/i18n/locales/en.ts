export default {
  ...
  inventory: {
    ...
    respool: {
      ...
      noteLabel: 'Note',
      notePlaceholder: 'Optional',
      actionDesc: 'Move this Bambu tag onto a fresh roll',
    },
    bulk: {
  ...
  ams: {
    ...
    emptySlotBinding: {
      ...
      clearMessage: 'Release {{spool}} from this slot. The spool returns to inventory with its recorded usage intact — nothing is deleted.',
    },
    unknown: 'Unknown',
    humidity: 'Humidity',
    temperature: 'Temperature',
