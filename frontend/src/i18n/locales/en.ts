export default {
  ...
  inventory: {
    ...
    freshRoll: {
      ...
      message: 'The tagless spool at {{location}} has been used past half its label weight. If a fresh roll is now loaded, record it so filament tracking stays accurate.',
      confirm: 'Fresh roll',
      pending: 'Recording…',
    ...
    respool: {
      ...
      promptToast: 'Spool almost empty on {{printer}} slot {{slot}} — new roll on this tag?',
