export default {
  ...
  skus: {
    nav: 'SKUs',
    title: 'SKU Catalog',
    description: 'Sellable part codes, each linking one or more library-file plates plus a default eject profile for production runs.',
    newSku: 'New SKU',
    loadError: 'Could not load SKUs.',
    empty: {
      title: 'No SKUs yet',
      body: 'Create your first SKU to link printable files and track production.',
    },
    columns: {
      files: 'Files',
      unitsCompleted: 'Lifetime units',
      successRate: 'Success',
    },
    createTitle: 'Create SKU',
    editTitle: 'Edit SKU',
    fields: {
      code: 'Code',
      name: 'Name',
      ...
      notes: 'Notes',
      defaultEjectProfile: 'Default eject profile',
      noEjectProfile: 'None',
    },
    ...
    updated: 'SKU updated',
    deleted: 'SKU deleted',
    saveFailed: 'Failed to save SKU',
    deleteFailed: 'Failed to delete SKU',
    deleteTitle: 'Delete this SKU?',
    deleteBody: '"{{code}}" will be permanently removed. This cannot be undone.',
    suggest: {
      appliedFromObjectName: 'Details filled from the part names in the file',
      appliedFromFilename: 'Details filled from the file name',
      appliedGeneric: 'Details filled from file',
      failed: 'Could not suggest details',
    },
    files: {
      title: 'Linked files',
      ...
      plate: 'Plate',
      unitsPerPlate: 'Units per plate',
      plateUnits: 'Plate {{plate}} · {{units}} per plate',
      add: 'Add file',
      added: 'File linked',
      addFailed: 'Failed to link file',
      savedButLinkFailed: 'The SKU was saved, but linking the file failed: {{reason}}',
      remove: 'Remove',
      removed: 'File unlinked',
      removeFailed: 'Failed to unlink file',
      removeTitle: 'Unlink this file?',
      removeBody: '"{{name}}" will be unlinked from this SKU.',
    },
  },
  ...
  productionRuns: {
    ...
    description: 'Dispatch copies of a SKU across printers until a target unit count is met, with live progress.',
    loadError: 'Could not load production runs.',
    empty: {
      title: 'No production runs yet',
      body: 'Start a run to print a SKU up to a target unit count.',
      noSkus: 'Add a SKU with at least one linked file before starting a run.',
    },
    startTitle: 'Start production run',
    startAction: 'Start run',
    runAgain: 'Run again',
    advanced: 'Advanced',
    starting: 'Starting…',
    started: 'Production run started',
    startFailed: 'Failed to start run',
    noFiles: 'This SKU has no linked files to print.',
    fileRequired: 'Select a file to print.',
    targetRequired: 'Enter a target of at least 1 unit.',
    printerRequired: 'Select at least one printer.',
    overProduction: 'Will produce {{planned}} units ({{plates}} plates) — {{extra}} more than the target of {{target}}.',
    fields: {
      sku: 'SKU',
      file: 'File / plate',
      filePlaceholder: 'Select a file…',
      plateUnits: 'plate {{plate}}, {{units}}/plate',
      ...
      skuNoFile: '— no file linked',
      skuNoFileHint: 'Link a file to a SKU on the SKUs page to make it runnable.',
    },
    status: {
      active: 'Active',
      paused: 'Paused',
    ...
    platesProgress: '{{completed}} / {{total}} plates',
    stats: {
      units: 'Units',
      target: 'Target',
      failed: 'Failed',
    ...
    startNow: 'Start now',
    startedNow: 'Run started',
    reschedule: 'Reschedule',
    rescheduleTitle: 'Reschedule start time',
    rescheduled: 'Start time updated',
    schedule: {
      ...
      pastError: 'Pick a time in the future.',
      invalidError: 'Enter a valid date and time.',
      helpAsap: 'The run starts as soon as an eligible printer is free.',
      helpScheduled: 'The run starts at the chosen time if a printer is free — otherwise it waits until one is.',
      startsIn: 'Starts {{when}}',
    },
    viewDetails: 'View run details',
    blockedPrinters: 'Printer blocked',
    pauseReason: {
      operator: 'Paused by operator',
    ...
    detail: {
      back: 'All production runs',
      loadError: 'Could not load this production run.',
      notFound: 'Production run not found.',
      printersTitle: 'Printers',
      noPrinters: 'No printers assigned yet — the scheduler picks an idle matching printer per unit.',
      unitsTitle: 'Units',
      ...
      retryOf: 'Retry #{{count}} of unit {{id}}',
      unitStatus: {
        pending: 'Pending',
        printing: 'Printing',
        completed: 'Completed',
      ...
      waiting: {
        ...
        externalFeedFault: 'External spool did not feed — check the holder and the PTFE tube, then resume on the printer',
        pinnedTrayUnavailable: 'Pinned slot is not loaded on this printer — load it or remove the pin',
        ...
        libraryFileMissing: 'Source file missing from library — restore or re-upload the file',
      ...
      eligibility: {
        title: 'Printers not participating',
        description: 'These printers won\'t take units from this run until resolved:',
        offline: 'Offline',
        quarantined: 'Quarantined',
        awaitingPlateClear: 'Bed not cleared',
        modelMismatch: 'Model mismatch',
        filamentShort: 'Low filament',
        noUsbDrive: 'No USB drive',
      },
    },
    abortTitle: 'Abort this run?',
    abortBody: '"{{name}}" will be cancelled. In-progress plates finish but no new plates start. This cannot be undone.',
    delete: 'Delete',
    deleted: 'Run deleted',
    ...
    firstArticle: {
      ...
      requireHelp: 'The first part prints without auto-eject and holds the run for your approval.',
      retriesLabel: 'Retries per plate',
      escalateLabel: 'Quarantine after consecutive failures',
      printing: 'First article printing',
      awaitingTitle: 'First article awaiting approval',
      awaitingBody: 'The first part has printed. Inspect it, then approve to continue the run or reject to stop and revise.',
      approvePhysical: 'Approve — I removed the part',
      approveEject: 'Approve & eject remotely',
      reject: 'Reject…',
      approveConfirm: 'Approve',
      approvePhysicalTitle: 'Approve first article?',
      approvePhysicalBody: 'Confirm you have removed the printed part from the bed. The run will continue and dispatch the remaining plates.',
      approveEjectTitle: 'Approve and eject remotely?',
      approveEjectBody: 'The toolhead will sweep the part off the bed before the run continues. Make sure the bed is clear of obstructions and nobody is reaching into the printer.',
      rejectTitle: 'Reject first article',
      rejectBody: 'Explain what was wrong. Resuming the run afterwards restarts a fresh first article.',
      rejectReasonLabel: 'Reason',
      rejectReasonPlaceholder: 'e.g. warped corners, poor bed adhesion…',
      rejectReasonRequired: 'A reason is required.',
      rejectAction: 'Reject first article',
      rejectedBadge: 'First article rejected',
      rejectedReason: 'Reason: {{reason}}',
      rejectedHint: 'Resume restarts a new first article.',
      approvedBadge: 'First article approved',
      approved: 'First article approved',
  ...
  ejectProfiles: {
    nav: 'Eject Profiles',
    title: 'Eject Profiles',
    description: 'Automatic part-removal profiles that sweep finished parts off the bed once it has cooled.',
    newProfile: 'New profile',
    loadError: 'Could not load eject profiles.',
    duplicateAction: 'Duplicate',
    copyName: '{{name}} (copy)',
    empty: {
      title: 'No eject profiles yet',
      body: 'Create your first profile to automatically clear finished parts from the bed.',
    },
    columns: {
      passes: 'Passes',
      ejectSpeed: 'Eject speed',
      maxHeight: 'Max height',
    },
    createTitle: 'Create eject profile',
    editTitle: 'Edit eject profile',
    fields: {
      name: 'Name',
      clearance: 'Clearance (mm)',
      zOffset: 'Z offset (mm)',
      descentSteps: 'Descent steps',
      xPasses: 'X passes',
      xMargin: 'X margin (mm)',
      frontOverhang: 'Front overhang (mm)',
      backOverhang: 'Back overhang (mm)',
      ejectSpeed: 'Eject speed (mm/min)',
      skimSpeed: 'Skim speed (mm/min)',
      finalSkim: 'Final skim pass',
      finalSkimHelp: 'Add one slow skim pass just above the plate after the sweeps to clear thin remnants. Turn off to push exactly once.',
      maxPartHeight: 'Max part height (mm)',
      sweepStartHeight: 'Sweep start height (%)',
      sweepStartHeightHelp: 'Begin the descending sweep at this percent of the part height (100% = part top).',
      sweepBand: 'Restrict X sweep band',
      sweepBandHelp: 'Sweep only a sub-band of the bed width instead of the full width. Leave off for the full width.',
      sweepXMin: 'X band min (mm)',
      sweepXMax: 'X band max (mm)',
      bedDrop: 'Bed-drop release assist',
      bedDropHelp: 'Bed drops to near the machine bottom and returns to the lift height, jolting a stuck part loose before the sweep.',
      bedDropClearance: 'Bottom clearance (mm)',
      bedDropDwell: 'Hold at drop floor (s)',
      bedDropDwellHelp: 'Bed holds at the drop floor for this many seconds before returning to the lift height.',
      bedDropJitter: 'Jitter at drop floor',
      bedDropJitterHelp: 'Bed rises and returns by the set distance for the set number of cycles at the drop floor.',
      bedDropJitterCycles: 'Jitter cycles',
      bedDropJitterMm: 'Jitter travel (mm)',
    },
    tooltips: {
      name: 'A short label to recognise this profile by — shown in the profile list and pickers.',
      clearance: 'How far above the part the toolhead stays as it moves into position, so it clears the print before sweeping.',
      zOffset: 'Fine height tweak for the sweep pass — raise it if the nozzle drags, lower it if the part is missed.',
      descentSteps: 'Number of small downward steps the toolhead takes to get behind the part before pushing it off.',
      xPasses: 'How many side-to-side sweep passes to make across the bed to clear the part.',
      xMargin: 'Gap kept from the left and right bed edges so the toolhead never hits the frame.',
      frontOverhang: 'How far the sweep reaches past the front of the part to make sure it is pushed fully off.',
      backOverhang: 'How far behind the part the sweep starts so the toolhead gets fully behind it before pushing.',
      ejectSpeed: 'How fast the toolhead moves during the pushing passes that shove the part off the plate.',
      skimSpeed: 'How fast the toolhead moves during the lighter skim passes that clear any leftover bits.',
      finalSkim: 'Runs an extra slow pass right above the plate after the main sweeps to clear thin leftover bits. Turn off for a single push (e.g. one mid-height lane for a tall part).',
      maxPartHeight: 'Tallest part this profile may eject — dispatch is blocked when the sliced part is taller.',
      sweepStartHeight: 'Height on the part where the descending sweep begins, as a percent (valid 1-100%; 100% = the very top of the part).',
      sweepBand: 'Sweep only a strip of the bed instead of its full width — handy when parts always sit in the same spot.',
      sweepXMin: 'Left edge of the sweep strip, in mm from the bed origin. Valid 0-340 mm (H2S bed width); must be smaller than the max and leave a band at least 10 mm wide.',
      sweepXMax: 'Right edge of the sweep strip, in mm from the bed origin. Valid 0-340 mm (H2S bed width); must be larger than the min and leave a band at least 10 mm wide.',
      bedDrop: 'The heatbed drops to near its lowest point and returns to the lift height, jolting a stuck part loose before the sweep. Needs a registered Z travel for the model.',
      bedDropClearance: "Gap kept from the machine's lowest bed position during the drop — 50 mm = stop 5 cm above the bottom.",
      bedDropDwell: 'Extra seconds at the drop floor give a stuck part time to finish peeling before the sweep.',
      bedDropJitter: 'Short up-and-down strokes at the drop floor loosen a part the single jolt leaves attached.',
    },
    nameRequired: 'Name is required.',
    created: 'Eject profile created',
    updated: 'Eject profile updated',
    deleted: 'Eject profile deleted',
    saveFailed: 'Failed to save profile',
    deleteFailed: 'Failed to delete profile',
    deleteTitle: 'Delete this profile?',
    deleteBody: '"{{name}}" will be permanently removed. This cannot be undone.',
    preview: {
      title: 'Preview & validate',
      description: 'Generate the eject G-code for a library file and plate to validate it before use.',
      file: 'Library file',
      filePlaceholder: 'Select a file…',
      plate: 'Plate',
      run: 'Generate preview',
      running: 'Generating…',
      noFiles: 'No library files available to preview.',
      ok: 'Validation passed',
      errors: 'Errors',
      warnings: 'Warnings',
      maxZ: 'Max Z height: {{value}} mm',
      showGcode: 'Show G-code',
      hideGcode: 'Hide G-code',
      gcodeLabel: 'Generated G-code',
      failed: 'Preview failed',
    },
    dryRun: {
      action: 'Dry run',
      title: 'Dry-run test',
      description: 'Send a geometry-only test of this profile to a printer, or download the test file to inspect it.',
      printer: 'Printer',
      printerPlaceholder: 'Select a connected printer…',
      loadingPrinters: 'Checking printer connections…',
      noPrinters: 'No connected printers available.',
      warningTitle: 'Empty bed required',
      warning: 'This test homes to the centre of the bed and sweeps across it, so the plate must be EMPTY. After dispatch the job waits until you clear the plate hold on the printer.',
      dispatch: 'Dispatch test',
      dispatching: 'Dispatching…',
      download: 'Download file',
      downloading: 'Preparing…',
      dispatchFailed: 'Could not dispatch the test.',
      downloadFailed: 'Could not build the dry-run file.',
      allowUnvalidated: 'Allow unvalidated geometry (hardware-ladder use only)',
      allowUnvalidatedWarning: "This model's envelope has NOT been hardware-validated. Dispatch only at the ladder, supervised, on an EMPTY bed.",
    },
    geometry: {
      model: 'Printer model',
      noModels: 'No geometry registry entries',
      unvalidated: 'not hardware-validated',
      warningsTitle: 'Geometry warnings',
      downloadModel: 'Download geometry model',
      downloadModelPlaceholder: "Use the selected printer's model",
      bandInverted: 'X band min must be less than X band max.',
      bandTooNarrow: 'The sweep band must be at least {{min}} mm wide.',
      bandExceedsBed: 'X band max is beyond the widest registered bed ({{max}} mm).',
      heightExceedsCeiling: 'Above the height ceiling of every registered model (max {{max}} mm) — eject dispatch would be refused.',
      bedDropNoTravel: 'Models without a registered Z travel ({{models}}) cannot generate this profile — set z_travel_mm in the geometry registry.',
      bedDropBedslinger: 'Bed-drop assist is unavailable on bedslinger models ({{models}}) — their bed does not move in Z.',
    },
    geometryManager: {
      title: 'Model geometry registry',
      description: 'Bed size, travel envelope, and hardware-validation state for each printer model. Rows come from the server seeds — there is no add button; edit a model to correct its geometry or change its validation.',
      edit: 'Edit geometry',
      editTitle: 'Edit {{model}} geometry',
      saved: 'Model geometry saved',
      saveFailed: 'Could not save model geometry',
      zTravelUnset: 'No Z travel registered — the bed-drop assist fails closed on this model.',
      validatedBadge: 'Validated',
      notValidatedBadge: 'Not validated',
      confirmValidateTitle: 'Mark model validated?',
      ...
      motion: {
        bedZ: 'Bed on Z',
        bedslinger: 'Bedslinger',
      },
      fields: {
        bedX: 'Bed width X (mm)',
        bedY: 'Bed depth Y (mm)',
        envXMin: 'Envelope X min (mm)',
        envXMax: 'Envelope X max (mm)',
        envYMin: 'Envelope Y min (mm)',
        envYMax: 'Envelope Y max (mm)',
        maxPartHeight: 'Max part height (mm)',
        zTravel: 'Z travel (mm)',
    ...
    queueLabel: 'Eject profile (auto part removal)',
    queueHelp: 'Part is swept off once the bed cools to the eject line.',
  },
  ...
  printers: {
    ...
    toast: {
      ...
      recheckUnchanged: 'Slot {{slot}} unchanged. No roll movement recorded since the last check.',
      recheckMinted: 'Slot {{slot}}: new roll recorded. {{grams}} g assumed.',
      recheckIdentified: 'Slot {{slot}}: {{identity}} recorded from its tag.',
      recheckIdentifiedUnnamed: 'Slot {{slot}}: tag read.',
      recheckIdentifiedNoRead: 'Slot {{slot}}: {{identity}} on record. Tag re-read deferred.',
      recheckQueued: 'Slot {{slot}} re-check queued. The farm reads the tag at the next idle window and records the roll then.',
      recheckEmpty: 'Slot {{slot}} is empty. Load a roll, then re-check.',
      recheckRestored: 'Slot {{slot}}: previous roll restored.',
      recheckFailed: 'Slot {{slot}}: re-check failed.',
      recheckUndoNoOffer: 'Slot {{slot}}: no re-check to undo.',
      recheckUndoNoPredecessor: 'Slot {{slot}}: no previous roll recorded for this slot.',
      recheckUndoMintGone: 'Slot {{slot}}: the recorded roll is gone.',
      recheckUndoBoundElsewhere: 'Slot {{slot}}: previous roll is seated in another tray. Nothing restored.',
      recheckUndoFailed: 'Slot {{slot}}: restore failed. {{detail}}',
    ...
    quarantine: {
      badge: 'Quarantined',
      recover: 'Recover & resume',
      recoverSuccess: 'Printer recovered — {{count}} run(s) resumed.',
      recoverError: 'Failed to recover printer',
      recoverTitle: 'Recover & resume?',
      recoverMessage: 'Recover "{{name}}"? This is an explicit override that will:',
    ...
    phase: {
      ...
      coolingToPlateau: 'Cooling to plateau',
      coolingToPlateauHeld: 'Cooling to plateau · plate raised',
    ...
    ejectPhase: {
      ...
      uploading: 'Ejecting: uploading {{pct}} %',
      uploadingNoPct: 'Ejecting: uploading…',
      sent: 'Ejecting: sent',
      sweeping: 'Ejecting: sweeping…',
      failed: 'Eject failed',
    },
    ...
    ejectNotQualified: 'Auto-eject is not hardware-qualified for this model yet — run the hardware ladder before unattended use.',
    plateStatus: {
    ...
    eject: {
      ...
      confirmBodyNoLine: 'The bed is {{bed}}°C — no shop-air or chamber reading to judge it against. Ejecting now sweeps the part off at that temperature. Continue?',
    ...
    rfid: {
      ...
      recheck: 'Re-check slot',
      recheckPending: 'Re-check pending. Concludes when the print finishes.',
      recheckQueuedTooltip: 'Queued until the print finishes.',
      restorePreviousRoll: 'Restore previous roll',
    },
    // AMS load/unload (#891)
    ams: {
      load: 'Load',
    ...
    permission: {
      ...
      noAmsRfid: 'You do not have permission to re-check AMS slots',
  ...
  archives: {
    ...
    modal: {
      ...
      deleteBlockedByLivePrint: 'Cannot delete — this archive records a print in progress. Stop the print first, then retry.',
  ...
  queue: {
    ...
    permissions: {
      ...
      noReleaseStaged: 'Ask a queue admin to release these items',
  ...
  settings: {
    ...
    spoolSelectionPolicy: 'Spool selection policy',
    spoolSelectionPolicyDesc: 'How the dispatcher and manual prints pick a spool when several AMS slots match.',
    spoolPolicyFirstLoaded: 'First loaded (FIFO)',
    spoolPolicyLowestRemaining: 'Lowest remaining',
    spoolPolicySlotOrder: 'AMS slot order',
    spoolPolicyBackupNote: 'Lowest remaining only takes effect when AMS Filament Backup is enabled on the printer — otherwise the printer cannot switch to a second spool when the picked one runs out.',
    minStartSpool: 'Minimum start spool weight (g)',
    ...
    taglessSubtype: 'Subtype',
    taglessSubtypeHint: "Bambu's variant code for the material, e.g. HF = High Flow. Shown on the spool label.",
    taglessColor: 'Color',
    taglessSlicerFilament: 'Slicer filament (optional)',
    taglessSlicerFilamentHint: 'The exact filament preset name your slicer uses, so prints match the right profile.',
    ...
    deleteUserChecking: 'Checking what this delete would remove...',
    deleteUserImpactUnavailable: 'Could not check what this delete would remove. Deleting anyway will remove this user\'s items without a preview.',
    deleteUserArchives_one: '{{count}} print archive',
    deleteUserArchives_other: '{{count}} print archives',
    deleteUserLibraryFiles_one: '{{count}} library file',
    deleteUserLibraryFiles_other: '{{count}} library files',
    deleteUserQueueItems_one: '{{count}} queue item',
    deleteUserQueueItems_other: '{{count}} queue items',
    deleteUserProductionRuns_one: '{{count}} production run',
    deleteUserProductionRuns_other: '{{count}} production runs',
    deleteUserDependentSkus_one: '{{count}} SKU uses a file this user uploaded. That SKU will lose the file and cannot be printed until you re-point it.',
    deleteUserDependentSkus_other: '{{count}} SKUs use files this user uploaded. Those SKUs will lose the files and cannot be printed until you re-point them.',
    deleteUserPrintingNow_one: '{{count}} unit is printing right now. Delete will be refused until it finishes or is stopped.',
    deleteUserPrintingNow_other: '{{count}} units are printing right now. Delete will be refused until they finish or are stopped.',
    deleteUserStillPrinting: 'Still printing on {{printers}}. Stop those prints or wait for them to finish, then delete.',
    // Smart plugs
    ...
    farmProductionDescription: 'Default retry and quarantine policy prefilled into the Start Run dialog. Can be overridden per run.',
    farmEjectCooldown: 'Eject Cooldown',
    farmEjectCooldownDescription: 'How the farm waits for the bed to cool before sweeping a finished plate off, and when it gives up or quarantines a printer that will not cool.',
    farmRetryMaxPerUnit: 'Retries per plate',
    farmRetryMaxPerUnitHelp: 'Automatic retries before a plate is marked failed (0–10)',
    farmEscalateConsecutiveFailures: 'Quarantine after failures',
    farmEscalateConsecutiveFailuresHelp: 'Consecutive failures on a printer that trip a quarantine (1–20)',
    farmCooldownMargin: 'Margin above shop air (°C)',
    farmCooldownMarginHelp: 'The eject line and the chamber-fan step-down sit this far above shop air.',
    shopAir: {
      label: 'Shop air',
      ejectLine: 'Eject line',
      noReading: 'no reading',
      atPlateau: 'at plateau',
      fresh_one: 'Measured inside {{count}} printer at rest, {{minutes}} min ago — reads slightly above room air.',
      fresh_other: 'Measured inside {{count}} printers at rest, {{minutes}} min ago — reads slightly above room air.',
      carried: 'Carried from {{time}} along the day curve.',
      unknown: 'No reading yet — each cooldown releases when the bed stops cooling.',
      readFailed: 'Shop-air read failed — retrying every minute.',
    },
    farmOfflineStallMinutes: 'Offline stall (min)',
    ...
    farmCooldownStallEpsilonHelp: 'The bed must drop at least this much between checks to count as still cooling.',
    farmCooldownMaxHold: 'Give-up timer (min)',
    ...
    farmCooldownPlateauMarginHelp: 'If cooling stalls with the bed within this many degrees of its own chamber air, treat it as cooled and eject; stuck hotter than that quarantines the printer.',
    farmCooldownAuxFanEnabled: 'Aux fan during cooldown',
    farmCooldownAuxFanEnabledHelp: 'Runs the auxiliary fan from the end of the print until the eject dispatches.',
    farmCooldownAuxFan: 'Aux fan speed (%)',
    farmCooldownAuxFanHelp: 'One speed for the whole cooldown (1–100).',
    farmCooldownChamberFanEnabled: 'Chamber fan during cooldown',
    farmCooldownChamberFanEnabledHelp: 'Sets the air duct to cooling and runs the chamber exhaust fan from the end of the print until the eject dispatches. Printer models without a chamber fan skip it.',
    farmCooldownChamberFan: 'Chamber fan boost speed (%)',
    farmCooldownChamberFanHelp: 'Speed while the chamber air is still above the eject temperature (1–100).',
    farmCooldownChamberFanSustain: 'Chamber fan speed after boost (%)',
    farmCooldownChamberFanSustainHelp: 'Speed once the chamber has reached the eject temperature, until the eject dispatches. 0 stops the fan there. The printer\'s own chamber-cooling speed is 50.',
    ...
    farmPlateBlowoffEnabled: 'Plate blow-off at print start',
    farmPlateBlowoffEnabledHelp: 'Aux fan at full speed across the plate before bed leveling.',
    farmPlateBlowoffSeconds: 'Blow-off time (s)',
    farmPlateBlowoffSecondsHelp: 'Aux fan run time before bed leveling (3–60).',
    ...
    queueCheckIntervalHelp: 'How often the farm re-checks the queue even when nothing happened. A backstop in case a live event is missed — lower reacts sooner but polls more (5–300).',
    dispatchKickDebounce: 'Burst settle delay (sec)',
    dispatchKickDebounceHelp: 'When several things happen at once, wait this brief moment to bundle them into a single dispatch pass instead of many. Higher batches more; lower reacts faster (0.2–10).',
    usbPreflightFreshWindow: 'USB check freshness (sec)',
    usbPreflightFreshWindowHelp: 'Trust a recent "USB drive present" report this many seconds old before re-checking. Higher skips redundant checks; 0 always re-checks (0–120).',
    usbPreflightMaxWait: 'USB check max wait (sec)',
    usbPreflightMaxWaitHelp: 'How long to wait for a fresh "USB present" report before starting a print anyway. Higher is more cautious; lower dispatches sooner (0–10).',
    dispatchParallelLimit: 'Simultaneous printer starts',
    dispatchParallelLimitHelp: 'How many printers can upload and start at the same time in one pass. Higher clears a big queue faster; lower is gentler on the network (1–10).',
    powerStagger: 'Power stagger',
    powerStaggerDescription: 'Free a stagger slot the moment a printer stops drawing heat-up power, instead of always waiting out the full interval. Lets the next printer start sooner while still limiting simultaneous power draw.',
    staggerDynamicRelease: 'Release a slot once the bed is hot',
    staggerDynamicReleaseHelp: 'When on, the next printer may start as soon as the current one finishes heating its bed, rather than waiting for the whole interval to pass. When off, every slot waits the full interval.',
    staggerReleaseEpsilon: 'At-temperature margin (°C)',
    staggerReleaseEpsilonHelp: 'How close to the target bed temperature counts as "hot enough" to free the slot early. Larger releases the next printer sooner.',
    staggerHeatupGrace: 'Heat-up grace (seconds)',
    staggerHeatupGraceHelp: 'If a printer has not started heating its bed yet, wait this long before freeing its slot anyway, so an idle printer does not hold up the batch.',
    ...
    erp: {
      title: 'ERP Directory Login',
      statusActive: 'ERP login: active',
      statusInactive: 'ERP login: not configured',
      activeDesc: 'Operators can sign in with their ERP directory credentials.',
      inactiveDesc: 'Add and save the connection details below to activate ERP login.',
      disableHint: 'To turn ERP login off, clear the host and database name below, then save.',
      connectionConfig: 'ERP Directory Connection',
      host: 'Database Host',
      port: 'Port',
      ...
      sslHint: 'Require an encrypted connection to the ERP database.',
      roleMapping: 'Role Mapping',
      roleMappingHint: 'Assign a BamBuddy group to each ERP role.',
      roleMappingNoGroup: '— No group —',
      roleMappingGroupFor: 'BamBuddy group for {{role}}',
      settingsSaved: 'ERP directory settings saved',
      errors: {
        hostRequired: 'Database host is required',
    ...
    oidc: {
      ...
      form: {
        ...
        groupsClaimDesc: 'Token claim that carries the user group or role values. Leave blank to disable group sync from this provider.',
        groupsClaimPlaceholder: 'groups',
        groupMapping: 'Group Mapping',
        groupMappingDesc: 'Map each claim value to a BamBuddy group. Matching users receive the mapped group on login.',
        groupMappingNone: 'No mappings configured.',
        groupMappingClaimValue: 'Claim value',
        groupMappingGroup: 'BamBuddy group',
        groupMappingSelectGroup: 'Select group',
        groupMappingRemove: 'Remove mapping',
        groupMappingAdd: 'Add mapping',
        autologin: 'Autologin',
  ...
  fileManager: {
    ...
    createSkuFromUploadToast: 'Uploaded {{filename}} — create a SKU from it?',
    createSkuFromUploadAction: 'Create SKU from this file',
    ...
    deleteFolderConfirm: 'Are you sure you want to delete this folder? Files inside move to the trash and can be restored to the root; the folder itself is deleted permanently.',
    deleteFileConfirm: 'Are you sure you want to delete this file?',
    deleteFilesConfirm: 'Are you sure you want to delete {{count}} selected files? They move to the trash and can be restored.',
    deleting: 'Deleting...',
  ...
  inventory: {
    ...
    freshRoll: {
      ...
      sameRoll: 'Same roll',
      reviewAction: 'Review…',
      title: 'Fresh roll on this slot?',
      message: 'The tagless spool at {{location}} has been used past most of its label weight. If a fresh roll is now loaded, record it so filament tracking stays accurate.',
      confirm: 'Fresh roll',
      pending: 'Recording…',
      success: 'Recorded a fresh roll',
      failed: 'Failed to record the fresh roll',
      dismissFailed: 'Couldn\'t dismiss the fresh-roll prompt',
      remaining: '{{grams}} g tracked as remaining',
      brandLabel: 'Brand',
      brandPlaceholder: 'e.g. Overture',
      ...
      manualDesc: 'Retire this record and start a fresh one',
      manualTitle: 'Mark as a new roll?',
      manualMessage: 'Retire the record at {{location}} ({{grams}} g used) and start a fresh full one for this slot. Do this only after physically swapping in a new roll.',
      manualConfirm: 'Mark as new roll',
    },
    respool: {
      title: 'Re-spool this tag?',
      manualTitle: 'Move this tag onto a new roll?',
      manualMessage: 'Retire the record at {{location}} ({{grams}} g used) and move its Bambu tag onto a fresh full roll. Do this only after physically swapping in a new roll.',
      message: 'A reused Bambu tag was detected at {{location}}. If it now sits on a fresh third-party spool, re-spool it to a full record.',
      confirm: 'Re-spooled — fresh spool',
      pending: 'Re-spooling…',
      success: 'Re-spooled to a fresh {{brand}} spool',
      failed: 'Failed to re-spool tag',
      autoToast: 'Auto re-spooled {{brand}} on {{printer}} slot {{slot}}',
      reusedTagToast: 'Possible new roll on a reused tag — {{printer}} slot {{slot}}',
      ...
      triggerSpent: 'This roll reported running out, and the slot has been handled since.',
      triggerRemainJump: 'The AMS reports far more filament than this record holds — the tag looks like it moved onto a refilled roll.',
      sameSpoolAction: 'Same spool',
      reviewAction: 'Review…',
      dismissFailed: 'Couldn\'t dismiss the re-spool prompt',
      donorLine: 'Replaces the tracked spool ({{grams}} g left); the old record is archived',
      donorRecordTitle: 'Record #{{id}}',
      detailsLabel: 'Details',
      tagIdLabel: 'Tag ID',
      warning: 'Use only ONE tag per donor roll — discard the second tag.',
      brandLabel: 'Brand',
      brandPlaceholder: 'e.g. Overture',
      weightLabel: 'Label weight (g)',
      weightPlaceholder: 'e.g. 1000',
    ...
    returnToRotationDone: 'Spool returned to rotation',
    returnToRotationFailed: 'Could not return spool to rotation',
  ...
  ams: {
    ...
    slotSpentSwapPark: '{{printer}}: {{ams}} slot {{slot}} is held by a spent spool with nothing to release it. Re-check the slot, or swap the roll.',
    ...
    emptySlotBinding: {
      ...
      unassignAria: 'Unassign {{spool}} from this slot',
      unassignTitle: 'Unassign this spool?',
      unassignMessage: 'Release {{spool}} from this slot. The spool returns to inventory with its recorded usage intact — nothing is deleted.',
    },
    unknown: 'Unknown',
    humidity: 'Humidity',
    temperature: 'Temperature',
  ...
  printModal: {
    ...
    reread: 'Re-read',
    requiredTooltip: 'Required: {{type}} - {{color}}',
    manuallySelected: 'Manually selected',
    autoMatched: 'Auto-matched',
    externalSlotNote: 'External spool — not weight-tracked; the printer will demand filament on the holder.',
    ...
    locationFilter: 'Location Filter (optional)',
    anyLocation: 'Any location',
    schedulerAssignHint: 'Scheduler will assign to first available idle {{model}} printer',
    schedulerAssignHintLocation: 'Scheduler will assign to first available idle {{model}} printer in {{location}}',
    selectPrinters: 'Select printers',
    printersSelected_one: '{{count}} printer selected',
    printersSelected_other: '{{count}} printers selected',
    selectAll: 'Select all',
    inactive: '(inactive)',
    ...
    autoButton: 'Auto',
    hiddenPrinters_one: '{{count}} other printer hidden (different model) —',
    hiddenPrinters_other: '{{count}} other printers hidden (different model) —',
    showAll: 'show all',
    showOnlyModelPrinters: 'Show only {{model}} printers',
    selectAtLeastOnePrinter: 'Select at least one printer',
    selectTargetModel: 'Select a target printer model',
    typeNotFound: '(Type not found)',
    colorMismatch: '(Color mismatch)',
    ready: '(Ready)',
    clickToChangeSlot: 'Click to change slot assignment',
    costNotAvailable: 'N/A',
    requiredTypeNotFound: 'Required filament type not found in printer.',
    printJob: 'Print Job',
    slicedModelMismatch: 'File was sliced for {{slicedModel}}, but printing on {{printerModel}}',
    ...
    toastQueueItemUpdated: 'Queue item updated',
    toastUpdateFailed: 'Failed to update queue item',
    toastSelectPrinter: 'Please select at least one printer',
    toastSelectModel: 'Please select a target printer model',
    toastQueuedForModel: 'Queued for any {{model}}',
    ejectFromSku: 'Default from SKU {{code}}',
    partialFailureTitle: '{{failed}} of {{total}} dispatches failed:',
    toastPartialSuccess: '{{success}} succeeded, {{failed}} failed',
    printerFallback: 'Printer {{id}}',
    slotFallback: 'Slot {{id}}',
    plateFallback: 'Plate {{index}}',
  },
  ...
  uploadModal: {
    ...
    libraryHint: 'For SKUs and production runs, upload in File Manager instead.',
    libraryHintLink: 'Go to File Manager →',
    uploaded: 'uploaded',
    failed: 'failed',
    uploading: 'Uploading...',
    upload: 'Upload',
  ...
  notifications: {
    ...
    storageLow: 'USB storage low',
    cooldownEscalation: 'Cooldown running long',
    // Quiet hours
    quietHours: 'Quiet Hours',
  ...
  fleetMetrics: {
    ...
    sections: {
      fleet: 'Fleet',
      matrix: 'Fleet matrix',
      stateOverTime: 'Printers by state over time',
      printsPerDay: 'Prints per day',
      downtimeByCause: 'Downtime by cause',
      coolingAndEject: 'Cooling and eject',
      recovery: 'Recovery',
      partsBySku: 'Parts by SKU',
    },
    summary: {
      now: 'Now',
      trend: 'Trend',
      trendOf: '{{metric}} trend',
      ...
      rows: {
        ...
        avg_cycle_overhead: 'Between prints',
        avg_idle: 'Idle',
        avg_down: 'Down',
        avg_planned: 'Maintenance',
        peak_down: 'Peak down',
        printers_in_fleet: 'In fleet',
        prints_per_day: 'Prints',
        prints_per_printer_per_day: 'Prints per printer',
        uptime: 'Uptime',
        time_printing: 'Time printing',
      },
      peak: 'peak {{count}}',
      downNow: 'Down now',
      nothingDown: 'Nothing down',
      showFewer: 'Show fewer',
      updated: 'Updated {{time}}',
      stale: 'Status {{age}} old',
      openPrinter: 'Open printer',
    },
    class: {
      cycle_overhead: 'Between prints',
      cooling: 'Cooling',
      ejecting: 'Ejecting',
      down: 'Down',
      planned: 'Maintenance',
      out_of_fleet: 'Deactivated',
    ...
    matrix: {
      ...
      caption: '{{lens}} by printer, {{from}} to {{to}}',
      captionDay: '{{lens}} by printer, {{date}}',
      details: 'Details',
    ...
    detail: {
      ...
      timeSplit: 'Time split',
      classes: 'Where the time went',
      printsByOutcome: 'Prints by outcome',
      outcome: {
        completed: 'Completed',
        failed: 'Failed',
        cancelled: 'Cancelled',
      ...
      incidents: 'Incidents',
      openPrinter: 'Open printer',
      noIntervals: 'No intervals recorded for this period.',
      noIncidents: 'No incidents in this period.',
      noPrints: 'No prints in this period.',
      ongoing: 'Ongoing',
    },
    widgets: {
      showData: 'Show data',
      showChart: 'Show chart',
      showDataFor: 'Show data for {{chart}}',
      showChartFor: 'Show chart for {{chart}}',
      median: 'Median',
      p90: 'P90',
      ...
      clearedNoPerson: 'Cleared with no person',
      inFleetLine: 'In fleet',
      peakDownLine: 'Peak down',
      sku: 'SKU',
      units: 'Units',
      plates: 'Plates',
      successRate: 'Success',
    ...
    states: {
      loading: 'Loading…',
      loadFailed: 'Could not load fleet history.',
      retry: 'Retry',
      empty: 'No data for this range.',
      recordingGap: 'Printer state recording started {{date}}. Fault and maintenance history from {{earliest}}.',
    },
    header: {
    ...
    hints: {
      ...
      cycle_overhead: 'The farm’s own work between prints: cooling the bed, then sweeping the part off it.',
      planned: 'Maintenance mode: a person put the printer out of the automatic lanes.',
      uptime: 'Share of counted time the printer could take work.',
      time_printing: 'Share of counted time the printer was printing.',
      prints_per_printer: 'Completed prints divided by the days each printer was counted. Counted days come from recorded buckets only, so this does not compare with Prints while part of the window is unrecorded.',
      unobserved: 'Nothing was recorded for this stretch, so only faults and holds are known about it.',
      not_recorded: 'Earlier than the first state ever recorded for this printer.',
      incidents_only: 'Printer state was not recorded here; only the fault and maintenance ledger covers it.',
      whileRecorded: 'Period figures cover recorded time only.',
      timeframeFleet: 'Days run midnight to midnight in {{tz}}.',
      timeframePrints: 'Days run midnight to midnight UTC.',
    },
  },
};
