export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      cooldownRetries: 'Cooldown retries',
    ...
    tooltips: {
      ...
      cooldownRetries: 'How many times to re-check the bed temperature while waiting for it to reach the cooldown target before giving up.',
  ...
  printers: {
    ...
    phase: {
      printing: 'Printing',
      cooling: 'Cooling to {{threshold}}°C (bed {{bed}}°C) — sweep runs in-file',
  ...
  settings: {
    ...
    farmRetryMaxPerUnitHelp: 'Automatic retries before a plate is marked failed (0–5)',
    farmEscalateConsecutiveFailures: 'Quarantine after failures',
    farmEscalateConsecutiveFailuresHelp: 'Consecutive failures on a printer that trip a quarantine (1–10)',
