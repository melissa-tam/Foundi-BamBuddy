export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      coolingFanAssist: 'Cooling fan assist',
    ...
    tooltips: {
      ...
      coolingFanAssist: 'Runs the part-cooling fan during the sweep to help a stubborn part let go of the plate.',
  ...
  printers: {
    ...
    eject: {
      ...
      foreignBody: 'This print wasn\'t dispatched by the farm (it was sent manually from Bambu Studio). The sweep will use the eject profile you select below — confirm the detected part height looks right first.',
      foreignPrintNameLabel: 'Print',
      foreignUnknownPrint: 'Unknown',
      foreignPartHeightLabel: 'Detected part height',
