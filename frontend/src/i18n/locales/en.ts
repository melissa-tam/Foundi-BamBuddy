export default {
  ...
  fleetMetrics: {
    ...
    matrix: {
      ...
      caption: '{{lens}} per printer, {{from}} to {{to}}',
      details: 'Details',
    ...
    states: {
      ...
      firstRun: 'Printer state recording started {{date}}. Fault and maintenance history from {{earliest}}.',
    },
    header: {
    ...
    hints: {
      ...
      prints_per_printer: 'Completed prints divided by the days each printer was counted.',
