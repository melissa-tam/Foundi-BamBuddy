export default {
  ...
  printers: {
    ...
    quarantine: {
      badge: 'Quarantined',
      clear: 'Clear quarantine',
      cleared: 'Quarantine cleared',
      clearTitle: 'Clear quarantine?',
      clearMessage: 'Lift the quarantine on "{{name}}"? The scheduler will resume dispatching prints to it.',
      clearMessageWithReason: 'Lift the quarantine on "{{name}}"? Reason: {{reason}}. The scheduler will resume dispatching prints to it.',
    },
    plateStatus: {
