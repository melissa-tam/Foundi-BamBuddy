export default {
  ...
  printers: {
    ...
    quarantine: {
      badge: 'Em quarentena',
      clear: 'Remover quarentena',
      cleared: 'Quarentena removida',
      clearTitle: 'Remover a quarentena?',
      clearMessage: 'Suspender a quarentena de "{{name}}"? O agendador voltará a enviar impressões para esta impressora.',
      clearMessageWithReason: 'Suspender a quarentena de "{{name}}"? Motivo: {{reason}}. O agendador voltará a enviar impressões para esta impressora.',
    },
    plateStatus: {
