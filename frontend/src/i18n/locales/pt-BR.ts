export default {
  ...
  inventory: {
    ...
    freshRoll: {
      ...
      message: 'A bobina sem etiqueta em {{location}} já foi usada além da metade do seu peso nominal. Se um rolo novo estiver carregado agora, registre-o para que o rastreamento de filamento continue preciso.',
      confirm: 'Rolo novo',
      pending: 'Registrando…',
    ...
    respool: {
      ...
      promptToast: 'Bobina quase vazia em {{printer}} slot {{slot}} — novo rolo nesta etiqueta?',
