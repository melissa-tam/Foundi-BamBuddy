export default {
  ...
  settings: {
    ...
    ejectUploadSkipIdentical: 'Reutilizar arquivos de ejeção já presentes na unidade USB',
    ejectUploadSkipIdenticalHelp: 'Pula o reenvio de um arquivo de ejeção quando o idêntico já está na unidade USB da impressora, economizando alguns segundos por ejeção.',
    ejectUploadSkipIdenticalWarning: 'Ative somente depois que a sonda de ejeção ao vivo confirmar que o arquivo na unidade é reutilizado corretamente. Na dúvida, deixe desativado — um reenvio sempre garante o arquivo certo.',
    ejectSlim3mf: 'Enxugar os arquivos de ejeção',
    ejectSlim3mfHelp: 'Remove o modelo 3D e a imagem de pré-visualização dos arquivos de ejeção para que enviem mais rápido — o movimento de ejeção em si não muda.',
    ejectSlim3mfWarning: 'Restrito por hardware: execute a escada de hardware de ejeção completa com arquivos enxutos antes de ativar para produção autônoma. Deixe desativado até essa escada passar.',
