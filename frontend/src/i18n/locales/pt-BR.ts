export default {
  ...
  productionRuns: {
    ...
    fields: {
      ...
      cooldownOverride: 'Substituir resfriamento (°C)',
      cooldownPlaceholder: 'Usar padrão do perfil',
      cooldownProfileDefault: 'Substitui o padrão do perfil: {{value}}°C',
  ...
  ejectProfiles: {
    ...
    fields: {
      name: 'Nome',
      cooldownTemp: 'Temperatura de resfriamento (°C)',
      clearance: 'Folga (mm)',
    ...
    tooltips: {
      ...
      cooldownTemp: 'Temperatura da mesa até a qual a impressão deve esfriar antes da varredura – as peças se soltam da placa quando frias.',
    ...
    geometry: {
      ...
      cooldownAmbientTrap: 'Abaixo do piso de aviso de resfriamento ({{floor}} °C). Um limite igual ou abaixo da temperatura ambiente da oficina nunca pode ser atingido e a espera de ejeção travaria para sempre — defina alguns graus acima do ambiente.',
    ...
    queueHelp: 'A peça é empurrada para fora depois que a mesa esfria abaixo do limite do perfil.',
  },
  // Navigation
  nav: {
    printers: 'Impressoras',
  ...
  settings: {
    ...
    farmCooldownWarnFloor: 'Piso de aviso de resfriamento (°C)',
    farmCooldownWarnFloorHelp: 'Avisar quando o limite de resfriamento de um perfil de ejeção estiver abaixo — um limite igual ou abaixo do ambiente da oficina nunca conclui (15–50)',
