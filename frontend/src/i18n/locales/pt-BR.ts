export default {
  ...
  printers: {
    ...
    eject: {
      ...
      foreignTitle: 'Ejetar uma impressão externa?',
      foreignBody: 'Esta impressão não foi enviada pela fazenda. A varredura usa o perfil de ejeção selecionado abaixo — corrija a altura da peça se o valor detectado estiver errado.',
