export default {
  ...
  printers: {
    ...
    eject: {
      ...
      foreignBody: 'Esta impressão não foi enviada pela fazenda (foi enviada manualmente pelo Bambu Studio). A varredura usará o perfil de ejeção selecionado abaixo — confirme primeiro se a altura da peça detectada está correta.',
      foreignPrintNameLabel: 'Impressão',
      foreignUnknownPrint: 'Desconhecida',
      foreignPartHeightLabel: 'Altura da peça detectada',
