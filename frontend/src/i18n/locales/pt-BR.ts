export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      cooldownRetries: 'Tentativas de resfriamento',
      clearance: 'Folga (mm)',
    ...
    tooltips: {
      ...
      cooldownRetries: 'Quantas vezes a temperatura da mesa é verificada novamente enquanto se aguarda que atinja o alvo antes de desistir.',
  ...
  printers: {
    ...
    phase: {
      printing: 'Imprimindo',
      cooling: 'Resfriando até {{threshold}}°C (placa {{bed}}°C) — a varredura roda no arquivo',
  ...
  settings: {
    ...
    farmRetryMaxPerUnitHelp: 'Tentativas automáticas antes de uma placa ser marcada como falha (0–5)',
    farmEscalateConsecutiveFailures: 'Quarentena após falhas',
    farmEscalateConsecutiveFailuresHelp: 'Falhas consecutivas em uma impressora que disparam uma quarentena (1–10)',
