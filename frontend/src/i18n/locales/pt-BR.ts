export default {
  ...
  skus: {
    ...
    suggest: {
      title: 'Sugerir do arquivo',
      description: 'Escolha um arquivo fatiado para preencher o código, o número da peça e o nome a partir dos seus metadados.',
      file: 'Arquivo da biblioteca',
      filePlaceholder: 'Selecione um arquivo…',
      action: 'Sugerir',
      applied: 'Dados preenchidos de {{source}}',
  ...
  settings: {
    ...
    autoAddUntaggedDesc: 'Criar silenciosamente uma bobina de inventário para bandejas AMS que não têm etiqueta RFID. Desative se você registra as bobinas manualmente para evitar duplicatas.',
    ...
    farmCooldownStallWindow: 'Janela de estagnação do resfriamento (min)',
    farmCooldownStallWindowHelp: 'Durante o resfriamento de ejeção a mesa deve continuar esfriando; duas janelas consecutivas sem progresso colocam a impressora em quarentena (0 desativa)',
    farmCooldownStallEpsilon: 'Resfriamento mín. por janela (°C)',
    farmCooldownStallEpsilonHelp: 'Resfriamento mínimo (°C) por janela que conta como progresso',
    farmCooldownMaxHold: 'Espera máx. de resfriamento (min)',
    farmCooldownMaxHoldHelp: 'Após estes minutos acima do limiar de liberação, a ejeção é executada mesmo assim (0 = aguardar o limiar indefinidamente)',
    farmCooldownPlateauMargin: 'Margem de ejeção em platô (°C)',
    farmCooldownPlateauMarginHelp: 'Se o resfriamento estabilizar dentro destes °C do limiar de liberação, ejetar (a mesa estabilizou na temperatura ambiente) em vez de colocar em quarentena. Acima do limiar + margem a mesa está realmente presa quente e a impressora é colocada em quarentena',
  ...
  inventory: {
    ...
    respool: {
      ...
      donorLine: 'Registro atual nº {{id}} — {{grams}} g restantes — será arquivado',
