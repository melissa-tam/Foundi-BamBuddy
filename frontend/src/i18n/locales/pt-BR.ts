export default {
  ...
  fleetMetrics: {
    ...
    matrix: {
      ...
      caption: '{{lens}} por impressora, de {{from}} a {{to}}',
      details: 'Detalhes',
    ...
    states: {
      ...
      firstRun: 'Registro do estado das impressoras desde {{date}}. Histórico de falhas e manutenção desde {{earliest}}.',
    },
    header: {
    ...
    hints: {
      ...
      prints_per_printer: 'Impressões concluídas divididas pelos dias contabilizados de cada impressora.',
