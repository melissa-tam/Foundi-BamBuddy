export default {
  // Catálogo de SKU (produção de fazenda, fase 2)
  skus: {
    nav: 'Referências',
    title: 'Catálogo de SKU',
    description: 'Códigos de peças vendáveis, cada um vinculando uma ou mais placas de arquivos da biblioteca além de um perfil de ejeção padrão para as execuções de produção.',
    newSku: 'Novo SKU',
    loadError: 'Não foi possível carregar os SKUs.',
    empty: {
      title: 'Nenhum SKU ainda',
      body: 'Crie seu primeiro SKU para vincular arquivos imprimíveis e acompanhar a produção.',
    },
    columns: {
      files: 'Arquivos',
      unitsCompleted: 'Unidades totais',
      successRate: 'Sucesso',
    },
    createTitle: 'Criar SKU',
    ...
    fields: {
      ...
      notes: 'Notas',
      defaultEjectProfile: 'Perfil de ejeção padrão',
      noEjectProfile: 'Nenhum',
    },
    codeRequired: 'O código é obrigatório.',
    nameRequired: 'O nome é obrigatório.',
    created: 'SKU criado',
    updated: 'SKU atualizado',
    deleted: 'SKU excluído',
    saveFailed: 'Não foi possível salvar o SKU',
    deleteFailed: 'Não foi possível excluir o SKU',
    deleteTitle: 'Excluir este SKU?',
    deleteBody: '"{{code}}" será removido permanentemente. Isso não pode ser desfeito.',
    suggest: {
      appliedFromObjectName: 'Detalhes preenchidos a partir dos nomes das peças no arquivo',
      appliedFromFilename: 'Detalhes preenchidos a partir do nome do arquivo',
      appliedGeneric: 'Dados preenchidos do arquivo',
      failed: 'Não foi possível sugerir os detalhes',
    },
    files: {
      ...
      added: 'Arquivo vinculado',
      addFailed: 'Não foi possível vincular o arquivo',
      savedButLinkFailed: 'O SKU foi salvo, mas não foi possível vincular o arquivo: {{reason}}',
      remove: 'Remover',
      removed: 'Arquivo desvinculado',
      removeFailed: 'Não foi possível desvincular o arquivo',
      removeTitle: 'Desvincular este arquivo?',
      removeBody: '"{{name}}" será desvinculado deste SKU.',
    },
  },

  // Execuções de produção (produção de fazenda, fase 2)
  productionRuns: {
    nav: 'Produção',
    title: 'Execuções de produção',
    description: 'Distribua cópias de um SKU entre as impressoras até atingir uma contagem de unidades alvo, com progresso ao vivo.',
    loadError: 'Não foi possível carregar as execuções de produção.',
    empty: {
      title: 'Nenhuma execução de produção ainda',
      body: 'Inicie uma execução para imprimir um SKU até uma contagem de unidades alvo.',
      noSkus: 'Adicione um SKU com pelo menos um arquivo vinculado antes de iniciar uma execução.',
    },
    startTitle: 'Iniciar execução de produção',
    startAction: 'Iniciar execução',
    runAgain: 'Executar novamente',
    advanced: 'Avançado',
    starting: 'Iniciando…',
    started: 'Execução de produção iniciada',
    startFailed: 'Não foi possível iniciar a execução',
    noFiles: 'Este SKU não tem arquivos vinculados para imprimir.',
    fileRequired: 'Selecione um arquivo para imprimir.',
    targetRequired: 'Insira um alvo de pelo menos 1 unidade.',
    printerRequired: 'Selecione pelo menos uma impressora.',
    overProduction: 'Produzirá {{planned}} unidades ({{plates}} placas) — {{extra}} a mais do que o alvo de {{target}}.',
    fields: {
      sku: 'SKU',
      file: 'Arquivo / placa',
      filePlaceholder: 'Selecione um arquivo…',
      ...
      skuNoFile: '— nenhum arquivo vinculado',
      skuNoFileHint: 'Vincule um arquivo a um SKU na página de SKUs para torná-lo iniciável.',
    },
    status: {
      active: 'Ativa',
      paused: 'Pausada',
    ...
    startedNow: 'Execução iniciada',
    reschedule: 'Reagendar',
    rescheduleTitle: 'Reagendar horário de início',
    rescheduled: 'Horário de início atualizado',
    schedule: {
      sectionTitle: 'Horário de início',
      whenToStart: 'Quando iniciar',
      asap: 'Iniciar assim que possível',
      later: 'Agendar para mais tarde',
      date: 'Data',
      time: 'Hora',
      openCalendar: 'Abrir calendário',
      pastError: 'Escolha um horário no futuro.',
      invalidError: 'Informe uma data e hora válidas.',
      helpAsap: 'A execução começa assim que uma impressora adequada estiver livre.',
      helpScheduled: 'A execução começa no horário escolhido se uma impressora estiver livre; caso contrário, aguarda até que uma fique.',
      startsIn: 'Começa {{when}}',
    },
    viewDetails: 'Ver detalhes da série',
    blockedPrinters: 'Impressora bloqueada',
    pauseReason: {
      operator: 'Pausada pelo operador',
    ...
    detail: {
      back: 'Todas as séries de produção',
      loadError: 'Não foi possível carregar esta série de produção.',
      notFound: 'Série de produção não encontrada.',
      printersTitle: 'Impressoras',
      noPrinters: 'Nenhuma impressora atribuída ainda — o agendador escolhe uma impressora livre compatível por unidade.',
      unitsTitle: 'Unidades',
      noUnits: 'Ainda não há unidades.',
      unitCol: 'Unidade',
      statusCol: 'Status',
      ...
      retryOf: 'Nova tentativa nº {{count}} da unidade {{id}}',
      unitStatus: {
        pending: 'Pendente',
        printing: 'Imprimindo',
        completed: 'Concluída',
      ...
      waiting: {
        ...
        visionHold: 'Pausada na verificação da placa — corrija a placa e depois retome',
        ...
        externalFeedFault: 'A bobina externa não alimentou — verifique o suporte e o tubo PTFE, depois retome na impressora',
        pinnedTrayUnavailable: 'O slot fixado não está carregado nesta impressora — carregue-o ou remova a fixação',
        ...
        libraryFileMissing: 'Arquivo de origem ausente na biblioteca — restaure o arquivo ou envie-o novamente',
      ...
      printerState: {
        ...
        modelMismatch: 'Modelo divergente',
        stalled: 'Offline no meio da impressão',
        visionHold: 'Retida na verificação da placa',
        filamentShort: 'Filamento insuficiente',
        noUsbDrive: 'Sem unidade USB',
      },
      eligibility: {
        title: 'Impressoras não participantes',
        description: 'Estas impressoras não pegarão unidades desta tanda até resolver:',
        offline: 'Offline',
        quarantined: 'Em quarentena',
        awaitingPlateClear: 'Placa não liberada',
        modelMismatch: 'Modelo divergente',
        filamentShort: 'Filamento insuficiente',
        noUsbDrive: 'Sem unidade USB',
      },
    },
    abortTitle: 'Abortar esta execução?',
    abortBody: '"{{name}}" será cancelada. As placas em andamento terminam, mas nenhuma nova placa é iniciada. Isso não pode ser desfeito.',
    delete: 'Excluir',
    deleted: 'Execução excluída',
    ...
    firstArticle: {
      ...
      requireHelp: 'A primeira peça é impressa sem ejeção automática e a série fica retida aguardando sua aprovação.',
      retriesLabel: 'Tentativas por placa',
      escalateLabel: 'Colocar em quarentena após falhas consecutivas',
      printing: 'Imprimindo a primeira peça',
      awaitingTitle: 'Primeira peça aguardando aprovação',
      awaitingBody: 'A primeira peça foi impressa. Inspecione-a e aprove para continuar a série ou rejeite para parar e revisar.',
      approvePhysical: 'Aprovar — removi a peça',
      approveEject: 'Aprovar e ejetar remotamente',
      reject: 'Rejeitar…',
      approveConfirm: 'Aprovar',
      approvePhysicalTitle: 'Aprovar a primeira peça?',
      approvePhysicalBody: 'Confirme que você removeu a peça impressa da mesa. A série continuará e despachará as placas restantes.',
      approveEjectTitle: 'Aprovar e ejetar remotamente?',
      approveEjectBody: 'O cabeçote varrerá a peça para fora da mesa antes de a série continuar. Verifique se a mesa está livre de obstáculos e se ninguém está com as mãos dentro da impressora.',
      rejectTitle: 'Rejeitar a primeira peça',
      rejectBody: 'Explique o que deu errado. Retomar a série depois reinicia uma nova primeira peça.',
      rejectReasonLabel: 'Motivo',
      rejectReasonPlaceholder: 'ex.: cantos empenados, má aderência…',
      rejectReasonRequired: 'É necessário um motivo.',
      rejectAction: 'Rejeitar a primeira peça',
      rejectedBadge: 'Primeira peça rejeitada',
      rejectedReason: 'Motivo: {{reason}}',
      rejectedHint: 'Retomar reinicia uma nova primeira peça.',
      approvedBadge: 'Primeira peça aprovada',
      approved: 'Primeira peça aprovada',
      rejected: 'Primeira peça rejeitada',
      approveFailed: 'Falha ao aprovar a primeira peça',
      rejectFailed: 'Falha ao rejeitar a primeira peça',
      photoAlt: 'Foto final da primeira peça',
      photoUnavailable: 'Foto final indisponível',
      viewCamera: 'Ver câmera',
      hideCamera: 'Ocultar câmera',
      printerLabel: 'Impressora: {{name}}',
    },
  },

  ejectProfiles: {
    nav: 'Perfis de ejeção',
    title: 'Perfis de ejeção',
    description: 'Perfis de remoção automática que empurram as peças concluídas para fora da mesa assim que ela esfria.',
    newProfile: 'Novo perfil',
    loadError: 'Não foi possível carregar os perfis de ejeção.',
    duplicateAction: 'Duplicar',
    copyName: '{{name}} (cópia)',
    empty: {
      title: 'Ainda não há perfis de ejeção',
      body: 'Crie seu primeiro perfil para remover automaticamente as peças concluídas da mesa.',
    },
    columns: {
      passes: 'Passagens',
      ejectSpeed: 'Velocidade de ejeção',
      maxHeight: 'Altura máx.',
    },
    createTitle: 'Criar perfil de ejeção',
    editTitle: 'Editar perfil de ejeção',
    fields: {
      name: 'Nome',
      clearance: 'Folga (mm)',
      zOffset: 'Deslocamento Z (mm)',
      descentSteps: 'Passos de descida',
      xPasses: 'Passagens em X',
      xMargin: 'Margem X (mm)',
      frontOverhang: 'Saliência frontal (mm)',
      backOverhang: 'Saliência traseira (mm)',
      ejectSpeed: 'Velocidade de ejeção (mm/min)',
      skimSpeed: 'Velocidade de rasamento (mm/min)',
      finalSkim: 'Passada de raspagem final',
      finalSkimHelp: 'Adiciona uma passada de raspagem lenta logo acima da placa após as varreduras para remover resíduos finos. Desligue para empurrar exatamente uma vez.',
      maxPartHeight: 'Altura máx. da peça (mm)',
      sweepStartHeight: 'Altura inicial da varredura (%)',
      sweepStartHeightHelp: 'Iniciar a varredura descendente nesta porcentagem da altura da peça (100% = topo da peça).',
      sweepBand: 'Restringir a faixa X da varredura',
      sweepBandHelp: 'Varrer apenas uma sub-faixa da largura da mesa em vez da largura total. Deixe desativado para a largura total.',
      sweepXMin: 'Mín. da faixa X (mm)',
      sweepXMax: 'Máx. da faixa X (mm)',
      bedDrop: 'Assistência de liberação por descida da mesa',
      bedDropHelp: 'A mesa desce quase até o fundo da máquina e volta à altura de elevação; o solavanco solta uma peça grudada antes da varredura.',
      bedDropClearance: 'Folga inferior (mm)',
      bedDropDwell: 'Espera no ponto baixo (s)',
      bedDropDwellHelp: 'A mesa permanece no ponto baixo da descida por estes segundos antes de voltar à altura de elevação.',
      bedDropJitter: 'Sacudida no ponto baixo',
      bedDropJitterHelp: 'No ponto baixo da descida, a mesa sobe e retorna a distância definida, pelo número de ciclos definido.',
      bedDropJitterCycles: 'Ciclos de sacudida',
      bedDropJitterMm: 'Curso da sacudida (mm)',
    },
    tooltips: {
      name: 'Um rótulo curto para reconhecer este perfil – exibido na lista de perfis e nos seletores.',
      clearance: 'A que altura acima da peça a cabeça permanece ao se posicionar, para não tocá-la antes da varredura.',
      zOffset: 'Ajuste fino da altura da varredura – aumente se o bico arrastar, diminua se a peça for perdida.',
      descentSteps: 'Número de pequenas descidas que a cabeça faz para ficar atrás da peça antes de empurrá-la.',
      xPasses: 'Quantas passadas de varredura laterais fazer sobre a mesa para remover a peça.',
      xMargin: 'Folga mantida em relação às bordas esquerda e direita da mesa para que a cabeça nunca atinja a estrutura.',
      frontOverhang: 'O quanto a varredura avança além da frente da peça para empurrá-la totalmente.',
      backOverhang: 'A que distância atrás da peça a varredura começa, para que a cabeça fique totalmente atrás dela antes de empurrar.',
      ejectSpeed: 'A que velocidade a cabeça se move durante as passadas de empurrão que jogam a peça para fora da placa.',
      skimSpeed: 'A que velocidade a cabeça se move durante as passadas de raspagem mais leves que removem os resíduos.',
      finalSkim: 'Executa uma passada lenta adicional logo acima da placa após as varreduras principais para remover os resíduos finos. Desligue para um único empurrão (por exemplo, uma única pista a meia altura para uma peça alta).',
      maxPartHeight: 'Peça mais alta que este perfil pode ejetar – o envio é bloqueado se a peça fatiada for mais alta.',
      sweepStartHeight: 'Altura na peça onde a varredura descendente começa, em porcentagem (válido 1-100%; 100% = o topo da peça).',
      sweepBand: 'Varrer apenas uma faixa da mesa em vez de toda a largura – útil quando as peças ficam sempre no mesmo lugar.',
      sweepXMin: 'Borda esquerda da faixa de varredura, em mm a partir da origem da mesa. Válido 0-340 mm (largura da mesa H2S); deve ser menor que o máximo e deixar uma faixa de pelo menos 10 mm de largura.',
      sweepXMax: 'Borda direita da faixa de varredura, em mm a partir da origem da mesa. Válido 0-340 mm (largura da mesa H2S); deve ser maior que o mínimo e deixar uma faixa de pelo menos 10 mm de largura.',
      bedDrop: 'A mesa aquecida desce quase até o ponto mais baixo e volta à altura de elevação; o solavanco solta uma peça grudada antes da varredura. Requer um curso Z registrado para o modelo.',
      bedDropClearance: 'Distância mantida em relação à posição mais baixa da mesa durante a descida — 50 mm = parar 5 cm acima do fundo.',
      bedDropDwell: 'Alguns segundos a mais no ponto baixo dão tempo para uma peça grudada terminar de se soltar antes da varredura.',
      bedDropJitter: 'Curtos movimentos de sobe e desce no ponto baixo soltam uma peça que o solavanco único deixa presa.',
    },
    nameRequired: 'O nome é obrigatório.',
    created: 'Perfil de ejeção criado',
    updated: 'Perfil de ejeção atualizado',
    deleted: 'Perfil de ejeção excluído',
    saveFailed: 'Falha ao salvar o perfil',
    deleteFailed: 'Falha ao excluir o perfil',
    deleteTitle: 'Excluir este perfil?',
    deleteBody: '"{{name}}" será removido permanentemente. Isso não pode ser desfeito.',
    preview: {
      title: 'Visualização e validação',
      description: 'Gere o G-code de ejeção para um arquivo da biblioteca e uma mesa para validá-lo antes de usar.',
      file: 'Arquivo da biblioteca',
      filePlaceholder: 'Selecione um arquivo…',
      plate: 'Mesa',
      run: 'Gerar visualização',
      running: 'Gerando…',
      noFiles: 'Nenhum arquivo da biblioteca disponível para visualização.',
      ...
      gcodeLabel: 'G-code gerado',
      failed: 'Falha na visualização',
    },
    dryRun: {
      action: 'Teste a seco',
      title: 'Teste de ejeção a seco',
      description: 'Envie um teste apenas de geometria deste perfil para uma impressora, ou baixe o arquivo de teste para inspecioná-lo.',
      printer: 'Impressora',
      printerPlaceholder: 'Selecione uma impressora conectada…',
      loadingPrinters: 'Verificando as conexões das impressoras…',
      noPrinters: 'Nenhuma impressora conectada disponível.',
      warningTitle: 'Mesa vazia obrigatória',
      warning: 'Este teste faz o referenciamento no centro da mesa e varre sobre ela, então a placa deve estar VAZIA. Após o envio, o trabalho aguarda até você liberar a retenção da placa na impressora.',
      dispatch: 'Enviar teste',
      dispatching: 'Enviando…',
      download: 'Baixar arquivo',
      downloading: 'Preparando…',
      dispatchFailed: 'Não foi possível enviar o teste.',
      downloadFailed: 'Não foi possível gerar o arquivo de teste a seco.',
      allowUnvalidated: 'Permitir geometria não validada (apenas para a escada de hardware)',
      allowUnvalidatedWarning: 'A envoltória deste modelo NÃO foi validada por hardware. Envie apenas na escada, supervisionado e com a mesa VAZIA.',
    },
    geometry: {
      model: 'Modelo de impressora',
      noModels: 'Nenhuma entrada no registro de geometria',
      unvalidated: 'sem validação de hardware',
      warningsTitle: 'Avisos de geometria',
      downloadModel: 'Modelo de geometria para o download',
      downloadModelPlaceholder: 'Usar o modelo da impressora selecionada',
      bandInverted: 'O mínimo da banda X deve ser menor que o máximo da banda X.',
      bandTooNarrow: 'A banda de varredura deve ter pelo menos {{min}} mm de largura.',
      bandExceedsBed: 'O máximo da banda X ultrapassa a mesa registrada mais larga ({{max}} mm).',
      heightExceedsCeiling: 'Acima do teto de altura de todos os modelos registrados (máx. {{max}} mm) — o envio de ejeção seria recusado.',
      bedDropNoTravel: 'Modelos sem um curso Z registrado ({{models}}) não podem gerar este perfil — defina z_travel_mm no registro de geometria.',
      bedDropBedslinger: 'A assistência de descida da mesa não está disponível em modelos de mesa móvel ({{models}}) — a mesa deles não se move em Z.',
    },
    geometryManager: {
      title: 'Registro de geometria dos modelos',
      description: 'Tamanho da mesa, envoltória de deslocamento e estado de validação de hardware de cada modelo de impressora. As linhas vêm das sementes do servidor — não há botão para adicionar; edite um modelo para corrigir sua geometria ou alterar sua validação.',
      edit: 'Editar geometria',
      editTitle: 'Editar a geometria de {{model}}',
      saved: 'Geometria do modelo salva',
      saveFailed: 'Não foi possível salvar a geometria do modelo',
      zTravelUnset: 'Nenhum curso Z registrado — a assistência de descida da mesa falha com segurança neste modelo.',
      validatedBadge: 'Validado',
      notValidatedBadge: 'Não validado',
      confirmValidateTitle: 'Marcar o modelo como validado?',
      ...
      columns: {
        model: 'Modelo',
        bed: 'Mesa (L×A mm)',
        envelope: 'Envoltória (mm)',
        zTravel: 'Curso Z',
        maxPartHeight: 'Altura máx. da peça',
        motion: 'Movimento',
        validated: 'Validado',
        notes: 'Notas',
        updated: 'Atualizado',
      ...
      motion: {
        bedZ: 'Mesa em Z',
        bedslinger: 'Mesa móvel',
      },
      fields: {
        bedX: 'Largura da mesa X (mm)',
        bedY: 'Profundidade da mesa Y (mm)',
        envXMin: 'Envoltória X mín (mm)',
        envXMax: 'Envoltória X máx (mm)',
        envYMin: 'Envoltória Y mín (mm)',
        envYMax: 'Envoltória Y máx (mm)',
        maxPartHeight: 'Altura máx. da peça (mm)',
        zTravel: 'Curso Z (mm)',
    ...
    queueLabel: 'Perfil de ejeção (remoção automática de peças)',
    queueHelp: 'A peça é empurrada para fora quando a mesa esfria até a linha de ejeção.',
  },
  // Navigation
  nav: {
    printers: 'Impressoras',
  ...
  printers: {
    ...
    maintenance: {
      ...
      toastExited: '{{name}} fora do modo manutenção',
    ...
    deactivated: {
      ...
      panelState: 'Desativada — sem conexão com esta impressora.',
      activate: 'Ativar',
      toastActivated: '{{name}} ativada',
      editFieldLabel: 'Desativada',
      editFieldHelp: 'Sem sessão MQTT; invisível para esta instância (instalações paralelas, desativação).',
    },
    // Chamber light
    ...
    toast: {
      ...
      recheckUnchanged: 'Slot {{slot}} sem alteração. Nenhuma troca de rolo registrada desde a última verificação.',
      recheckMinted: 'Slot {{slot}}: novo rolo registrado. {{grams}} g presumidos.',
      recheckIdentified: 'Slot {{slot}}: {{identity}} registrado a partir da etiqueta.',
      recheckIdentifiedUnnamed: 'Slot {{slot}}: etiqueta lida.',
      recheckIdentifiedNoRead: 'Slot {{slot}}: {{identity}} registrado. Nova leitura da etiqueta adiada.',
      recheckQueued: 'Verificação do slot {{slot}} na fila. A fazenda lerá a etiqueta na próxima janela ociosa e registrará o rolo então.',
      recheckEmpty: 'O slot {{slot}} está vazio. Carregue um rolo e verifique novamente.',
      recheckRestored: 'Slot {{slot}}: rolo anterior restaurado.',
      recheckFailed: 'Slot {{slot}}: falha na verificação.',
      recheckUndoNoOffer: 'Slot {{slot}}: nenhuma verificação para desfazer.',
      recheckUndoNoPredecessor: 'Slot {{slot}}: nenhum rolo anterior registrado para este slot.',
      recheckUndoMintGone: 'Slot {{slot}}: o rolo registrado não existe mais.',
      recheckUndoBoundElsewhere: 'Slot {{slot}}: o rolo anterior está em outra bandeja. Nada foi restaurado.',
      recheckUndoFailed: 'Slot {{slot}}: falha ao restaurar. {{detail}}',
    ...
    quarantine: {
      badge: 'Em quarentena',
      recover: 'Recuperar e retomar',
      recoverSuccess: 'Impressora recuperada — {{count}} série(s) retomada(s).',
      recoverError: 'Falha ao recuperar a impressora',
      recoverTitle: 'Recuperar e retomar?',
      recoverMessage: 'Recuperar "{{name}}"? Esta é uma substituição explícita que irá:',
    ...
    phase: {
      ...
      coolingToPlateau: 'Resfriando até o platô',
      coolingToPlateauHeld: 'Resfriando até o platô · placa elevada',
    ...
    ejectPhase: {
      ...
      uploading: 'Ejeção: enviando {{pct}} %',
      uploadingNoPct: 'Ejeção: enviando…',
      sent: 'Ejeção: enviada',
      sweeping: 'Ejeção: varrendo…',
      failed: 'Falha na ejeção',
    },
    ...
    ejectNotQualified: 'A ejeção automática ainda não está qualificada por hardware para este modelo — execute a escada de hardware antes do uso sem supervisão.',
    plateStatus: {
      markCleared: 'Marcar placa como liberada',
      cleared: 'Placa liberada',
      notCleared: 'Placa não liberada',
      inUse: 'Placa em uso',
      markClearedCancelsEject: 'Marcar a placa como liberada cancela a ejeção automática pendente.',
      ejectInFlight: 'Ejeção em andamento. Use Recuperar para sobrepor.',
      markOccupied: 'Marcar placa como ocupada',
      markOccupiedSuccess: 'Placa marcada como ocupada — envio bloqueado até ser liberada',
      ejectInProgress: 'Ejeção em andamento · {{age}}',
      ejectStalled: 'Ejeção travada · {{age}} — a farm perdeu o rastro da varredura',
      refusal: 'Verificação da placa: {{message}}',
    ...
    eject: {
      action: 'Ejetar placa',
      dispatched: 'Ejeção iniciada',
      confirmTitle: 'Ejetar com a placa quente?',
      confirmBodyNoLine: 'A placa está a {{bed}} °C, sem leitura do ar da oficina nem da câmara para compará-la. Ejetar agora varre a peça nessa temperatura. Continuar?',
      confirmBody: 'A placa está a {{bed}} °C, acima do limite de liberação de {{threshold}} °C. Ejetar agora varre a peça com a placa ainda quente. Continuar?',
      confirm: 'Ejetar placa',
      cancel: 'Cancelar',
      foreignPrintNameLabel: 'Impressão',
      foreignUnknownPrint: 'Desconhecida',
      foreignPartHeightEditLabel: 'Altura da peça (mm)',
      foreignProfileLabel: 'Perfil de ejeção',
      foreignSuggested: 'sugerido',
      foreignNoProfiles: 'Nenhum perfil de ejeção disponível',
      foreignConfirm: 'Ejetar placa',
      dialog: {
        foreignTitle: 'Ejetar placa — impressão não enviada pela fazenda',
        farmUnitTitle: 'Ejetar placa — {{name}}',
        declaredTitle: 'Ejetar placa',
        body: 'A varredura é construída a partir da altura da peça e do perfil de ejeção abaixo. Confira os dois contra a placa antes de iniciar.',
        heightRequired: 'Altura da peça desconhecida. Informe o ponto mais alto da peça sobre a placa.',
      },
      error: {
        jobActive: 'A impressora está executando um trabalho. Aguarde o término ou pare-o e então ejete.',
        dispatchInFlight: 'Uma unidade da fila está sendo enviada para esta impressora. Tente novamente em alguns segundos.',
        ejectInFlightPending: 'Ejeção enviada há {{age}} s; aguardando a impressora iniciá-la.',
        ejectInFlightPendingNoAge: 'Ejeção já enviada; aguardando a impressora iniciá-la.',
        ejectInFlightStarted: 'Ejeção em andamento há {{age}} s.',
        ejectInFlightStartedNoAge: 'Ejeção em andamento.',
        bedUnreadable: 'Temperatura da placa indisponível. Tente novamente em alguns segundos.',
        noDonor: 'Nenhum arquivo disponível para construir a ejeção. Marque a placa como liberada e retire a peça à mão.',
        firstArticle: 'Primeira peça aguardando aprovação. Aprove-a ou rejeite-a a partir da série.',
    ...
    rfid: {
      ...
      recheck: 'Verificar slot novamente',
      recheckPending: 'Verificação pendente. Conclui quando a impressão terminar.',
      recheckQueuedTooltip: 'Na fila até a impressão terminar.',
      restorePreviousRoll: 'Restaurar rolo anterior',
    },
    // AMS load/unload (#891)
    ams: {
      load: 'Carregar',
    ...
    permission: {
      ...
      noAmsRfid: 'Você não tem permissão para verificar novamente os slots do AMS',
    ...
    incidentAction: {
      ...
      plate_vision: 'Corrija a placa e depois retome a impressão',
  ...
  archives: {
    ...
    modal: {
      ...
      deleteBlockedByLivePrint: 'Não é possível excluir — este arquivo registra uma impressão em andamento. Pare a impressão primeiro e tente novamente.',
  ...
  queue: {
    ...
    filter: {
      ...
      emptyTitle: 'Nenhum item corresponde aos filtros',
    ...
    reorder: {
      requiresPositionSort: 'Reordenar exige a ordenação por posição, crescente, com SJF desativado',
    },
    // Badges
    badges: {
    ...
    permissions: {
      ...
      noReleaseStaged: 'Peça a um administrador da fila para liberar estes itens',
  ...
  settings: {
    ...
    spoolSelectionPolicy: 'Política de seleção de bobina',
    spoolSelectionPolicyDesc: 'Como o despachante e as impressões manuais escolhem uma bobina quando vários slots AMS correspondem.',
    spoolPolicyFirstLoaded: 'Primeiro carregado (FIFO)',
    spoolPolicyLowestRemaining: 'Menor restante',
    spoolPolicySlotOrder: 'Ordem de slots AMS',
    spoolPolicyBackupNote: 'Menor restante só tem efeito quando o AMS Filament Backup está habilitado na impressora — caso contrário, a impressora não pode trocar para um segundo carretel quando o escolhido acaba.',
    minStartSpool: 'Peso mínimo da bobina para iniciar (g)',
    ...
    taglessSubtypeHint: 'O código de variante da Bambu para o material, ex.: HF = High Flow. Exibido na etiqueta da bobina.',
    taglessColor: 'Cor',
    taglessSlicerFilament: 'Filamento do slicer (opcional)',
    taglessSlicerFilamentHint: 'O nome exato do preset de filamento que seu slicer usa, para que as impressões correspondam ao perfil certo.',
    ...
    deleteUserChecking: 'Verificando o que esta exclusão removeria...',
    deleteUserImpactUnavailable: 'Não foi possível verificar o que esta exclusão removeria. Se excluir mesmo assim, os itens deste usuário serão removidos sem prévia.',
    deleteUserArchives_one: '{{count}} arquivo de impressão',
    deleteUserArchives_other: '{{count}} arquivos de impressão',
    deleteUserLibraryFiles_one: '{{count}} arquivo da biblioteca',
    deleteUserLibraryFiles_other: '{{count}} arquivos da biblioteca',
    deleteUserQueueItems_one: '{{count}} item da fila',
    deleteUserQueueItems_other: '{{count}} itens da fila',
    deleteUserProductionRuns_one: '{{count}} execução de produção',
    deleteUserProductionRuns_other: '{{count}} execuções de produção',
    deleteUserDependentSkus_one: '{{count}} SKU usa um arquivo enviado por este usuário. Esse SKU perderá o arquivo e não poderá ser impresso até você reapontá-lo.',
    deleteUserDependentSkus_other: '{{count}} SKUs usam arquivos enviados por este usuário. Esses SKUs perderão os arquivos e não poderão ser impressos até você reapontá-los.',
    deleteUserPrintingNow_one: '{{count}} unidade está imprimindo agora. A exclusão será recusada até que termine ou seja parada.',
    deleteUserPrintingNow_other: '{{count}} unidades estão imprimindo agora. A exclusão será recusada até que terminem ou sejam paradas.',
    deleteUserStillPrinting: 'Ainda imprimindo em {{printers}}. Pare essas impressões ou aguarde o término e depois exclua.',
    // Smart plugs
    ...
    farmProduction: 'Produção em fazenda',
    farmProductionDescription: 'Política padrão de tentativas e quarentena pré-preenchida na janela Iniciar série. Pode ser substituída por série.',
    farmEjectCooldown: 'Resfriamento de ejeção',
    farmEjectCooldownDescription: 'Como a fazenda espera a mesa esfriar antes de varrer uma placa concluída, e quando desiste ou coloca em quarentena uma impressora que não esfria.',
    farmRetryMaxPerUnit: 'Tentativas por placa',
    farmRetryMaxPerUnitHelp: 'Tentativas automáticas antes de uma placa ser marcada como falha (0–10)',
    farmEscalateConsecutiveFailures: 'Quarentena após falhas',
    farmEscalateConsecutiveFailuresHelp: 'Falhas consecutivas em uma impressora que disparam uma quarentena (1–20)',
    farmCooldownMargin: 'Margem acima do ar da oficina (°C)',
    farmCooldownMarginHelp: 'A linha de ejeção e a redução da ventoinha da câmara ficam esta margem acima do ar da oficina.',
    shopAir: {
      label: 'Ar da oficina',
      ejectLine: 'Linha de ejeção',
      noReading: 'sem leitura',
      atPlateau: 'no platô',
      fresh_one: 'Medido dentro de {{count}} impressora em repouso, há {{minutes}} min — fica um pouco acima do ar do ambiente.',
      fresh_other: 'Medido dentro de {{count}} impressoras em repouso, há {{minutes}} min — fica um pouco acima do ar do ambiente.',
      carried: 'Transportado de {{time}} ao longo da curva diária.',
      unknown: 'Ainda sem leitura — cada resfriamento é liberado quando a mesa para de esfriar.',
      readFailed: 'Falha ao ler o ar da oficina — nova tentativa a cada minuto.',
    },
    farmOfflineStallMinutes: 'Travamento offline (min)',
    farmOfflineStallMinutesHelp: 'Sinaliza uma unidade ainda imprimindo cuja impressora está offline há este tempo — nunca é encerrada, apenas mostra o travamento (5–720)',
    farmPauseStallMinutes: 'Travamento em pausa (min)',
    farmPauseStallMinutesHelp: 'Sinaliza e notifica quando uma unidade imprimindo fica pausada por este tempo sem recuperação automática em andamento — nunca cancela nada (5–720)',
    farmCooldownStallWindow: 'Intervalo de verificação de resfriamento (min)',
    farmCooldownStallWindowHelp: 'Com que frequência confirmar que a mesa ainda está esfriando antes de uma ejeção. Duas verificações falhas seguidas colocam a impressora em quarentena. 0 desliga a verificação.',
    farmCooldownStallEpsilon: 'Resfriamento mínimo por verificação (°C)',
    farmCooldownStallEpsilonHelp: 'A mesa deve cair pelo menos isto entre verificações para contar como ainda esfriando.',
    farmCooldownMaxHold: 'Cronômetro de desistência (min)',
    ...
    farmCooldownPlateauMarginHelp: 'Se o resfriamento estagnar mas a mesa estiver dentro destes graus do ar da própria câmara, tratá-la como resfriada e ejetar; se ficar mais quente que isso, a impressora é colocada em quarentena.',
    farmCooldownAuxFanEnabled: 'Ventoinha auxiliar durante o resfriamento',
    farmCooldownAuxFanEnabledHelp: 'Mantém a ventoinha auxiliar ligada do fim da impressão até a ejeção ser despachada.',
    farmCooldownAuxFan: 'Velocidade da ventoinha auxiliar (%)',
    farmCooldownAuxFanHelp: 'Uma única velocidade para todo o resfriamento (1–100).',
    farmCooldownChamberFanEnabled: 'Ventoinha da câmara durante o resfriamento',
    farmCooldownChamberFanEnabledHelp: 'Coloca o duto de ar em modo resfriamento e mantém a ventoinha de exaustão da câmara ligada do fim da impressão até a ejeção ser despachada. Modelos de impressora sem ventoinha de câmara a ignoram.',
    farmCooldownChamberFan: 'Velocidade de reforço da ventoinha da câmara (%)',
    farmCooldownChamberFanHelp: 'Velocidade enquanto o ar da câmara ainda está acima da temperatura de ejeção (1–100).',
    farmCooldownChamberFanSustain: 'Velocidade da ventoinha da câmara após o reforço (%)',
    farmCooldownChamberFanSustainHelp: 'Velocidade depois que a câmara atinge a temperatura de ejeção, até a ejeção ser despachada. 0 para a ventoinha nesse ponto. A velocidade de resfriamento de câmara da própria impressora é 50.',
    farmCooldownHoldEnabled: 'Manter a mesa junto à ventoinha durante o resfriamento',
    farmCooldownHoldEnabledHelp: 'Eleva a mesa em direção ao plano do bico com o cabeçote estacionado na rampa enquanto a peça esfria. Desligado deixa a mesa onde a impressão terminou.',
    farmCooldownHoldPartTop: 'Topo da peça acima do plano do bico (mm)',
    farmCooldownHoldPartTopHelp: 'Define onde a mesa fica durante o resfriamento da peça, como a altura do topo da peça acima do fluxo da ventoinha auxiliar no plano do bico. 100 mantém a mesa junto à ventoinha com a peça subindo para a zona livre acima do bico. 0 coloca o topo da peça no nível da ventoinha. Abaixo de 0 mantém a peça essa distância sob a ventoinha para o ar passar por cima. Limitado à altura livre medida do modelo da impressora.',
    ...
    farmUsbAutoCleanupHelp: 'Em uma falha de armazenamento USB cheio, excluir automaticamente primeiro as gravações antigas da câmera e depois os arquivos de impressão não utilizados mais antigos, para que o despacho continue funcionando',
    farmIdlePark: 'Estacionamento da mesa em repouso',
    ...
    farmPlateBlowoffEnabled: 'Sopro da placa no início da impressão',
    farmPlateBlowoffEnabledHelp: 'Ventoinha auxiliar em velocidade máxima sobre a placa antes do nivelamento da mesa.',
    farmPlateBlowoffSeconds: 'Tempo de sopro (s)',
    farmPlateBlowoffSecondsHelp: 'Tempo de funcionamento da ventoinha auxiliar antes do nivelamento da mesa (3–60).',
    ...
    queueCheckIntervalHelp: 'Com que frequência a fazenda reverifica a fila mesmo quando nada aconteceu. Uma rede de segurança caso um evento ao vivo seja perdido — menor reage mais cedo, mas consulta mais (5–300).',
    dispatchKickDebounce: 'Atraso de agrupamento de rajadas (seg)',
    dispatchKickDebounceHelp: 'Quando várias coisas acontecem ao mesmo tempo, aguarde este breve momento para agrupá-las em um único despacho em vez de vários. Maior agrupa mais; menor reage mais rápido (0.2–10).',
    usbPreflightFreshWindow: 'Validade da verificação USB (seg)',
    usbPreflightFreshWindowHelp: 'Confie em um relatório recente de "unidade USB presente" com até estes segundos de idade antes de verificar novamente. Maior pula verificações redundantes; 0 sempre verifica de novo (0–120).',
    usbPreflightMaxWait: 'Espera máx. da verificação USB (seg)',
    usbPreflightMaxWaitHelp: 'Quanto esperar por um relatório recente de "USB presente" antes de iniciar uma impressão mesmo assim. Maior é mais cauteloso; menor despacha mais cedo (0–10).',
    dispatchParallelLimit: 'Inícios de impressora simultâneos',
    dispatchParallelLimitHelp: 'Quantas impressoras podem enviar e iniciar ao mesmo tempo em uma passagem. Maior esvazia uma fila grande mais rápido; menor é mais suave com a rede (1–10).',
    powerStagger: 'Escalonamento de energia',
    powerStaggerDescription: 'Libera um espaço de escalonamento no momento em que uma impressora para de consumir energia de aquecimento, em vez de sempre esperar todo o intervalo. Permite que a próxima impressora inicie mais cedo, ainda limitando o consumo de energia simultâneo.',
    staggerDynamicRelease: 'Liberar um espaço quando a mesa estiver quente',
    staggerDynamicReleaseHelp: 'Quando ativado, a próxima impressora pode iniciar assim que a atual termina de aquecer sua mesa, em vez de esperar todo o intervalo passar. Quando desativado, cada espaço espera todo o intervalo.',
    staggerReleaseEpsilon: 'Margem na temperatura (°C)',
    staggerReleaseEpsilonHelp: 'Quão perto da temperatura-alvo da mesa conta como "quente o suficiente" para liberar o espaço mais cedo. Maior libera a próxima impressora mais cedo.',
    staggerHeatupGrace: 'Tolerância de aquecimento (segundos)',
    staggerHeatupGraceHelp: 'Se uma impressora ainda não começou a aquecer sua mesa, aguarde este tempo antes de liberar seu espaço mesmo assim, para que uma impressora ociosa não segure o lote.',
    ...
    erp: {
      title: 'Login do diretório ERP',
      statusActive: 'Login ERP: ativo',
      statusInactive: 'Login ERP: não configurado',
      activeDesc: 'Os operadores podem entrar com suas credenciais do diretório ERP.',
      inactiveDesc: 'Adicione e salve os dados de conexão abaixo para ativar o login ERP.',
      disableHint: 'Para desativar o login ERP, limpe o host e o nome do banco de dados abaixo e salve.',
      connectionConfig: 'Conexão do diretório ERP',
      ...
      ssl: 'Conectar via TLS',
      sslHint: 'Exigir uma conexão criptografada com o banco de dados ERP.',
      roleMapping: 'Mapeamento de funções',
      roleMappingHint: 'Atribua um grupo do BamBuddy a cada função do ERP.',
      roleMappingNoGroup: '— Sem grupo —',
      roleMappingGroupFor: 'Grupo do BamBuddy para {{role}}',
      settingsSaved: 'Configurações do diretório ERP salvas',
      errors: {
        hostRequired: 'O host do banco de dados é obrigatório',
        databaseRequired: 'O nome do banco de dados é obrigatório',
      },
    },
    oidc: {
      ...
      form: {
        ...
        groupsClaimDesc: 'Claim do token que contém os valores de grupo ou função do usuário. Deixe em branco para desativar a sincronização de grupos deste provedor.',
        groupsClaimPlaceholder: 'grupos',
        groupMapping: 'Mapeamento de grupos',
        groupMappingDesc: 'Mapeie cada valor de claim para um grupo do BamBuddy. Usuários correspondentes recebem o grupo mapeado ao fazer login.',
        groupMappingNone: 'Nenhum mapeamento configurado.',
        groupMappingClaimValue: 'Valor do claim',
        groupMappingGroup: 'Grupo do BamBuddy',
        groupMappingSelectGroup: 'Selecionar grupo',
        groupMappingRemove: 'Remover mapeamento',
        groupMappingAdd: 'Adicionar mapeamento',
  ...
  hmsErrors: {
    ...
    unknownDescription: 'Erro de impressora desconhecido — não está no banco de dados de códigos conhecidos. Verifique este código na wiki da Bambu.',
    severity: {
      fatal: 'Crítico',
      serious: 'Grave',
      warning: 'Aviso',
  ...
  fileManager: {
    ...
    createSkuFromUploadToast: '{{filename}} enviado — criar uma SKU a partir dele?',
    createSkuFromUploadAction: 'Criar SKU a partir deste arquivo',
    ...
    deleteFolderConfirm: 'Tem certeza de que deseja excluir esta pasta? Os arquivos dentro vão para a lixeira e podem ser restaurados na raiz; a pasta em si é excluída permanentemente.',
    deleteFileConfirm: 'Tem certeza de que deseja excluir este arquivo?',
    deleteFilesConfirm: 'Tem certeza de que deseja excluir {{count}} arquivos selecionados? Eles vão para a lixeira e podem ser restaurados.',
    deleting: 'Excluindo...',
  ...
  inventory: {
    ...
    freshRoll: {
      ...
      title: 'Rolo novo neste slot?',
      message: 'A bobina sem etiqueta em {{location}} já foi usada na maior parte do seu peso nominal. Se um rolo novo estiver carregado agora, registre-o para que o rastreamento de filamento continue preciso.',
      confirm: 'Rolo novo',
      pending: 'Registrando…',
      success: 'Rolo novo registrado',
      failed: 'Falha ao registrar o rolo novo',
      dismissFailed: 'Não foi possível dispensar o aviso de rolo novo',
      remaining: '{{grams}} g registrados como restantes',
      brandLabel: 'Marca',
      brandPlaceholder: 'ex. Overture',
      ...
      manualDesc: 'Encerrar este registro e iniciar um novo',
      manualTitle: 'Marcar como rolo novo?',
      manualMessage: 'Encerra o registro em {{location}} ({{grams}} g usados) e cria um novo e cheio para este slot. Faça isso somente depois de trocar fisicamente o rolo.',
      manualConfirm: 'Marcar como rolo novo',
    },
    respool: {
      title: 'Reatribuir esta etiqueta?',
      manualTitle: 'Mover esta etiqueta para um rolo novo?',
      manualMessage: 'Encerre o registro em {{location}} ({{grams}} g usados) e mova a etiqueta Bambu para um rolo novo cheio. Faça isso somente após trocar o rolo fisicamente.',
      message: 'Uma etiqueta Bambu reutilizada foi detectada em {{location}}. Se agora está em uma bobina nova de terceiros, reatribua-a a um registro cheio.',
      confirm: 'Reatribuída — bobina nova',
      pending: 'Reatribuindo…',
      success: 'Reatribuída a uma bobina {{brand}} nova',
      failed: 'Falha ao reatribuir a etiqueta',
      autoToast: '{{brand}} reatribuída automaticamente em {{printer}} slot {{slot}}',
      reusedTagToast: 'Possível rolo novo em uma etiqueta reutilizada — {{printer}} slot {{slot}}',
      nearEmptyToast: 'Bobina quase vazia em {{printer}} slot {{slot}} — está trocando este rolo?',
      spentToast: '{{printer}} slot {{slot}}: esta bobina foi marcada como vazia há {{age}} por um sinal de fim de filamento, mas ainda está carregada.',
      spentToastNumbers: 'O AMS indica ~{{ams}}% restante; os registros dizem {{ledger}}%.',
      ledgerUnreliable: 'O registro de uso desta bobina é impossível (mais usado que o rótulo), portanto nenhum valor restante é confiável.',
      nearEmptyToastRemaining: 'Restam {{remaining}} g.',
      nearEmptyTitle: 'Está trocando este rolo?',
      nearEmptyMessage: 'A bobina em {{location}} está quase vazia. Se você acabou de colocar um rolo novo nela, registre aqui para que o rastreamento de filamento continue preciso.',
      triggerSpent: 'Este rolo informou que acabou, e o slot foi manipulado desde então.',
      triggerRemainJump: 'O AMS informa muito mais filamento do que este registro contém — a etiqueta parece ter passado para um rolo reabastecido.',
      sameSpoolAction: 'Mesma bobina',
      reviewAction: 'Revisar…',
      dismissFailed: 'Não foi possível dispensar o aviso de reatribuição',
      donorLine: 'Substitui a bobina rastreada (restam {{grams}} g); o registro antigo é arquivado',
      donorRecordTitle: 'Registro nº {{id}}',
      detailsLabel: 'Detalhes',
      tagIdLabel: 'ID da etiqueta',
      warning: 'Use apenas UMA etiqueta por rolo de origem — descarte a segunda etiqueta.',
      brandLabel: 'Marca',
      brandPlaceholder: 'ex. Overture',
      weightLabel: 'Peso nominal (g)',
      weightPlaceholder: 'ex. 1000',
    ...
    returnToRotation: 'Retornar à rotação',
    returnToRotationDone: 'Bobina retornada à rotação',
    returnToRotationFailed: 'Não foi possível retornar a bobina à rotação',
  ...
  ams: {
    ...
    slotDialogLabel: 'Slot {{slot}} de {{ams}}: {{content}}',
    ...
    slotSpentSwapPark: '{{printer}}: o slot {{slot}} do {{ams}} está ocupado por uma bobina esgotada e nada pode liberá-lo. Verifique o slot novamente ou troque o rolo.',
    ...
    emptySlotBinding: {
      ...
      unassignAria: 'Desatribuir {{spool}} deste slot',
      unassignTitle: 'Cancelar a atribuição deste carretel?',
      unassignMessage: 'Libera {{spool}} deste slot. O carretel volta ao estoque com o consumo registrado intacto — nada é excluído.',
    },
    unknown: 'Desconhecido',
    humidity: 'Umidade',
    temperature: 'Temperatura',
  ...
  printModal: {
    ...
    customSlotMapping: 'Mapeamento de slots personalizado',
    reread: 'Reler',
    requiredTooltip: 'Necessário: {{type}} - {{color}}',
    manuallySelected: 'Selecionado manualmente',
    autoMatched: 'Correspondido automaticamente',
    externalSlotNote: 'Bobina externa: sem controle de peso; a impressora vai pedir filamento no suporte.',
    selectSlot: '-- Selecionar slot --',
    noActivePrintersAvailable: 'Nenhuma impressora ativa disponível',
    specificPrinter: 'Impressora específica',
    anyModel: 'Qualquer {{model}}',
    modelFallback: 'Modelo',
    targetModelLabel: 'Modelo de destino',
    selectModelPlaceholder: 'Selecionar um modelo...',
    locationFilter: 'Filtro de local (opcional)',
    anyLocation: 'Qualquer local',
    schedulerAssignHint: 'O agendador atribuirá à primeira impressora {{model}} ociosa disponível',
    schedulerAssignHintLocation: 'O agendador atribuirá à primeira impressora {{model}} ociosa disponível em {{location}}',
    selectPrinters: 'Selecionar impressoras',
    printersSelected_one: '{{count}} impressora selecionada',
    printersSelected_other: '{{count}} impressoras selecionadas',
    selectAll: 'Selecionar tudo',
    inactive: '(inativa)',
    unknownModel: 'Modelo desconhecido',
    customMapping: 'Mapeamento personalizado',
    matchedCount: '({{matched}}/{{total}} correspondentes)',
    autoButton: 'Auto',
    hiddenPrinters_one: '{{count}} outra impressora oculta (modelo diferente) —',
    hiddenPrinters_other: '{{count}} outras impressoras ocultas (modelo diferente) —',
    showAll: 'mostrar tudo',
    showOnlyModelPrinters: 'Mostrar apenas impressoras {{model}}',
    selectAtLeastOnePrinter: 'Selecione pelo menos uma impressora',
    selectTargetModel: 'Selecione um modelo de impressora de destino',
    typeNotFound: '(Tipo não encontrado)',
    colorMismatch: '(Cor não corresponde)',
    ready: '(Pronto)',
    clickToChangeSlot: 'Clique para alterar a atribuição de slots',
    costNotAvailable: 'N/D',
    requiredTypeNotFound: 'Tipo de filamento necessário não encontrado na impressora.',
    printJob: 'Trabalho de impressão',
    slicedModelMismatch: 'O arquivo foi fatiado para {{slicedModel}}, mas está imprimindo em {{printerModel}}',
    archiveDataUnavailable: 'Dados do arquivo indisponíveis. O arquivo de origem pode ter sido excluído. O mapeamento de filamentos está desativado.',
    failedToComplete: 'Falha ao concluir a operação',
    toastQueueItemUpdated: 'Item da fila atualizado',
    toastUpdateFailed: 'Falha ao atualizar o item da fila',
    toastSelectPrinter: 'Selecione pelo menos uma impressora',
    toastSelectModel: 'Selecione um modelo de impressora de destino',
    toastQueuedForModel: 'Na fila para qualquer {{model}}',
    ejectFromSku: 'Padrão do SKU {{code}}',
    partialFailureTitle: '{{failed}} de {{total}} envios falharam:',
    toastPartialSuccess: '{{success}} com sucesso, {{failed}} com falha',
    printerFallback: 'Impressora {{id}}',
    slotFallback: 'Encaixe {{id}}',
    plateFallback: 'Placa {{index}}',
  },
  ...
  uploadModal: {
    ...
    libraryHint: 'Para SKUs e execuções de produção, envie no Gerenciador de arquivos.',
    libraryHintLink: 'Ir para o Gerenciador de arquivos →',
    uploaded: 'enviado',
    failed: 'falhou',
    uploading: 'Enviando...',
    upload: 'Enviar',
  ...
  notifications: {
    ...
    events: {
      farm: {
        sectionTitle: 'Produção da fazenda',
      },
    },
    firstArticlePending: 'Primeiro artigo pendente',
    firstArticleApproved: 'Primeiro artigo aprovado',
    runPaused: 'Série pausada',
    runResumed: 'Série retomada',
    runCompleted: 'Série concluída',
    runAborted: 'Série cancelada',
    printerQuarantined: 'Impressora em quarentena',
    foreignJobDetected: 'Trabalho externo detectado',
    modelMismatch: 'Modelo incompatível',
    runUnitStopped: 'Unidade parada',
    printStalled: 'Impressão travada',
    storageLow: 'Armazenamento USB quase cheio',
    cooldownEscalation: 'Resfriamento prolongado',
    // Quiet hours
  ...
  fleetMetrics: {
    tabs: {
      ariaLabel: 'Visões das estatísticas',
      prints: 'Impressões',
      fleet: 'Frota',
    },
    sections: {
      fleet: 'Frota',
      matrix: 'Matriz da frota',
      stateOverTime: 'Estado das impressoras ao longo do tempo',
      printsPerDay: 'Impressões por dia',
      downtimeByCause: 'Tempo parado por causa',
      coolingAndEject: 'Resfriamento e ejeção',
      recovery: 'Recuperação',
      partsBySku: 'Peças por SKU',
    },
    summary: {
      now: 'Agora',
      trend: 'Evolução',
      trendOf: 'Evolução: {{metric}}',
      vsPrevious: 'ante o período anterior',
      period: {
        today: 'Hoje',
        ...
        custom: 'Intervalo selecionado',
      },
      rows: {
        avg_printing: 'Imprimindo',
        avg_cycle_overhead: 'Entre impressões',
        avg_idle: 'Ociosas',
        avg_down: 'Paradas',
        avg_planned: 'Manutenção',
        peak_down: 'Pico de paradas',
        printers_in_fleet: 'Na frota',
        prints_per_day: 'Impressões',
        prints_per_printer_per_day: 'Impressões por impressora',
        uptime: 'Tempo operacional',
        time_printing: 'Tempo imprimindo',
      },
      peak: 'pico {{count}}',
      downNow: 'Paradas agora',
      nothingDown: 'Nada parado',
      showFewer: 'Mostrar menos',
      updated: 'Atualizado {{time}}',
      stale: 'Estado de {{age}} atrás',
      openPrinter: 'Abrir impressora',
    },
    class: {
      cycle_overhead: 'Entre impressões',
      cooling: 'Resfriando',
      ejecting: 'Ejetando',
      down: 'Parada',
      planned: 'Manutenção',
      out_of_fleet: 'Desativada',
    ...
    matrix: {
      ...
      showDays: 'Mostrar os dias',
      hideDays: 'Ocultar os dias',
      sortBy: 'Ordenar por {{column}}',
      caption: '{{lens}} segundo a impressora, de {{from}} a {{to}}',
      captionDay: '{{lens}} segundo a impressora, {{date}}',
      details: 'Detalhes',
    ...
    detail: {
      ...
      timeSplit: 'Divisão do tempo',
      classes: 'Uso do tempo',
      printsByOutcome: 'Impressões por resultado',
      outcome: {
      ...
      openPrinter: 'Abrir impressora',
      noIntervals: 'Nenhum intervalo registrado neste período.',
      noIncidents: 'Nenhuma ocorrência neste período.',
      noPrints: 'Nenhuma impressão neste período.',
      ongoing: 'Em andamento',
    },
    widgets: {
      showData: 'Mostrar os dados',
      showChart: 'Mostrar o gráfico',
      showDataFor: 'Mostrar os dados de {{chart}}',
      showChartFor: 'Mostrar o gráfico de {{chart}}',
      median: 'Mediana',
      p90: 'P90',
      overExpected: 'acima do previsto',
      count: 'Contagem',
      variant: {
      ...
      clearedNoPerson: 'Resolvido sem intervenção',
      inFleetLine: 'Na frota',
    ...
    states: {
      loading: 'Carregando…',
      loadFailed: 'Não foi possível carregar o histórico da frota.',
      retry: 'Tentar novamente',
      empty: 'Sem dados para este intervalo.',
      recordingGap: 'Registro do estado das impressoras desde {{date}}. Histórico de falhas e manutenção desde {{earliest}}.',
    },
    header: {
    ...
    hints: {
      ...
      cycle_overhead: 'O trabalho próprio da fazenda entre impressões: resfriar a mesa e varrer a peça.',
      planned: 'Modo manutenção: uma pessoa tirou a impressora dos fluxos automáticos.',
      uptime: 'Parcela do tempo contabilizado em que a impressora pôde receber trabalho.',
      time_printing: 'Parcela do tempo contabilizado em que a impressora esteve imprimindo.',
      prints_per_printer: 'Impressões concluídas divididas pelos dias contabilizados de cada impressora. Os dias contabilizados vêm apenas dos intervalos registrados, portanto não se compara com «Impressões» enquanto parte do período não estiver registrada.',
      unobserved: 'Nada foi registrado neste trecho; conhecem-se apenas falhas e retenções.',
      not_recorded: 'Anterior ao primeiro estado já registrado desta impressora.',
      incidents_only: 'Aqui o estado da impressora não foi registrado; só o registro de falhas e manutenção cobre o período.',
      whileRecorded: 'Os números do período cobrem apenas o tempo registrado.',
      timeframeFleet: 'Os dias vão de meia-noite a meia-noite em {{tz}}.',
      timeframePrints: 'Os dias vão de meia-noite a meia-noite UTC.',
    },
  },
};
