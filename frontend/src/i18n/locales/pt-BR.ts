export default {
  ...
  printers: {
    ...
    toast: {
      ...
      recheckFailed: 'Falha na verificação',
  ...
  inventory: {
    ...
    respool: {
      ...
      noteLabel: 'Nota',
      notePlaceholder: 'Opcional',
      actionDesc: 'Passar esta etiqueta Bambu para um rolo novo',
    },
    bulk: {
  ...
  ams: {
    ...
    emptySlotBinding: {
      ...
      clearMessage: 'Libera {{spool}} deste slot. O carretel volta ao estoque com o consumo registrado intacto — nada é excluído.',
    },
    unknown: 'Desconhecido',
    humidity: 'Umidade',
    temperature: 'Temperatura',
