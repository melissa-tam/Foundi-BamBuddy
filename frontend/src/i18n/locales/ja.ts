export default {
  ...
  printers: {
    ...
    eject: {
      ...
      foreignBody: 'このプリントはファームから送信されたものではありません（Bambu Studio から手動で送信されました）。掃き出しには下で選択した排出プロファイルが使用されます。まず検出された部品の高さが正しいか確認してください。',
      foreignPrintNameLabel: 'プリント',
      foreignUnknownPrint: '不明',
      foreignPartHeightLabel: '検出された部品の高さ',
