export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      bedDropHelp: '部品の上まで持ち上げた後、ベッドを機械の最下部近くまで下げてから戻し、スイープ前に部品を揺すって外します。',
    ...
    tooltips: {
      ...
      bedDrop: '持ち上げで部品から離れた後、ヒートベッドが最下点近くまで下がってから戻り、その衝撃でスイープ前に張り付いた部品を外します。モデルに登録済みの Z 移動量が必要です。',
