export default {
  // SKUカタログ（ファーム生産、フェーズ2）
  skus: {
    nav: 'SKU一覧',
    title: 'SKUカタログ',
    description: '販売可能な部品コード。それぞれが1つ以上のライブラリファイルのプレートと、生産ランのデフォルト取り出しプロファイルを関連付けます。',
    newSku: '新しいSKU',
    loadError: 'SKUを読み込めませんでした。',
    empty: {
      title: 'SKUがまだありません',
      body: '最初のSKUを作成して、印刷可能なファイルを関連付け、生産を追跡しましょう。',
    },
    columns: {
      files: 'ファイル',
      unitsCompleted: '累計ユニット数',
      successRate: '成功率',
    },
    createTitle: 'SKUを作成',
    editTitle: 'SKUを編集',
    fields: {
      ...
      partNumber: '部品番号',
      notes: 'メモ',
      defaultEjectProfile: 'デフォルト取り出しプロファイル',
      noEjectProfile: 'なし',
    },
    ...
    updated: 'SKUを更新しました',
    deleted: 'SKUを削除しました',
    saveFailed: 'SKUの保存に失敗しました',
    deleteFailed: 'SKUの削除に失敗しました',
    deleteTitle: 'このSKUを削除しますか？',
    deleteBody: '「{{code}}」は完全に削除されます。この操作は元に戻せません。',
    suggest: {
      appliedFromObjectName: 'ファイル内のパーツ名から詳細を入力しました',
      appliedFromFilename: 'ファイル名から詳細を入力しました',
      appliedGeneric: 'ファイルから情報を入力しました',
      failed: '詳細を提案できませんでした',
    },
    files: {
      title: '関連付けられたファイル',
      ...
      plate: 'プレート',
      unitsPerPlate: 'プレートあたりのユニット数',
      plateUnits: 'プレート {{plate}} · プレートあたり {{units}}',
      add: 'ファイルを追加',
      added: 'ファイルを関連付けました',
      addFailed: 'ファイルの関連付けに失敗しました',
      savedButLinkFailed: 'SKUは保存されましたが、ファイルの関連付けに失敗しました: {{reason}}',
      remove: '削除',
      removed: 'ファイルの関連付けを解除しました',
      removeFailed: '関連付けの解除に失敗しました',
      removeTitle: 'このファイルの関連付けを解除しますか？',
      removeBody: '「{{name}}」はこのSKUから関連付け解除されます。',
    },
  },
  ...
  productionRuns: {
    nav: '生産',
    title: '生産ラン',
    description: 'SKUのコピーを複数のプリンターに割り当て、目標ユニット数に達するまで実行します。進捗はリアルタイムで表示されます。',
    loadError: '生産ランを読み込めませんでした。',
    empty: {
      title: '生産ランがまだありません',
      body: 'ランを開始して、SKUを目標ユニット数まで印刷しましょう。',
      noSkus: 'ランを開始する前に、少なくとも1つのファイルが関連付けられたSKUを追加してください。',
    },
    startTitle: '生産ランを開始',
    startAction: 'ランを開始',
    runAgain: '再実行',
    ...
    starting: '開始中…',
    started: '生産ランを開始しました',
    startFailed: 'ランの開始に失敗しました',
    noFiles: 'このSKUには印刷するファイルが関連付けられていません。',
    fileRequired: '印刷するファイルを選択してください。',
    targetRequired: '1ユニット以上の目標を入力してください。',
    printerRequired: 'プリンターを少なくとも1台選択してください。',
    overProduction: '{{planned}} ユニット（{{plates}} プレート）を生産します。目標 {{target}} より {{extra}} 多くなります。',
    fields: {
      sku: 'SKU',
      file: 'ファイル / プレート',
      filePlaceholder: 'ファイルを選択…',
      plateUnits: 'プレート {{plate}}、{{units}}/プレート',
      targetUnits: '目標ユニット数',
      printers: 'プリンター',
      ...
      skuNoFile: '— ファイル未リンク',
      skuNoFileHint: 'SKUページでSKUにファイルをリンクすると実行できるようになります。',
    },
    status: {
      active: '実行中',
      paused: '一時停止',
    ...
    platesProgress: '{{completed}} / {{total}} プレート',
    stats: {
      units: 'ユニット',
      target: '目標',
      failed: '失敗',
    ...
    startNow: '今すぐ開始',
    startedNow: 'ランを開始しました',
    reschedule: '再スケジュール',
    rescheduleTitle: '開始時刻を変更',
    rescheduled: '開始時刻を更新しました',
    schedule: {
      sectionTitle: '開始時刻',
      whenToStart: '開始タイミング',
      asap: 'すぐに開始',
      ...
      pastError: '未来の時刻を選択してください。',
      invalidError: '有効な日付と時刻を入力してください。',
      helpAsap: '対応可能なプリンターが空き次第、ランを開始します。',
      helpScheduled: '選択した時刻にプリンターが空いていればランを開始し、使用中の場合は空くまで待機します。',
      startsIn: '{{when}}に開始',
    },
    viewDetails: 'ラン詳細を表示',
    blockedPrinters: 'プリンターがブロック中',
    pauseReason: {
      operator: 'オペレーターによる一時停止',
      ...
      unknown: '一時停止中 — 実行の詳細を確認してください',
    },
    stagedBanner: {
      lowSpool: '{{count}} 個のユニットが保留中: フィラメント不足 — スプールをセットすればファームが自動で再開します（「再開」を押せばすぐに解放されます）。',
      other: '{{count}} 個のユニットが保留中 — 再開を押すと解放されます。',
    },
    detail: {
      back: 'すべての生産ラン',
      loadError: 'この生産ランを読み込めませんでした。',
      notFound: '生産ランが見つかりません。',
      printersTitle: 'プリンター',
      noPrinters: 'まだプリンターが割り当てられていません — スケジューラーがユニットごとに空いている対応プリンターを選びます。',
      unitsTitle: 'ユニット',
      ...
      waiting: {
        ...
        visionHold: 'プレート検査で一時停止 — プレートを直してから再開',
        ...
        externalFeedFault: '外部スプールが送り込まれません — ホルダーと PTFE チューブを確認し、プリンターで再開してください',
        pinnedTrayUnavailable: '固定したスロットはこのプリンターに装填されていません — 装填するか固定を解除してください',
        ...
        libraryFileMissing: 'ライブラリにソースファイルがありません — ファイルを復元するか再アップロードしてください',
      ...
      printerState: {
        ...
        stalled: '印刷中にオフラインで停滞',
        visionHold: 'プレート検査で保留中',
        filamentShort: 'フィラメント不足',
        noUsbDrive: 'USBドライブなし',
      },
      eligibility: {
        title: '参加しないプリンター',
        description: 'これらのプリンターは、解決するまでこのランのユニットを引き受けません:',
        offline: 'オフライン',
        quarantined: '隔離中',
        awaitingPlateClear: 'ベッド未清掃',
        modelMismatch: 'モデル不一致',
        filamentShort: 'フィラメント不足',
        noUsbDrive: 'USBドライブなし',
      },
    },
    abortTitle: 'このランを中止しますか？',
    abortBody: '「{{name}}」はキャンセルされます。進行中のプレートは完了しますが、新しいプレートは開始されません。この操作は元に戻せません。',
    delete: '削除',
    deleted: 'ランを削除しました',
    ...
    firstArticle: {
      ...
      requireHelp: '最初の部品は自動排出せずに印刷され、ランはあなたの承認を待って保留されます。',
      retriesLabel: 'プレートごとの再試行回数',
      escalateLabel: '連続失敗後に隔離する',
      printing: '初品を印刷中',
      awaitingTitle: '初品が承認待ちです',
      awaitingBody: '最初の部品が印刷されました。確認してから、承認してランを続行するか、拒否して停止し修正してください。',
      approvePhysical: '承認 — 部品を取り外しました',
      approveEject: '承認してリモート排出',
      reject: '拒否…',
      approveConfirm: '承認',
      approvePhysicalTitle: '初品を承認しますか？',
      approvePhysicalBody: '印刷された部品をプレートから取り外したことを確認してください。ランは続行され、残りのプレートが送出されます。',
      approveEjectTitle: '承認してリモート排出しますか？',
      approveEjectBody: 'ランを続行する前に、ツールヘッドが部品をプレートから払い落とします。プレートに障害物がなく、誰もプリンターに手を入れていないことを確認してください。',
      rejectTitle: '初品を拒否',
      rejectBody: '何が問題だったか説明してください。その後ランを再開すると、新しい初品からやり直します。',
      rejectReasonLabel: '理由',
      rejectReasonPlaceholder: '例: 角の反り、定着不良…',
      rejectReasonRequired: '理由が必要です。',
      rejectAction: '初品を拒否',
      rejectedBadge: '初品が拒否されました',
      rejectedReason: '理由: {{reason}}',
      rejectedHint: '再開すると新しい初品を開始します。',
      approvedBadge: '初品が承認されました',
      approved: '初品を承認しました',
      rejected: '初品を拒否しました',
  ...
  ejectProfiles: {
    nav: '取り出しプロファイル',
    title: '取り出しプロファイル',
    description: 'ベッドが冷えると完成した部品をベッドから払い出す、自動部品取り出しプロファイルです。',
    newProfile: '新しいプロファイル',
    loadError: '取り出しプロファイルを読み込めませんでした。',
    duplicateAction: '複製',
    copyName: '{{name}}（コピー）',
    empty: {
      title: '取り出しプロファイルはまだありません',
      body: '最初のプロファイルを作成して、完成した部品をベッドから自動的に取り除きます。',
    },
    columns: {
      passes: 'パス数',
      ejectSpeed: '取り出し速度',
    ...
    createTitle: '取り出しプロファイルを作成',
    editTitle: '取り出しプロファイルを編集',
    fields: {
      name: '名前',
      clearance: 'クリアランス (mm)',
      zOffset: 'Z オフセット (mm)',
      descentSteps: '下降ステップ数',
      xPasses: 'X パス数',
      xMargin: 'X マージン (mm)',
      frontOverhang: '前方オーバーハング (mm)',
      backOverhang: '後方オーバーハング (mm)',
      ejectSpeed: '取り出し速度 (mm/min)',
      skimSpeed: 'スキム速度 (mm/min)',
      finalSkim: '最終スキムパス',
      finalSkimHelp: 'スイープ後にプレートのすぐ上で低速のスキムパスを1回追加し、薄い残りを除去します。ちょうど1回だけ押し出すにはオフにします。',
      maxPartHeight: '部品の最大高さ (mm)',
      sweepStartHeight: '掃引開始高さ (%)',
      sweepStartHeightHelp: '部品の高さのこの割合から下降掃引を開始します（100% = 部品の上端）。',
      sweepBand: 'X 掃引バンドを制限',
      sweepBandHelp: '全幅ではなくベッド幅の一部のバンドのみを掃引します。全幅の場合はオフのままにします。',
      sweepXMin: 'X バンド最小 (mm)',
      sweepXMax: 'X バンド最大 (mm)',
      bedDrop: 'ベッド降下による剥離アシスト',
      bedDropHelp: 'ベッドを機械の最下部近くまで下げてから持ち上げ高さに戻し、その衝撃でスイープ前に張り付いた部品を外します。',
      bedDropClearance: '底部クリアランス (mm)',
      bedDropDwell: '降下位置での保持時間 (秒)',
      bedDropDwellHelp: 'ベッドは持ち上げ高さに戻る前に、降下位置でこの秒数だけ保持します。',
      bedDropJitter: '降下位置での揺すり',
      bedDropJitterHelp: 'ベッドは降下位置で、設定した距離だけ上下する動作を設定した回数だけ繰り返します。',
      bedDropJitterCycles: '揺すり回数',
      bedDropJitterMm: '揺すり移動量 (mm)',
    },
    tooltips: {
      name: 'このプロファイルを見分けるための短いラベル。プロファイル一覧や選択欄に表示されます。',
      clearance: '位置に移動する際、ツールヘッドが部品の上にどれだけの高さを保つか。スイープ前に部品へ触れないようにします。',
      zOffset: 'スイープ経路の高さの微調整。ノズルが擦れる場合は上げ、部品を外せない場合は下げます。',
      descentSteps: 'ツールヘッドが部品を押し出す前に、その後ろへ回り込むために行う小さな下降ステップの数。',
      xPasses: '部品を取り除くためにベッド上で行う左右のスイープ回数。',
      xMargin: 'ツールヘッドがフレームに当たらないよう、ベッドの左右の端から保つ余白。',
      frontOverhang: '部品を完全に押し出すために、スイープが部品の前方をどれだけ超えて進むか。',
      backOverhang: 'ツールヘッドが押し出す前に部品の完全に後ろへ回り込めるよう、スイープが部品のどれだけ後方から始まるか。',
      ejectSpeed: '部品をプレートから押し出す押し出し経路でツールヘッドが動く速さ。',
      skimSpeed: '残りかすを取り除く、より軽いスキム経路でツールヘッドが動く速さ。',
      finalSkim: 'メインのスイープ後にプレートのすぐ上で低速の追加パスを行い、薄い残留物を除去します。1回だけ押し出す場合はオフにします（例：背の高い部品用に中間の高さのレーンを1本）。',
      maxPartHeight: 'このプロファイルで排出できる最大の部品の高さ。スライスした部品がこれより高い場合、ディスパッチはブロックされます。',
      sweepStartHeight: '下降スイープを始める部品上の高さをパーセントで指定（有効範囲 1-100%、100% は部品の最上部）。',
      sweepBand: 'ベッドの全幅ではなく一部の帯だけをスイープします。部品が常に同じ位置にある場合に便利です。',
      sweepXMin: 'スイープ帯の左端。ベッド原点からの mm。有効範囲 0-340 mm（H2S のベッド幅）。最大値より小さく、幅を少なくとも 10 mm 残す必要があります。',
      sweepXMax: 'スイープ帯の右端。ベッド原点からの mm。有効範囲 0-340 mm（H2S のベッド幅）。最小値より大きく、幅を少なくとも 10 mm 残す必要があります。',
      bedDrop: 'ヒートベッドが最下点近くまで下がってから持ち上げ高さに戻り、その衝撃でスイープ前に張り付いた部品を外します。モデルに登録済みの Z 移動量が必要です。',
      bedDropClearance: '降下時にベッドの最下位置から保つ間隔 — 50 mm = 最下部より 5 cm 上で停止。',
      bedDropDwell: '降下位置で数秒待つことで、張り付いた部品がスイープ前に完全に剥がれる時間を確保します。',
      bedDropJitter: '降下位置での短い上下動により、1 回の衝撃では外れずに残った部品を剥がします。',
    },
    nameRequired: '名前は必須です。',
    created: '取り出しプロファイルを作成しました',
    updated: '取り出しプロファイルを更新しました',
    deleted: '取り出しプロファイルを削除しました',
    saveFailed: 'プロファイルの保存に失敗しました',
    deleteFailed: 'プロファイルの削除に失敗しました',
    deleteTitle: 'このプロファイルを削除しますか？',
    deleteBody: '「{{name}}」は完全に削除されます。この操作は元に戻せません。',
    preview: {
      title: 'プレビューと検証',
      description: 'ライブラリファイルとプレートの取り出し G コードを生成し、使用前に検証します。',
      file: 'ライブラリファイル',
      filePlaceholder: 'ファイルを選択…',
      plate: 'プレート',
      run: 'プレビューを生成',
      running: '生成中…',
      noFiles: 'プレビューできるライブラリファイルがありません。',
      ok: '検証に合格しました',
      errors: 'エラー',
      warnings: '警告',
      maxZ: '最大 Z 高さ: {{value}} mm',
      showGcode: 'G コードを表示',
      hideGcode: 'G コードを非表示',
      gcodeLabel: '生成された G コード',
      failed: 'プレビューに失敗しました',
    },
    dryRun: {
      action: 'ドライラン',
      title: 'ドライランテスト',
      description: 'このプロファイルのジオメトリのみのテストをプリンターに送るか、テストファイルをダウンロードして確認します。',
      printer: 'プリンター',
      printerPlaceholder: '接続済みのプリンターを選択…',
      loadingPrinters: 'プリンターの接続を確認中…',
      noPrinters: '利用可能な接続済みプリンターがありません。',
      warningTitle: '空のベッドが必要',
      warning: 'このテストはベッド中央へ原点復帰して掃くため、プレートは空でなければなりません。ディスパッチ後、ジョブはプリンターのプレート保留を解除するまで待機します。',
      dispatch: 'テストを送信',
      dispatching: '送信中…',
      download: 'ファイルをダウンロード',
      downloading: '準備中…',
      dispatchFailed: 'テストを送信できませんでした。',
      downloadFailed: 'ドライランファイルを作成できませんでした。',
      allowUnvalidated: '未検証のジオメトリを許可（ハードウェアラダー専用）',
      allowUnvalidatedWarning: 'このモデルの可動範囲はハードウェア検証されていません。ラダーで、監視下、空のベッドでのみディスパッチしてください。',
    },
    geometry: {
      model: 'プリンターモデル',
      noModels: 'ジオメトリレジストリにエントリがありません',
      unvalidated: 'ハードウェア未検証',
      warningsTitle: 'ジオメトリ警告',
      downloadModel: 'ダウンロード用ジオメトリモデル',
      downloadModelPlaceholder: '選択したプリンターのモデルを使用',
      bandInverted: 'Xバンドの最小値は最大値より小さくする必要があります。',
      bandTooNarrow: 'スイープバンドは最低 {{min}} mm の幅が必要です。',
      bandExceedsBed: 'Xバンドの最大値が登録済みの最も広いベッド（{{max}} mm）を超えています。',
      heightExceedsCeiling: '登録済みの全モデルの高さ上限（最大 {{max}} mm）を超えています — 取り出しのディスパッチは拒否されます。',
      bedDropNoTravel: 'Z 移動量が登録されていないモデル（{{models}}）ではこのプロファイルを生成できません — ジオメトリレジストリで z_travel_mm を設定してください。',
      bedDropBedslinger: 'ベッド降下アシストはベッドスリンガー型（{{models}}）では利用できません — これらのベッドは Z 方向に動きません。',
    },
    geometryManager: {
      title: 'モデルジオメトリレジストリ',
      description: '各プリンターモデルのベッドサイズ、移動可動範囲、ハードウェア検証状態です。行はサーバーのシードから作成されます — 追加ボタンはありません。モデルを編集してジオメトリを修正するか、検証状態を変更してください。',
      edit: 'ジオメトリを編集',
      editTitle: '{{model}} のジオメトリを編集',
      saved: 'モデルジオメトリを保存しました',
      saveFailed: 'モデルジオメトリを保存できませんでした',
      zTravelUnset: 'Z 移動量が未登録です — このモデルではベッド降下アシストはフェイルクローズします。',
      validatedBadge: '検証済み',
      notValidatedBadge: '未検証',
      confirmValidateTitle: 'モデルを検証済みにしますか？',
      ...
      fields: {
        bedX: 'ベッド幅 X（mm）',
        bedY: 'ベッド奥行 Y（mm）',
        envXMin: '可動範囲 X 最小（mm）',
        envXMax: '可動範囲 X 最大（mm）',
        envYMin: '可動範囲 Y 最小（mm）',
        envYMax: '可動範囲 Y 最大（mm）',
    ...
    queueLabel: '取り出しプロファイル（自動部品取り出し）',
    queueHelp: 'ベッドが排出ラインまで冷えると、部品が払い出されます。',
  },
  // Navigation
  nav: {
    printers: 'プリンター',
  ...
  printers: {
    ...
    deactivated: {
      pillLabel: '無効',
      panelState: '無効 — このプリンターへの接続はありません。',
      activate: '有効化',
      toastActivated: '{{name}} を有効化しました',
      editFieldLabel: '無効',
      editFieldHelp: 'MQTT セッションなし。このインスタンスからは見えません（並行インストール、運用終了）。',
    },
    // Chamber light
    ...
    toast: {
      ...
      recheckUnchanged: 'スロット {{slot}} は変化なし。前回の確認以降、ロールの交換は記録されていません。',
      recheckMinted: 'スロット {{slot}}: 新しいロールを記録しました。{{grams}} g と想定します。',
      recheckIdentified: 'スロット {{slot}}: タグから {{identity}} を記録しました。',
      recheckIdentifiedUnnamed: 'スロット {{slot}}: タグを読み取りました。',
      recheckIdentifiedNoRead: 'スロット {{slot}}: {{identity}} を記録済み。タグの再読み取りは保留しました。',
      recheckQueued: 'スロット {{slot}} の再確認をキューに入れました。次のアイドル時にタグを読み取り、ロールを記録します。',
      recheckEmpty: 'スロット {{slot}} は空です。ロールを装填してから再確認してください。',
      recheckRestored: 'スロット {{slot}}: 以前のロールを復元しました。',
      recheckFailed: 'スロット {{slot}}: 再確認に失敗しました。',
      recheckUndoNoOffer: 'スロット {{slot}}: 取り消せる再確認はありません。',
      recheckUndoNoPredecessor: 'スロット {{slot}}: このスロットに以前のロールの記録がありません。',
      recheckUndoMintGone: 'スロット {{slot}}: 記録されたロールは存在しません。',
      recheckUndoBoundElsewhere: 'スロット {{slot}}: 以前のロールは別のトレイに装着されています。復元しませんでした。',
      recheckUndoFailed: 'スロット {{slot}}: 復元に失敗しました。{{detail}}',
    ...
    quarantine: {
      badge: '隔離中',
      recover: '復旧して再開',
      recoverSuccess: 'プリンターを復旧しました — {{count}} 件のランを再開しました。',
      recoverError: 'プリンターの復旧に失敗しました',
      recoverTitle: '復旧して再開しますか？',
      recoverMessage: '"{{name}}" を復旧しますか？これは次を実行する明示的なオーバーライドです:',
    ...
    phase: {
      ...
      coolingToPlateau: '横ばいまで冷却中',
      coolingToPlateauHeld: '横ばいまで冷却中・プレート保持中',
    ...
    ejectNotQualified: 'このモデルの自動取り出しはまだハードウェア認定されていません — 無人運転の前にハードウェアラダーを実行してください。',
    plateStatus: {
      markCleared: 'プレートをクリア済みにする',
      cleared: 'プレートクリア済み',
      notCleared: 'プレート未クリア',
      inUse: 'プレート使用中',
      markClearedCancelsEject: 'プレートをクリア済みにすると、保留中の自動排出がキャンセルされます。',
      ejectInFlight: '排出実行中。上書きするには「復旧して再開」を使用してください。',
      markOccupied: 'プレートを占有済みにする',
      markOccupiedSuccess: 'プレートを占有済みにしました — クリアするまでディスパッチはブロックされます',
      ejectInProgress: '排出実行中 · {{age}}',
      ejectStalled: '排出が停滞 · {{age}} — ファームがスイープを追跡できなくなりました',
      refusal: 'プレート検査: {{message}}',
    ...
    eject: {
      action: 'プレートを排出',
      dispatched: '排出を開始しました',
      confirmTitle: 'プレートが高温のまま排出しますか？',
      confirmBodyNoLine: 'プレートは{{bed}}°Cで、判断に使える作業場の気温もチャンバーの測定値もありません。今すぐ排出すると、この温度のまま部品を掃き出します。続行しますか？',
      confirmBody: 'プレートは{{bed}}°Cで、解放しきい値{{threshold}}°Cを超えています。今すぐ排出すると、プレートが高温のまま部品を掃き出します。続行しますか？',
      confirm: 'プレートを排出',
      cancel: 'キャンセル',
      foreignPrintNameLabel: 'プリント',
      foreignUnknownPrint: '不明',
      foreignPartHeightEditLabel: '部品の高さ (mm)',
      foreignProfileLabel: '排出プロファイル',
      foreignSuggested: '推奨',
      foreignNoProfiles: '利用可能な排出プロファイルがありません',
      foreignConfirm: 'プレートを排出',
      dialog: {
        foreignTitle: 'プレートを排出 — ファームから送信されていないプリント',
        farmUnitTitle: 'プレートを排出 — {{name}}',
        declaredTitle: 'プレートを排出',
        body: '掃き出しは下の部品の高さと排出プロファイルから生成されます。開始する前に、両方をプレートと照合してください。',
        heightRequired: '部品の高さが不明です。プレート上の部品の最も高い点を入力してください。',
      },
      error: {
        jobActive: 'プリンターがジョブを実行中です。完了を待つか停止してから排出してください。',
        dispatchInFlight: 'キュー内のユニットをこのプリンターへ送信中です。数秒後に再試行してください。',
        ejectInFlightPending: '{{age}} 秒前に排出を送信しました。プリンターの開始を待っています。',
        ejectInFlightPendingNoAge: '排出は送信済みです。プリンターの開始を待っています。',
        ejectInFlightStarted: '排出を実行中です（{{age}} 秒経過）。',
        ejectInFlightStartedNoAge: '排出を実行中です。',
        bedUnreadable: 'プレート温度を取得できません。数秒後に再試行してください。',
        noDonor: '排出を生成するファイルがありません。プレートをクリア済みにして、部品を手で取り外してください。',
        firstArticle: '初品が承認待ちです。ランから承認または拒否してください。',
    ...
    rfid: {
      ...
      recheck: 'スロットを再確認',
      recheckPending: '再確認は保留中です。印刷終了後に完了します。',
      recheckQueuedTooltip: '印刷が終わるまでキュー待ちです。',
      restorePreviousRoll: '以前のロールを復元',
    },
    // AMS load/unload (#891)
    ams: {
      load: 'ロード',
    ...
    permission: {
      ...
      noAmsRfid: 'AMSスロットを再確認する権限がありません',
  ...
  archives: {
    ...
    modal: {
      ...
      deleteBlockedByLivePrint: '削除できません — このアーカイブは進行中の印刷を記録しています。先に印刷を停止してから再試行してください。',
  ...
  queue: {
    ...
    farm: {
      runBadge: 'ラン',
      runBadgeTitle: '生産ラン #{{id}} の一部 — ラン詳細を開く',
      stopConsequence: 'オペレーター停止として扱われます: 自動再試行なし。プレートを片付けて再開を押すまで、ランはこのプリンターを保留します。',
      destructiveNote: 'この項目は生産ラン「{{run}}」に属しています。削除すると、次の再開で補充されるまでランが不足します。',
      stagedBannerTitle: 'フィラメント不足 — スプールをセットすればファームが自動で再開します',
      stagedBannerBody: '{{count}} 件がフィラメント待ちです。下に表示されたプリンターにフィラメントをセットしてください。ファームがそれを検知し、通常 1 分以内に自動で解放します。',
      recheckButton: '今すぐ再チェック',
    ...
    permissions: {
      ...
      noReleaseStaged: 'これらのアイテムの解放はキュー管理者に依頼してください',
  ...
  settings: {
    ...
    spoolSelectionPolicy: 'スプール選択ポリシー',
    spoolSelectionPolicyDesc: '複数の AMS スロットが一致する場合に、ディスパッチャと手動印刷がスプールを選ぶ方法。',
    spoolPolicyFirstLoaded: '最初に装填 (FIFO)',
    spoolPolicyLowestRemaining: '残量が最少',
    spoolPolicySlotOrder: 'AMS スロット順',
    spoolPolicyBackupNote: '「残量が最少」はプリンターで AMS Filament Backup が有効な場合にのみ動作します。無効の場合、選択したスプールが切れても予備スプールに切り替えできません。',
    minStartSpool: '開始時の最小スプール重量 (g)',
    ...
    taglessBrand: 'ブランド',
    taglessMaterial: '素材',
    taglessSubtype: 'サブタイプ',
    taglessSubtypeHint: '素材に対する Bambu のバリアントコードです（例: HF = High Flow）。スプールのラベルに表示されます。',
    taglessColor: '色',
    taglessSlicerFilament: 'スライサーのフィラメント（任意）',
    taglessSlicerFilamentHint: 'スライサーが使用するフィラメントプリセットの正確な名前です。プリントが正しいプロファイルに一致するようにします。',
    ...
    deleteUserChecking: 'この削除で何が失われるか確認しています...',
    deleteUserImpactUnavailable: 'この削除で何が失われるかを確認できませんでした。このまま削除すると、このユーザーの項目はプレビューなしで削除されます。',
    deleteUserArchives_one: '印刷アーカイブ {{count}} 件',
    deleteUserArchives_other: '印刷アーカイブ {{count}} 件',
    deleteUserLibraryFiles_one: 'ライブラリファイル {{count}} 件',
    deleteUserLibraryFiles_other: 'ライブラリファイル {{count}} 件',
    deleteUserQueueItems_one: 'キュー項目 {{count}} 件',
    deleteUserQueueItems_other: 'キュー項目 {{count}} 件',
    deleteUserProductionRuns_one: '生産ラン {{count}} 件',
    deleteUserProductionRuns_other: '生産ラン {{count}} 件',
    deleteUserDependentSkus_one: '{{count}} 件のSKUがこのユーザーのアップロードしたファイルを使用しています。該当SKUはファイルを失い、再設定するまで印刷できません。',
    deleteUserDependentSkus_other: '{{count}} 件のSKUがこのユーザーのアップロードしたファイルを使用しています。該当SKUはファイルを失い、再設定するまで印刷できません。',
    deleteUserPrintingNow_one: '{{count}} ユニットが現在印刷中です。完了または停止するまで削除は拒否されます。',
    deleteUserPrintingNow_other: '{{count}} ユニットが現在印刷中です。完了または停止するまで削除は拒否されます。',
    deleteUserStillPrinting: '{{printers}} でまだ印刷中です。それらの印刷を停止するか終了を待ってから削除してください。',
    // Smart plugs
    ...
    farmProduction: 'ファーム生産',
    farmProductionDescription: 'ラン開始ダイアログにあらかじめ入力される、再試行と隔離の既定ポリシー。ランごとに上書きできます。',
    farmEjectCooldown: '排出冷却',
    farmEjectCooldownDescription: '完成したプレートを掃き出す前に、ファームがベッドの冷却をどのように待つか、また冷えないプリンターをいつ諦めて隔離するかを設定します。',
    farmRetryMaxPerUnit: 'プレートごとの再試行回数',
    farmRetryMaxPerUnitHelp: 'プレートが失敗と判定されるまでの自動再試行回数（0〜10）',
    farmEscalateConsecutiveFailures: '失敗後の隔離',
    farmEscalateConsecutiveFailuresHelp: '隔離を発動するプリンターの連続失敗回数（1〜20）',
    farmCooldownMargin: '作業場の気温からの余裕 (°C)',
    farmCooldownMarginHelp: '排出ラインとチャンバーファンの減速点は、作業場の気温よりこの分だけ上に置かれます。',
    shopAir: {
      label: '作業場の気温',
      ejectLine: '排出ライン',
      noReading: '測定値なし',
      atPlateau: '横ばいまで',
      fresh_one: '待機中のプリンター {{count}} 台の内部で {{minutes}} 分前に測定 — 室温よりわずかに高めに出ます。',
      fresh_other: '待機中のプリンター {{count}} 台の内部で {{minutes}} 分前に測定 — 室温よりわずかに高めに出ます。',
      carried: '{{time}} の値から日内カーブに沿って推定。',
      unknown: 'まだ測定値がありません — 各冷却はベッドの温度が下がらなくなった時点で解放されます。',
      readFailed: '作業場の気温を読み取れませんでした — 1 分ごとに再試行します。',
    },
    farmOfflineStallMinutes: 'オフライン停滞（分）',
    farmOfflineStallMinutesHelp: 'プリンターがこの時間オフラインのまま印刷中のユニットを表示 — 終了はせず停滞を示すだけ（5〜720）',
    farmPauseStallMinutes: '一時停止停滞（分）',
    farmPauseStallMinutesHelp: '印刷中のユニットが自動復旧なしでこの時間一時停止したままの場合に表示・通知します — 何もキャンセルしません（5〜720）',
    farmCooldownStallWindow: '冷却確認間隔（分）',
    farmCooldownStallWindowHelp: '排出前にベッドがまだ冷えているかを確認する間隔です。確認が2回連続で失敗するとプリンターを隔離します。0で確認を無効にします。',
    farmCooldownStallEpsilon: '確認ごとの最小冷却（°C）',
    farmCooldownStallEpsilonHelp: 'まだ冷却中とみなすには、ベッドが確認と確認の間に少なくともこの分だけ下がる必要があります。',
    farmCooldownMaxHold: '打ち切りタイマー（分）',
    farmCooldownMaxHoldHelp: 'この時間が過ぎてもベッドが排出温度より高い場合は、そのまま排出します。0 = 待ち続けます。',
    farmCooldownPlateauMargin: '許容マージン（°C）',
    farmCooldownPlateauMarginHelp: '冷却が停滞しても、ベッドが自身のチャンバー内の空気からこの度数以内であれば、冷却済みとして排出します。それより高温のまま止まっている場合はプリンターを隔離します。',
    farmCooldownAuxFanEnabled: '冷却中の補助ファン',
    farmCooldownAuxFanEnabledHelp: '印刷終了から排出が送信されるまで補助ファンを回します。',
    farmCooldownAuxFan: '補助ファンの速度 (%)',
    farmCooldownAuxFanHelp: '冷却中ずっと同じ速度です (1–100)。',
    farmCooldownChamberFanEnabled: '冷却中のチャンバーファン',
    farmCooldownChamberFanEnabledHelp: 'エアダクトを冷却モードにし、印刷終了から排出が送信されるまでチャンバー排気ファンを回します。チャンバーファンのない機種では省略されます。',
    farmCooldownChamberFan: 'チャンバーファンのブースト速度 (%)',
    farmCooldownChamberFanHelp: 'チャンバー内の空気が排出温度を上回っている間の速度です (1–100)。',
    farmCooldownChamberFanSustain: 'ブースト後のチャンバーファン速度 (%)',
    farmCooldownChamberFanSustainHelp: 'チャンバーが排出温度に達してから排出が送信されるまでの速度です。0 でファンを停止します。プリンター自身のチャンバー冷却速度は 50 です。',
    farmCooldownHoldEnabled: '冷却中にプレートをファンの位置で保持',
    farmCooldownHoldEnabledHelp: 'ツールヘッドをシュートに待避させたまま、部品の冷却中はプレートをノズル面まで上げます。オフでは印刷終了時の位置のままにします。',
    farmCooldownHoldPartTop: 'ノズル面からの部品上面の高さ (mm)',
    farmCooldownHoldPartTopHelp: '部品の冷却中にプレートを保持する位置を、ノズル面にある補助ファンの気流からの部品上面の高さとして設定します。100 はプレートをファンの位置で保持し、部品はノズル上のクリアゾーンに入ります。0 は部品上面をファンと同じ高さにします。0 未満では部品をファンよりその分だけ下げ、空気が上を流れるようにします。プリンター機種の実測クリア高さが上限です。',
    ...
    farmPlateBlowoffEnabled: '印刷開始時にプレートをブロー',
    farmPlateBlowoffEnabledHelp: 'ベッドレベリングの前に補助ファンを全速でプレートに当てます。',
    farmPlateBlowoffSeconds: 'ブロー時間 (s)',
    farmPlateBlowoffSecondsHelp: 'ベッドレベリング前の補助ファンの運転時間 (3–60)。',
    ...
    queueCheckIntervalHelp: '何も起きていなくてもファームがキューを再確認する頻度です。ライブイベントを取りこぼした場合の保険で、低いほど早く反応しますがポーリングが増えます（5–300）。',
    dispatchKickDebounce: 'バースト整定遅延（秒）',
    dispatchKickDebounceHelp: '複数の事象が同時に発生したとき、この短い時間だけ待って、多数ではなく1回のディスパッチにまとめます。高いほどまとめる量が増え、低いほど早く反応します（0.2–10）。',
    usbPreflightFreshWindow: 'USB確認の鮮度（秒）',
    usbPreflightFreshWindowHelp: '最近の"USBドライブあり"報告を、この秒数までなら信頼して再確認を省きます。高いほど冗長な確認を省き、0は常に再確認します（0–120）。',
    usbPreflightMaxWait: 'USB確認の最大待機（秒）',
    usbPreflightMaxWaitHelp: '新しい"USBあり"報告をどれだけ待ってから、いずれにせよ印刷を開始するかです。高いほど慎重で、低いほど早くディスパッチします（0–10）。',
    dispatchParallelLimit: 'プリンター同時開始数',
    dispatchParallelLimitHelp: '1回のパスで同時にアップロードして開始できるプリンター数です。高いほど大きなキューを速く消化し、低いほどネットワークに優しくなります（1–10）。',
    powerStagger: '電力スタガー',
    powerStaggerDescription: '常に全区間を待つのではなく、プリンターが加熱電力を消費しなくなった瞬間にスタガー枠を解放します。同時消費電力を抑えつつ、次のプリンターをより早く開始できます。',
    staggerDynamicRelease: 'ベッドが熱くなったら枠を解放',
    staggerDynamicReleaseHelp: 'オンの場合、区間全体の経過を待つのではなく、現在のプリンターがベッドの加熱を終えた時点で次のプリンターを開始できます。オフの場合、各枠は全区間を待ちます。',
    staggerReleaseEpsilon: '温度到達マージン（°C）',
    staggerReleaseEpsilonHelp: '枠を早く解放するために、目標ベッド温度にどれだけ近ければ"十分に熱い"とみなすかです。大きいほど次のプリンターを早く解放します。',
    staggerHeatupGrace: '加熱猶予（秒）',
    staggerHeatupGraceHelp: 'プリンターがまだベッドの加熱を始めていない場合、アイドル状態のプリンターがバッチを止めないよう、この時間だけ待ってから枠を解放します。',
    ...
    erp: {
      title: 'ERP ディレクトリログイン',
      statusActive: 'ERP ログイン: 有効',
      statusInactive: 'ERP ログイン: 未設定',
      activeDesc: 'オペレーターは ERP ディレクトリの資格情報でサインインできます。',
      inactiveDesc: 'ERP ログインを有効にするには、下の接続情報を入力して保存してください。',
      disableHint: 'ERP ログインを無効にするには、下のホストとデータベース名を消去して保存してください。',
      connectionConfig: 'ERP ディレクトリ接続',
      host: 'データベースホスト',
      port: 'ポート',
      database: 'データベース名',
      user: 'データベースユーザー',
      password: 'データベースパスワード',
      passwordHint: '保存されたパスワードを維持するには空欄のままにします。',
      ssl: 'TLS で接続',
      sslHint: 'ERP データベースへの暗号化された接続を必須にします。',
      roleMapping: 'ロールマッピング',
      roleMappingHint: '各 ERP ロールに BamBuddy グループを割り当てます。',
      roleMappingNoGroup: '— グループなし —',
      roleMappingGroupFor: '{{role}} の BamBuddy グループ',
      settingsSaved: 'ERP ディレクトリ設定を保存しました',
      errors: {
        hostRequired: 'データベースホストは必須です',
        databaseRequired: 'データベース名は必須です',
      },
    },
    oidc: {
      ...
      form: {
        ...
        groupsClaimDesc: 'ユーザーのグループまたはロールの値を保持するトークンのクレーム。空欄にすると、このプロバイダーからのグループ同期を無効にします。',
        groupsClaimPlaceholder: 'グループ',
        groupMapping: 'グループマッピング',
        groupMappingDesc: '各クレーム値を BamBuddy グループに割り当てます。一致するユーザーはログイン時に割り当てられたグループを受け取ります。',
        groupMappingNone: 'マッピングが設定されていません。',
        groupMappingClaimValue: 'クレーム値',
        groupMappingGroup: 'BamBuddy グループ',
        groupMappingSelectGroup: 'グループを選択',
        groupMappingRemove: 'マッピングを削除',
        groupMappingAdd: 'マッピングを追加',
        autologin: '自動サインイン',
  ...
  fileManager: {
    ...
    createSkuFromUploadToast: '{{filename}} をアップロードしました — これから SKU を作成しますか？',
    createSkuFromUploadAction: 'このファイルから SKU を作成',
    ...
    deleteFolderConfirm: 'このフォルダを削除しますか？中のファイルはゴミ箱に移動し、ルートに復元できます。フォルダ自体は完全に削除されます。',
    deleteFileConfirm: 'このファイルを削除しますか？',
    deleteFilesConfirm: '選択した{{count}}件のファイルを削除しますか？ファイルはゴミ箱に移動し、復元できます。',
    deleting: '削除中...',
  ...
  inventory: {
    ...
    freshRoll: {
      ...
      sameRoll: '同じロール',
      reviewAction: '確認…',
      title: 'このスロットに新しいロールですか？',
      message: '{{location}} のタグなしスプールはラベル重量の大半を使用しました。今新しいロールが取り付けられている場合は、フィラメント追跡を正確に保つために記録してください。',
      confirm: '新しいロール',
      pending: '記録中…',
      success: '新しいロールを記録しました',
      failed: '新しいロールの記録に失敗しました',
      dismissFailed: '新しいロールの確認を閉じられませんでした',
      remaining: '残量として {{grams}} g を記録',
      brandLabel: 'ブランド',
      brandPlaceholder: '例: Overture',
      weightLabel: 'ラベル重量 (g)',
      ...
      noteLabel: 'メモ',
      notePlaceholder: '任意',
      manualDesc: 'この記録を終了し、新しい記録を開始します',
      manualTitle: '新しいロールとして記録しますか？',
      manualMessage: '{{location}} の記録（使用量 {{grams}} g）を終了し、このスロット用に新しい満量の記録を作成します。実際にロールを交換したあとにのみ実行してください。',
      manualConfirm: '新しいロールとして記録',
    },
    respool: {
      title: 'このタグを付け替えますか？',
      manualTitle: 'このタグを新しいロールに移しますか？',
      manualMessage: '{{location}} の記録（使用量 {{grams}} g）を終了し、Bambu タグを新しい満量ロールに移します。実際にロールを交換したあとに実行してください。',
      message: '{{location}} で再利用された Bambu タグが検出されました。新しいサードパーティ製スプールに付いている場合は、満量の記録に付け替えてください。',
      confirm: '付け替え済み — 新しいスプール',
      pending: '付け替え中…',
      success: '新しい {{brand}} スプールに付け替えました',
      failed: 'タグの付け替えに失敗しました',
      autoToast: '{{brand}} を {{printer}} スロット {{slot}} に自動付け替えしました',
      reusedTagToast: '再利用されたタグに新しいロールの可能性 — {{printer}} スロット {{slot}}',
      ...
      triggerSpent: 'このロールはフィラメント切れを報告し、その後スロットが操作されました。',
      triggerRemainJump: 'AMS はこの記録よりはるかに多いフィラメントを報告しています — タグが詰め替え済みのロールに移された可能性があります。',
      sameSpoolAction: '同じスプール',
      reviewAction: '確認…',
      dismissFailed: '付け替え確認を閉じられませんでした',
      donorLine: '追跡中のスプールを置き換えます（残り {{grams}} g）。古い記録はアーカイブされます',
      donorRecordTitle: '記録 #{{id}}',
      detailsLabel: '詳細',
      tagIdLabel: 'タグ ID',
      warning: 'ドナーロール 1 本につきタグは 1 つだけ使用してください — 2 つ目のタグは破棄してください。',
      brandLabel: 'ブランド',
      brandPlaceholder: '例: Overture',
      weightLabel: 'ラベル重量 (g)',
      weightPlaceholder: '例: 1000',
    ...
    returnToRotation: 'ローテーションに戻す',
    returnToRotationDone: 'スプールをローテーションに戻しました',
    returnToRotationFailed: 'スプールをローテーションに戻せませんでした',
  ...
  ams: {
    ...
    slotDialogLabel: '{{ams}} スロット {{slot}}: {{content}}',
    slotBoundPresenceUnknown: '{{printer}}: {{ams}} スロット {{slot}} が応答しません — 割り当てられたスプールがまだあるか確認できません。スロットを確認してください',
    slotSpentSwapPark: '{{printer}}: {{ams}} スロット {{slot}} は使い切ったスプールが占有しており、解除できる材料がありません。スロットを再確認するか、ロールを交換してください',
    ...
    emptySlotBinding: {
      ...
      unassignAria: '{{spool}} をこのスロットから割り当て解除',
      unassignTitle: 'このスプールの割り当てを解除しますか？',
      unassignMessage: '{{spool}} をこのスロットから解除します。スプールは使用量の記録を保ったまま在庫に戻り、削除されるものはありません。',
    },
    unknown: '不明',
    humidity: '湿度',
    temperature: '温度',
  ...
  printModal: {
    ...
    customSlotMapping: 'カスタムスロット割り当て',
    reread: '再読み込み',
    requiredTooltip: '必要: {{type}} - {{color}}',
    manuallySelected: '手動で選択',
    autoMatched: '自動一致',
    externalSlotNote: '外部スプール — 重量は追跡されません。プリンターはホルダーのフィラメントを要求します。',
    selectSlot: '-- スロットを選択 --',
    noActivePrintersAvailable: '利用可能なアクティブなプリンターがありません',
    specificPrinter: '特定のプリンター',
    anyModel: '任意の{{model}}',
    modelFallback: 'モデル',
    targetModelLabel: '対象モデル',
    selectModelPlaceholder: 'モデルを選択...',
    locationFilter: '場所フィルター（任意）',
    anyLocation: '任意の場所',
    schedulerAssignHint: 'スケジューラーは最初に利用可能な待機中の{{model}}プリンターに割り当てます',
    schedulerAssignHintLocation: 'スケジューラーは{{location}}で最初に利用可能な待機中の{{model}}プリンターに割り当てます',
    selectPrinters: 'プリンターを選択',
    printersSelected_one: '{{count}}台のプリンターを選択',
    printersSelected_other: '{{count}}台のプリンターを選択',
    selectAll: 'すべて選択',
    inactive: '(非アクティブ)',
    unknownModel: '不明なモデル',
    customMapping: 'カスタム割り当て',
    matchedCount: '({{matched}}/{{total}} 一致)',
    autoButton: '自動',
    hiddenPrinters_one: '他に{{count}}台のプリンターが非表示（異なるモデル）—',
    hiddenPrinters_other: '他に{{count}}台のプリンターが非表示（異なるモデル）—',
    showAll: 'すべて表示',
    showOnlyModelPrinters: '{{model}}プリンターのみ表示',
    selectAtLeastOnePrinter: '少なくとも1台のプリンターを選択してください',
    selectTargetModel: '対象のプリンターモデルを選択してください',
    typeNotFound: '（タイプが見つかりません）',
    colorMismatch: '（色が一致しません）',
    ready: '（準備完了）',
    clickToChangeSlot: 'クリックしてスロット割り当てを変更',
    costNotAvailable: '該当なし',
    requiredTypeNotFound: '必要なフィラメントタイプがプリンターに見つかりません。',
    printJob: '印刷ジョブ',
    slicedModelMismatch: 'ファイルは{{slicedModel}}用にスライスされましたが、{{printerModel}}で印刷します',
    archiveDataUnavailable: 'アーカイブデータを利用できません。ソースファイルが削除された可能性があります。フィラメント割り当ては無効です。',
    failedToComplete: '操作を完了できませんでした',
    toastQueueItemUpdated: 'キュー項目を更新しました',
    toastUpdateFailed: 'キュー項目を更新できませんでした',
    toastSelectPrinter: '少なくとも1台のプリンターを選択してください',
    toastSelectModel: '対象のプリンターモデルを選択してください',
    toastQueuedForModel: '任意の{{model}}用にキューに追加しました',
    ejectFromSku: 'SKU {{code}} のデフォルト',
    partialFailureTitle: '{{total}} 件中 {{failed}} 件の送信が失敗しました：',
    toastPartialSuccess: '{{success}}件成功、{{failed}}件失敗',
    printerFallback: 'プリンター {{id}}',
    slotFallback: 'スロット {{id}}',
    plateFallback: 'プレート {{index}}',
  },
  ...
  uploadModal: {
    ...
    libraryHint: 'SKU や量産ジョブは、代わりにファイルマネージャーからアップロードしてください。',
    libraryHintLink: 'ファイルマネージャーへ →',
    uploaded: 'アップロード済み',
  ...
  notifications: {
    ...
    printStalled: '印刷停滞',
    storageLow: 'USBストレージ残量不足',
    cooldownEscalation: '冷却が長引いています',
    // Quiet hours
    quietHours: '静音時間',
  ...
  fleetMetrics: {
    ...
    sections: {
      fleet: 'フリート',
      matrix: 'フリートマトリクス',
      stateOverTime: 'プリンター状態の推移',
      printsPerDay: '1日あたりの印刷数',
      downtimeByCause: '原因別の停止時間',
      coolingAndEject: '冷却と排出',
      recovery: '復旧',
      partsBySku: 'SKU別の部品数',
    },
    summary: {
      ...
      rows: {
        avg_printing: '印刷中',
        avg_cycle_overhead: '印刷の合間',
        avg_idle: '待機',
        avg_down: '停止',
        avg_planned: 'メンテナンス',
        peak_down: '停止のピーク',
        printers_in_fleet: 'フリート内',
        prints_per_day: '印刷数',
        prints_per_printer_per_day: 'プリンターあたりの印刷数',
        uptime: '稼働率',
        time_printing: '印刷時間比率',
      },
      peak: 'ピーク {{count}}',
      downNow: '現在停止中',
      nothingDown: '停止なし',
    ...
    matrix: {
      ...
      hideDays: '日を隠す',
      sortBy: '{{column}}で並べ替え',
      caption: 'プリンター別の{{lens}}、{{from}}から{{to}}まで',
      captionDay: 'プリンター別の{{lens}}、{{date}}',
      details: '詳細',
    ...
    detail: {
      ...
      incidents: '事象',
      openPrinter: 'プリンターを開く',
      noIntervals: 'この期間に記録された区間はありません。',
      noIncidents: 'この期間に事象はありません。',
      noPrints: 'この期間に印刷はありません。',
      ongoing: '継続中',
    },
    widgets: {
      showData: 'データを表示',
      showChart: 'グラフを表示',
      showDataFor: '{{chart}}のデータを表示',
      showChartFor: '{{chart}}のグラフを表示',
      median: '中央値',
      p90: 'P90',
      overExpected: '想定超過',
      count: '件数',
    ...
    states: {
      loading: '読み込み中…',
      loadFailed: 'フリートの履歴を読み込めませんでした。',
      retry: '再試行',
      empty: 'この期間のデータはありません。',
      recordingGap: 'プリンター状態の記録は{{date}}に開始しました。障害とメンテナンスの履歴は{{earliest}}からです。',
    },
    header: {
    ...
    hints: {
      ...
      cycle_overhead: '印刷の合間にファーム自身が行う作業です。ベッドを冷やし、部品を掃き出します。',
      planned: 'メンテナンスモードです。担当者が自動処理からこのプリンターを外しています。',
      uptime: '計上時間のうち、プリンターが作業を受けられた割合です。',
      time_printing: '計上時間のうち、プリンターが印刷していた割合です。',
      prints_per_printer: '完了した印刷数を、各プリンターの計上日数で割った値です。計上日数は記録済みの区間だけから求めるため、期間の一部が未記録のあいだは「印刷数」と比較できません。',
      unobserved: 'この区間は何も記録されていないため、障害と保留だけが分かります。',
      not_recorded: 'このプリンターで最初に記録された状態より前の期間です。',
      incidents_only: 'ここではプリンター状態が記録されておらず、障害とメンテナンスの記録だけが対象期間を覆っています。',
      whileRecorded: '期間の数値は記録された時間のみを対象としています。',
      timeframeFleet: '1日は{{tz}}の深夜0時から翌深夜0時までです。',
      timeframePrints: '1日はUTCの深夜0時から翌深夜0時までです。',
    },
  },
};
