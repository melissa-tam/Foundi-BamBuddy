export default {
  ...
  printers: {
    ...
    quarantine: {
      ...
      clear: '隔離を解除',
      cleared: '隔離を解除しました',
      clearTitle: '隔離を解除しますか？',
      clearMessage: '"{{name}}" の隔離を解除しますか？スケジューラーがこのプリンターへの印刷送出を再開します。',
      clearMessageWithReason: '"{{name}}" の隔離を解除しますか？理由: {{reason}}。スケジューラーがこのプリンターへの印刷送出を再開します。',
    },
    plateStatus: {
