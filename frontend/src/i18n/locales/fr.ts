export default {
  // Catalogue de SKU (production de ferme, phase 2)
  skus: {
    nav: 'Références',
    title: 'Catalogue de SKU',
    description: 'Codes d\'articles vendables, chacun liant une ou plusieurs plaques de fichiers de bibliothèque ainsi qu\'un profil d\'éjection par défaut pour les séries de production.',
    newSku: 'Nouveau SKU',
    loadError: 'Impossible de charger les SKU.',
    empty: {
      title: 'Aucun SKU pour l\'instant',
      body: 'Créez votre premier SKU pour lier des fichiers imprimables et suivre la production.',
    },
    columns: {
      files: 'Fichiers',
      unitsCompleted: 'Unités cumulées',
      successRate: 'Réussite',
    },
    createTitle: 'Créer un SKU',
    editTitle: 'Modifier le SKU',
    fields: {
      code: 'Code',
      name: 'Nom',
      partNumber: 'Numéro de pièce',
      notes: 'Remarques',
      defaultEjectProfile: 'Profil d\'éjection par défaut',
      noEjectProfile: 'Aucun',
    },
    codeRequired: 'Le code est obligatoire.',
    nameRequired: 'Le nom est obligatoire.',
    created: 'SKU créé',
    updated: 'SKU mis à jour',
    deleted: 'SKU supprimé',
    saveFailed: 'Échec de l\'enregistrement du SKU',
    deleteFailed: 'Échec de la suppression du SKU',
    deleteTitle: 'Supprimer ce SKU ?',
    deleteBody: '"{{code}}" sera définitivement supprimé. Cette action est irréversible.',
    suggest: {
      appliedFromObjectName: 'Détails remplis à partir des noms de pièces du fichier',
      appliedFromFilename: 'Détails remplis à partir du nom du fichier',
      appliedGeneric: 'Données remplies depuis le fichier',
      failed: 'Impossible de suggérer les détails',
    },
    files: {
      title: 'Fichiers liés',
      ...
      plate: 'Plaque',
      unitsPerPlate: 'Unités par plaque',
      plateUnits: 'Plaque {{plate}} · {{units}} par plaque',
      add: 'Ajouter un fichier',
      added: 'Fichier lié',
      addFailed: 'Échec de la liaison du fichier',
      savedButLinkFailed: 'Le SKU a été enregistré, mais la liaison du fichier a échoué : {{reason}}',
      remove: 'Retirer',
      removed: 'Fichier délié',
      removeFailed: 'Échec de la dissociation du fichier',
      removeTitle: 'Dissocier ce fichier ?',
      removeBody: '"{{name}}" sera dissocié de ce SKU.',
    },
  },

  // Séries de production (production de ferme, phase 2)
  productionRuns: {
    nav: 'Fabrication',
    title: 'Séries de production',
    description: 'Répartissez des copies d\'un SKU entre les imprimantes jusqu\'à atteindre un nombre cible d\'unités, avec progression en direct.',
    loadError: 'Impossible de charger les séries de production.',
    empty: {
      title: 'Aucune série de production',
      body: 'Démarrez une série pour imprimer un SKU jusqu\'à un nombre cible d\'unités.',
      noSkus: 'Ajoutez un SKU avec au moins un fichier lié avant de démarrer une série.',
    },
    startTitle: 'Démarrer une série de production',
    startAction: 'Démarrer la série',
    runAgain: 'Relancer',
    advanced: 'Avancé',
    starting: 'Démarrage…',
    started: 'Série de production démarrée',
    startFailed: 'Échec du démarrage de la série',
    noFiles: 'Ce SKU n\'a aucun fichier lié à imprimer.',
    fileRequired: 'Sélectionnez un fichier à imprimer.',
    targetRequired: 'Saisissez un objectif d\'au moins 1 unité.',
    printerRequired: 'Sélectionnez au moins une imprimante.',
    overProduction: 'Produira {{planned}} unités ({{plates}} plaques) — {{extra}} de plus que l\'objectif de {{target}}.',
    fields: {
      sku: 'SKU',
      file: 'Fichier / plaque',
      filePlaceholder: 'Sélectionnez un fichier…',
      plateUnits: 'plaque {{plate}}, {{units}}/plaque',
      ...
      skuNoFile: '— aucun fichier lié',
      skuNoFileHint: 'Liez un fichier à un SKU sur la page des SKU pour le rendre lançable.',
    },
    status: {
      active: 'En cours',
      paused: 'En pause',
    ...
    platesProgress: '{{completed}} / {{total}} plaques',
    stats: {
      units: 'Unités',
      target: 'Objectif',
      failed: 'Échouées',
    ...
    resumed: 'Série reprise',
    aborted: 'Série abandonnée',
    actionFailed: 'Échec de l\'action',
    startNow: 'Démarrer maintenant',
    startedNow: 'Série démarrée',
    reschedule: 'Replanifier',
    rescheduleTitle: 'Modifier l\'heure de début',
    rescheduled: 'Heure de début mise à jour',
    schedule: {
      sectionTitle: 'Heure de début',
      whenToStart: 'Quand démarrer',
      asap: 'Démarrer dès que possible',
      later: 'Planifier pour plus tard',
      date: 'Date',
      time: 'Heure',
      openCalendar: 'Ouvrir le calendrier',
      pastError: 'Choisissez une heure future.',
      invalidError: 'Saisissez une date et une heure valides.',
      helpAsap: 'La série démarre dès qu\'une imprimante disponible est libre.',
      helpScheduled: 'La série démarre à l\'heure choisie si une imprimante est libre, sinon elle attend qu\'une le soit.',
      startsIn: 'Démarre {{when}}',
    },
    viewDetails: 'Voir le détail de la série',
    blockedPrinters: 'Imprimante bloquée',
    pauseReason: {
      operator: 'Mise en pause par l\'opérateur',
    ...
    detail: {
      back: 'Toutes les séries de production',
      loadError: 'Impossible de charger cette série de production.',
      notFound: 'Série de production introuvable.',
      printersTitle: 'Imprimantes',
      noPrinters: 'Aucune imprimante assignée pour l\'instant — le planificateur choisit une imprimante libre compatible par unité.',
      unitsTitle: 'Unités',
      ...
      retryOf: 'Nouvelle tentative n°{{count}} de l\'unité {{id}}',
      unitStatus: {
        pending: 'En attente',
      ...
      waiting: {
        ...
        visionHold: 'En pause au contrôle du plateau — corrigez le plateau, puis reprenez',
        ...
        externalFeedFault: "La bobine externe n'avance pas — vérifiez le support et le tube PTFE, puis reprenez sur l'imprimante",
        pinnedTrayUnavailable: "L'emplacement épinglé n'est pas chargé sur cette imprimante — chargez-le ou retirez l'épinglage",
        ...
        libraryFileMissing: 'Fichier source absent de la bibliothèque — restaurez-le ou téléversez-le à nouveau',
      ...
      printerState: {
        ...
        stalled: 'Hors ligne en cours d\'impression',
        visionHold: 'En attente au contrôle du plateau',
        filamentShort: 'Filament insuffisant',
        noUsbDrive: 'Aucune clé USB',
      },
      eligibility: {
        title: 'Imprimantes non participantes',
        description: 'Ces imprimantes ne prendront pas d\'unités de cette série tant que ce n\'est pas résolu :',
        offline: 'Hors ligne',
        quarantined: 'En quarantaine',
        awaitingPlateClear: 'Plateau non dégagé',
        modelMismatch: 'Modèle non concordant',
        filamentShort: 'Filament insuffisant',
        noUsbDrive: 'Aucune clé USB',
      },
    },
    abortTitle: 'Abandonner cette série ?',
    abortBody: '"{{name}}" sera annulée. Les plaques en cours se terminent mais aucune nouvelle plaque ne démarre. Cette action est irréversible.',
    delete: 'Supprimer',
    ...
    firstArticle: {
      ...
      requireHelp: 'La première pièce est imprimée sans éjection automatique et la série attend votre validation.',
      retriesLabel: 'Tentatives par plateau',
      escalateLabel: 'Mise en quarantaine après des échecs consécutifs',
      printing: 'Impression de la première pièce',
      awaitingTitle: 'Première pièce en attente de validation',
      awaitingBody: 'La première pièce est imprimée. Inspectez-la, puis validez pour poursuivre la série ou rejetez pour l\'arrêter et la corriger.',
      approvePhysical: 'Valider — pièce retirée',
      approveEject: 'Valider et éjecter à distance',
      reject: 'Rejeter…',
      approveConfirm: 'Valider',
      approvePhysicalTitle: 'Valider la première pièce ?',
      approvePhysicalBody: 'Confirmez que vous avez retiré la pièce imprimée du plateau. La série se poursuivra et enverra les plateaux restants.',
      approveEjectTitle: 'Valider et éjecter à distance ?',
      approveEjectBody: 'La tête d\'impression balaiera la pièce hors du plateau avant la reprise de la série. Assurez-vous que le plateau est dégagé et que personne n\'a les mains dans l\'imprimante.',
      rejectTitle: 'Rejeter la première pièce',
      rejectBody: 'Expliquez ce qui n\'allait pas. La reprise de la série relance ensuite une nouvelle première pièce.',
      rejectReasonLabel: 'Motif',
      rejectReasonPlaceholder: 'p. ex. coins déformés, mauvaise adhérence…',
      rejectReasonRequired: 'Un motif est requis.',
      rejectAction: 'Rejeter la première pièce',
      rejectedBadge: 'Première pièce rejetée',
      rejectedReason: 'Motif : {{reason}}',
      rejectedHint: 'La reprise relance une nouvelle première pièce.',
      approvedBadge: 'Première pièce validée',
      approved: 'Première pièce validée',
  ...
  ejectProfiles: {
    nav: 'Profils d\'éjection',
    title: 'Profils d\'éjection',
    description: 'Profils de retrait automatique qui poussent les pièces terminées hors du plateau une fois celui-ci refroidi.',
    newProfile: 'Nouveau profil',
    loadError: 'Impossible de charger les profils d\'éjection.',
    duplicateAction: 'Dupliquer',
    copyName: '{{name}} (copie)',
    empty: {
      title: 'Aucun profil d\'éjection pour le moment',
      body: 'Créez votre premier profil pour retirer automatiquement les pièces terminées du plateau.',
    },
    columns: {
      passes: 'Passages',
      ejectSpeed: 'Vitesse d\'éjection',
      maxHeight: 'Hauteur max.',
    },
    createTitle: 'Créer un profil d\'éjection',
    editTitle: 'Modifier le profil d\'éjection',
    fields: {
      name: 'Nom',
      clearance: 'Dégagement (mm)',
      zOffset: 'Décalage Z (mm)',
      descentSteps: 'Étapes de descente',
      xPasses: 'Passages en X',
      xMargin: 'Marge X (mm)',
      frontOverhang: 'Débord avant (mm)',
      backOverhang: 'Débord arrière (mm)',
      ejectSpeed: 'Vitesse d\'éjection (mm/min)',
      skimSpeed: 'Vitesse de rasage (mm/min)',
      finalSkim: 'Passe de rasage finale',
      finalSkimHelp: 'Ajoute une passe de rasage lente juste au-dessus du plateau après les balayages pour enlever les résidus fins. Désactivez pour pousser exactement une fois.',
      maxPartHeight: 'Hauteur max. de la pièce (mm)',
      sweepStartHeight: 'Hauteur de début du balayage (%)',
      sweepStartHeightHelp: 'Commencer le balayage descendant à ce pourcentage de la hauteur de la pièce (100 % = sommet de la pièce).',
      sweepBand: 'Restreindre la bande X du balayage',
      sweepBandHelp: 'Balayer uniquement une sous-bande de la largeur du plateau au lieu de toute la largeur. Laisser désactivé pour toute la largeur.',
      sweepXMin: 'Min. de bande X (mm)',
      sweepXMax: 'Max. de bande X (mm)',
      bedDrop: 'Assistance au décollage par descente du plateau',
      bedDropHelp: 'Le plateau descend presque jusqu\'au fond de la machine puis remonte à la hauteur de levée ; la secousse décolle une pièce coincée avant le balayage.',
      bedDropClearance: 'Dégagement inférieur (mm)',
      bedDropDwell: 'Maintien au point bas (s)',
      bedDropDwellHelp: 'Le plateau reste au point bas de la descente pendant ce nombre de secondes avant de remonter à la hauteur de levée.',
      bedDropJitter: 'Secousses au point bas',
      bedDropJitterHelp: 'Au point bas de la descente, le plateau monte et redescend de la distance indiquée, autant de fois que le nombre de cycles indiqué.',
      bedDropJitterCycles: 'Nombre de secousses',
      bedDropJitterMm: 'Course des secousses (mm)',
    },
    tooltips: {
      name: 'Une étiquette courte pour reconnaître ce profil – affichée dans la liste des profils et les sélecteurs.',
      clearance: 'Hauteur que la tête conserve au-dessus de la pièce en se mettant en position, pour ne pas la toucher avant le balayage.',
      zOffset: 'Réglage fin de la hauteur du balayage – augmentez-le si la buse frotte, réduisez-le si la pièce est manquée.',
      descentSteps: 'Nombre de petites descentes que la tête effectue pour passer derrière la pièce avant de la pousser.',
      xPasses: 'Nombre de passages de balayage latéraux effectués sur le plateau pour dégager la pièce.',
      xMargin: 'Marge conservée par rapport aux bords gauche et droit du plateau pour que la tête ne heurte jamais le châssis.',
      frontOverhang: 'Distance à laquelle le balayage dépasse l\'avant de la pièce pour bien la pousser entièrement.',
      backOverhang: 'Distance derrière la pièce où commence le balayage, afin que la tête passe entièrement derrière elle avant de pousser.',
      ejectSpeed: 'Vitesse de déplacement de la tête pendant les passages de poussée qui éjectent la pièce du plateau.',
      skimSpeed: 'Vitesse de déplacement de la tête pendant les passages d\'effleurage plus légers qui enlèvent les résidus.',
      finalSkim: 'Effectue une passe lente supplémentaire juste au-dessus du plateau après les balayages principaux pour enlever les petits résidus. Désactivez pour une seule poussée (par ex. une seule voie à mi-hauteur pour une pièce haute).',
      maxPartHeight: 'Pièce la plus haute que ce profil peut éjecter – l\'envoi est bloqué si la pièce tranchée est plus haute.',
      sweepStartHeight: 'Hauteur sur la pièce où commence le balayage descendant, en pourcentage (valide 1-100 % ; 100 % = tout en haut de la pièce).',
      sweepBand: 'Ne balayer qu\'une bande du plateau au lieu de toute sa largeur – pratique quand les pièces sont toujours au même endroit.',
      sweepXMin: 'Bord gauche de la bande de balayage, en mm depuis l\'origine du plateau. Valide 0-340 mm (largeur du plateau H2S) ; doit être inférieur au max et laisser une bande d\'au moins 10 mm de large.',
      sweepXMax: 'Bord droit de la bande de balayage, en mm depuis l\'origine du plateau. Valide 0-340 mm (largeur du plateau H2S) ; doit être supérieur au min et laisser une bande d\'au moins 10 mm de large.',
      bedDrop: 'Le plateau chauffant descend presque jusqu\'à son point le plus bas puis remonte à la hauteur de levée ; la secousse décolle une pièce coincée avant le balayage. Nécessite une course Z enregistrée pour le modèle.',
      bedDropClearance: 'Distance conservée par rapport à la position la plus basse du plateau pendant la descente — 50 mm = s\'arrêter 5 cm au-dessus du fond.',
      bedDropDwell: 'Quelques secondes de plus au point bas laissent à une pièce coincée le temps de finir de se décoller avant le balayage.',
      bedDropJitter: 'De courts va-et-vient verticaux au point bas décollent une pièce que la secousse unique laisse attachée.',
    },
    nameRequired: 'Le nom est obligatoire.',
    created: 'Profil d\'éjection créé',
    updated: 'Profil d\'éjection mis à jour',
    deleted: 'Profil d\'éjection supprimé',
    ...
    deleteBody: '« {{name}} » sera définitivement supprimé. Cette action est irréversible.',
    preview: {
      title: 'Aperçu et validation',
      description: 'Générez le G-code d\'éjection pour un fichier de la bibliothèque et un plateau afin de le valider avant utilisation.',
      file: 'Fichier de la bibliothèque',
      filePlaceholder: 'Sélectionnez un fichier…',
      plate: 'Plateau',
      run: 'Générer l\'aperçu',
      running: 'Génération…',
      noFiles: 'Aucun fichier de la bibliothèque disponible pour l\'aperçu.',
      ok: 'Validation réussie',
      errors: 'Erreurs',
      warnings: 'Avertissements',
      maxZ: 'Hauteur Z max. : {{value}} mm',
      showGcode: 'Afficher le G-code',
      hideGcode: 'Masquer le G-code',
      gcodeLabel: 'G-code généré',
      failed: 'Échec de l\'aperçu',
    },
    dryRun: {
      action: 'Test à vide',
      title: 'Test d\'éjection à vide',
      description: 'Envoyez un test purement géométrique de ce profil vers une imprimante, ou téléchargez le fichier de test pour l\'inspecter.',
      printer: 'Imprimante',
      printerPlaceholder: 'Sélectionnez une imprimante connectée…',
      loadingPrinters: 'Vérification des connexions des imprimantes…',
      noPrinters: 'Aucune imprimante connectée disponible.',
      warningTitle: 'Plateau vide requis',
      warning: 'Ce test effectue son référencement au centre du plateau puis le balaye, le plateau doit donc être VIDE. Après l\'envoi, la tâche attend que vous leviez le maintien de plateau sur l\'imprimante.',
      dispatch: 'Envoyer le test',
      dispatching: 'Envoi…',
      download: 'Télécharger le fichier',
      downloading: 'Préparation…',
      dispatchFailed: 'Impossible d\'envoyer le test.',
      downloadFailed: 'Impossible de générer le fichier de test à vide.',
      allowUnvalidated: "Autoriser une géométrie non validée (réservé à l'échelle matérielle)",
      allowUnvalidatedWarning: "L'enveloppe de ce modèle n'a PAS été validée matériellement. N'envoyez qu'à l'échelle, sous surveillance et sur un plateau VIDE.",
    },
    geometry: {
      model: "Modèle d'imprimante",
      noModels: 'Aucune entrée dans le registre de géométrie',
      unvalidated: 'non validé matériellement',
      warningsTitle: 'Avertissements de géométrie',
      downloadModel: 'Modèle de géométrie pour le téléchargement',
      downloadModelPlaceholder: "Utiliser le modèle de l'imprimante sélectionnée",
      bandInverted: 'Le minimum de la bande X doit être inférieur au maximum de la bande X.',
      bandTooNarrow: 'La bande de balayage doit faire au moins {{min}} mm de large.',
      bandExceedsBed: 'Le maximum de la bande X dépasse le plateau enregistré le plus large ({{max}} mm).',
      heightExceedsCeiling: "Au-dessus du plafond de hauteur de tous les modèles enregistrés (max {{max}} mm) — l'envoi d'éjection serait refusé.",
      bedDropNoTravel: 'Les modèles sans course Z enregistrée ({{models}}) ne peuvent pas générer ce profil — définissez z_travel_mm dans le registre de géométrie.',
      bedDropBedslinger: "L'assistance d'abaissement du plateau n'est pas disponible sur les modèles à plateau mobile ({{models}}) — leur plateau ne bouge pas en Z.",
    },
    geometryManager: {
      title: 'Registre de géométrie des modèles',
      description: "Taille du plateau, enveloppe de déplacement et état de validation matérielle pour chaque modèle d'imprimante. Les lignes proviennent des données de départ du serveur — il n'y a pas de bouton d'ajout ; modifiez un modèle pour corriger sa géométrie ou changer sa validation.",
      edit: 'Modifier la géométrie',
      editTitle: 'Modifier la géométrie de {{model}}',
      saved: 'Géométrie du modèle enregistrée',
      saveFailed: "Impossible d'enregistrer la géométrie du modèle",
      zTravelUnset: "Aucune course Z enregistrée — l'assistance d'abaissement du plateau échoue en sécurité sur ce modèle.",
      validatedBadge: 'Validé',
      notValidatedBadge: 'Non validé',
      confirmValidateTitle: 'Marquer le modèle comme validé ?',
      ...
      columns: {
        model: 'Modèle',
        bed: 'Plateau (L×H mm)',
        envelope: 'Enveloppe (mm)',
        zTravel: 'Course Z',
        maxPartHeight: 'Hauteur max. de pièce',
        motion: 'Mouvement',
        validated: 'Validé',
        notes: 'Notes',
        updated: 'Mis à jour',
      ...
      motion: {
        bedZ: 'Plateau sur Z',
        bedslinger: 'Plateau mobile',
      },
      fields: {
        bedX: 'Largeur de plateau X (mm)',
        bedY: 'Profondeur de plateau Y (mm)',
        envXMin: 'Enveloppe X min (mm)',
        envXMax: 'Enveloppe X max (mm)',
        envYMin: 'Enveloppe Y min (mm)',
        envYMax: 'Enveloppe Y max (mm)',
    ...
    queueLabel: 'Profil d\'éjection (retrait automatique des pièces)',
    queueHelp: 'La pièce est poussée hors du plateau une fois que celui-ci refroidit jusqu\'à la ligne d\'éjection.',
  },
  // Navigation
  nav: {
    printers: 'Imprimantes',
  ...
  printers: {
    ...
    deactivated: {
      ...
      panelState: 'Désactivée — aucune connexion à cette imprimante.',
      activate: 'Activer',
      toastActivated: '{{name}} activée',
      editFieldLabel: 'Désactivée',
      editFieldHelp: 'Aucune session MQTT ; invisible pour cette instance (installations parallèles, mise hors service).',
    },
    // Chamber light
    ...
    toast: {
      ...
      recheckUnchanged: 'Emplacement {{slot}} inchangé. Aucun mouvement de bobine enregistré depuis la dernière vérification.',
      recheckMinted: 'Emplacement {{slot}} : nouvelle bobine enregistrée. {{grams}} g supposés.',
      recheckIdentified: 'Emplacement {{slot}} : {{identity}} enregistré depuis son étiquette.',
      recheckIdentifiedUnnamed: 'Emplacement {{slot}} : étiquette lue.',
      recheckIdentifiedNoRead: 'Emplacement {{slot}} : {{identity}} enregistré. Nouvelle lecture de l’étiquette différée.',
      recheckQueued: 'Vérification de l’emplacement {{slot}} mise en file. La ferme lira l’étiquette à la prochaine fenêtre d’inactivité et enregistrera la bobine à ce moment-là.',
      recheckEmpty: 'L’emplacement {{slot}} est vide. Chargez une bobine, puis revérifiez.',
      recheckRestored: 'Emplacement {{slot}} : bobine précédente restaurée.',
      recheckFailed: 'Emplacement {{slot}} : échec de la vérification.',
      recheckUndoNoOffer: 'Emplacement {{slot}} : aucune vérification à annuler.',
      recheckUndoNoPredecessor: 'Emplacement {{slot}} : aucune bobine précédente enregistrée pour cet emplacement.',
      recheckUndoMintGone: 'Emplacement {{slot}} : la bobine enregistrée n’existe plus.',
      recheckUndoBoundElsewhere: 'Emplacement {{slot}} : la bobine précédente se trouve dans un autre bac. Rien n’a été restauré.',
      recheckUndoFailed: 'Emplacement {{slot}} : échec de la restauration. {{detail}}',
    ...
    quarantine: {
      badge: 'En quarantaine',
      recover: 'Récupérer et reprendre',
      recoverSuccess: 'Imprimante récupérée — {{count}} série(s) reprise(s).',
      recoverError: 'Échec de la récupération de l\'imprimante',
      recoverTitle: 'Récupérer et reprendre ?',
      recoverMessage: 'Récupérer "{{name}}" ? Il s\'agit d\'un forçage explicite qui :',
    ...
    phase: {
      ...
      coolingToPlateau: 'Refroidissement jusqu\'au palier',
      coolingToPlateauHeld: 'Refroidissement jusqu\'au palier · plateau relevé',
    ...
    ejectPhase: {
      ...
      uploading: 'Éjection : téléversement {{pct}} %',
      uploadingNoPct: 'Éjection : téléversement…',
      sent: 'Éjection : envoyée',
      sweeping: 'Éjection : balayage…',
    ...
    ejectNotQualified: "L'éjection automatique n'est pas encore qualifiée matériellement pour ce modèle — exécutez l'échelle matérielle avant tout usage sans surveillance.",
    plateStatus: {
      ...
      markClearedCancelsEject: 'Marquer le plateau comme dégagé annule l\'éjection automatique en attente.',
      ejectInFlight: 'Éjection en cours. Utilisez Récupérer pour forcer.',
      markOccupied: 'Marquer le plateau comme occupé',
      markOccupiedSuccess: 'Plateau marqué comme occupé — envoi bloqué jusqu\'au dégagement',
      ejectInProgress: 'Éjection en cours · {{age}}',
      ejectStalled: 'Éjection bloquée · {{age}} — la ferme a perdu la trace du balayage',
      refusal: 'Contrôle du plateau : {{message}}',
    ...
    eject: {
      action: 'Éjecter le plateau',
      dispatched: 'Éjection lancée',
      confirmTitle: 'Éjecter avec le plateau chaud ?',
      confirmBodyNoLine: 'Le plateau est à {{bed}} °C, sans mesure de l\'air de l\'atelier ni de la chambre pour en juger. Éjecter maintenant balaie la pièce à cette température. Continuer ?',
      confirmBody: 'Le plateau est à {{bed}} °C, au-dessus du seuil de libération de {{threshold}} °C. Éjecter maintenant balaie la pièce alors que le plateau est encore chaud. Continuer ?',
      confirm: 'Éjecter le plateau',
      cancel: 'Annuler',
      foreignPrintNameLabel: 'Impression',
      foreignUnknownPrint: 'Inconnue',
      foreignPartHeightEditLabel: 'Hauteur de pièce (mm)',
      foreignProfileLabel: 'Profil d\'éjection',
      foreignSuggested: 'suggéré',
      foreignNoProfiles: 'Aucun profil d\'éjection disponible',
      foreignConfirm: 'Éjecter le plateau',
      dialog: {
        foreignTitle: 'Éjecter le plateau — impression non lancée par la ferme',
        farmUnitTitle: 'Éjecter le plateau — {{name}}',
        declaredTitle: 'Éjecter le plateau',
        body: 'Le balayage est construit à partir de la hauteur de pièce et du profil d\'éjection ci-dessous. Vérifiez les deux par rapport au plateau avant de lancer.',
        heightRequired: 'Hauteur de pièce inconnue. Saisissez le point le plus haut de la pièce sur le plateau.',
      },
      error: {
        jobActive: 'L\'imprimante exécute un travail. Attendez la fin ou arrêtez-le, puis éjectez.',
        dispatchInFlight: 'Une unité en file est en cours d\'envoi vers cette imprimante. Réessayez dans quelques secondes.',
        ejectInFlightPending: 'Éjection envoyée il y a {{age}} s ; en attente de son démarrage par l\'imprimante.',
        ejectInFlightPendingNoAge: 'Éjection déjà envoyée ; en attente de son démarrage par l\'imprimante.',
        ejectInFlightStarted: 'Éjection en cours depuis {{age}} s.',
        ejectInFlightStartedNoAge: 'Éjection en cours.',
        bedUnreadable: 'Température du plateau indisponible. Réessayez dans quelques secondes.',
        noDonor: 'Aucun fichier disponible pour construire l\'éjection. Marquez le plateau comme dégagé et retirez la pièce à la main.',
        firstArticle: 'Première pièce en attente de validation. Validez-la ou rejetez-la depuis la série.',
    ...
    rfid: {
      ...
      recheck: 'Revérifier l’emplacement',
      recheckPending: 'Revérification en attente. Se conclut à la fin de l’impression.',
      recheckQueuedTooltip: 'En file d’attente jusqu’à la fin de l’impression.',
      restorePreviousRoll: 'Restaurer la bobine précédente',
    },
    // AMS load/unload (#891)
    ams: {
      load: 'Charger',
    ...
    permission: {
      ...
      noAmsRfid: 'Pas d’autorisation pour revérifier les emplacements AMS',
    ...
    incidentAction: {
      ...
      plate_vision: 'Corrigez le plateau, puis reprenez l\'impression',
  ...
  archives: {
    ...
    modal: {
      ...
      deleteBlockedByLivePrint: 'Suppression impossible — cette archive enregistre une impression en cours. Arrêtez l\'impression d\'abord, puis réessayez.',
  ...
  queue: {
    ...
    permissions: {
      ...
      noReleaseStaged: 'Demandez à un administrateur de file d\'attente de libérer ces éléments',
  ...
  settings: {
    ...
    spoolSelectionPolicy: 'Politique de sélection de bobine',
    spoolSelectionPolicyDesc: 'Comment le répartiteur et les impressions manuelles choisissent une bobine lorsque plusieurs emplacements AMS correspondent.',
    spoolPolicyFirstLoaded: 'Chargé en premier (FIFO)',
    spoolPolicyLowestRemaining: 'Le moins restant',
    spoolPolicySlotOrder: 'Ordre des emplacements AMS',
    spoolPolicyBackupNote: "Le moins restant ne prend effet que si AMS Filament Backup est activé sur l'imprimante — sinon, l'imprimante ne peut pas basculer vers une seconde bobine quand celle choisie est vide.",
    minStartSpool: 'Poids minimal de bobine au démarrage (g)',
    ...
    taglessBrand: 'Marque',
    taglessMaterial: 'Matériau',
    taglessSubtype: 'Sous-type',
    taglessSubtypeHint: 'Le code de variante Bambu du matériau, p. ex. HF = High Flow. Affiché sur l\'étiquette de la bobine.',
    taglessColor: 'Couleur',
    taglessSlicerFilament: 'Filament du slicer (optionnel)',
    taglessSlicerFilamentHint: 'Le nom exact du préréglage de filament utilisé par votre slicer, pour que les impressions correspondent au bon profil.',
    ...
    deleteUserChecking: 'Vérification de ce que cette suppression retirerait...',
    deleteUserImpactUnavailable: 'Impossible de vérifier ce que cette suppression retirerait. Si vous supprimez quand même, les éléments de cet utilisateur seront retirés sans aperçu.',
    deleteUserArchives_one: '{{count}} archive d\'impression',
    deleteUserArchives_other: '{{count}} archives d\'impression',
    deleteUserLibraryFiles_one: '{{count}} fichier de la bibliothèque',
    deleteUserLibraryFiles_other: '{{count}} fichiers de la bibliothèque',
    deleteUserQueueItems_one: '{{count}} élément de la file',
    deleteUserQueueItems_other: '{{count}} éléments de la file',
    deleteUserProductionRuns_one: '{{count}} série de production',
    deleteUserProductionRuns_other: '{{count}} séries de production',
    deleteUserDependentSkus_one: '{{count}} SKU utilise un fichier téléversé par cet utilisateur. Ce SKU perdra le fichier et ne pourra pas être imprimé tant que vous ne l\'aurez pas réassigné.',
    deleteUserDependentSkus_other: '{{count}} SKU utilisent des fichiers téléversés par cet utilisateur. Ces SKU perdront les fichiers et ne pourront pas être imprimés tant que vous ne les aurez pas réassignés.',
    deleteUserPrintingNow_one: '{{count}} unité est en cours d\'impression. La suppression sera refusée tant qu\'elle n\'est pas terminée ou arrêtée.',
    deleteUserPrintingNow_other: '{{count}} unités sont en cours d\'impression. La suppression sera refusée tant qu\'elles ne sont pas terminées ou arrêtées.',
    deleteUserStillPrinting: 'Impression toujours en cours sur {{printers}}. Arrêtez ces impressions ou attendez qu\'elles se terminent, puis supprimez.',
    // Smart plugs
    ...
    farmProduction: 'Production en ferme',
    farmProductionDescription: 'Politique de tentatives et de quarantaine par défaut préremplie dans la fenêtre Démarrer une série. Modifiable pour chaque série.',
    farmEjectCooldown: 'Refroidissement d\'éjection',
    farmEjectCooldownDescription: 'Comment la ferme attend que le plateau refroidisse avant de balayer une plaque terminée, et quand elle abandonne ou met en quarantaine une imprimante qui ne refroidit pas.',
    farmRetryMaxPerUnit: 'Tentatives par plateau',
    farmRetryMaxPerUnitHelp: 'Tentatives automatiques avant qu\'un plateau soit marqué en échec (0–10)',
    farmEscalateConsecutiveFailures: 'Quarantaine après des échecs',
    farmEscalateConsecutiveFailuresHelp: 'Échecs consécutifs sur une imprimante qui déclenchent une quarantaine (1–20)',
    farmCooldownMargin: 'Marge au-dessus de l\'air de l\'atelier (°C)',
    farmCooldownMarginHelp: 'La ligne d\'éjection et la baisse du ventilateur de chambre se situent à cette marge au-dessus de l\'air de l\'atelier.',
    shopAir: {
      label: 'Air de l\'atelier',
      ejectLine: 'Ligne d\'éjection',
      noReading: 'aucune mesure',
      atPlateau: 'au palier',
      fresh_one: 'Mesuré dans {{count}} imprimante au repos, il y a {{minutes}} min — légèrement au-dessus de l\'air ambiant.',
      fresh_other: 'Mesuré dans {{count}} imprimantes au repos, il y a {{minutes}} min — légèrement au-dessus de l\'air ambiant.',
      carried: 'Reporté depuis {{time}} selon la courbe journalière.',
      unknown: 'Aucune mesure pour le moment — chaque refroidissement se libère quand le plateau cesse de refroidir.',
      readFailed: 'Lecture de l\'air de l\'atelier en échec — nouvel essai chaque minute.',
    },
    farmOfflineStallMinutes: 'Blocage hors ligne (min)',
    farmOfflineStallMinutesHelp: 'Signaler une unité encore en impression dont l\'imprimante est hors ligne depuis ce délai — jamais terminée, juste signalée (5–720)',
    farmPauseStallMinutes: 'Blocage en pause (min)',
    farmPauseStallMinutesHelp: 'Signaler et notifier quand une unité en impression reste en pause aussi longtemps sans récupération automatique en cours — n\'annule jamais rien (5–720)',
    farmCooldownStallWindow: 'Intervalle de vérification du refroidissement (min)',
    farmCooldownStallWindowHelp: 'À quelle fréquence vérifier que le plateau refroidit encore avant une éjection. Deux vérifications échouées de suite mettent l\'imprimante en quarantaine. 0 désactive la vérification.',
    farmCooldownStallEpsilon: 'Refroidissement minimal par vérification (°C)',
    farmCooldownStallEpsilonHelp: 'Le plateau doit baisser d\'au moins cette valeur entre deux vérifications pour être considéré comme refroidissant encore.',
    farmCooldownMaxHold: 'Minuteur d\'abandon (min)',
    ...
    farmCooldownPlateauMarginHelp: 'Si le refroidissement stagne mais que le plateau est à moins de ce nombre de degrés de l\'air de sa propre chambre, le considérer comme refroidi et éjecter ; s\'il reste plus chaud, l\'imprimante est mise en quarantaine.',
    farmCooldownAuxFanEnabled: 'Ventilateur auxiliaire pendant le refroidissement',
    farmCooldownAuxFanEnabledHelp: 'Fait tourner le ventilateur auxiliaire depuis la fin de l\'impression jusqu\'à l\'envoi de l\'éjection.',
    farmCooldownAuxFan: 'Vitesse du ventilateur auxiliaire (%)',
    farmCooldownAuxFanHelp: 'Une seule vitesse pour tout le refroidissement (1–100).',
    farmCooldownChamberFanEnabled: 'Ventilateur de chambre pendant le refroidissement',
    farmCooldownChamberFanEnabledHelp: 'Met le conduit d\'air en mode refroidissement et fait tourner le ventilateur d\'extraction de la chambre depuis la fin de l\'impression jusqu\'à l\'envoi de l\'éjection. Les modèles d\'imprimante sans ventilateur de chambre l\'ignorent.',
    farmCooldownChamberFan: 'Vitesse de renfort du ventilateur de chambre (%)',
    farmCooldownChamberFanHelp: 'Vitesse tant que l\'air de la chambre reste au-dessus de la température d\'éjection (1–100).',
    farmCooldownChamberFanSustain: 'Vitesse du ventilateur de chambre après le renfort (%)',
    farmCooldownChamberFanSustainHelp: 'Vitesse une fois que la chambre a atteint la température d\'éjection, jusqu\'à l\'envoi de l\'éjection. 0 arrête le ventilateur à ce moment. La vitesse de refroidissement de chambre propre à l\'imprimante est 50.',
    ...
    farmIdlePark: 'Parcage du plateau au repos',
    ...
    farmPlateBlowoffEnabled: 'Soufflage du plateau au démarrage de l\'impression',
    farmPlateBlowoffEnabledHelp: 'Ventilateur auxiliaire à pleine vitesse sur le plateau avant le nivellement du lit.',
    farmPlateBlowoffSeconds: 'Durée de soufflage (s)',
    farmPlateBlowoffSecondsHelp: 'Durée de marche du ventilateur auxiliaire avant le nivellement du lit (3–60).',
    ...
    queueCheckIntervalHelp: 'À quelle fréquence la ferme revérifie la file d\'attente même si rien ne s\'est passé. Un filet de sécurité au cas où un événement en direct serait manqué — plus bas réagit plus tôt mais interroge davantage (5–300).',
    dispatchKickDebounce: 'Délai de regroupement des rafales (s)',
    dispatchKickDebounceHelp: 'Lorsque plusieurs choses se produisent en même temps, attendre ce bref instant pour les regrouper en un seul passage d\'envoi plutôt que plusieurs. Plus haut regroupe davantage ; plus bas réagit plus vite (0.2–10).',
    usbPreflightFreshWindow: 'Fraîcheur de la vérification USB (s)',
    usbPreflightFreshWindowHelp: 'Faire confiance à un rapport récent "clé USB présente" jusqu\'à ce nombre de secondes avant de revérifier. Plus haut ignore les vérifications redondantes ; 0 revérifie toujours (0–120).',
    usbPreflightMaxWait: 'Attente max. de la vérification USB (s)',
    usbPreflightMaxWaitHelp: 'Combien de temps attendre un rapport récent "USB présente" avant de lancer une impression malgré tout. Plus haut est plus prudent ; plus bas envoie plus tôt (0–10).',
    dispatchParallelLimit: 'Démarrages d\'imprimante simultanés',
    dispatchParallelLimitHelp: 'Combien d\'imprimantes peuvent téléverser et démarrer en même temps en un passage. Plus haut vide une grande file plus vite ; plus bas ménage le réseau (1–10).',
    powerStagger: 'Échelonnement de l\'alimentation',
    powerStaggerDescription: 'Libérer un créneau d\'échelonnement dès qu\'une imprimante cesse de consommer de la puissance de chauffe, au lieu d\'attendre systématiquement tout l\'intervalle. Permet à l\'imprimante suivante de démarrer plus tôt tout en limitant la consommation simultanée.',
    staggerDynamicRelease: 'Libérer un créneau une fois le plateau chaud',
    staggerDynamicReleaseHelp: 'Lorsque activé, l\'imprimante suivante peut démarrer dès que l\'actuelle a fini de chauffer son plateau, plutôt que d\'attendre la fin de tout l\'intervalle. Lorsque désactivé, chaque créneau attend tout l\'intervalle.',
    staggerReleaseEpsilon: 'Marge à température (°C)',
    staggerReleaseEpsilonHelp: 'À quel point la température cible du plateau compte comme "assez chaude" pour libérer le créneau plus tôt. Plus grand libère l\'imprimante suivante plus tôt.',
    staggerHeatupGrace: 'Délai de grâce de chauffe (secondes)',
    staggerHeatupGraceHelp: 'Si une imprimante n\'a pas encore commencé à chauffer son plateau, attendre ce délai avant de libérer son créneau malgré tout, afin qu\'une imprimante inactive ne bloque pas le lot.',
    ...
    erp: {
      title: 'Connexion à l’annuaire ERP',
      statusActive: 'Connexion ERP : active',
      statusInactive: 'Connexion ERP : non configurée',
      activeDesc: 'Les opérateurs peuvent se connecter avec leurs identifiants de l’annuaire ERP.',
      inactiveDesc: 'Ajoutez et enregistrez les informations de connexion ci-dessous pour activer la connexion ERP.',
      disableHint: 'Pour désactiver la connexion ERP, effacez l’hôte et le nom de la base de données ci-dessous, puis enregistrez.',
      connectionConfig: 'Configuration de la connexion ERP',
      ...
      ssl: 'Se connecter via TLS',
      sslHint: 'Exiger une connexion chiffrée à la base de données ERP.',
      roleMapping: 'Correspondance des rôles',
      roleMappingHint: 'Attribuez un groupe BamBuddy à chaque rôle ERP.',
      roleMappingNoGroup: '— Aucun groupe —',
      roleMappingGroupFor: 'Groupe BamBuddy pour {{role}}',
      settingsSaved: 'Paramètres de l’annuaire ERP enregistrés',
      errors: {
        hostRequired: 'L’hôte de la base de données est requis',
        databaseRequired: 'Le nom de la base de données est requis',
      },
    },
    oidc: {
      ...
      form: {
        ...
        groupsClaimDesc: 'Claim du jeton contenant les valeurs de groupe ou de rôle de l’utilisateur. Laissez vide pour désactiver la synchronisation des groupes de ce fournisseur.',
        groupsClaimPlaceholder: 'groupes',
        groupMapping: 'Correspondance des groupes',
        groupMappingDesc: 'Associez chaque valeur de claim à un groupe BamBuddy. Les utilisateurs correspondants reçoivent le groupe associé à la connexion.',
        groupMappingNone: 'Aucune correspondance configurée.',
        groupMappingClaimValue: 'Valeur du claim',
        groupMappingGroup: 'Groupe BamBuddy',
        groupMappingSelectGroup: 'Sélectionner un groupe',
        groupMappingRemove: 'Supprimer la correspondance',
        groupMappingAdd: 'Ajouter une correspondance',
  ...
  fileManager: {
    ...
    createSkuFromUploadToast: '{{filename}} téléversé — créer une SKU à partir de celui-ci ?',
    createSkuFromUploadAction: 'Créer une SKU à partir de ce fichier',
    ...
    deleteFolderConfirm: "Supprimer ce dossier ? Les fichiers qu'il contient sont déplacés dans la corbeille et peuvent être restaurés à la racine ; le dossier lui-même est supprimé définitivement.",
    deleteFileConfirm: 'Supprimer ce fichier ?',
    deleteFilesConfirm: 'Supprimer {{count}} fichiers sélectionnés ? Ils sont déplacés dans la corbeille et peuvent être restaurés.',
  ...
  inventory: {
    ...
    freshRoll: {
      ...
      title: 'Nouvelle bobine sur cet emplacement ?',
      message: 'La bobine sans étiquette à {{location}} a été utilisée pour la majeure partie de son poids nominal. Si une nouvelle bobine est maintenant chargée, enregistrez-la pour que le suivi du filament reste exact.',
      confirm: 'Nouvelle bobine',
      pending: 'Enregistrement…',
      success: 'Nouvelle bobine enregistrée',
      failed: 'Échec de l\'enregistrement de la nouvelle bobine',
      dismissFailed: 'Impossible de fermer l\'invite de nouvelle bobine',
      remaining: '{{grams}} g suivis comme restants',
      brandLabel: 'Marque',
      brandPlaceholder: 'p. ex. Overture',
      weightLabel: 'Poids nominal (g)',
      weightPlaceholder: 'p. ex. 1000',
      costLabel: 'Coût / kg',
      costPlaceholder: 'Facultatif',
      noteLabel: 'Note',
      notePlaceholder: 'Facultatif',
      manualDesc: 'Clôturer cette fiche et en ouvrir une neuve',
      manualTitle: 'Marquer comme nouvelle bobine ?',
      manualMessage: 'Clôture la fiche de {{location}} ({{grams}} g consommés) et en ouvre une neuve et pleine pour cet emplacement. À faire uniquement après avoir physiquement changé la bobine.',
      manualConfirm: 'Marquer comme nouvelle bobine',
    },
    respool: {
      title: 'Réaffecter cette étiquette ?',
      manualTitle: 'Transférer cette puce sur une nouvelle bobine ?',
      manualMessage: 'Retirer l’enregistrement de {{location}} ({{grams}} g utilisés) et transférer sa puce Bambu sur une nouvelle bobine pleine. À faire uniquement après avoir changé la bobine.',
      message: 'Une étiquette Bambu réutilisée a été détectée à {{location}}. Si elle est maintenant sur une bobine tierce neuve, réaffectez-la à une fiche pleine.',
      confirm: 'Réaffectée — bobine neuve',
      pending: 'Réaffectation…',
      success: 'Réaffectée à une bobine {{brand}} neuve',
      failed: 'Échec de la réaffectation de l\'étiquette',
      autoToast: '{{brand}} réaffectée automatiquement sur {{printer}} emplacement {{slot}}',
      reusedTagToast: 'Nouveau rouleau possible sur une étiquette réutilisée — {{printer}} emplacement {{slot}}',
      ...
      triggerSpent: 'Ce rouleau a signalé une fin de filament, et l\'emplacement a été manipulé depuis.',
      triggerRemainJump: 'L\'AMS signale beaucoup plus de filament que cette fiche n\'en contient — l\'étiquette semble être passée sur un rouleau rechargé.',
      sameSpoolAction: 'Même bobine',
      reviewAction: 'Vérifier…',
      dismissFailed: 'Impossible de fermer l\'invite de réaffectation',
      donorLine: 'Remplace la bobine suivie (il reste {{grams}} g) ; l\'ancien enregistrement est archivé',
      donorRecordTitle: 'Fiche n° {{id}}',
      detailsLabel: 'Détails',
      tagIdLabel: 'ID de tag',
      warning: 'N\'utilisez qu\'UNE seule étiquette par rouleau d\'origine — jetez la seconde étiquette.',
      brandLabel: 'Marque',
      brandPlaceholder: 'p. ex. Overture',
      weightLabel: 'Poids nominal (g)',
      weightPlaceholder: 'p. ex. 1000',
    ...
    returnToRotation: 'Remettre en rotation',
    returnToRotationDone: 'Bobine remise en rotation',
    returnToRotationFailed: 'Impossible de remettre la bobine en rotation',
  ...
  ams: {
    ...
    slotDialogLabel: '{{ams}} emplacement {{slot}} : {{content}}',
    ...
    slotSpentSwapPark: '{{printer}} : l’emplacement {{slot}} de {{ams}} est occupé par une bobine épuisée que rien ne peut libérer. Revérifiez l’emplacement ou changez la bobine.',
    ...
    emptySlotBinding: {
      ...
      unassignAria: 'Désassigner {{spool}} de cet emplacement',
      unassignTitle: 'Désaffecter cette bobine ?',
      unassignMessage: 'Libère {{spool}} de cet emplacement. La bobine retourne à l’inventaire avec sa consommation enregistrée intacte — rien n’est supprimé.',
    },
    unknown: 'Inconnu',
    humidity: 'Humidité',
    temperature: 'Température',
  ...
  printModal: {
    ...
    customSlotMapping: 'Mappage de slots personnalisé',
    reread: 'Relire',
    requiredTooltip: 'Requis : {{type}} - {{color}}',
    manuallySelected: 'Sélectionné manuellement',
    autoMatched: 'Associé automatiquement',
    externalSlotNote: "Bobine externe : pas de suivi du poids ; l'imprimante demandera du filament sur le support.",
    selectSlot: '-- Sélectionner un slot --',
    noActivePrintersAvailable: 'Aucune imprimante active disponible',
    specificPrinter: 'Imprimante spécifique',
    anyModel: 'Tout {{model}}',
    modelFallback: 'Modèle',
    targetModelLabel: 'Modèle cible',
    selectModelPlaceholder: 'Sélectionner un modèle...',
    locationFilter: 'Filtre de lieu (facultatif)',
    anyLocation: 'Tout emplacement',
    schedulerAssignHint: 'Le planificateur affectera à la première imprimante {{model}} inactive disponible',
    schedulerAssignHintLocation: 'Le planificateur affectera à la première imprimante {{model}} inactive disponible dans {{location}}',
    selectPrinters: 'Sélectionner des imprimantes',
    printersSelected_one: '{{count}} imprimante sélectionnée',
    printersSelected_other: '{{count}} imprimantes sélectionnées',
    selectAll: 'Tout sélectionner',
    inactive: '(inactif)',
    unknownModel: 'Modèle inconnu',
    customMapping: 'Mappage personnalisé',
    matchedCount: '({{matched}}/{{total}} associés)',
    autoButton: 'Auto',
    hiddenPrinters_one: '{{count}} autre imprimante masquée (modèle différent) —',
    hiddenPrinters_other: '{{count}} autres imprimantes masquées (modèle différent) —',
    showAll: 'tout afficher',
    showOnlyModelPrinters: 'Afficher uniquement les imprimantes {{model}}',
    selectAtLeastOnePrinter: 'Sélectionnez au moins une imprimante',
    selectTargetModel: 'Sélectionnez un modèle d\'imprimante cible',
    typeNotFound: '(Type introuvable)',
    colorMismatch: '(Couleur non concordante)',
    ready: '(Prêt)',
    clickToChangeSlot: 'Cliquez pour changer l\'affectation des slots',
    costNotAvailable: 'N/D',
    requiredTypeNotFound: 'Type de filament requis introuvable dans l\'imprimante.',
    printJob: 'Tâche d\'impression',
    slicedModelMismatch: 'Le fichier a été découpé pour {{slicedModel}}, mais imprimé sur {{printerModel}}',
    archiveDataUnavailable: 'Données d\'archive indisponibles. Le fichier source a peut-être été supprimé. Le mappage des filaments est désactivé.',
    failedToComplete: 'Échec de l\'opération',
    toastQueueItemUpdated: 'Élément de la file mis à jour',
    toastUpdateFailed: 'Échec de la mise à jour de l\'élément de la file',
    toastSelectPrinter: 'Veuillez sélectionner au moins une imprimante',
    toastSelectModel: 'Veuillez sélectionner un modèle d\'imprimante cible',
    toastQueuedForModel: 'Mis en file pour tout {{model}}',
    ejectFromSku: 'Par défaut depuis le SKU {{code}}',
    partialFailureTitle: '{{failed}} envois sur {{total}} ont échoué :',
    toastPartialSuccess: '{{success}} réussies, {{failed}} échouées',
    printerFallback: 'Imprimante {{id}}',
    slotFallback: 'Emplacement {{id}}',
    plateFallback: 'Plaque {{index}}',
  },
  ...
  uploadModal: {
    ...
    libraryHint: 'Pour les SKU et les séries de production, importez-les plutôt dans le Gestionnaire de fichiers.',
    libraryHintLink: 'Aller au Gestionnaire de fichiers →',
    uploaded: 'téléversé',
    failed: 'échoué',
    uploading: 'En cours...',
    upload: 'Téléverser',
  ...
  notifications: {
    ...
    storageLow: 'Stockage USB presque plein',
    cooldownEscalation: 'Refroidissement prolongé',
    // Quiet hours
  ...
  fleetMetrics: {
    tabs: {
      ariaLabel: 'Vues des statistiques',
      prints: 'Impressions',
      fleet: 'Parc',
    },
    sections: {
      fleet: 'Parc',
      matrix: 'Matrice du parc',
      stateOverTime: 'État des imprimantes dans le temps',
      printsPerDay: 'Impressions par jour',
      downtimeByCause: 'Indisponibilité par cause',
      coolingAndEject: 'Refroidissement et éjection',
      recovery: 'Rétablissement',
      partsBySku: 'Pièces par SKU',
    },
    summary: {
      now: 'Maintenant',
      trend: 'Tendance',
      ...
      period: {
        ...
        custom: 'Plage sélectionnée',
      },
      rows: {
        avg_printing: 'En impression',
        avg_cycle_overhead: 'Entre deux impressions',
        avg_idle: 'Au repos',
        avg_down: 'Hors service',
        avg_planned: 'Maintenance',
        peak_down: 'Pic hors service',
        printers_in_fleet: 'Dans le parc',
        prints_per_day: 'Impressions',
        prints_per_printer_per_day: 'Impressions par imprimante',
        uptime: 'Taux de service',
        time_printing: 'Temps d’impression',
      },
      peak: 'pic {{count}}',
    ...
    class: {
      cycle_overhead: 'Entre deux impressions',
      cooling: 'Refroidissement',
      ejecting: 'Éjection',
      down: 'Hors service',
      planned: 'Maintenance',
      out_of_fleet: 'Désactivée',
    ...
    matrix: {
      ...
      lens: {
        ...
        timeSplit: 'Répartition du temps',
      },
      columns: {
        printer: 'Imprimante',
        total: 'Total',
      ...
      caption: '{{lens}} selon l’imprimante, du {{from}} au {{to}}',
      captionDay: '{{lens}} selon l’imprimante, {{date}}',
      details: 'Détails',
      ...
      legend: {
        ...
        over: '{{hours}} h+',
        scale: '0 à {{max}}',
        printingBand: 'En impression',
        otherBand: 'Autre',
        downBand: 'Hors service',
      },
    },
    detail: {
      title: '{{printer}} · {{bucket}}',
      timeSplit: 'Répartition du temps',
      classes: 'Utilisation du temps',
      printsByOutcome: 'Impressions par résultat',
      outcome: {
        completed: 'Terminées',
        failed: 'Échouées',
        cancelled: 'Annulées',
      ...
      incidents: 'Incidents',
      openPrinter: 'Ouvrir l’imprimante',
      noIntervals: 'Aucun intervalle enregistré pour cette période.',
      noIncidents: 'Aucun incident sur cette période.',
      noPrints: 'Aucune impression sur cette période.',
      ongoing: 'En cours',
    },
    widgets: {
      showData: 'Afficher les données',
      showChart: 'Afficher le graphique',
      showDataFor: 'Afficher les données de {{chart}}',
      showChartFor: 'Afficher le graphique de {{chart}}',
      median: 'Médiane',
      p90: 'P90',
      overExpected: 'au-delà du prévu',
      count: 'Nombre',
      variant: {
      ...
      clearedNoPerson: 'Résolu sans intervention',
      inFleetLine: 'Dans le parc',
      peakDownLine: 'Pic hors service',
      sku: 'SKU',
      units: 'Unités',
      plates: 'Plateaux',
      successRate: 'Réussite',
    ...
    states: {
      loading: 'Chargement…',
      loadFailed: 'Impossible de charger l’historique du parc.',
      retry: 'Réessayer',
      empty: 'Aucune donnée pour cette plage.',
      recordingGap: 'Enregistrement de l’état des imprimantes depuis le {{date}}. Historique des pannes et de la maintenance depuis le {{earliest}}.',
    },
    header: {
    ...
    hints: {
      ...
      cycle_overhead: 'Le travail propre de la ferme entre deux impressions : refroidir le plateau, puis balayer la pièce.',
      planned: 'Mode maintenance : une personne a retiré l’imprimante des flux automatiques.',
      uptime: 'Part du temps comptabilisé où l’imprimante pouvait prendre du travail.',
      time_printing: 'Part du temps comptabilisé où l’imprimante imprimait.',
      prints_per_printer: 'Impressions terminées divisées par les jours comptabilisés de chaque imprimante. Les jours comptabilisés proviennent uniquement des intervalles enregistrés : la valeur n’est donc pas comparable à « Impressions » tant qu’une partie de la période n’est pas enregistrée.',
      unobserved: 'Rien n’a été enregistré sur cette plage ; seules les pannes et les immobilisations sont connues.',
      not_recorded: 'Antérieur au premier état jamais enregistré pour cette imprimante.',
      incidents_only: 'Aucun état d’imprimante enregistré ici ; seul le journal des pannes et de la maintenance couvre la période.',
      whileRecorded: 'Les chiffres de la période ne couvrent que le temps enregistré.',
      timeframeFleet: 'Les jours vont de minuit à minuit en {{tz}}.',
      timeframePrints: 'Les jours vont de minuit à minuit UTC.',
    },
  },
};
