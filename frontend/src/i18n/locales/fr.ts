export default {
  ...
  fleetMetrics: {
    ...
    matrix: {
      ...
      caption: '{{lens}} par imprimante, du {{from}} au {{to}}',
      details: 'Détails',
    ...
    states: {
      ...
      firstRun: 'Enregistrement de l’état des imprimantes depuis le {{date}}. Historique des pannes et de la maintenance depuis le {{earliest}}.',
    },
    header: {
    ...
    hints: {
      ...
      prints_per_printer: 'Impressions terminées divisées par les jours comptabilisés de chaque imprimante.',
