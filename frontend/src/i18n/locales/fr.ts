export default {
  ...
  printers: {
    ...
    eject: {
      now: 'Éjecter maintenant',
      menuEjectPlate: 'Éjecter le plateau…',
      ...
      foreignTitle: 'Éjecter une impression externe ?',
      foreignBody: 'Cette impression n\'a pas été lancée par la ferme. Le balayage utilise le profil d\'éjection sélectionné ci-dessous — corrigez la hauteur de pièce si la valeur détectée est incorrecte.',
