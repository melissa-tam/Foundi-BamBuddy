export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      bedDropHelp: 'Après que la tête s\'est levée au-dessus de la pièce, le plateau descend presque jusqu\'au fond de la machine puis remonte pour décoller la pièce d\'une secousse avant le balayage.',
    ...
    tooltips: {
      ...
      bedDrop: 'Une fois la pièce dégagée par la levée, le plateau chauffant descend presque jusqu\'à son point le plus bas puis remonte ; la secousse décolle une pièce coincée avant le balayage. Nécessite une course Z enregistrée pour le modèle.',
