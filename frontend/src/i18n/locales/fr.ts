export default {
  ...
  inventory: {
    ...
    freshRoll: {
      ...
      message: 'La bobine sans étiquette à {{location}} a été utilisée à plus de la moitié de son poids nominal. Si une nouvelle bobine est maintenant chargée, enregistrez-la pour que le suivi du filament reste exact.',
    ...
    respool: {
      ...
      promptToast: 'Bobine presque vide sur {{printer}} emplacement {{slot}} — nouvelle bobine sur ce tag ?',
