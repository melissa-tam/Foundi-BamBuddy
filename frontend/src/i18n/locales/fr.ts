export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      cooldownRetries: 'Tentatives de refroidissement',
    ...
    tooltips: {
      ...
      cooldownRetries: 'Nombre de fois où la température du plateau est revérifiée en attendant qu\'elle atteigne la cible avant d\'abandonner.',
  ...
  printers: {
    ...
    phase: {
      printing: 'Impression',
      cooling: 'Refroidissement jusqu\'à {{threshold}}°C (plateau {{bed}}°C) — le balayage s\'exécute dans le fichier',
  ...
  settings: {
    ...
    farmRetryMaxPerUnitHelp: 'Tentatives automatiques avant qu\'un plateau soit marqué en échec (0–5)',
    farmEscalateConsecutiveFailures: 'Quarantaine après des échecs',
    farmEscalateConsecutiveFailuresHelp: 'Échecs consécutifs sur une imprimante qui déclenchent une quarantaine (1–10)',
