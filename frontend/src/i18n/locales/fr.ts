export default {
  ...
  settings: {
    ...
    ejectUploadSkipIdentical: 'Réutiliser les fichiers d\'éjection déjà présents sur la clé USB',
    ejectUploadSkipIdenticalHelp: 'Ignorer le renvoi d\'un fichier d\'éjection lorsque le fichier identique est déjà sur la clé USB de l\'imprimante, ce qui économise quelques secondes par éjection.',
    ejectUploadSkipIdenticalWarning: 'À activer uniquement après que la sonde d\'éjection en direct a confirmé que le fichier sur la clé est réutilisé correctement. En cas de doute, laissez désactivé — un renvoi garantit toujours le bon fichier.',
    ejectSlim3mf: 'Alléger les fichiers d\'éjection',
    ejectSlim3mfHelp: 'Retirer le modèle 3D et l\'image d\'aperçu des fichiers d\'éjection pour qu\'ils se téléversent plus vite — le mouvement d\'éjection lui-même reste inchangé.',
    ejectSlim3mfWarning: 'Verrouillé au matériel : exécutez l\'échelle matérielle d\'éjection complète avec des fichiers allégés avant de l\'activer pour une production sans surveillance. Laissez désactivé jusqu\'à ce que cette échelle soit validée.',
