export default {
  ...
  printers: {
    ...
    quarantine: {
      ...
      clear: 'Lever la quarantaine',
      cleared: 'Quarantaine levée',
      clearTitle: 'Lever la quarantaine ?',
      clearMessage: 'Lever la quarantaine de "{{name}}" ? Le planificateur reprendra l\'envoi des impressions vers cette imprimante.',
      clearMessageWithReason: 'Lever la quarantaine de "{{name}}" ? Motif : {{reason}}. Le planificateur reprendra l\'envoi des impressions vers cette imprimante.',
    },
    plateStatus: {
