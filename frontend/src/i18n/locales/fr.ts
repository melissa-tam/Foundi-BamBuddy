export default {
  ...
  productionRuns: {
    ...
    fields: {
      ...
      cooldownOverride: 'Remplacer le refroidissement (°C)',
      cooldownPlaceholder: 'Utiliser la valeur du profil',
      cooldownProfileDefault: 'Remplace la valeur du profil : {{value}}°C',
  ...
  ejectProfiles: {
    ...
    columns: {
      cooldownTemp: 'Refroidissement °C',
      passes: 'Passages',
    ...
    fields: {
      name: 'Nom',
      cooldownTemp: 'Température de refroidissement (°C)',
    ...
    tooltips: {
      ...
      cooldownTemp: 'Température du plateau à laquelle l\'impression doit refroidir avant le balayage – les pièces se détachent du plateau une fois froides.',
    ...
    geometry: {
      ...
      cooldownAmbientTrap: "Sous le seuil d'alerte de refroidissement ({{floor}} °C). Un seuil égal ou inférieur à la température ambiante de l'atelier ne peut jamais être atteint et l'attente d'éjection resterait bloquée — réglez-le quelques degrés au-dessus de l'ambiante.",
    ...
    queueHelp: 'La pièce est poussée hors du plateau une fois que celui-ci refroidit sous le seuil du profil.',
  },
  // Navigation
  nav: {
    printers: 'Imprimantes',
  ...
  settings: {
    ...
    farmCooldownWarnFloor: "Seuil d'alerte de refroidissement (°C)",
    farmCooldownWarnFloorHelp: "Avertir quand le seuil de refroidissement d'un profil d'éjection est en dessous — un seuil égal ou inférieur à l'ambiante de l'atelier ne se termine jamais (15–50)",
