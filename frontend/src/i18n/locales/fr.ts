export default {
  ...
  printers: {
    ...
    toast: {
      ...
      recheckFailed: 'Échec de la vérification',
  ...
  inventory: {
    ...
    respool: {
      ...
      noteLabel: 'Note',
      notePlaceholder: 'Facultatif',
      actionDesc: 'Transférer cette étiquette Bambu sur une bobine neuve',
    },
    bulk: {
  ...
  ams: {
    ...
    emptySlotBinding: {
      ...
      clearMessage: 'Libère {{spool}} de cet emplacement. La bobine retourne à l’inventaire avec sa consommation enregistrée intacte — rien n’est supprimé.',
    },
    unknown: 'Inconnu',
    humidity: 'Humidité',
    temperature: 'Température',
