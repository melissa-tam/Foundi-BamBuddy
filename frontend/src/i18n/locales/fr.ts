export default {
  ...
  printers: {
    ...
    eject: {
      ...
      foreignBody: 'Cette impression n\'a pas été lancée par la ferme (elle a été envoyée manuellement depuis Bambu Studio). Le balayage utilisera le profil d\'éjection sélectionné ci-dessous — vérifiez d\'abord que la hauteur de pièce détectée est correcte.',
      foreignPrintNameLabel: 'Impression',
      foreignUnknownPrint: 'Inconnue',
      foreignPartHeightLabel: 'Hauteur de pièce détectée',
