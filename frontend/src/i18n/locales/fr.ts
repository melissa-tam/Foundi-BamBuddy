export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      coolingFanAssist: 'Assistance du ventilateur de refroidissement',
    ...
    tooltips: {
      ...
      coolingFanAssist: 'Fait tourner le ventilateur de pièce pendant le balayage pour aider une pièce tenace à se décoller du plateau.',
  ...
  inventory: {
    ...
    assignEmptyHidden: '{{count}} bobines vides masquées',
