export default {
  ...
  ejectProfiles: {
    ...
    tooltips: {
      ...
      cooldownRetries: '在等待热床达到目标温度的过程中，放弃前重新检查温度的次数。',
  ...
  printers: {
    ...
    phase: {
      printing: '打印中',
      cooling: '正在冷却至 {{threshold}}°C（热床 {{bed}}°C）— 扫除在文件内执行',
  ...
  settings: {
    ...
    farmRetryMaxPerUnitHelp: '在打印板被标记为失败前的自动重试次数（0–5）',
    farmEscalateConsecutiveFailures: '失败后隔离',
    farmEscalateConsecutiveFailuresHelp: '触发隔离的打印机连续失败次数（1–10）',
