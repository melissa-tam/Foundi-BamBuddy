export default {
  ...
  productionRuns: {
    ...
    fields: {
      ...
      noEjectProfile: '无',
      skuDefault: 'SKU 默认',
      cooldownOverride: '覆盖冷却温度 (°C)',
      cooldownPlaceholder: '使用配置默认值',
      cooldownProfileDefault: '覆盖配置默认值 {{value}}°C',
      skuNoFile: '— 未关联文件',
  ...
  ejectProfiles: {
    ...
    tooltips: {
      ...
      cooldownTemp: '打印件在开始扫除前必须冷却到的热床温度 – 冷却后零件会从打印板上脱离。',
    ...
    geometry: {
      ...
      cooldownAmbientTrap: '低于冷却警告下限（{{floor}} °C）。等于或低于车间环境温度的阈值永远无法达到，取件等待将永久卡住 — 请设置为高于环境温度几度。',
    ...
    queueHelp: '当热床冷却到低于配置阈值后，零件将被扫下。',
  },
  // Navigation
  nav: {
    printers: '打印机',
  ...
  settings: {
    ...
    farmCooldownWarnFloorHelp: '当取件配置的冷却阈值低于此值时发出警告 — 等于或低于车间环境温度的阈值永远不会完成（15–50）',
