export default {
  ...
  skus: {
    nav: 'SKU 列表',
    title: 'SKU 目录',
    description: '可销售的部件编码，每个编码关联一个或多个库文件盘板，以及用于生产运行的默认取件配置。',
    newSku: '新建 SKU',
    loadError: '无法加载 SKU。',
    empty: {
      title: '尚无 SKU',
      body: '创建您的第一个 SKU，以关联可打印文件并跟踪生产。',
    },
    columns: {
      files: '文件',
      unitsCompleted: '累计件数',
    ...
    deleted: '已删除 SKU',
    saveFailed: '无法保存 SKU',
    deleteFailed: '无法删除 SKU',
    deleteTitle: '删除此 SKU？',
    deleteBody: '“{{code}}”将被永久删除。此操作无法撤销。',
    suggest: {
      appliedFromObjectName: '已根据文件中的零件名称填充信息',
      appliedFromFilename: '已根据文件名填充信息',
      appliedGeneric: '已从文件填充信息',
      failed: '无法建议详细信息',
    },
    files: {
      title: '已关联文件',
      ...
      plate: '盘板',
      unitsPerPlate: '每盘板件数',
      plateUnits: '盘板 {{plate}} · 每盘板 {{units}} 件',
      add: '添加文件',
      added: '已关联文件',
      addFailed: '无法关联文件',
      savedButLinkFailed: 'SKU 已保存，但文件关联失败：{{reason}}',
      remove: '移除',
      removed: '已取消关联文件',
      removeFailed: '无法取消关联文件',
      removeTitle: '取消关联此文件？',
      removeBody: '“{{name}}”将从此 SKU 取消关联。',
    },
  },
  ...
  productionRuns: {
    nav: '生产',
    title: '生产运行',
    description: '将 SKU 的副本分配到多台打印机，直到达到目标件数，并实时显示进度。',
    loadError: '无法加载生产运行。',
    empty: {
      title: '尚无生产运行',
      body: '启动一个运行，将 SKU 打印到目标件数。',
      noSkus: '启动运行前，请添加一个至少关联一个文件的 SKU。',
    },
    startTitle: '启动生产运行',
    startAction: '启动运行',
    runAgain: '再次运行',
    ...
    started: '已启动生产运行',
    startFailed: '无法启动运行',
    noFiles: '此 SKU 没有可打印的关联文件。',
    fileRequired: '请选择要打印的文件。',
    targetRequired: '请输入至少 1 件的目标。',
    printerRequired: '请至少选择一台打印机。',
    overProduction: '将生产 {{planned}} 件（{{plates}} 盘板）——比目标 {{target}} 多 {{extra}} 件。',
    fields: {
      sku: 'SKU',
      file: '文件 / 盘板',
      filePlaceholder: '选择一个文件…',
      plateUnits: '盘板 {{plate}}，{{units}}/盘板',
      targetUnits: '目标件数',
      printers: '打印机',
      ...
      skuDefault: 'SKU 默认',
      skuNoFile: '— 未关联文件',
      skuNoFileHint: '在 SKU 页面为该 SKU 关联一个文件后即可启动生产。',
    },
    status: {
      active: '进行中',
      paused: '已暂停',
    ...
    platesProgress: '{{completed}} / {{total}} 盘板',
    stats: {
      units: '件数',
      target: '目标',
      failed: '失败',
    ...
    schedule: {
      ...
      openCalendar: '打开日历',
      pastError: '请选择将来的时间。',
      invalidError: '请输入有效的日期和时间。',
      helpAsap: '一旦有合适的打印机空闲，运行即开始。',
      helpScheduled: '如果打印机空闲，运行将在所选时间开始；否则将等待直到有打印机空闲。',
      startsIn: '{{when}}开始',
    },
    viewDetails: '查看运行详情',
    blockedPrinters: '打印机被阻止',
    pauseReason: {
      operator: '已由操作员暂停',
    ...
    detail: {
      ...
      notFound: '未找到生产运行。',
      printersTitle: '打印机',
      noPrinters: '尚未分配打印机 — 调度器会为每个单元挑选空闲的匹配打印机。',
      unitsTitle: '单元',
      noUnits: '暂无单元。',
      unitCol: '单元',
      statusCol: '状态',
      ...
      waiting: {
        ...
        visionHold: '在打印板检测处暂停 — 修正打印板后继续',
        powerLossHold: '停在打印机的断电恢复提示 — 请在打印机上继续',
        zReferenceLost: '重启时打印板上仍有零件 — 请手动取下',
        previousPrintFailed: '已搁置：上一次打印失败',
        filamentShort: '耗材不足',
        externalSpoolRunout: '外置料卷已用尽 — 请补充外置料架，而不是 AMS 料槽',
        externalFeedFault: '外置料卷未能进料 — 请检查料架和 PTFE 导管，然后在打印机上恢复',
        pinnedTrayUnavailable: '固定的料槽在这台打印机上未装载 — 请装载该料槽或取消固定',
        ...
        libraryFileMissing: '库中缺少源文件 — 请恢复该文件或重新上传',
      ...
      printerState: {
        ...
        visionHold: '打印板检测暂停',
        filamentShort: '耗材不足',
        noUsbDrive: '无 USB 驱动器',
      },
      eligibility: {
        title: '未参与的打印机',
        description: '在解决之前，这些打印机不会接受本次运行的单元：',
        offline: '离线',
        quarantined: '已隔离',
        awaitingPlateClear: '热床未清理',
        modelMismatch: '型号不匹配',
        filamentShort: '耗材不足',
        noUsbDrive: '无 USB 驱动器',
      },
    ...
    abortTitle: '中止此运行？',
    abortBody: '“{{name}}”将被取消。进行中的盘板会完成，但不会启动新盘板。此操作无法撤销。',
    delete: '删除',
    deleted: '已删除运行',
    deleteTitle: '删除此运行？',
    deleteBody: '“{{name}}”及其单元历史记录将被永久删除，其打印板将不再计入 SKU 统计。此操作无法撤销。',
    deleteFailed: '删除运行失败',
    deleteHasPrintingUnits: '该运行在 {{printers}} 上仍有单元正在打印。请先停止或等待其完成，然后再删除。',
    firstArticle: {
      sectionTitle: '首件批准',
      requireLabel: '要求首件批准',
      requireHelp: '首个零件将在不自动弹出的情况下打印，任务将暂停以等待你的批准。',
      retriesLabel: '每块板的重试次数',
      escalateLabel: '连续失败后隔离',
      printing: '正在打印首件',
      awaitingTitle: '首件等待批准',
      awaitingBody: '首个零件已打印完成。请检查后批准以继续任务，或拒绝以停止并修改。',
      approvePhysical: '批准 — 我已取下零件',
      approveEject: '批准并远程弹出',
      reject: '拒绝…',
      approveConfirm: '批准',
      approvePhysicalTitle: '批准首件？',
      approvePhysicalBody: '请确认你已将打印好的零件从打印板上取下。任务将继续并派发其余打印板。',
      approveEjectTitle: '批准并远程弹出？',
      approveEjectBody: '在任务继续前，工具头会将零件从打印板上扫落。请确保打印板上没有障碍物，且无人将手伸入打印机。',
      rejectTitle: '拒绝首件',
      rejectBody: '请说明哪里出了问题。之后恢复任务将重新开始一个新的首件。',
      rejectReasonLabel: '原因',
      rejectReasonPlaceholder: '例如：翘边、附着不良…',
      rejectReasonRequired: '需要填写原因。',
      rejectAction: '拒绝首件',
      rejectedBadge: '首件已拒绝',
      rejectedReason: '原因：{{reason}}',
      rejectedHint: '恢复将重新开始一个新的首件。',
      approvedBadge: '首件已批准',
      approved: '首件已批准',
      rejected: '首件已拒绝',
      approveFailed: '批准首件失败',
      rejectFailed: '拒绝首件失败',
      photoAlt: '首件完成照片',
      photoUnavailable: '完成照片不可用',
      viewCamera: '查看摄像头',
      hideCamera: '隐藏摄像头',
      printerLabel: '打印机：{{name}}',
    },
  },
  ...
  ejectProfiles: {
    nav: '取件配置',
    title: '取件配置',
    description: '自动取件配置，在热床冷却后将完成的零件从热床上扫下。',
    newProfile: '新建配置',
    loadError: '无法加载取件配置。',
    duplicateAction: '复制',
    copyName: '{{name}}（副本）',
    empty: {
      title: '尚无取件配置',
      body: '创建您的第一个配置，以自动将完成的零件从热床上清除。',
    },
    columns: {
      passes: '行程次数',
      ejectSpeed: '取件速度',
    ...
    fields: {
      ...
      xPasses: 'X 行程次数',
      xMargin: 'X 边距 (mm)',
      frontOverhang: '前伸出量 (mm)',
      backOverhang: '后伸出量 (mm)',
      ejectSpeed: '取件速度 (mm/min)',
      skimSpeed: '掠过速度 (mm/min)',
      finalSkim: '最终掠扫行程',
      finalSkimHelp: '在扫除后于打印板正上方增加一次缓慢的掠扫行程，以清除薄残留物。若只想推动一次，请关闭。',
      maxPartHeight: '最大零件高度 (mm)',
      sweepStartHeight: '清扫起始高度 (%)',
      sweepStartHeightHelp: '从零件高度的此百分比处开始下降清扫（100% = 零件顶部）。',
      sweepBand: '限制 X 清扫带',
      sweepBandHelp: '仅清扫热床宽度的一个子区间，而非整个宽度。若需整个宽度请关闭。',
      sweepXMin: 'X 区间最小值 (mm)',
      sweepXMax: 'X 区间最大值 (mm)',
      bedDrop: '热床下降脱离辅助',
      bedDropHelp: '热床下降到接近机器底部再返回抬升高度，借助震动在扫除前使粘住的零件脱离。',
      bedDropClearance: '底部间隙 (mm)',
      bedDropDwell: '在下降最低点保持 (秒)',
      bedDropDwellHelp: '热床在返回抬升高度之前，先在下降最低点保持所设的秒数。',
      bedDropJitter: '在下降最低点抖动',
      bedDropJitterHelp: '热床在下降最低点按所设距离上下往复，往复次数为所设的次数。',
      bedDropJitterCycles: '抖动次数',
      bedDropJitterMm: '抖动行程 (mm)',
    },
    tooltips: {
      name: '用于识别此配置的简短标签 – 显示在配置列表和选择器中。',
      clearance: '工具头移动到位时保持在零件上方的高度，以便在扫除前不碰到打印件。',
      zOffset: '扫除路径高度的微调 – 喷嘴刮蹭时调高，未能扫到零件时调低。',
      descentSteps: '工具头在推走零件前，为绕到其后方而执行的小幅下降步数。',
      xPasses: '为清除零件而在打印板上进行的左右扫除次数。',
      xMargin: '与打印板左右边缘保持的间距，使工具头不会撞到机架。',
      frontOverhang: '扫除超出零件前方的距离，以确保将其完全推走。',
      backOverhang: '扫除在零件后方多远处开始，以便工具头在推动前完全绕到其后方。',
      ejectSpeed: '将零件推离打印板的推动行程中，工具头的移动速度。',
      skimSpeed: '清除残余碎屑的较轻掠过行程中，工具头的移动速度。',
      finalSkim: '在主扫除之后于打印板正上方执行一次额外的缓慢行程，以清除薄残留物。若只需推动一次请关闭（例如为高零件设置一条中间高度的通道）。',
      maxPartHeight: '此配置可弹出的最高零件 – 若切片零件更高，将阻止派发。',
      sweepStartHeight: '下降扫除在零件上开始的高度，以百分比表示（有效范围 1-100%，100% 表示零件顶部）。',
      sweepBand: '仅扫除打印板的一条区带而非整个宽度 – 当零件总在同一位置时很有用。',
      sweepXMin: '扫除区带的左边缘，从打印板原点起算，单位 mm。有效范围 0-340 mm（H2S 打印板宽度）；必须小于最大值，并留出至少 10 mm 宽的区带。',
      sweepXMax: '扫除区带的右边缘，从打印板原点起算，单位 mm。有效范围 0-340 mm（H2S 打印板宽度）；必须大于最小值，并留出至少 10 mm 宽的区带。',
      bedDrop: '热床下降到接近最低点再返回抬升高度，借助震动在扫除前使粘住的零件脱离。需要为该型号登记 Z 行程。',
      bedDropClearance: '下降过程中与热床最低位置保持的间隙 — 50 mm = 在底部上方 5 cm 处停止。',
      bedDropDwell: '在下降最低点多停留几秒，可让粘住的零件在扫除前有时间彻底剥离。',
      bedDropJitter: '在下降最低点做短距离上下往复，可使单次震动未能震落的零件脱离。',
    },
    nameRequired: '名称为必填项。',
    created: '取件配置已创建',
    updated: '取件配置已更新',
    ...
    deleteFailed: '删除配置失败',
    deleteTitle: '删除此配置？',
    deleteBody: '"{{name}}" 将被永久删除。此操作无法撤销。',
    preview: {
      title: '预览与验证',
      description: '为库文件和盘面生成取件 G-code，以便在使用前进行验证。',
      file: '库文件',
      ...
      errors: '错误',
      warnings: '警告',
      maxZ: '最大 Z 高度：{{value}} mm',
      showGcode: '显示 G-code',
      hideGcode: '隐藏 G-code',
      gcodeLabel: '生成的 G-code',
      failed: '预览失败',
    },
    dryRun: {
      action: '空跑',
      title: '空跑测试',
      description: '将此配置的仅几何测试发送到打印机，或下载测试文件以进行检查。',
      printer: '打印机',
      printerPlaceholder: '选择已连接的打印机…',
      loadingPrinters: '正在检查打印机连接…',
      noPrinters: '没有可用的已连接打印机。',
      warningTitle: '需要空打印板',
      warning: '此测试会归位到打印板中心并在其上扫过，因此打印板必须为空。派发后，任务会等待，直到您在打印机上解除打印板保持。',
      dispatch: '发送测试',
      dispatching: '正在发送…',
      download: '下载文件',
      downloading: '正在准备…',
      dispatchFailed: '无法发送测试。',
      downloadFailed: '无法生成空跑文件。',
      allowUnvalidated: '允许未验证的几何（仅用于硬件阶梯）',
      allowUnvalidatedWarning: '此型号的运动范围尚未经过硬件验证。仅可在阶梯上、有人监督且打印板为空时派发。',
    },
    geometry: {
      model: '打印机型号',
      noModels: '几何注册表中没有条目',
      unvalidated: '未经硬件验证',
      warningsTitle: '几何警告',
      downloadModel: '下载用几何型号',
      downloadModelPlaceholder: '使用所选打印机的型号',
      bandInverted: 'X 区间最小值必须小于最大值。',
      bandTooNarrow: '扫掠区间宽度至少需 {{min}} mm。',
      bandExceedsBed: 'X 区间最大值超出已注册的最宽热床（{{max}} mm）。',
      heightExceedsCeiling: '超过所有已注册型号的高度上限（最大 {{max}} mm）— 取件派发将被拒绝。',
      bedDropNoTravel: '未登记 Z 行程的型号（{{models}}）无法生成此配置 — 请在几何注册表中设置 z_travel_mm。',
      bedDropBedslinger: '热床下降辅助在动床型号（{{models}}）上不可用 — 它们的热床不沿 Z 方向移动。',
    },
    geometryManager: {
      title: '型号几何注册表',
      description: '每个打印机型号的热床尺寸、运动范围和硬件验证状态。行由服务器种子创建 — 没有添加按钮；编辑某个型号以更正其几何或更改其验证状态。',
      edit: '编辑几何',
      editTitle: '编辑 {{model}} 的几何',
      saved: '型号几何已保存',
      saveFailed: '无法保存型号几何',
      zTravelUnset: '未登记 Z 行程 — 此型号的热床下降辅助将安全失效。',
      validatedBadge: '已验证',
      notValidatedBadge: '未验证',
      confirmValidateTitle: '将型号标记为已验证？',
      confirmValidateBody: '将 {{model}} 标记为已验证会解锁无人值守的量产取件。仅在操作员见证的硬件阶梯之后确认：空床空跑 → 有人监督的打印→冷却→取件循环 → 短循环。',
      confirmUnvalidateTitle: '移除验证？',
      confirmUnvalidateBody: '移除 {{model}} 的验证会使该型号的量产自动取件安全失效，直到重新验证。',
      confirmZReferenceTitle: '启用 Z 重新参考？',
      confirmZReferenceBody: '为 {{model}} 启用 Z 重新参考后，每次带件取出都会先执行一次受保护的热床下行动作，直到下限位。请仅在操作员现场完成硬件阶梯验证、且已安装脱模辅具后确认。',
      confirmUnZReferenceTitle: '停用 Z 重新参考？',
      confirmUnZReferenceBody: '停用后，{{model}} 的取出将重新依赖保留的 Z 原点，而断电会破坏该原点。',
      columns: {
        model: '型号',
        bed: '热床（宽×高 mm）',
        envelope: '运动范围（mm）',
        zTravel: 'Z 行程',
        maxPartHeight: '最大零件高度',
        motion: '运动方式',
        validated: '验证',
        notes: '备注',
        updated: '更新时间',
      ...
      fields: {
        bedX: '热床宽度 X（mm）',
        bedY: '热床深度 Y（mm）',
        envXMin: '运动范围 X 最小（mm）',
        envXMax: '运动范围 X 最大（mm）',
        envYMin: '运动范围 Y 最小（mm）',
        envYMax: '运动范围 Y 最大（mm）',
        maxPartHeight: '最大零件高度（mm）',
        zTravel: 'Z 行程（mm）',
        zTravelHelp: '留空则清除。此时该型号的热床下降辅助将安全失效。',
        zReferenceValidated: 'Z 重新参考已验证',
        holdLift: '保持时热床抬升 (mm)',
        holdLiftHelp: '热床检查确认后打印机处于保持状态时，热床从下限位抬升的距离。',
        notes: '备注',
        validated: '已硬件验证',
      },
    },
    queueLabel: '取件配置（自动取件）',
    queueHelp: '当热床冷却到取件线后，零件将被扫下。',
  },
  // Navigation
  nav: {
    printers: '打印机',
  ...
  printers: {
    ...
    deactivated: {
      pillLabel: '已停用',
      panelState: '已停用 — 与此打印机无连接。',
      activate: '启用',
      toastActivated: '{{name}} 已启用',
      editFieldLabel: '已停用',
      editFieldHelp: '无 MQTT 会话；对此实例不可见（并行安装、停止使用）。',
    },
    // Chamber light
    ...
    toast: {
      ...
      recheckUnchanged: '槽位 {{slot}} 无变化。自上次检查以来未记录到换卷。',
      recheckMinted: '槽位 {{slot}}：已记录新卷。按 {{grams}} g 计。',
      recheckIdentified: '槽位 {{slot}}：已从标签记录 {{identity}}。',
      recheckIdentifiedUnnamed: '槽位 {{slot}}：已读取标签。',
      recheckIdentifiedNoRead: '槽位 {{slot}}：已记录 {{identity}}。标签重读已推迟。',
      recheckQueued: '槽位 {{slot}} 的检查已排队。农场将在下一个空闲窗口读取标签并记录该卷。',
      recheckEmpty: '槽位 {{slot}} 为空。装入一卷后重新检查。',
      recheckRestored: '槽位 {{slot}}：已恢复上一卷。',
      recheckFailed: '槽位 {{slot}}：检查失败。',
      recheckUndoNoOffer: '槽位 {{slot}}：没有可撤销的检查。',
      recheckUndoNoPredecessor: '槽位 {{slot}}：该槽位没有记录上一卷。',
      recheckUndoMintGone: '槽位 {{slot}}：所记录的卷已不存在。',
      recheckUndoBoundElsewhere: '槽位 {{slot}}：上一卷料已装入其他料盘。未恢复任何内容。',
      recheckUndoFailed: '槽位 {{slot}}：恢复失败。{{detail}}',
      loadInitiated: '加载耗材中…',
      unloadInitiated: '卸载耗材中…',
      failedToLoad: '加载耗材失败',
      failedToUnload: '卸载耗材失败',
      amsLoadNoMovement: '已发送加载指令。AMS 未动作。',
      amsUnloadNoMovement: '已发送卸载指令。AMS 未动作。',
      amsUnloadNothingLoaded: '已发送卸载指令。此前未加载耗材。',
    ...
    quarantine: {
      badge: '已隔离',
      recover: '恢复并继续',
      recoverSuccess: '打印机已恢复 — 已继续 {{count}} 个运行。',
      recoverError: '恢复打印机失败',
      recoverTitle: '恢复并继续？',
      recoverMessage: '恢复 "{{name}}"？这是一次显式覆盖操作，将会：',
    ...
    phase: {
      ...
      coolingToPlateau: '正在冷却至平台期',
      coolingToPlateauHeld: '正在冷却至平台期 · 打印板已抬升',
    ...
    ejectNotQualified: '该型号的自动取件尚未通过硬件认证 — 无人值守使用前请先执行硬件阶梯测试。',
    plateStatus: {
      markCleared: '将打印板标记为已清理',
      cleared: '打印板已清理',
      notCleared: '打印板未清理',
      inUse: '打印板使用中',
      markClearedCancelsEject: '将打印板标记为已清理会取消待处理的自动弹出。',
      ejectInFlight: '弹出进行中。使用恢复并继续可强制覆盖。',
      markOccupied: '将打印板标记为已占用',
      markOccupiedSuccess: '打印板已标记为已占用 — 在清理之前派发将被阻止',
      ejectInProgress: '弹出进行中 · {{age}}',
      ejectStalled: '弹出停滞 · {{age}} — 农场已失去对清扫的跟踪',
      refusal: '打印板检测：{{message}}',
      menuRecover: '恢复打印机',
    ...
    eject: {
      action: '弹出打印板',
      dispatched: '已开始弹出',
      confirmTitle: '在热板状态下弹出？',
      confirmBodyNoLine: '打印板为 {{bed}}°C，没有可用于判断的车间气温或腔室读数。现在弹出会在此温度下扫落零件。是否继续？',
      confirmBody: '打印板为 {{bed}}°C，高于 {{threshold}}°C 的释放阈值。现在弹出会在打印板仍然很热时扫落零件。是否继续？',
      confirm: '弹出打印板',
      cancel: '取消',
      foreignPrintNameLabel: '打印',
      foreignUnknownPrint: '未知',
      foreignPartHeightEditLabel: '零件高度 (mm)',
      foreignProfileLabel: '弹出配置',
      foreignSuggested: '建议',
      foreignNoProfiles: '没有可用的弹出配置',
      foreignConfirm: '弹出打印板',
      dialog: {
        foreignTitle: '弹出打印板 — 该打印不是由农场派发的',
        farmUnitTitle: '弹出打印板 — {{name}}',
        declaredTitle: '弹出打印板',
        body: '扫落动作依据下面的零件高度和弹出配置生成。开始前请对照打印板核对两者。',
        heightRequired: '零件高度未知。请输入打印板上零件的最高点。',
      },
      error: {
        jobActive: '打印机正在执行任务。等待其完成或将其停止，然后再弹出。',
        dispatchInFlight: '正在向该打印机发送队列中的单元。请在几秒后重试。',
        ejectInFlightPending: '弹出已于 {{age}} 秒前发送，正在等待打印机启动。',
        ejectInFlightPendingNoAge: '弹出已发送，正在等待打印机启动。',
        ejectInFlightStarted: '弹出已运行 {{age}} 秒。',
        ejectInFlightStartedNoAge: '弹出正在运行。',
        bedUnreadable: '无法读取打印板温度。请在几秒后重试。',
        noDonor: '没有可用于生成弹出的文件。请将打印板标记为已清理，并手动取下零件。',
        firstArticle: '首件等待批准。请在该运行中批准或拒绝。',
    ...
    // RFID
    rfid: {
      disabledWhileDrying: 'AMS 烘干期间不可用',
      recheck: '重新检查槽位',
      recheckPending: '重新检查待处理。打印结束后完成。',
      recheckQueuedTooltip: '已排队，等待打印结束。',
      restorePreviousRoll: '恢复上一卷',
    },
    // AMS load/unload (#891)
    ams: {
      load: '加载',
    ...
    confirm: {
      ...
      pauseButton: '暂停打印',
      amsRecoveryTitle: '恢复进行中',
      amsRecoveryMessage: '{{name}}：恢复正在运行。发送此指令将终止恢复。',
      amsCommandButton: '发送',
      resumeTitle: '继续打印',
    ...
    slot: {
      ranOut: '已用完——请补充此槽位',
      spentCore: '已用尽——请更换料卷',
      noBackupSlot: '没有备用料槽。另一个料槽装有相同线材，但颜色不同。',
      wasFeeding: '曾为此次打印供料',
    },
    activeJobSlot: {
  ...
  archives: {
    ...
    modal: {
      ...
      deleteBlockedByLivePrint: '无法删除 — 此归档记录着一个正在进行的打印。请先停止打印再重试。',
  ...
  queue: {
    ...
    startBelowMin: {
      confirmTitle: '使用余量偏低的料卷开始？',
      confirmIntro: '分配的料卷足以完成本次打印，但低于最低起始重量。仍要开始吗？',
      slots: '受影响的槽位：{{slots}}',
      unknownGramsTitle: '使用未称重的料卷开始吗？',
      unknownGramsIntro: '匹配料卷没有重量记录，因此无法确认这次打印能否完成。请称重或分配该料卷，或者仍然开始。',
      printAnyway: '仍要开始',
    },
    farm: {
      runBadge: '运行',
  ...
  settings: {
    ...
    spoolSelectionPolicy: '料卷选择策略',
    spoolSelectionPolicyDesc: '当多个 AMS 槽位匹配时，调度器和手动打印如何选择料卷。',
    spoolPolicyFirstLoaded: '最先装载 (FIFO)',
    spoolPolicyLowestRemaining: '剩余最少',
    spoolPolicySlotOrder: 'AMS 槽位顺序',
    spoolPolicyBackupNote: '「剩余最少」仅当打印机端启用了 AMS Filament Backup 时才生效——否则当选中的料卷耗尽时，打印机无法切换到第二个料卷。',
    minStartSpool: '最低起始料卷重量 (g)',
    minStartSpoolDesc: '剩余克数低于此值的料卷永远无法开始打印（但可以完成正在进行的打印）。0 表示禁用下限。',
    spoolRecoveryEnabled: '料卷卡料自动恢复',
    spoolRecoveryEnabledDesc: '当 AMS 送料故障（缠绕）暂停农场打印时，自动切换到下一个符合条件的料卷并恢复。卡住的料卷在重新插入之前会被移出轮换。',
    runoutAutoResumeEnabled: '补充耗材后自动恢复',
    runoutAutoResumeEnabledDesc: '当打印因等待某个 AMS 槽位的耗材而暂停时，该槽位补充后自动恢复打印。关闭 = 打印等待手动恢复。',
    spoolRecoveryMaxAttempts: '最大恢复尝试次数',
    spoolRecoveryMaxAttemptsDesc: '在为人工留下暂停的打印之前，尝试多少个料卷（1-5）。',
    spoolRecoveryStepTimeout: '单步超时（秒）',
    spoolRecoveryStepTimeoutDesc: '每个恢复步骤在被视为失败之前可运行的时长（15-600 秒）。',
    spoolRecoveryProtectLayers: '保护起始层',
    spoolRecoveryProtectLayersDesc: '在前 N 层内，低于最小起始重量的料盘不能用作替换；此后即可使用。0 表示余量不足的料盘始终可用。',
    taglessDefaultFilament: '无标签空料盘的默认耗材',
    taglessDefaultFilamentDesc: '用此耗材自动配置未配置的无标签 AMS 料盘，使其无需手动设置即可打印。',
    taglessBrand: '品牌',
    taglessMaterial: '材料',
    taglessSubtype: '子类型',
    taglessSubtypeHint: 'Bambu 对该材料的变体代码，例如 HF = High Flow。显示在料卷标签上。',
    taglessColor: '颜色',
    taglessSlicerFilament: '切片机耗材（可选）',
    taglessSlicerFilamentHint: '切片软件所用耗材预设的准确名称，让打印匹配正确的配置文件。',
    ...
    deleteUserChecking: '正在检查此删除会移除哪些内容...',
    deleteUserImpactUnavailable: '无法检查此删除会移除哪些内容。若仍然删除，该用户的项目将在没有预览的情况下被移除。',
    deleteUserArchives_one: '{{count}} 个打印归档',
    deleteUserArchives_other: '{{count}} 个打印归档',
    deleteUserLibraryFiles_one: '{{count}} 个资料库文件',
    deleteUserLibraryFiles_other: '{{count}} 个资料库文件',
    deleteUserQueueItems_one: '{{count}} 个队列项目',
    deleteUserQueueItems_other: '{{count}} 个队列项目',
    deleteUserProductionRuns_one: '{{count}} 个生产运行',
    deleteUserProductionRuns_other: '{{count}} 个生产运行',
    deleteUserDependentSkus_one: '{{count}} 个 SKU 使用该用户上传的文件。这些 SKU 将失去文件，在重新指向之前无法打印。',
    deleteUserDependentSkus_other: '{{count}} 个 SKU 使用该用户上传的文件。这些 SKU 将失去文件，在重新指向之前无法打印。',
    deleteUserPrintingNow_one: '{{count}} 个单元正在打印。删除将被拒绝，直到其完成或被停止。',
    deleteUserPrintingNow_other: '{{count}} 个单元正在打印。删除将被拒绝，直到其完成或被停止。',
    deleteUserStillPrinting: '{{printers}} 上仍在打印。请停止这些打印或等待其完成，然后再删除。',
    // Smart plugs
    ...
    farmProduction: '农场生产',
    farmProductionDescription: '在“开始任务”对话框中预填的默认重试与隔离策略。可按任务覆盖。',
    farmEjectCooldown: '取件冷却',
    farmEjectCooldownDescription: '农场在扫走已完成板件前如何等待热床冷却，以及何时放弃或隔离无法冷却的打印机。',
    farmRetryMaxPerUnit: '每块板的重试次数',
    farmRetryMaxPerUnitHelp: '在打印板被标记为失败前的自动重试次数（0–10）',
    farmEscalateConsecutiveFailures: '失败后隔离',
    farmEscalateConsecutiveFailuresHelp: '触发隔离的打印机连续失败次数（1–20）',
    farmCooldownMargin: '高于车间气温的余量 (°C)',
    farmCooldownMarginHelp: '取件线和腔室风扇降速点比车间气温高出这一余量。',
    shopAir: {
      label: '车间气温',
      ejectLine: '取件线',
      noReading: '无读数',
      atPlateau: '至平台期',
      fresh_one: '于 {{minutes}} 分钟前在 {{count}} 台静置的打印机内测得 — 读数略高于室温。',
      fresh_other: '于 {{minutes}} 分钟前在 {{count}} 台静置的打印机内测得 — 读数略高于室温。',
      carried: '沿日内曲线由 {{time}} 的读数推算。',
      unknown: '尚无读数 — 每次冷却在热床不再降温时释放。',
      readFailed: '车间气温读取失败 — 每分钟重试。',
    },
    farmOfflineStallMinutes: '离线停滞（分钟）',
    farmOfflineStallMinutesHelp: '标记打印机已离线这么久但仍在打印的单元 — 不会终止，只显示停滞（5–720）',
    farmPauseStallMinutes: '暂停停滞（分钟）',
    farmPauseStallMinutesHelp: '当正在打印的单元在没有自动恢复运行的情况下暂停这么久时，标记并通知 — 它绝不会取消任何内容（5–720）',
    farmCooldownStallWindow: '冷却检查间隔（分钟）',
    farmCooldownStallWindowHelp: '在取件前多久确认一次热床仍在降温。连续两次检查失败会将打印机隔离。0 关闭检查。',
    farmCooldownStallEpsilon: '每次检查的最小降温（°C）',
    farmCooldownStallEpsilonHelp: '两次检查之间热床至少要下降这么多，才算仍在降温。',
    farmCooldownMaxHold: '放弃计时器（分钟）',
    farmCooldownMaxHoldHelp: '超过这段时间后热床仍高于取件温度，则照常取件。0 = 一直等待。',
    farmCooldownPlateauMargin: '足够接近余量（°C）',
    farmCooldownPlateauMarginHelp: '若降温停滞但热床处于自身腔室空气的该温差范围内，则视为已冷却并取件；若卡在更高温度，则将打印机隔离。',
    farmCooldownAuxFanEnabled: '冷却期间的辅助风扇',
    farmCooldownAuxFanEnabledHelp: '从打印结束到取件下发期间运行辅助风扇。',
    farmCooldownAuxFan: '辅助风扇转速 (%)',
    farmCooldownAuxFanHelp: '整个冷却过程使用同一转速 (1–100)。',
    farmCooldownChamberFanEnabled: '冷却期间的腔室风扇',
    farmCooldownChamberFanEnabledHelp: '将风道设为冷却模式，并从打印结束到取件下发期间运行腔室排气风扇。没有腔室风扇的打印机型号会跳过。',
    farmCooldownChamberFan: '腔室风扇强冷转速 (%)',
    farmCooldownChamberFanHelp: '腔室空气仍高于取件温度时使用的转速 (1–100)。',
    farmCooldownChamberFanSustain: '强冷之后的腔室风扇转速 (%)',
    farmCooldownChamberFanSustainHelp: '腔室达到取件温度后直到取件下发期间使用的转速。0 表示此时停止风扇。打印机自身的腔室冷却转速为 50。',
    ...
    farmPlateBlowoffEnabled: '开始打印时吹扫打印板',
    farmPlateBlowoffEnabledHelp: '热床调平前以全速辅助风扇吹扫打印板。',
    farmPlateBlowoffSeconds: '吹扫时间 (s)',
    farmPlateBlowoffSecondsHelp: '热床调平前辅助风扇的运行时间 (3–60)。',
    ...
    queueCheckIntervalHelp: '即使没有任何变化，农场重新检查队列的频率。这是万一漏掉实时事件时的兜底——数值越低反应越快，但轮询越频繁（5–300）。',
    dispatchKickDebounce: '突发合并延迟（秒）',
    dispatchKickDebounceHelp: '当多件事同时发生时，等待这短暂的片刻，将它们合并为一次派发而非多次。数值越高合并越多；越低反应越快（0.2–10）。',
    usbPreflightFreshWindow: 'USB 检查有效期（秒）',
    usbPreflightFreshWindowHelp: '在重新检查之前，信任这么多秒内的近期"USB 驱动器存在"报告。数值越高越能跳过多余检查；0 则始终重新检查（0–120）。',
    usbPreflightMaxWait: 'USB 检查最长等待（秒）',
    usbPreflightMaxWaitHelp: '在无论如何开始打印之前，等待新的"USB 存在"报告多长时间。数值越高越谨慎；越低派发越早（0–10）。',
    dispatchParallelLimit: '同时启动的打印机数',
    dispatchParallelLimitHelp: '一次派发中可同时上传并启动的打印机数量。数值越高清空大队列越快；越低对网络越温和（1–10）。',
    powerStagger: '功率错峰',
    powerStaggerDescription: '在打印机不再消耗加热功率的那一刻即释放一个错峰名额，而不是始终等满整个间隔。让下一台打印机更早启动，同时仍限制同时的功率消耗。',
    staggerDynamicRelease: '热床变热后即释放名额',
    staggerDynamicReleaseHelp: '启用时，下一台打印机可在当前打印机完成热床加热后立即启动，而不必等待整个间隔过去。关闭时，每个名额都等满整个间隔。',
    staggerReleaseEpsilon: '到温余量（°C）',
    staggerReleaseEpsilonHelp: '距离目标热床温度多近才算"足够热"，可提前释放名额。数值越大，越早释放下一台打印机。',
    staggerHeatupGrace: '加热宽限（秒）',
    staggerHeatupGraceHelp: '如果打印机尚未开始加热热床，则在此时间后仍释放其名额，以免空闲的打印机拖住整批。',
    ...
    erp: {
      title: 'ERP 目录登录',
      statusActive: 'ERP 登录：已启用',
      statusInactive: 'ERP 登录：未配置',
      activeDesc: '操作员可以使用其 ERP 目录凭据登录。',
      inactiveDesc: '在下方添加并保存连接信息以启用 ERP 登录。',
      disableHint: '要关闭 ERP 登录，请清除下方的主机和数据库名称，然后保存。',
      connectionConfig: 'ERP 目录连接',
      host: '数据库主机',
      port: '端口',
      database: '数据库名称',
      user: '数据库用户',
      password: '数据库密码',
      passwordHint: '留空以保留已存储的密码。',
      ssl: '通过 TLS 连接',
      sslHint: '要求与 ERP 数据库建立加密连接。',
      roleMapping: '角色映射',
      roleMappingHint: '为每个 ERP 角色分配一个 BamBuddy 组。',
      roleMappingNoGroup: '— 无组 —',
      roleMappingGroupFor: '{{role}} 的 BamBuddy 组',
      settingsSaved: '已保存 ERP 目录设置',
      errors: {
        hostRequired: '数据库主机为必填项',
        databaseRequired: '数据库名称为必填项',
      },
    },
    oidc: {
      title: 'SSO / OIDC 提供商',
      ...
      form: {
        ...
        groupsClaim: '组声明',
        groupsClaimDesc: '包含用户组或角色值的令牌声明。留空可禁用来自此提供程序的组同步。',
        groupsClaimPlaceholder: '组',
        groupMapping: '组映射',
        groupMappingDesc: '将每个声明值映射到一个 BamBuddy 组。匹配的用户在登录时会获得映射的组。',
        groupMappingNone: '未配置映射。',
        groupMappingClaimValue: '声明值',
        groupMappingGroup: 'BamBuddy 组',
        groupMappingSelectGroup: '选择组',
        groupMappingRemove: '移除映射',
        groupMappingAdd: '添加映射',
        autologin: '自动登录',
  ...
  fileManager: {
    ...
    createSkuFromUploadToast: '已上传 {{filename}} — 用它创建 SKU 吗？',
    createSkuFromUploadAction: '用此文件创建 SKU',
    ...
    deleteFolderConfirm: '确定要删除此文件夹吗？其中的文件将移至回收站，可还原到根目录；文件夹本身将被永久删除。',
    deleteFileConfirm: '确定要删除此文件吗？',
    deleteFilesConfirm: '确定要删除 {{count}} 个选中的文件吗？文件将移至回收站，可以还原。',
    deleting: '删除中...',
  ...
  inventory: {
    ...
    unknownSpoolToast: '{{printer}} 槽位 {{slot}} 检测到未知耗材 {{material}} — 是否添加到库存？',
    unknownSpoolSlot: '槽位',
    freshRoll: {
      promptToast: '{{printer}} 槽位 {{slot}} 上是新卷吗？',
      sameRoll: '同一卷',
      reviewAction: '查看…',
      title: '此槽位上是新卷吗？',
      message: '{{location}} 的无标签料卷已用掉标称重量的大部分。如果现在装的是新卷，请记录以保持耗材跟踪准确。',
      confirm: '新卷',
      pending: '正在记录…',
      success: '已记录新卷',
      failed: '记录新卷失败',
      dismissFailed: '无法关闭新卷提示',
      remaining: '已记录剩余 {{grams}} g',
      brandLabel: '品牌',
      brandPlaceholder: '例如 Overture',
      weightLabel: '标称重量 (g)',
      ...
      noteLabel: '备注',
      notePlaceholder: '可选',
      manualDesc: '结束当前记录并新建一条记录',
      manualTitle: '标记为新料卷？',
      manualMessage: '结束 {{location}} 的记录（已用 {{grams}} g），并为该槽位新建一条满卷记录。请仅在实际更换料卷后执行。',
      manualConfirm: '标记为新料卷',
    },
    respool: {
      title: '重新绑定此标签？',
      manualTitle: '将此标签转移到新料卷？',
      manualMessage: '停用 {{location}} 的记录（已用 {{grams}} g），并将其 Bambu 标签转移到一卷全新的料卷。请在实际更换料卷后再执行。',
      message: '在 {{location}} 检测到重复使用的 Bambu 标签。如果它现在装在全新的第三方料卷上，请将其重新绑定到满卷记录。',
      confirm: '已重新绑定 — 全新料卷',
      pending: '正在重新绑定…',
      success: '已重新绑定到全新的 {{brand}} 料卷',
      failed: '标签重新绑定失败',
      autoToast: '已在 {{printer}} 槽位 {{slot}} 自动重新绑定 {{brand}}',
      reusedTagToast: '重复使用的标签上可能是新卷——{{printer}} 槽位 {{slot}}',
      ...
      triggerSpent: '此卷报告已用尽，此后槽位已被操作过。',
      triggerRemainJump: 'AMS 报告的耗材量远多于此记录——该标签似乎已换到重新装填的料卷上。',
      sameSpoolAction: '同一料卷',
      reviewAction: '查看…',
      dismissFailed: '无法关闭重新绑定提示',
      donorLine: '替换已跟踪的料卷（剩余 {{grams}} g）；旧记录将被归档',
      donorRecordTitle: '记录 #{{id}}',
      detailsLabel: '详细信息',
      tagIdLabel: '标签 ID',
      warning: '每个供体料卷只使用一个标签 — 丢弃第二个标签。',
      brandLabel: '品牌',
      brandPlaceholder: '例如 Overture',
      weightLabel: '标称重量 (g)',
      weightPlaceholder: '例如 1000',
    ...
    spoolArchived: '耗材已归档',
    spoolRestored: '耗材已恢复',
    returnToRotation: '恢复轮换',
    returnToRotationDone: '料卷已恢复轮换',
    returnToRotationFailed: '无法将料卷恢复轮换',
  ...
  ams: {
    ...
    emptySlot: '空槽位',
    slotEmpty: '空',
    slotStateUnknown: '料槽状态未知 — 打印机未报告其中是否有料卷',
    slotStateUnknownShort: '未知',
    slotPresentUnread: '有料卷 — 无法识别',
    slotDialogLabel: '{{ams}} 槽位 {{slot}}：{{content}}',
    slotBoundPresenceUnknown: '{{printer}}: {{ams}} 槽位 {{slot}} 无响应 — 无法确认已绑定的料卷是否仍在其中，请检查该槽位',
    slotSpentSwapPark: '{{printer}}: {{ams}} 槽位 {{slot}} 被用尽的料卷占用，没有可解除的依据。请重新检查该槽位或更换料卷',
    outOfRotation: '已移出轮换 — 检测到料卷卡料；重新插入料卷或清除标记即可再次使用',
    outOfRotationShort: '已移出轮换',
    emptySlotBinding: {
      title: '仍有绑定',
      used: '已用 {{grams}} g',
      ranOut: '已用尽 — 等待新料卷',
      awaitingInsert: '等待装入（已预先配置）',
      seatedUnread: '已装入 — 等待识别',
      presenceUnknown: '未确认在此料槽中',
      notInserted: '未装入',
      elsewhereHint: '（未装入 — 已绑定到 {{location}}）',
      unassignAria: '取消分配 {{spool}}（此槽位）',
      unassignTitle: '取消分配此料卷？',
      unassignMessage: '将 {{spool}} 从该槽位释放。料卷会带着已记录的用量回到库存，不会删除任何数据。',
    },
    unknown: '未知',
    humidity: '湿度',
    temperature: '温度',
  ...
  printModal: {
    ...
    customSlotMapping: '自定义槽位映射',
    reread: '重新读取',
    requiredTooltip: '需要：{{type}} - {{color}}',
    manuallySelected: '手动选择',
    autoMatched: '自动匹配',
    externalSlotNote: '外置料卷 — 不统计用量；打印机会要求在料架上补料。',
    selectSlot: '-- 选择槽位 --',
    noActivePrintersAvailable: '没有可用的活动打印机',
    specificPrinter: '指定打印机',
    anyModel: '任意 {{model}}',
    modelFallback: '型号',
    targetModelLabel: '目标型号',
    selectModelPlaceholder: '选择型号...',
    locationFilter: '位置筛选（可选）',
    anyLocation: '任意位置',
    schedulerAssignHint: '调度器将分配给第一台可用的空闲 {{model}} 打印机',
    schedulerAssignHintLocation: '调度器将分配给 {{location}} 中第一台可用的空闲 {{model}} 打印机',
    selectPrinters: '选择打印机',
    printersSelected_one: '已选择 {{count}} 台打印机',
    printersSelected_other: '已选择 {{count}} 台打印机',
    selectAll: '全选',
    inactive: '(未激活)',
    unknownModel: '未知型号',
    customMapping: '自定义映射',
    ...
    autoButton: '自动',
    hiddenPrinters_one: '还有 {{count}} 台其他打印机被隐藏（不同型号）—',
    hiddenPrinters_other: '还有 {{count}} 台其他打印机被隐藏（不同型号）—',
    showAll: '显示全部',
    showOnlyModelPrinters: '仅显示 {{model}} 打印机',
    selectAtLeastOnePrinter: '请至少选择一台打印机',
    selectTargetModel: '请选择目标打印机型号',
    typeNotFound: '（未找到类型）',
    colorMismatch: '（颜色不匹配）',
    ready: '（就绪）',
    clickToChangeSlot: '点击以更改槽位分配',
    costNotAvailable: '不适用',
    requiredTypeNotFound: '打印机中未找到所需的耗材类型。',
    printJob: '打印任务',
    slicedModelMismatch: '文件是为 {{slicedModel}} 切片的，但正在 {{printerModel}} 上打印',
    archiveDataUnavailable: '归档数据不可用。源文件可能已被删除。耗材映射已禁用。',
    failedToComplete: '无法完成操作',
    toastQueueItemUpdated: '队列项已更新',
    toastUpdateFailed: '无法更新队列项',
    toastSelectPrinter: '请至少选择一台打印机',
    toastSelectModel: '请选择目标打印机型号',
    toastQueuedForModel: '已加入任意 {{model}} 的队列',
    ejectFromSku: '来自 SKU {{code}} 的默认值',
    partialFailureTitle: '{{total}} 个调度中有 {{failed}} 个失败：',
    toastPartialSuccess: '{{success}} 个成功，{{failed}} 个失败',
    printerFallback: '打印机 {{id}}',
    slotFallback: '槽位 {{id}}',
    plateFallback: '打印板 {{index}}',
  },
  ...
  uploadModal: {
    ...
    libraryHint: '对于 SKU 和生产批次，请改用文件管理器上传。',
    libraryHintLink: '前往文件管理器 →',
    uploaded: '已上传',
    failed: '失败',
    uploading: '上传中...',
    upload: '上传',
  ...
  notifications: {
    ...
    printStalled: '打印停滞',
    storageLow: 'USB 存储空间不足',
    cooldownEscalation: '冷却时间过长',
    // Quiet hours
    quietHours: '免打扰时段',
  ...
  fleetMetrics: {
    ...
    sections: {
      fleet: '机群',
      matrix: '机群矩阵',
      stateOverTime: '打印机状态随时间变化',
      printsPerDay: '每日打印数',
      downtimeByCause: '按原因划分的停机时间',
      coolingAndEject: '冷却与推件',
      recovery: '恢复',
      partsBySku: '按 SKU 统计零件',
    },
    summary: {
      now: '当前',
      trend: '走势',
      ...
      rows: {
        avg_printing: '打印中',
        avg_cycle_overhead: '打印间隙',
        avg_idle: '空闲',
        avg_down: '停机',
        avg_planned: '维护',
        peak_down: '停机峰值',
        printers_in_fleet: '在群内',
        prints_per_day: '打印数',
        prints_per_printer_per_day: '每台打印数',
        uptime: '正常运行率',
        time_printing: '打印时间占比',
      },
      peak: '峰值 {{count}}',
      downNow: '当前停机',
      nothingDown: '无停机',
    ...
    matrix: {
      ...
      hideDays: '隐藏日期',
      sortBy: '按{{column}}排序',
      caption: '各打印机的{{lens}}，{{from}} 至 {{to}}',
      captionDay: '各打印机的{{lens}}，{{date}}',
      details: '详情',
    ...
    widgets: {
      showData: '显示数据',
      showChart: '显示图表',
      showDataFor: '显示{{chart}}的数据',
      showChartFor: '显示{{chart}}的图表',
      median: '中位数',
      p90: 'P90',
      overExpected: '超出预期',
      count: '数量',
    ...
    states: {
      ...
      retry: '重试',
      empty: '该区间没有数据。',
      recordingGap: '打印机状态记录自 {{date}} 开始。故障与维护历史自 {{earliest}} 起。',
    },
    header: {
    ...
    hints: {
      ...
      cycle_overhead: '农场在两次打印之间自己做的事：给热床降温，然后把零件扫下去。',
      planned: '维护模式：有人把这台打印机移出了自动流程。',
      uptime: '计入时间中打印机能够接活的比例。',
      time_printing: '计入时间中打印机正在打印的比例。',
      prints_per_printer: '已完成打印数除以每台打印机计入的天数。计入天数仅来自已记录的区间，因此在时段仍有部分未记录时无法与「打印数」相比。',
      unobserved: '这段时间没有任何记录，只知道故障和挂起。',
      not_recorded: '早于这台打印机最早记录到的状态。',
      incidents_only: '此处没有记录打印机状态，只有故障与维护台账覆盖该时段。',
      whileRecorded: '周期数值仅涵盖已记录的时间。',
      timeframeFleet: '一天按 {{tz}} 的零点到零点计算。',
      timeframePrints: '一天按 UTC 零点到零点计算。',
    },
  },
};
