export default {
  ...
  printers: {
    ...
    toast: {
      ...
      recheckFailed: 'Prüfung fehlgeschlagen',
  ...
  inventory: {
    ...
    respool: {
      ...
      noteLabel: 'Notiz',
      notePlaceholder: 'Optional',
      actionDesc: 'Diesen Bambu-Tag auf eine frische Rolle übertragen',
    },
    bulk: {
  ...
  ams: {
    ...
    emptySlotBinding: {
      ...
      clearMessage: '{{spool}} von diesem Steckplatz lösen. Die Spule kehrt mit unverändertem Verbrauch ins Inventar zurück — es wird nichts gelöscht.',
    },
    unknown: 'Unbekannt',
    humidity: 'Luftfeuchtigkeit',
    temperature: 'Temperatur',
