export default {
  ...
  printers: {
    ...
    quarantine: {
      badge: 'In Quarantäne',
      clear: 'Quarantäne aufheben',
      cleared: 'Quarantäne aufgehoben',
      clearTitle: 'Quarantäne aufheben?',
      clearMessage: 'Quarantäne für "{{name}}" aufheben? Der Planer nimmt die Ausgabe von Drucken an diesen Drucker wieder auf.',
      clearMessageWithReason: 'Quarantäne für "{{name}}" aufheben? Grund: {{reason}}. Der Planer nimmt die Ausgabe von Drucken an diesen Drucker wieder auf.',
    },
    plateStatus: {
