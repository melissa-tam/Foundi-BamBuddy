export default {
  ...
  settings: {
    ...
    ejectUploadSkipIdentical: 'Auswurfdateien wiederverwenden, die bereits auf dem USB-Laufwerk sind',
    ejectUploadSkipIdenticalHelp: 'Das erneute Hochladen einer Auswurfdatei überspringen, wenn die identische Datei bereits auf dem USB-Laufwerk des Druckers liegt, was pro Auswurf ein paar Sekunden spart.',
    ejectUploadSkipIdenticalWarning: 'Erst aktivieren, nachdem die Live-Auswurfprüfung bestätigt hat, dass die Datei auf dem Laufwerk korrekt wiederverwendet wird. Im Zweifel ausgeschaltet lassen – ein erneutes Hochladen garantiert immer die richtige Datei.',
    ejectSlim3mf: 'Auswurfdateien verschlanken',
    ejectSlim3mfHelp: 'Das 3D-Modell und das Vorschaubild aus Auswurfdateien entfernen, damit sie schneller hochladen – die Auswurfbewegung selbst bleibt unverändert.',
    ejectSlim3mfWarning: 'Hardware-gesperrt: Führen Sie die vollständige Auswurf-Hardwareleiter mit verschlankten Dateien durch, bevor Sie dies für den unbeaufsichtigten Betrieb aktivieren. Ausgeschaltet lassen, bis diese Leiter bestanden ist.',
