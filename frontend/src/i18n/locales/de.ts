export default {
  // SKU-Katalog (Farm-Produktion, Phase 2)
  skus: {
    nav: 'Artikel',
    title: 'SKU-Katalog',
    description: 'Verkäufliche Teilenummern, die je eine oder mehrere Bibliotheksdatei-Platten sowie ein Standard-Auswurfprofil für Produktionsläufe verknüpfen.',
    newSku: 'Neuer SKU',
    loadError: 'SKUs konnten nicht geladen werden.',
    empty: {
      title: 'Noch keine SKUs',
      body: 'Erstellen Sie Ihren ersten SKU, um druckbare Dateien zu verknüpfen und die Produktion zu verfolgen.',
    },
    columns: {
      files: 'Dateien',
      unitsCompleted: 'Einheiten gesamt',
      successRate: 'Erfolg',
    },
    createTitle: 'SKU erstellen',
    editTitle: 'SKU bearbeiten',
    fields: {
      code: 'Code',
      name: 'Name',
      partNumber: 'Teilenummer',
      notes: 'Notizen',
      defaultEjectProfile: 'Standard-Auswurfprofil',
      noEjectProfile: 'Keines',
    },
    codeRequired: 'Code ist erforderlich.',
    nameRequired: 'Name ist erforderlich.',
    created: 'SKU erstellt',
    updated: 'SKU aktualisiert',
    deleted: 'SKU gelöscht',
    saveFailed: 'SKU konnte nicht gespeichert werden',
    deleteFailed: 'SKU konnte nicht gelöscht werden',
    deleteTitle: 'Diesen SKU löschen?',
    deleteBody: '"{{code}}" wird dauerhaft entfernt. Dies kann nicht rückgängig gemacht werden.',
    suggest: {
      appliedFromObjectName: 'Details aus den Objektnamen in der Datei übernommen',
      appliedFromFilename: 'Details aus dem Dateinamen übernommen',
      appliedGeneric: 'Daten aus Datei übernommen',
      failed: 'Details konnten nicht vorgeschlagen werden',
    },
    files: {
      ...
      plate: 'Platte',
      unitsPerPlate: 'Einheiten pro Platte',
      plateUnits: 'Platte {{plate}} · {{units}} pro Platte',
      add: 'Datei hinzufügen',
      added: 'Datei verknüpft',
      addFailed: 'Datei konnte nicht verknüpft werden',
      savedButLinkFailed: 'Die SKU wurde gespeichert, aber die Datei konnte nicht verknüpft werden: {{reason}}',
      remove: 'Entfernen',
      removed: 'Dateiverknüpfung entfernt',
      removeFailed: 'Verknüpfung konnte nicht entfernt werden',
      removeTitle: 'Diese Datei entkoppeln?',
      removeBody: '"{{name}}" wird von diesem SKU entkoppelt.',
    },
  },

  // Produktionsläufe (Farm-Produktion, Phase 2)
  productionRuns: {
    nav: 'Produktion',
    title: 'Produktionsläufe',
    description: 'Kopien eines SKU über Drucker verteilen, bis eine Zielstückzahl erreicht ist – mit Live-Fortschritt.',
    loadError: 'Produktionsläufe konnten nicht geladen werden.',
    empty: {
      title: 'Noch keine Produktionsläufe',
      body: 'Starten Sie einen Lauf, um einen SKU bis zu einer Zielstückzahl zu drucken.',
      noSkus: 'Fügen Sie einen SKU mit mindestens einer verknüpften Datei hinzu, bevor Sie einen Lauf starten.',
    },
    startTitle: 'Produktionslauf starten',
    startAction: 'Lauf starten',
    runAgain: 'Erneut ausführen',
    advanced: 'Erweitert',
    starting: 'Wird gestartet…',
    started: 'Produktionslauf gestartet',
    startFailed: 'Lauf konnte nicht gestartet werden',
    noFiles: 'Dieser SKU hat keine verknüpften Dateien zum Drucken.',
    fileRequired: 'Wählen Sie eine zu druckende Datei.',
    targetRequired: 'Geben Sie ein Ziel von mindestens 1 Einheit ein.',
    printerRequired: 'Wählen Sie mindestens einen Drucker.',
    overProduction: 'Produziert {{planned}} Einheiten ({{plates}} Platten) – {{extra}} mehr als das Ziel von {{target}}.',
    fields: {
      sku: 'SKU',
      file: 'Datei / Platte',
      filePlaceholder: 'Datei auswählen…',
      plateUnits: 'Platte {{plate}}, {{units}}/Platte',
      targetUnits: 'Zielstückzahl',
      printers: 'Drucker',
      ...
      skuNoFile: '— keine Datei verknüpft',
      skuNoFileHint: 'Verknüpfe auf der SKU-Seite eine Datei mit einer SKU, um sie startbar zu machen.',
    },
    status: {
      active: 'Aktiv',
      paused: 'Pausiert',
    ...
    platesProgress: '{{completed}} / {{total}} Platten',
    stats: {
      units: 'Einheiten',
      target: 'Ziel',
    ...
    resume: 'Fortsetzen',
    abort: 'Abbrechen',
    paused: 'Lauf pausiert',
    resumed: 'Lauf fortgesetzt',
    aborted: 'Lauf abgebrochen',
    actionFailed: 'Aktion fehlgeschlagen',
    startNow: 'Jetzt starten',
    startedNow: 'Lauf gestartet',
    reschedule: 'Neu planen',
    rescheduleTitle: 'Startzeit ändern',
    rescheduled: 'Startzeit aktualisiert',
    schedule: {
      sectionTitle: 'Startzeit',
      whenToStart: 'Wann starten',
      asap: 'Sofort starten',
      later: 'Für später planen',
      date: 'Datum',
      time: 'Uhrzeit',
      openCalendar: 'Kalender öffnen',
      pastError: 'Wählen Sie einen Zeitpunkt in der Zukunft.',
      invalidError: 'Geben Sie ein gültiges Datum und eine gültige Uhrzeit ein.',
      helpAsap: 'Der Lauf startet, sobald ein geeigneter Drucker frei ist.',
      helpScheduled: 'Der Lauf startet zur gewählten Zeit, wenn ein Drucker frei ist – andernfalls wartet er, bis einer frei wird.',
      startsIn: 'Start {{when}}',
    },
    viewDetails: 'Laufdetails anzeigen',
    blockedPrinters: 'Drucker blockiert',
    pauseReason: {
      operator: 'Vom Bediener pausiert',
    ...
    detail: {
      back: 'Alle Produktionsläufe',
      loadError: 'Dieser Produktionslauf konnte nicht geladen werden.',
      notFound: 'Produktionslauf nicht gefunden.',
      printersTitle: 'Drucker',
      noPrinters: 'Noch keine Drucker zugewiesen — der Planer wählt pro Einheit einen freien passenden Drucker.',
      ...
      retryOf: 'Wiederholung #{{count}} von Einheit {{id}}',
      unitStatus: {
        pending: 'Ausstehend',
      ...
      waiting: {
        ...
        visionHold: 'Bei der Plattenprüfung pausiert — Platte korrigieren, dann fortsetzen',
        ...
        externalFeedFault: 'Externe Spule fördert nicht — Halter und PTFE-Schlauch prüfen, dann am Drucker fortsetzen',
        pinnedTrayUnavailable: 'Festgelegtes Fach ist an diesem Drucker nicht geladen — einlegen oder Festlegung entfernen',
        ...
        libraryFileMissing: 'Quelldatei fehlt in der Bibliothek — Datei wiederherstellen oder erneut hochladen',
      ...
      printerState: {
        ...
        modelMismatch: 'Modellabweichung',
        stalled: 'Offline mitten im Druck',
        visionHold: 'Angehalten bei Plattenprüfung',
        filamentShort: 'Filament knapp',
        noUsbDrive: 'Kein USB-Stick',
      },
      eligibility: {
        title: 'Nicht teilnehmende Drucker',
        description: 'Diese Drucker übernehmen keine Einheiten dieses Laufs, bis das behoben ist:',
        offline: 'Offline',
        quarantined: 'In Quarantäne',
        awaitingPlateClear: 'Bett nicht freigeräumt',
        modelMismatch: 'Modellabweichung',
        filamentShort: 'Filament knapp',
        noUsbDrive: 'Kein USB-Stick',
      },
    },
    abortTitle: 'Diesen Lauf abbrechen?',
    abortBody: '"{{name}}" wird abgebrochen. Laufende Platten werden fertiggestellt, aber es werden keine neuen Platten gestartet. Dies kann nicht rückgängig gemacht werden.',
    delete: 'Löschen',
    ...
    firstArticle: {
      ...
      requireHelp: 'Das erste Teil wird ohne automatischen Auswurf gedruckt und die Serie wartet auf Ihre Freigabe.',
      retriesLabel: 'Wiederholungen pro Platte',
      escalateLabel: 'Quarantäne nach aufeinanderfolgenden Fehlern',
      printing: 'Erstmuster wird gedruckt',
      awaitingTitle: 'Erstmuster wartet auf Freigabe',
      awaitingBody: 'Das erste Teil wurde gedruckt. Prüfen Sie es und geben Sie die Serie frei oder lehnen Sie sie zur Überarbeitung ab.',
      approvePhysical: 'Freigeben – Teil entnommen',
      approveEject: 'Freigeben & per Fernbefehl auswerfen',
      reject: 'Ablehnen…',
      approveConfirm: 'Freigeben',
      approvePhysicalTitle: 'Erstmuster freigeben?',
      approvePhysicalBody: 'Bestätigen Sie, dass Sie das gedruckte Teil von der Platte entnommen haben. Die Serie wird fortgesetzt und die restlichen Platten werden ausgegeben.',
      approveEjectTitle: 'Freigeben und per Fernbefehl auswerfen?',
      approveEjectBody: 'Der Druckkopf schiebt das Teil vor dem Fortsetzen von der Platte. Stellen Sie sicher, dass die Platte frei von Hindernissen ist und niemand in den Drucker greift.',
      rejectTitle: 'Erstmuster ablehnen',
      rejectBody: 'Erläutern Sie, was nicht in Ordnung war. Beim erneuten Starten der Serie beginnt ein neues Erstmuster.',
      rejectReasonLabel: 'Grund',
      rejectReasonPlaceholder: 'z. B. verzogene Ecken, schlechte Haftung…',
      rejectReasonRequired: 'Ein Grund ist erforderlich.',
      rejectAction: 'Erstmuster ablehnen',
      rejectedBadge: 'Erstmuster abgelehnt',
      rejectedReason: 'Grund: {{reason}}',
      rejectedHint: 'Fortsetzen startet ein neues Erstmuster.',
      approvedBadge: 'Erstmuster freigegeben',
      approved: 'Erstmuster freigegeben',
  ...
  ejectProfiles: {
    nav: 'Auswurfprofile',
    title: 'Auswurfprofile',
    description: 'Automatische Profile zum Abräumen des Druckbetts, die fertige Teile abschieben, sobald das Bett abgekühlt ist.',
    newProfile: 'Neues Profil',
    loadError: 'Auswurfprofile konnten nicht geladen werden.',
    duplicateAction: 'Duplizieren',
    copyName: '{{name}} (Kopie)',
    empty: {
      title: 'Noch keine Auswurfprofile',
      body: 'Erstellen Sie Ihr erstes Profil, um fertige Teile automatisch vom Druckbett zu räumen.',
    },
    columns: {
      passes: 'Durchgänge',
      ejectSpeed: 'Auswurfgeschwindigkeit',
      maxHeight: 'Max. Höhe',
    },
    createTitle: 'Auswurfprofil erstellen',
    editTitle: 'Auswurfprofil bearbeiten',
    fields: {
      name: 'Name',
      clearance: 'Abstand (mm)',
      zOffset: 'Z-Versatz (mm)',
      descentSteps: 'Absenkschritte',
      xPasses: 'X-Durchgänge',
      xMargin: 'X-Rand (mm)',
      frontOverhang: 'Vorderer Überstand (mm)',
      backOverhang: 'Hinterer Überstand (mm)',
      ejectSpeed: 'Auswurfgeschwindigkeit (mm/min)',
      skimSpeed: 'Streifgeschwindigkeit (mm/min)',
      finalSkim: 'Letzter Abstreif-Durchgang',
      finalSkimHelp: 'Fügt nach den Durchgängen einen langsamen Abstreif-Durchgang knapp über der Platte hinzu, um dünne Reste zu entfernen. Ausschalten, um genau einmal zu schieben.',
      maxPartHeight: 'Max. Teilehöhe (mm)',
      sweepStartHeight: 'Wischbeginnhöhe (%)',
      sweepStartHeightHelp: 'Den absteigenden Wischvorgang bei diesem Prozentsatz der Teilehöhe beginnen (100 % = Teileoberkante).',
      sweepBand: 'X-Wischband einschränken',
      sweepBandHelp: 'Nur ein Teilband der Bettbreite statt der vollen Breite wischen. Für die volle Breite ausgeschaltet lassen.',
      sweepXMin: 'X-Band Min. (mm)',
      sweepXMax: 'X-Band Max. (mm)',
      bedDrop: 'Bett-Absenkung zur Löseunterstützung',
      bedDropHelp: 'Das Bett senkt sich fast bis zum Maschinenboden und fährt zur Abhebehöhe zurück; der Ruck löst ein festsitzendes Teil vor dem Abstreifen.',
      bedDropClearance: 'Bodenabstand (mm)',
      bedDropDwell: 'Haltezeit an der Absenkposition (s)',
      bedDropDwellHelp: 'Das Bett hält so viele Sekunden an der Absenkposition, bevor es zur Abhebehöhe zurückfährt.',
      bedDropJitter: 'Rütteln an der Absenkposition',
      bedDropJitterHelp: 'Das Bett fährt an der Absenkposition um die eingestellte Strecke hoch und wieder zurück, und zwar so oft wie eingestellt.',
      bedDropJitterCycles: 'Rüttelzyklen',
      bedDropJitterMm: 'Rüttelweg (mm)',
    },
    tooltips: {
      name: 'Ein kurzer Name, an dem Sie dieses Profil wiedererkennen – erscheint in der Profilliste und den Auswahlfeldern.',
      clearance: 'Wie weit über dem Teil der Druckkopf bleibt, während er in Position fährt, damit er das Teil vor dem Abstreifen nicht berührt.',
      zOffset: 'Feine Höhenkorrektur für den Abstreifweg – erhöhen, wenn die Düse schleift, verringern, wenn das Teil verfehlt wird.',
      descentSteps: 'Anzahl kleiner Abwärtsschritte, mit denen der Druckkopf hinter das Teil gelangt, bevor er es abschiebt.',
      xPasses: 'Wie viele seitliche Abstreifdurchgänge über das Bett gefahren werden, um das Teil zu entfernen.',
      xMargin: 'Abstand zu den linken und rechten Bettkanten, damit der Druckkopf nie den Rahmen trifft.',
      frontOverhang: 'Wie weit der Abstreifer über die Vorderseite des Teils hinausreicht, damit es vollständig abgeschoben wird.',
      backOverhang: 'Wie weit hinter dem Teil der Abstreifvorgang beginnt, damit der Druckkopf vollständig dahinter gelangt, bevor er schiebt.',
      ejectSpeed: 'Wie schnell der Druckkopf bei den Schiebedurchgängen fährt, die das Teil von der Platte stoßen.',
      skimSpeed: 'Wie schnell der Druckkopf bei den leichteren Abziehdurchgängen fährt, die Reste entfernen.',
      finalSkim: 'Führt nach den Hauptdurchgängen einen zusätzlichen langsamen Durchgang direkt über der Platte aus, um dünne Reste zu entfernen. Zum einmaligen Schieben ausschalten (z. B. eine einzelne Bahn auf halber Höhe für ein hohes Teil).',
      maxPartHeight: 'Höchstes Teil, das dieses Profil auswerfen darf – der Versand wird blockiert, wenn das geslicete Teil höher ist.',
      sweepStartHeight: 'Höhe am Teil, auf der der absteigende Abstreifer beginnt, in Prozent (gültig 1-100 %; 100 % = ganz oben am Teil).',
      sweepBand: 'Nur einen Streifen des Betts abstreifen statt der vollen Breite – praktisch, wenn Teile immer an derselben Stelle liegen.',
      sweepXMin: 'Linke Kante des Abstreifstreifens, in mm vom Bettnullpunkt. Gültig 0-340 mm (H2S-Bettbreite); muss kleiner als der Max-Wert sein und ein mindestens 10 mm breites Band lassen.',
      sweepXMax: 'Rechte Kante des Abstreifstreifens, in mm vom Bettnullpunkt. Gültig 0-340 mm (H2S-Bettbreite); muss größer als der Min-Wert sein und ein mindestens 10 mm breites Band lassen.',
      bedDrop: 'Das Heizbett senkt sich fast bis zum tiefsten Punkt und fährt zur Abhebehöhe zurück – der Ruck löst ein festsitzendes Teil vor dem Abstreifen. Erfordert einen hinterlegten Z-Verfahrweg für das Modell.',
      bedDropClearance: 'Abstand, der beim Absenken zur tiefsten Bettposition der Maschine eingehalten wird – 50 mm = 5 cm über dem Boden anhalten.',
      bedDropDwell: 'Zusätzliche Sekunden an der Absenkposition geben einem festsitzenden Teil Zeit, sich vor dem Abstreifen vollständig zu lösen.',
      bedDropJitter: 'Kurze Auf- und Ab-Bewegungen an der Absenkposition lösen ein Teil, das nach dem einzelnen Ruck noch haftet.',
    },
    nameRequired: 'Name ist erforderlich.',
    created: 'Auswurfprofil erstellt',
    updated: 'Auswurfprofil aktualisiert',
    deleted: 'Auswurfprofil gelöscht',
    ...
    deleteBody: '„{{name}}“ wird dauerhaft entfernt. Dies kann nicht rückgängig gemacht werden.',
    preview: {
      title: 'Vorschau & Prüfung',
      description: 'Erzeugen Sie den Auswurf-G-Code für eine Bibliotheksdatei und Platte, um ihn vor der Nutzung zu prüfen.',
      file: 'Bibliotheksdatei',
      filePlaceholder: 'Datei auswählen…',
      plate: 'Platte',
      run: 'Vorschau erzeugen',
      running: 'Wird erzeugt…',
      noFiles: 'Keine Bibliotheksdateien für die Vorschau verfügbar.',
      ok: 'Prüfung bestanden',
      errors: 'Fehler',
      warnings: 'Warnungen',
      maxZ: 'Max. Z-Höhe: {{value}} mm',
      showGcode: 'G-Code anzeigen',
      hideGcode: 'G-Code ausblenden',
      gcodeLabel: 'Erzeugter G-Code',
      failed: 'Vorschau fehlgeschlagen',
    },
    dryRun: {
      action: 'Trockenlauf',
      title: 'Trockenlauf-Test',
      description: 'Senden Sie einen reinen Geometrietest dieses Profils an einen Drucker oder laden Sie die Testdatei zur Prüfung herunter.',
      printer: 'Drucker',
      printerPlaceholder: 'Verbundenen Drucker auswählen…',
      loadingPrinters: 'Druckerverbindungen werden geprüft…',
      noPrinters: 'Keine verbundenen Drucker verfügbar.',
      warningTitle: 'Leeres Bett erforderlich',
      warning: 'Dieser Test fährt in die Bettmitte und streift darüber, daher muss die Platte LEER sein. Nach dem Versand wartet der Auftrag, bis Sie die Plattensperre am Drucker aufheben.',
      dispatch: 'Test senden',
      dispatching: 'Wird gesendet…',
      download: 'Datei herunterladen',
      downloading: 'Wird vorbereitet…',
      dispatchFailed: 'Test konnte nicht gesendet werden.',
      downloadFailed: 'Trockenlauf-Datei konnte nicht erstellt werden.',
      allowUnvalidated: 'Nicht validierte Geometrie zulassen (nur für die Hardware-Leiter)',
      allowUnvalidatedWarning: 'Der Verfahrraum dieses Modells wurde NICHT hardware-validiert. Nur an der Leiter, beaufsichtigt und auf LEEREM Bett senden.',
    },
    geometry: {
      model: 'Druckermodell',
      noModels: 'Keine Einträge in der Geometrie-Registry',
      unvalidated: 'nicht hardware-validiert',
      warningsTitle: 'Geometrie-Warnungen',
      downloadModel: 'Geometrie-Modell für den Download',
      downloadModelPlaceholder: 'Modell des ausgewählten Druckers verwenden',
      bandInverted: 'X-Band-Minimum muss kleiner als das X-Band-Maximum sein.',
      bandTooNarrow: 'Das Schiebeband muss mindestens {{min}} mm breit sein.',
      bandExceedsBed: 'X-Band-Maximum liegt jenseits des breitesten registrierten Betts ({{max}} mm).',
      heightExceedsCeiling: 'Über der Höhengrenze aller registrierten Modelle (max. {{max}} mm) — der Auswurf-Versand würde abgelehnt.',
      bedDropNoTravel: 'Modelle ohne hinterlegten Z-Verfahrweg ({{models}}) können dieses Profil nicht erzeugen – z_travel_mm in der Geometrie-Registry setzen.',
      bedDropBedslinger: 'Die Bett-Absenk-Hilfe ist bei Bettschubser-Modellen ({{models}}) nicht verfügbar – deren Bett bewegt sich nicht in Z.',
    },
    geometryManager: {
      title: 'Modell-Geometrie-Registry',
      description: 'Bettgröße, Verfahrraum und Hardware-Validierungsstatus für jedes Druckermodell. Die Einträge stammen aus den Server-Seeds – es gibt keine Schaltfläche zum Hinzufügen; bearbeiten Sie ein Modell, um seine Geometrie zu korrigieren oder seine Validierung zu ändern.',
      edit: 'Geometrie bearbeiten',
      editTitle: 'Geometrie von {{model}} bearbeiten',
      saved: 'Modell-Geometrie gespeichert',
      saveFailed: 'Modell-Geometrie konnte nicht gespeichert werden',
      zTravelUnset: 'Kein Z-Verfahrweg hinterlegt – die Bett-Absenk-Hilfe fällt bei diesem Modell sicher aus.',
      validatedBadge: 'Validiert',
      notValidatedBadge: 'Nicht validiert',
      confirmValidateTitle: 'Modell als validiert markieren?',
      ...
      columns: {
        model: 'Modell',
        bed: 'Bett (B×H mm)',
        envelope: 'Verfahrraum (mm)',
        zTravel: 'Z-Verfahrweg',
        maxPartHeight: 'Max. Teilehöhe',
        motion: 'Bewegung',
        validated: 'Validiert',
        notes: 'Notizen',
      ...
      motion: {
        bedZ: 'Bett auf Z',
        bedslinger: 'Bettschubser',
      },
      fields: {
        bedX: 'Bettbreite X (mm)',
        bedY: 'Betttiefe Y (mm)',
        envXMin: 'Verfahrraum X min (mm)',
        envXMax: 'Verfahrraum X max (mm)',
        envYMin: 'Verfahrraum Y min (mm)',
        envYMax: 'Verfahrraum Y max (mm)',
        maxPartHeight: 'Max. Teilehöhe (mm)',
    ...
    queueLabel: 'Auswurfprofil (automatische Teileentnahme)',
    queueHelp: 'Das Teil wird abgeschoben, sobald das Bett auf die Auswurflinie abgekühlt ist.',
  },
  // Navigation
  nav: {
    printers: 'Drucker',
  ...
  printers: {
    ...
    deactivated: {
      ...
      panelState: 'Deaktiviert — keine Verbindung zu diesem Drucker.',
      activate: 'Aktivieren',
      toastActivated: '{{name}} aktiviert',
      editFieldLabel: 'Deaktiviert',
      editFieldHelp: 'Keine MQTT-Sitzung; für diese Instanz unsichtbar (parallele Installationen, Außerbetriebnahme).',
    },
    // Chamber light
    ...
    toast: {
      ...
      recheckUnchanged: 'Slot {{slot}} unverändert. Seit der letzten Prüfung wurde kein Rollenwechsel erfasst.',
      recheckMinted: 'Slot {{slot}}: neue Rolle erfasst. {{grams}} g angenommen.',
      recheckIdentified: 'Slot {{slot}}: {{identity}} vom Tag übernommen.',
      recheckIdentifiedUnnamed: 'Slot {{slot}}: Tag gelesen.',
      recheckIdentifiedNoRead: 'Slot {{slot}}: {{identity}} erfasst. Erneutes Lesen des Tags zurückgestellt.',
      recheckQueued: 'Prüfung für Slot {{slot}} eingereiht. Die Farm liest den Tag im nächsten Leerlauffenster und erfasst die Rolle dann.',
      recheckEmpty: 'Slot {{slot}} ist leer. Rolle einlegen, dann erneut prüfen.',
      recheckRestored: 'Slot {{slot}}: vorherige Rolle wiederhergestellt.',
      recheckFailed: 'Slot {{slot}}: Prüfung fehlgeschlagen.',
      recheckUndoNoOffer: 'Slot {{slot}}: keine Prüfung zum Rückgängigmachen.',
      recheckUndoNoPredecessor: 'Slot {{slot}}: keine vorherige Rolle für diesen Slot erfasst.',
      recheckUndoMintGone: 'Slot {{slot}}: die erfasste Rolle ist nicht mehr vorhanden.',
      recheckUndoBoundElsewhere: 'Slot {{slot}}: die vorherige Rolle steckt in einem anderen Fach. Nichts wiederhergestellt.',
      recheckUndoFailed: 'Slot {{slot}}: Wiederherstellung fehlgeschlagen. {{detail}}',
    ...
    quarantine: {
      badge: 'In Quarantäne',
      recover: 'Wiederherstellen & fortsetzen',
      recoverSuccess: 'Drucker wiederhergestellt — {{count}} Lauf/Läufe fortgesetzt.',
      recoverError: 'Wiederherstellung des Druckers fehlgeschlagen',
      recoverTitle: 'Wiederherstellen & fortsetzen?',
      recoverMessage: '"{{name}}" wiederherstellen? Dies ist eine ausdrückliche Übersteuerung, die:',
    ...
    phase: {
      ...
      coolingToPlateau: 'Kühlt bis zum Plateau ab',
      coolingToPlateauHeld: 'Kühlt bis zum Plateau ab · Platte angehoben',
    ...
    ejectPhase: {
      ...
      uploading: 'Auswurf: wird hochgeladen {{pct}} %',
      uploadingNoPct: 'Auswurf: wird hochgeladen…',
      sent: 'Auswurf: gesendet',
      sweeping: 'Auswurf: wird abgeräumt…',
      failed: 'Auswurf fehlgeschlagen',
    },
    ...
    ejectNotQualified: 'Der automatische Auswurf ist für dieses Modell noch nicht hardware-qualifiziert — vor unbeaufsichtigtem Einsatz die Hardware-Leiter durchlaufen.',
    plateStatus: {
      ...
      markClearedCancelsEject: 'Die Platte als freigegeben zu markieren bricht den ausstehenden Auto-Auswurf ab.',
      ejectInFlight: 'Auswurf läuft. Zum Überschreiben „Wiederherstellen“ verwenden.',
      markOccupied: 'Platte als belegt markieren',
      markOccupiedSuccess: 'Platte als belegt markiert — Versand blockiert, bis sie freigegeben ist',
      ejectInProgress: 'Auswurf läuft · {{age}}',
      ejectStalled: 'Auswurf hängt · {{age}} — die Farm hat den Sweep aus den Augen verloren',
      refusal: 'Plattenprüfung: {{message}}',
    ...
    eject: {
      action: 'Platte auswerfen',
      dispatched: 'Auswurf gestartet',
      confirmTitle: 'Bei heißer Platte auswerfen?',
      confirmBodyNoLine: 'Die Platte ist {{bed}} °C — kein Werkstattluft- oder Kammerwert zum Vergleich. Ein Auswurf jetzt streift das Teil bei dieser Temperatur ab. Fortfahren?',
      confirmBody: 'Die Platte ist {{bed}} °C — über der Freigabeschwelle von {{threshold}} °C. Ein Auswurf jetzt streift das Teil ab, während die Platte noch heiß ist. Fortfahren?',
      confirm: 'Platte auswerfen',
      cancel: 'Abbrechen',
      foreignPrintNameLabel: 'Druck',
      foreignUnknownPrint: 'Unbekannt',
      foreignPartHeightEditLabel: 'Teilehöhe (mm)',
      foreignProfileLabel: 'Auswurfprofil',
      foreignSuggested: 'empfohlen',
      foreignNoProfiles: 'Keine Auswurfprofile verfügbar',
      foreignConfirm: 'Platte auswerfen',
      dialog: {
        foreignTitle: 'Platte auswerfen — Druck nicht von der Farm gestartet',
        farmUnitTitle: 'Platte auswerfen — {{name}}',
        declaredTitle: 'Platte auswerfen',
        body: 'Der Abstreifvorgang wird aus der Teilehöhe und dem Auswurfprofil unten erzeugt. Prüfen Sie beide gegen die Platte, bevor Sie starten.',
        heightRequired: 'Teilehöhe unbekannt. Geben Sie den höchsten Punkt des Teils auf der Platte an.',
      },
      error: {
        jobActive: 'Drucker führt einen Auftrag aus. Warten Sie auf das Ende oder stoppen Sie ihn, dann auswerfen.',
        dispatchInFlight: 'Eine Einheit aus der Warteschlange wird gerade an diesen Drucker gesendet. In wenigen Sekunden erneut versuchen.',
        ejectInFlightPending: 'Auswurf vor {{age}} s gesendet; warten auf den Start durch den Drucker.',
        ejectInFlightPendingNoAge: 'Auswurf bereits gesendet; warten auf den Start durch den Drucker.',
        ejectInFlightStarted: 'Auswurf läuft seit {{age}} s.',
        ejectInFlightStartedNoAge: 'Auswurf läuft.',
        bedUnreadable: 'Temperatur der Platte nicht verfügbar. In wenigen Sekunden erneut versuchen.',
        noDonor: 'Keine Datei zum Erzeugen des Auswurfs verfügbar. Platte als freigegeben markieren und das Teil von Hand entnehmen.',
        firstArticle: 'Erstmuster wartet auf Freigabe. Im Lauf freigeben oder ablehnen.',
    ...
    rfid: {
      ...
      recheck: 'Slot erneut prüfen',
      recheckPending: 'Erneute Prüfung ausstehend. Wird nach Druckende abgeschlossen.',
      recheckQueuedTooltip: 'In der Warteschlange bis zum Druckende.',
      restorePreviousRoll: 'Vorherige Rolle wiederherstellen',
    },
    ...
    permission: {
      ...
      noAmsRfid: 'Sie haben keine Berechtigung, AMS-Slots erneut zu prüfen',
    ...
    incidentAction: {
      ...
      plate_vision: 'Platte korrigieren, dann den Druck fortsetzen',
  ...
  archives: {
    ...
    modal: {
      ...
      deleteBlockedByLivePrint: 'Löschen nicht möglich — dieses Archiv zeichnet einen laufenden Druck auf. Druck zuerst stoppen und erneut versuchen.',
  ...
  queue: {
    ...
    phase: {
      ...
      uploadingNoPct: 'Wird hochgeladen…',
      sent: 'Gesendet',
    ...
    permissions: {
      ...
      noReleaseStaged: 'Bitten Sie einen Warteschlangen-Admin, diese Elemente freizugeben',
  ...
  settings: {
    ...
    spoolSelectionPolicy: 'Spulenauswahl-Richtlinie',
    spoolSelectionPolicyDesc: 'Wie der Dispatcher und manuelle Drucke eine Spule auswählen, wenn mehrere AMS-Fächer passen.',
    spoolPolicyFirstLoaded: 'Zuerst geladen (FIFO)',
    spoolPolicyLowestRemaining: 'Geringster Restbestand',
    spoolPolicySlotOrder: 'AMS-Fachreihenfolge',
    spoolPolicyBackupNote: 'Geringster Restbestand wird nur wirksam, wenn AMS Filament Backup am Drucker aktiviert ist — sonst kann der Drucker beim Aufbrauchen der gewählten Spule nicht auf eine zweite Spule wechseln.',
    minStartSpool: 'Mindest-Startgewicht der Spule (g)',
    ...
    taglessSubtype: 'Untertyp',
    taglessSubtypeHint: 'Bambus Variantencode für das Material, z. B. HF = High Flow. Wird auf dem Spulenetikett angezeigt.',
    taglessColor: 'Farbe',
    taglessSlicerFilament: 'Slicer-Filament (optional)',
    taglessSlicerFilamentHint: 'Der genaue Filament-Voreinstellungsname deines Slicers, damit Drucke zum richtigen Profil passen.',
    ...
    deleteUserChecking: 'Wird geprüft, was dieses Löschen entfernt...',
    deleteUserImpactUnavailable: 'Es konnte nicht geprüft werden, was dieses Löschen entfernt. Wenn Sie trotzdem löschen, werden die Elemente dieses Benutzers ohne Vorschau entfernt.',
    deleteUserArchives_one: '{{count}} Druckarchiv',
    deleteUserArchives_other: '{{count}} Druckarchive',
    deleteUserLibraryFiles_one: '{{count}} Bibliotheksdatei',
    deleteUserLibraryFiles_other: '{{count}} Bibliotheksdateien',
    deleteUserQueueItems_one: '{{count}} Warteschlangeneintrag',
    deleteUserQueueItems_other: '{{count}} Warteschlangeneinträge',
    deleteUserProductionRuns_one: '{{count}} Produktionslauf',
    deleteUserProductionRuns_other: '{{count}} Produktionsläufe',
    deleteUserDependentSkus_one: '{{count}} SKU verwendet eine von diesem Benutzer hochgeladene Datei. Diese SKU verliert die Datei und kann erst gedruckt werden, wenn Sie sie neu zuordnen.',
    deleteUserDependentSkus_other: '{{count}} SKUs verwenden von diesem Benutzer hochgeladene Dateien. Diese SKUs verlieren die Dateien und können erst gedruckt werden, wenn Sie sie neu zuordnen.',
    deleteUserPrintingNow_one: '{{count}} Einheit druckt gerade. Das Löschen wird abgelehnt, bis sie fertig ist oder gestoppt wird.',
    deleteUserPrintingNow_other: '{{count}} Einheiten drucken gerade. Das Löschen wird abgelehnt, bis sie fertig sind oder gestoppt werden.',
    deleteUserStillPrinting: 'Druckt noch auf {{printers}}. Stoppen Sie diese Drucke oder warten Sie, bis sie fertig sind, und löschen Sie dann.',
    // Smart plugs
    ...
    farmProduction: 'Farm-Produktion',
    farmProductionDescription: 'Standardrichtlinie für Wiederholungen und Quarantäne, die im Dialog "Serie starten" vorbelegt wird. Kann pro Serie überschrieben werden.',
    farmEjectCooldown: 'Auswurf-Abkühlung',
    farmEjectCooldownDescription: 'Wie die Farm auf das Abkühlen des Betts wartet, bevor eine fertige Platte abgeräumt wird, und wann sie aufgibt oder einen Drucker unter Quarantäne stellt, der nicht abkühlt.',
    farmRetryMaxPerUnit: 'Wiederholungen pro Platte',
    farmRetryMaxPerUnitHelp: 'Automatische Wiederholungen, bevor eine Platte als fehlgeschlagen markiert wird (0–10)',
    farmEscalateConsecutiveFailures: 'Quarantäne nach Fehlern',
    farmEscalateConsecutiveFailuresHelp: 'Aufeinanderfolgende Fehler an einem Drucker, die eine Quarantäne auslösen (1–20)',
    farmCooldownMargin: 'Abstand über Werkstattluft (°C)',
    farmCooldownMarginHelp: 'Auswurflinie und Rückschaltung des Kammerlüfters liegen so weit über der Werkstattluft.',
    shopAir: {
      label: 'Werkstattluft',
      ejectLine: 'Auswurflinie',
      noReading: 'kein Messwert',
      atPlateau: 'bei Plateau',
      fresh_one: 'Gemessen in {{count}} Drucker im Ruhezustand, vor {{minutes}} Min. — liegt leicht über der Raumluft.',
      fresh_other: 'Gemessen in {{count}} Druckern im Ruhezustand, vor {{minutes}} Min. — liegt leicht über der Raumluft.',
      carried: 'Fortgeschrieben ab {{time}} entlang der Tageskurve.',
      unknown: 'Noch kein Messwert — jede Abkühlung gibt frei, sobald das Bett nicht mehr abkühlt.',
      readFailed: 'Werkstattluft nicht lesbar — neuer Versuch jede Minute.',
    },
    farmOfflineStallMinutes: 'Offline-Stillstand (Min.)',
    farmOfflineStallMinutesHelp: 'Eine noch druckende Einheit markieren, deren Drucker so lange offline war — sie wird nie beendet, nur als blockiert angezeigt (5–720)',
    farmPauseStallMinutes: 'Pausen-Stillstand (Min.)',
    farmPauseStallMinutesHelp: 'Melden und benachrichtigen, wenn eine druckende Einheit so lange pausiert bleibt und keine automatische Behebung läuft — es wird nie etwas abgebrochen (5–720)',
    farmCooldownStallWindow: 'Abkühl-Prüfintervall (Min.)',
    farmCooldownStallWindowHelp: 'Wie oft geprüft wird, ob das Bett vor einem Auswurf noch abkühlt. Zwei fehlgeschlagene Prüfungen in Folge stellen den Drucker unter Quarantäne. 0 schaltet die Prüfung ab.',
    farmCooldownStallEpsilon: 'Mindestabkühlung pro Prüfung (°C)',
    farmCooldownStallEpsilonHelp: 'Das Bett muss zwischen zwei Prüfungen mindestens so viel abkühlen, um als noch abkühlend zu gelten.',
    farmCooldownMaxHold: 'Aufgabe-Timer (Min.)',
    ...
    farmCooldownPlateauMarginHelp: 'Stockt die Abkühlung, liegt das Bett aber innerhalb dieser Grad zur eigenen Kammerluft, wird es als abgekühlt behandelt und ausgeworfen; bleibt es heißer, wird der Drucker unter Quarantäne gestellt.',
    farmCooldownAuxFanEnabled: 'Hilfslüfter beim Abkühlen',
    farmCooldownAuxFanEnabledHelp: 'Betreibt den Hilfslüfter vom Druckende bis zum Absenden des Auswurfs.',
    farmCooldownAuxFan: 'Drehzahl des Hilfslüfters (%)',
    farmCooldownAuxFanHelp: 'Eine Drehzahl für das gesamte Abkühlen (1–100).',
    farmCooldownChamberFanEnabled: 'Kammerlüfter beim Abkühlen',
    farmCooldownChamberFanEnabledHelp: 'Stellt den Luftkanal auf Kühlen und betreibt den Kammer-Abluftlüfter vom Druckende bis zum Absenden des Auswurfs. Druckermodelle ohne Kammerlüfter überspringen ihn.',
    farmCooldownChamberFan: 'Boost-Drehzahl des Kammerlüfters (%)',
    farmCooldownChamberFanHelp: 'Drehzahl, solange die Kammerluft noch über der Auswurftemperatur liegt (1–100).',
    farmCooldownChamberFanSustain: 'Drehzahl des Kammerlüfters nach dem Boost (%)',
    farmCooldownChamberFanSustainHelp: 'Drehzahl, sobald die Kammer die Auswurftemperatur erreicht hat, bis zum Absenden des Auswurfs. 0 stoppt den Lüfter dort. Die eigene Kammerkühl-Drehzahl des Druckers ist 50.',
    farmCooldownHoldEnabled: 'Platte beim Abkühlen am Lüfter halten',
    farmCooldownHoldEnabledHelp: 'Hebt die Platte zur Düsenebene an, während der Werkzeugkopf am Auswurfschacht parkt und das Teil abkühlt. Aus lässt die Platte dort, wo der Druck endete.',
    farmCooldownHoldPartTop: 'Teileoberkante über der Düsenebene (mm)',
    farmCooldownHoldPartTopHelp: 'Legt fest, wo die Platte während des Abkühlens gehalten wird — als Höhe der Teileoberkante über dem Luftstrom des Hilfslüfters auf der Düsenebene. 100 hält die Platte am Lüfter, das Teil ragt in den freien Bereich über der Düse. 0 setzt die Teileoberkante auf Lüfterhöhe. Unter 0 wird das Teil so weit unter dem Lüfter gehalten, dass die Luft darüber streicht. Begrenzt durch die gemessene freie Höhe des Druckermodells.',
    ...
    farmIdlePark: 'Bett im Leerlauf parken',
    ...
    farmPlateBlowoffEnabled: 'Platte beim Druckstart abblasen',
    farmPlateBlowoffEnabledHelp: 'Hilfslüfter mit voller Drehzahl über die Platte vor dem Bett-Nivellieren.',
    farmPlateBlowoffSeconds: 'Abblasdauer (s)',
    farmPlateBlowoffSecondsHelp: 'Laufzeit des Hilfslüfters vor dem Bett-Nivellieren (3–60).',
    ...
    queueCheckIntervalHelp: 'Wie oft die Farm die Warteschlange erneut prüft, selbst wenn nichts passiert ist. Eine Absicherung, falls ein Live-Ereignis verpasst wird – niedriger reagiert schneller, fragt aber häufiger ab (5–300).',
    dispatchKickDebounce: 'Sammel-Verzögerung (Sek.)',
    dispatchKickDebounceHelp: 'Wenn mehrere Dinge gleichzeitig passieren, diesen kurzen Moment warten, um sie zu einem einzigen Versanddurchlauf zu bündeln statt vieler. Höher bündelt mehr; niedriger reagiert schneller (0.2–10).',
    usbPreflightFreshWindow: 'USB-Prüfung Aktualität (Sek.)',
    usbPreflightFreshWindowHelp: 'Einem aktuellen Bericht "USB-Laufwerk vorhanden" bis zu so viele Sekunden alt vertrauen, bevor erneut geprüft wird. Höher überspringt überflüssige Prüfungen; 0 prüft immer erneut (0–120).',
    usbPreflightMaxWait: 'USB-Prüfung max. Wartezeit (Sek.)',
    usbPreflightMaxWaitHelp: 'Wie lange auf einen aktuellen Bericht "USB vorhanden" gewartet wird, bevor ein Druck trotzdem gestartet wird. Höher ist vorsichtiger; niedriger versendet schneller (0–10).',
    dispatchParallelLimit: 'Gleichzeitige Druckerstarts',
    dispatchParallelLimitHelp: 'Wie viele Drucker in einem Durchlauf gleichzeitig hochladen und starten können. Höher leert eine große Warteschlange schneller; niedriger ist schonender für das Netzwerk (1–10).',
    powerStagger: 'Leistungsstaffelung',
    powerStaggerDescription: 'Einen Staffelungsplatz freigeben, sobald ein Drucker keine Aufheizleistung mehr zieht, anstatt immer das volle Intervall abzuwarten. Lässt den nächsten Drucker früher starten und begrenzt dennoch die gleichzeitige Leistungsaufnahme.',
    staggerDynamicRelease: 'Platz freigeben, sobald das Bett heiß ist',
    staggerDynamicReleaseHelp: 'Wenn aktiviert, darf der nächste Drucker starten, sobald der aktuelle das Aufheizen seines Betts abgeschlossen hat, statt das gesamte Intervall abzuwarten. Wenn deaktiviert, wartet jeder Platz das volle Intervall.',
    staggerReleaseEpsilon: 'Toleranz bei Zieltemperatur (°C)',
    staggerReleaseEpsilonHelp: 'Wie nah an der Zielbetttemperatur als "heiß genug" gilt, um den Platz früher freizugeben. Größer gibt den nächsten Drucker früher frei.',
    staggerHeatupGrace: 'Aufheiz-Kulanz (Sekunden)',
    staggerHeatupGraceHelp: 'Wenn ein Drucker noch nicht mit dem Aufheizen seines Betts begonnen hat, so lange warten, bevor sein Platz trotzdem freigegeben wird, damit ein untätiger Drucker den Stapel nicht aufhält.',
    ...
    erp: {
      title: 'ERP-Verzeichnisanmeldung',
      statusActive: 'ERP-Anmeldung: aktiv',
      statusInactive: 'ERP-Anmeldung: nicht konfiguriert',
      activeDesc: 'Bediener können sich mit ihren ERP-Verzeichnisdaten anmelden.',
      inactiveDesc: 'Fügen Sie unten die Verbindungsdaten hinzu und speichern Sie, um die ERP-Anmeldung zu aktivieren.',
      disableHint: 'Um die ERP-Anmeldung zu deaktivieren, löschen Sie unten Host und Datenbankname und speichern Sie.',
      connectionConfig: 'ERP-Verzeichnisverbindung',
      host: 'Datenbank-Host',
      port: 'Port',
      ...
      ssl: 'Über TLS verbinden',
      sslHint: 'Eine verschlüsselte Verbindung zur ERP-Datenbank erzwingen.',
      roleMapping: 'Rollenzuordnung',
      roleMappingHint: 'Weisen Sie jeder ERP-Rolle eine BamBuddy-Gruppe zu.',
      roleMappingNoGroup: '— Keine Gruppe —',
      roleMappingGroupFor: 'BamBuddy-Gruppe für {{role}}',
      settingsSaved: 'ERP-Verzeichniseinstellungen gespeichert',
      errors: {
        hostRequired: 'Datenbank-Host ist erforderlich',
        databaseRequired: 'Datenbankname ist erforderlich',
      },
    },
    oidc: {
      ...
      form: {
        ...
        groupsClaimDesc: 'Token-Claim mit den Gruppen- oder Rollenwerten des Benutzers. Leer lassen, um die Gruppensynchronisierung dieses Anbieters zu deaktivieren.',
        groupsClaimPlaceholder: 'Gruppen',
        groupMapping: 'Gruppenzuordnung',
        groupMappingDesc: 'Ordnen Sie jeden Claim-Wert einer BamBuddy-Gruppe zu. Passende Benutzer erhalten die zugeordnete Gruppe bei der Anmeldung.',
        groupMappingNone: 'Keine Zuordnungen konfiguriert.',
        groupMappingClaimValue: 'Claim-Wert',
        groupMappingGroup: 'BamBuddy-Gruppe',
        groupMappingSelectGroup: 'Gruppe auswählen',
        groupMappingRemove: 'Zuordnung entfernen',
        groupMappingAdd: 'Zuordnung hinzufügen',
  ...
  fileManager: {
    ...
    createSkuFromUploadToast: '{{filename}} hochgeladen – daraus eine SKU erstellen?',
    createSkuFromUploadAction: 'SKU aus dieser Datei erstellen',
    ...
    deleteFolderConfirm: 'Möchten Sie diesen Ordner wirklich löschen? Die Dateien darin wandern in den Papierkorb und können im Stammverzeichnis wiederhergestellt werden; der Ordner selbst wird endgültig gelöscht.',
    deleteFileConfirm: 'Möchten Sie diese Datei wirklich löschen?',
    deleteFilesConfirm: 'Möchten Sie {{count}} ausgewählte Dateien wirklich löschen? Sie wandern in den Papierkorb und können wiederhergestellt werden.',
  ...
  inventory: {
    ...
    freshRoll: {
      ...
      reviewAction: 'Prüfen…',
      title: 'Neue Rolle in diesem Fach?',
      message: 'Die Spule ohne Tag bei {{location}} wurde zum größten Teil ihres Nenngewichts verbraucht. Wenn jetzt eine neue Rolle eingelegt ist, erfasse sie, damit die Filamentverfolgung korrekt bleibt.',
      confirm: 'Neue Rolle',
      pending: 'Wird erfasst…',
      success: 'Neue Rolle erfasst',
      failed: 'Neue Rolle konnte nicht erfasst werden',
      dismissFailed: 'Aufforderung für neue Rolle konnte nicht geschlossen werden',
      remaining: '{{grams}} g als Restmenge erfasst',
      brandLabel: 'Marke',
      brandPlaceholder: 'z. B. Overture',
      weightLabel: 'Nenngewicht (g)',
      weightPlaceholder: 'z. B. 1000',
      costLabel: 'Kosten / kg',
      costPlaceholder: 'Optional',
      noteLabel: 'Notiz',
      notePlaceholder: 'Optional',
      manualDesc: 'Diesen Datensatz stilllegen und einen neuen beginnen',
      manualTitle: 'Als neue Rolle markieren?',
      manualMessage: 'Den Datensatz bei {{location}} ({{grams}} g verbraucht) stilllegen und einen frischen, vollen Datensatz für diesen Steckplatz anlegen. Nur ausführen, nachdem tatsächlich eine neue Rolle eingelegt wurde.',
      manualConfirm: 'Als neue Rolle markieren',
    },
    respool: {
      title: 'Diesen Tag umspulen?',
      manualTitle: 'Diesen Tag auf eine neue Rolle übertragen?',
      manualMessage: 'Den Datensatz bei {{location}} ({{grams}} g verbraucht) stilllegen und seinen Bambu-Tag auf eine neue volle Rolle übertragen. Erst nach dem physischen Rollenwechsel ausführen.',
      message: 'Ein wiederverwendeter Bambu-Tag wurde bei {{location}} erkannt. Wenn er jetzt auf einer frischen Fremdspule sitzt, spule ihn auf einen vollen Datensatz um.',
      confirm: 'Umgespult — frische Spule',
      pending: 'Wird umgespult…',
      success: 'Auf eine frische {{brand}}-Spule umgespult',
      failed: 'Tag konnte nicht umgespult werden',
      autoToast: '{{brand}} auf {{printer}} Slot {{slot}} automatisch umgespult',
      reusedTagToast: 'Möglicherweise neue Rolle auf einem wiederverwendeten Tag — {{printer}} Slot {{slot}}',
      ...
      triggerSpent: 'Diese Rolle hat Filamentende gemeldet, und der Slot wurde seitdem bearbeitet.',
      triggerRemainJump: 'Das AMS meldet deutlich mehr Filament, als dieser Datensatz enthält — der Tag scheint auf eine nachgefüllte Rolle gewandert zu sein.',
      sameSpoolAction: 'Gleiche Spule',
      reviewAction: 'Prüfen…',
      dismissFailed: 'Umspul-Aufforderung konnte nicht geschlossen werden',
      donorLine: 'Ersetzt die erfasste Spule (noch {{grams}} g); der alte Eintrag wird archiviert',
      donorRecordTitle: 'Eintrag #{{id}}',
      detailsLabel: 'Einzelheiten',
      tagIdLabel: 'Tag-ID',
      warning: 'Verwende nur EINEN Tag pro Spenderrolle — den zweiten Tag entsorgen.',
      brandLabel: 'Marke',
      brandPlaceholder: 'z. B. Overture',
      weightLabel: 'Nenngewicht (g)',
      weightPlaceholder: 'z. B. 1000',
    ...
    returnToRotation: 'Zurück in die Rotation',
    returnToRotationDone: 'Spule zurück in die Rotation aufgenommen',
    returnToRotationFailed: 'Spule konnte nicht zurück in die Rotation aufgenommen werden',
  ...
  ams: {
    ...
    slotDialogLabel: '{{ams}} Slot {{slot}}: {{content}}',
    ...
    slotSpentSwapPark: '{{printer}}: {{ams}} Slot {{slot}} wird von einer verbrauchten Spule belegt, die nichts freigeben kann. Slot neu prüfen oder Rolle wechseln.',
    ...
    emptySlotBinding: {
      ...
      unassignAria: 'Zuweisung aufheben: {{spool}} von diesem Steckplatz',
      unassignTitle: 'Zuweisung dieser Spule aufheben?',
      unassignMessage: '{{spool}} von diesem Steckplatz lösen. Die Spule kehrt mit unverändertem Verbrauch ins Inventar zurück — es wird nichts gelöscht.',
    },
    unknown: 'Unbekannt',
    humidity: 'Luftfeuchtigkeit',
    temperature: 'Temperatur',
  ...
  printModal: {
    ...
    reread: 'Neu einlesen',
    requiredTooltip: 'Benötigt: {{type}} - {{color}}',
    manuallySelected: 'Manuell ausgewählt',
    autoMatched: 'Automatisch zugeordnet',
    externalSlotNote: 'Externe Spule — keine Gewichtsverfolgung; der Drucker fordert Filament am Halter an.',
    selectSlot: '-- Slot auswählen --',
    noActivePrintersAvailable: 'Keine aktiven Drucker verfügbar',
    specificPrinter: 'Bestimmter Drucker',
    anyModel: 'Beliebiges {{model}}',
    modelFallback: 'Modell',
    targetModelLabel: 'Zielmodell',
    selectModelPlaceholder: 'Modell auswählen...',
    locationFilter: 'Standortfilter (optional)',
    anyLocation: 'Beliebiger Standort',
    schedulerAssignHint: 'Der Planer weist dem ersten verfügbaren freien {{model}}-Drucker zu',
    schedulerAssignHintLocation: 'Der Planer weist dem ersten verfügbaren freien {{model}}-Drucker in {{location}} zu',
    selectPrinters: 'Drucker auswählen',
    printersSelected_one: '{{count}} Drucker ausgewählt',
    printersSelected_other: '{{count}} Drucker ausgewählt',
    selectAll: 'Alle auswählen',
    inactive: '(inaktiv)',
    ...
    autoButton: 'Autom.',
    hiddenPrinters_one: '{{count}} weiterer Drucker ausgeblendet (anderes Modell) —',
    hiddenPrinters_other: '{{count}} weitere Drucker ausgeblendet (anderes Modell) —',
    showAll: 'alle anzeigen',
    showOnlyModelPrinters: 'Nur {{model}}-Drucker anzeigen',
    selectAtLeastOnePrinter: 'Mindestens einen Drucker auswählen',
    selectTargetModel: 'Ein Ziel-Druckermodell auswählen',
    typeNotFound: '(Typ nicht gefunden)',
    colorMismatch: '(Farbabweichung)',
    ready: '(Bereit)',
    clickToChangeSlot: 'Klicken, um die Slot-Zuordnung zu ändern',
    costNotAvailable: 'k.A.',
    requiredTypeNotFound: 'Erforderlicher Filamenttyp im Drucker nicht gefunden.',
    printJob: 'Druckauftrag',
    slicedModelMismatch: 'Datei wurde für {{slicedModel}} gesliced, wird aber auf {{printerModel}} gedruckt',
    archiveDataUnavailable: 'Archivdaten nicht verfügbar. Die Quelldatei wurde möglicherweise gelöscht. Filamentzuordnung ist deaktiviert.',
    failedToComplete: 'Vorgang konnte nicht abgeschlossen werden',
    toastQueueItemUpdated: 'Warteschlangeneintrag aktualisiert',
    toastUpdateFailed: 'Warteschlangeneintrag konnte nicht aktualisiert werden',
    toastSelectPrinter: 'Bitte wählen Sie mindestens einen Drucker aus',
    toastSelectModel: 'Bitte wählen Sie ein Ziel-Druckermodell aus',
    toastQueuedForModel: 'Für beliebiges {{model}} in die Warteschlange gestellt',
    ejectFromSku: 'Standard aus SKU {{code}}',
    partialFailureTitle: '{{failed}} von {{total}} Aufträgen fehlgeschlagen:',
    toastPartialSuccess: '{{success}} erfolgreich, {{failed}} fehlgeschlagen',
    printerFallback: 'Drucker {{id}}',
    slotFallback: 'Steckplatz {{id}}',
    plateFallback: 'Platte {{index}}',
  },
  ...
  uploadModal: {
    ...
    libraryHint: 'Für SKUs und Produktionsläufe stattdessen im Dateimanager hochladen.',
    libraryHintLink: 'Zum Dateimanager →',
  ...
  notifications: {
    ...
    storageLow: 'USB-Speicher fast voll',
    cooldownEscalation: 'Abkühlung dauert lange',
    // Quiet hours
    quietHours: 'Ruhezeiten',
  ...
  fleetMetrics: {
    tabs: {
      ariaLabel: 'Statistikansichten',
      prints: 'Drucke',
      fleet: 'Flotte',
    },
    sections: {
      fleet: 'Flotte',
      matrix: 'Flottenmatrix',
      stateOverTime: 'Druckerzustände im Zeitverlauf',
      printsPerDay: 'Drucke pro Tag',
      downtimeByCause: 'Ausfallzeit nach Ursache',
      coolingAndEject: 'Abkühlen und Auswurf',
      recovery: 'Wiederherstellung',
      partsBySku: 'Teile nach SKU',
    },
    summary: {
      now: 'Jetzt',
      trend: 'Verlauf',
      ...
      period: {
        ...
        custom: 'Gewählter Zeitraum',
      },
      rows: {
        avg_printing: 'Druckt',
        avg_cycle_overhead: 'Zwischen Drucken',
        avg_idle: 'Leerlauf',
        avg_down: 'Ausgefallen',
        avg_planned: 'Wartung',
        peak_down: 'Spitze ausgefallen',
        printers_in_fleet: 'In der Flotte',
        prints_per_day: 'Drucke',
        prints_per_printer_per_day: 'Drucke pro Drucker',
        uptime: 'Betriebszeit',
        time_printing: 'Druckzeitanteil',
      },
      peak: 'Spitze {{count}}',
    ...
    class: {
      cycle_overhead: 'Zwischen Drucken',
      cooling: 'Kühlt ab',
      ejecting: 'Wirft aus',
      down: 'Ausgefallen',
      planned: 'Wartung',
      out_of_fleet: 'Deaktiviert',
    ...
    matrix: {
      ...
      showDays: 'Tage einblenden',
      hideDays: 'Tage ausblenden',
      sortBy: 'Nach {{column}} sortieren',
      caption: '{{lens}} nach Drucker, {{from}} bis {{to}}',
      captionDay: '{{lens}} nach Drucker, {{date}}',
      ...
      legend: {
        ...
        printingBand: 'Druckt',
        otherBand: 'Sonstiges',
        downBand: 'Ausgefallen',
      },
    },
    detail: {
      title: '{{printer}} · {{bucket}}',
      timeSplit: 'Zeitverteilung',
      classes: 'Zeitverwendung',
      printsByOutcome: 'Drucke nach Ergebnis',
      outcome: {
        completed: 'Abgeschlossen',
        failed: 'Fehlgeschlagen',
        cancelled: 'Abgebrochen',
      ...
      intervals: 'Zeitabschnitte',
      incidents: 'Störungen',
      openPrinter: 'Drucker öffnen',
      noIntervals: 'Für diesen Zeitraum wurden keine Abschnitte aufgezeichnet.',
      noIncidents: 'Keine Störungen in diesem Zeitraum.',
      noPrints: 'Keine Drucke in diesem Zeitraum.',
      ongoing: 'Laufend',
    },
    widgets: {
      showData: 'Daten anzeigen',
      showChart: 'Diagramm anzeigen',
      showDataFor: 'Daten für {{chart}} anzeigen',
      showChartFor: 'Diagramm für {{chart}} anzeigen',
      median: 'Medianwert',
      p90: 'P90',
      overExpected: 'über Erwartung',
      count: 'Anzahl',
      variant: {
      ...
      clearedNoPerson: 'Ohne Eingriff behoben',
      inFleetLine: 'In der Flotte',
      peakDownLine: 'Spitze ausgefallen',
      sku: 'SKU',
      units: 'Einheiten',
      plates: 'Platten',
      successRate: 'Erfolg',
    ...
    states: {
      ...
      loadFailed: 'Flottenverlauf konnte nicht geladen werden.',
      retry: 'Erneut versuchen',
      empty: 'Keine Daten für diesen Zeitraum.',
      recordingGap: 'Aufzeichnung der Druckerzustände seit {{date}}. Stör- und Wartungsverlauf ab {{earliest}}.',
    },
    header: {
    ...
    hints: {
      ...
      cycle_overhead: 'Eigenleistung der Farm zwischen den Drucken: Bett abkühlen, dann das Teil abräumen.',
      planned: 'Wartungsmodus: Eine Person hat den Drucker aus den automatischen Abläufen genommen.',
      uptime: 'Anteil der gezählten Zeit, in der der Drucker Aufträge annehmen konnte.',
      time_printing: 'Anteil der gezählten Zeit, in der der Drucker gedruckt hat.',
      prints_per_printer: 'Abgeschlossene Drucke geteilt durch die gezählten Tage je Drucker. Gezählte Tage stammen nur aus aufgezeichneten Intervallen und sind daher nicht mit „Drucke“ vergleichbar, solange ein Teil des Zeitraums nicht aufgezeichnet ist.',
      unobserved: 'Für diesen Abschnitt wurde nichts aufgezeichnet; bekannt sind nur Störungen und Haltezustände.',
      not_recorded: 'Liegt vor dem ersten je aufgezeichneten Zustand dieses Druckers.',
      incidents_only: 'Hier wurde kein Druckerzustand aufgezeichnet; nur das Stör- und Wartungsprotokoll deckt den Zeitraum ab.',
      whileRecorded: 'Zeitraumwerte umfassen nur aufgezeichnete Zeit.',
      timeframeFleet: 'Tage laufen von Mitternacht bis Mitternacht in {{tz}}.',
      timeframePrints: 'Tage laufen von Mitternacht bis Mitternacht UTC.',
    },
  },
};
