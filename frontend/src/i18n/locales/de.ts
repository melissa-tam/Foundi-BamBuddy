export default {
  ...
  productionRuns: {
    ...
    fields: {
      ...
      cooldownOverride: 'Abkühlung überschreiben (°C)',
      cooldownPlaceholder: 'Profilstandard verwenden',
      cooldownProfileDefault: 'Überschreibt Profilstandard {{value}}°C',
  ...
  ejectProfiles: {
    ...
    fields: {
      name: 'Name',
      cooldownTemp: 'Abkühltemperatur (°C)',
    ...
    tooltips: {
      ...
      cooldownTemp: 'Betttemperatur, auf die der Druck abkühlen muss, bevor der Abstreifvorgang startet – abgekühlte Teile lösen sich von der Platte.',
    ...
    geometry: {
      ...
      cooldownAmbientTrap: 'Unter der Abkühl-Warnschwelle ({{floor}} °C). Ein Schwellwert auf oder unter der Umgebungstemperatur der Werkstatt kann nie erreicht werden, das Auswurf-Warten würde für immer hängen — ein paar Grad über der Umgebungstemperatur wählen.',
    ...
    queueHelp: 'Das Teil wird abgeschoben, sobald das Bett unter den Profil-Schwellenwert abgekühlt ist.',
  },
  // Navigation
  nav: {
    printers: 'Drucker',
  ...
  settings: {
    ...
    farmCooldownWarnFloor: 'Abkühl-Warnschwelle (°C)',
    farmCooldownWarnFloorHelp: 'Warnen, wenn die Abkühlschwelle eines Auswurfprofils darunter liegt — eine Schwelle auf oder unter der Umgebungstemperatur wird nie erreicht (15–50)',
