export default {
  ...
  inventory: {
    ...
    freshRoll: {
      ...
      message: 'Die Spule ohne Tag bei {{location}} wurde über die Hälfte ihres Nenngewichts verbraucht. Wenn jetzt eine neue Rolle eingelegt ist, erfasse sie, damit die Filamentverfolgung korrekt bleibt.',
      confirm: 'Neue Rolle',
    ...
    respool: {
      ...
      promptToast: 'Spule fast leer an {{printer}} Slot {{slot}} — neue Rolle auf diesem Tag?',
