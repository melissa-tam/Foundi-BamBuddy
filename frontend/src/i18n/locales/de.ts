export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      coolingFanAssist: 'Kühllüfter-Unterstützung',
    ...
    tooltips: {
      ...
      coolingFanAssist: 'Lässt den Bauteillüfter während des Abstreifens laufen, damit sich ein hartnäckiges Teil von der Platte löst.',
