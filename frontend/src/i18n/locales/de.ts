export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      cooldownRetries: 'Abkühl-Wiederholungen',
    ...
    tooltips: {
      ...
      cooldownRetries: 'Wie oft die Betttemperatur beim Warten auf die Zieltemperatur erneut geprüft wird, bevor abgebrochen wird.',
  ...
  printers: {
    ...
    phase: {
      printing: 'Druckt',
      cooling: 'Kühlt auf {{threshold}}°C ab (Bett {{bed}}°C) — Abstreifen läuft in der Druckdatei',
  ...
  settings: {
    ...
    farmRetryMaxPerUnitHelp: 'Automatische Wiederholungen, bevor eine Platte als fehlgeschlagen markiert wird (0–5)',
    farmEscalateConsecutiveFailures: 'Quarantäne nach Fehlern',
    farmEscalateConsecutiveFailuresHelp: 'Aufeinanderfolgende Fehler an einem Drucker, die eine Quarantäne auslösen (1–10)',
