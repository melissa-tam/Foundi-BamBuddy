export default {
  ...
  printers: {
    ...
    eject: {
      now: 'Jetzt auswerfen',
      menuEjectPlate: 'Platte auswerfen…',
      ...
      foreignTitle: 'Fremden Druck auswerfen?',
      foreignBody: 'Dieser Druck wurde nicht von der Farm gestartet. Der Abstreifvorgang verwendet das unten gewählte Auswurfprofil — korrigiere die Teilehöhe, falls der erkannte Wert falsch ist.',
