export default {
  ...
  skus: {
    ...
    suggest: {
      title: 'Aus Datei vorschlagen',
      description: 'Wählen Sie eine geslicete Datei, um Code, Teilenummer und Name aus deren Metadaten vorauszufüllen.',
      file: 'Bibliotheksdatei',
      filePlaceholder: 'Datei auswählen…',
      action: 'Vorschlagen',
      applied: 'Daten aus {{source}} übernommen',
  ...
  settings: {
    ...
    autoAddUntaggedDesc: 'Für AMS-Fächer ohne RFID-Tag automatisch eine Bestandsspule anlegen. Deaktivieren, wenn du Spulen manuell vorab registrierst, um Duplikate zu vermeiden.',
    ...
    farmCooldownStallWindow: 'Abkühl-Stillstandsfenster (Min.)',
    farmCooldownStallWindowHelp: 'Während der Auswurf-Abkühlung muss das Bett weiter abkühlen; zwei aufeinanderfolgende Fenster ohne Fortschritt stellen den Drucker unter Quarantäne (0 deaktiviert)',
    farmCooldownStallEpsilon: 'Min. Abkühlung pro Fenster (°C)',
    farmCooldownStallEpsilonHelp: 'Mindestabkühlung (°C) pro Fenster, die als Fortschritt zählt',
    farmCooldownMaxHold: 'Max. Abkühl-Wartezeit (Min.)',
    farmCooldownMaxHoldHelp: 'Nach so vielen Minuten über der Freigabeschwelle wird der Auswurf trotzdem ausgeführt (0 = unbegrenzt auf die Schwelle warten)',
    farmCooldownPlateauMargin: 'Plateau-Auswurfmarge (°C)',
    farmCooldownPlateauMarginHelp: 'Wenn die Abkühlung innerhalb dieser °C zur Freigabeschwelle stagniert, wird ausgeworfen (Bett auf Umgebungstemperatur) statt den Drucker in Quarantäne zu setzen. Über Schwelle + Marge ist das Bett wirklich zu heiß und der Drucker wird in Quarantäne gesetzt',
  ...
  inventory: {
    ...
    respool: {
      ...
      donorLine: 'Aktueller Datensatz #{{id}} — {{grams}} g übrig — wird archiviert',
