export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      bedDropHelp: 'Nachdem der Druckkopf frei über dem Teil abgehoben hat, das Bett fast bis zum Maschinenboden absenken und wieder anheben, um das Teil vor dem Abstreifen loszurütteln.',
    ...
    tooltips: {
      ...
      bedDrop: 'Nachdem das Abheben das Teil freigegeben hat, senkt sich das Heizbett fast bis zum tiefsten Punkt und fährt wieder hoch – der Ruck löst ein festsitzendes Teil vor dem Abstreifen. Erfordert einen hinterlegten Z-Verfahrweg für das Modell.',
