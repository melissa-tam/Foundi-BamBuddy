export default {
  ...
  fleetMetrics: {
    ...
    matrix: {
      ...
      caption: '{{lens}} je Drucker, {{from}} bis {{to}}',
    ...
    states: {
      ...
      firstRun: 'Aufzeichnung der Druckerzustände seit {{date}}. Stör- und Wartungsverlauf ab {{earliest}}.',
    },
    header: {
    ...
    hints: {
      ...
      prints_per_printer: 'Abgeschlossene Drucke geteilt durch die gezählten Tage je Drucker.',
