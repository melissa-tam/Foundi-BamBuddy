export default {
  ...
  printers: {
    ...
    eject: {
      ...
      foreignBody: 'Dieser Druck wurde nicht von der Farm gestartet (er wurde manuell aus Bambu Studio gesendet). Der Abstreifvorgang verwendet das unten gewählte Auswurfprofil — prüfe zuerst, ob die erkannte Teilehöhe stimmt.',
      foreignPrintNameLabel: 'Druck',
      foreignUnknownPrint: 'Unbekannt',
      foreignPartHeightLabel: 'Erkannte Teilehöhe',
