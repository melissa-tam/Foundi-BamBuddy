export default {
  ...
  printers: {
    ...
    toast: {
      ...
      recheckFailed: 'Controllo non riuscito',
  ...
  inventory: {
    ...
    respool: {
      ...
      noteLabel: 'Nota',
      notePlaceholder: 'Opzionale',
      actionDesc: 'Spostare questo tag Bambu su una bobina nuova',
    },
    bulk: {
  ...
  ams: {
    ...
    emptySlotBinding: {
      ...
      clearMessage: 'Libera {{spool}} da questo slot. La bobina torna in inventario con il consumo registrato intatto: non viene eliminato nulla.',
    },
    unknown: 'Sconosciuto',
    humidity: 'Umidità',
    temperature: 'Temperatura',
