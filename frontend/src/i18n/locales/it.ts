export default {
  ...
  inventory: {
    ...
    freshRoll: {
      ...
      message: 'La bobina senza tag in {{location}} è stata usata per oltre metà del suo peso nominale. Se ora è caricata una bobina nuova, registrala così il tracciamento del filamento resta preciso.',
    ...
    respool: {
      ...
      promptToast: 'Bobina quasi vuota su {{printer}} slot {{slot}} — nuova bobina su questo tag?',
