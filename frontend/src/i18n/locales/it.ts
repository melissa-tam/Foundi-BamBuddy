export default {
  // Catalogo SKU (produzione di fattoria, fase 2)
  skus: {
    nav: 'Articoli',
    title: 'Catalogo SKU',
    description: 'Codici di articoli vendibili, ciascuno collega una o più piastre di file della libreria oltre a un profilo di espulsione predefinito per le tirature di produzione.',
    newSku: 'Nuovo SKU',
    loadError: 'Impossibile caricare gli SKU.',
    empty: {
      title: 'Nessuno SKU ancora',
      body: 'Crea il tuo primo SKU per collegare file stampabili e monitorare la produzione.',
    },
    columns: {
      files: 'File',
      unitsCompleted: 'Unità totali',
      successRate: 'Successo',
    },
    createTitle: 'Crea SKU',
    editTitle: 'Modifica SKU',
    fields: {
      code: 'Codice',
      name: 'Nome',
      partNumber: 'Numero parte',
      notes: 'Note',
      defaultEjectProfile: 'Profilo di espulsione predefinito',
      noEjectProfile: 'Nessuno',
    },
    codeRequired: 'Il codice è obbligatorio.',
    nameRequired: 'Il nome è obbligatorio.',
    created: 'SKU creato',
    updated: 'SKU aggiornato',
    deleted: 'SKU eliminato',
    saveFailed: 'Impossibile salvare lo SKU',
    deleteFailed: 'Impossibile eliminare lo SKU',
    deleteTitle: 'Eliminare questo SKU?',
    deleteBody: '"{{code}}" verrà rimosso definitivamente. L\'operazione non può essere annullata.',
    suggest: {
      appliedFromObjectName: 'Dettagli compilati dai nomi delle parti nel file',
      appliedFromFilename: 'Dettagli compilati dal nome del file',
      appliedGeneric: 'Dati compilati dal file',
      failed: 'Impossibile suggerire i dettagli',
    },
    files: {
      ...
      plate: 'Piastra',
      unitsPerPlate: 'Unità per piastra',
      plateUnits: 'Piastra {{plate}} · {{units}} per piastra',
      add: 'Aggiungi file',
      added: 'File collegato',
      addFailed: 'Impossibile collegare il file',
      savedButLinkFailed: 'Lo SKU è stato salvato, ma il collegamento del file non è riuscito: {{reason}}',
      remove: 'Rimuovi',
      removed: 'File scollegato',
      removeFailed: 'Impossibile scollegare il file',
      removeTitle: 'Scollegare questo file?',
      removeBody: '"{{name}}" verrà scollegato da questo SKU.',
    },
  },

  // Tirature di produzione (produzione di fattoria, fase 2)
  productionRuns: {
    nav: 'Produzione',
    title: 'Tirature di produzione',
    description: 'Distribuisci copie di uno SKU tra le stampanti fino al raggiungimento di un numero di unità obiettivo, con avanzamento in tempo reale.',
    loadError: 'Impossibile caricare le tirature di produzione.',
    empty: {
      title: 'Nessuna tiratura di produzione',
      body: 'Avvia una tiratura per stampare uno SKU fino a un numero di unità obiettivo.',
      noSkus: 'Aggiungi uno SKU con almeno un file collegato prima di avviare una tiratura.',
    },
    startTitle: 'Avvia tiratura di produzione',
    startAction: 'Avvia tiratura',
    runAgain: 'Esegui di nuovo',
    advanced: 'Avanzate',
    starting: 'Avvio…',
    started: 'Tiratura di produzione avviata',
    startFailed: 'Impossibile avviare la tiratura',
    noFiles: 'Questo SKU non ha file collegati da stampare.',
    fileRequired: 'Seleziona un file da stampare.',
    targetRequired: 'Inserisci un obiettivo di almeno 1 unità.',
    printerRequired: 'Seleziona almeno una stampante.',
    overProduction: 'Produrrà {{planned}} unità ({{plates}} piastre) — {{extra}} in più rispetto all\'obiettivo di {{target}}.',
    fields: {
      sku: 'SKU',
      file: 'File / piastra',
      filePlaceholder: 'Seleziona un file…',
      plateUnits: 'piastra {{plate}}, {{units}}/piastra',
      targetUnits: 'Unità obiettivo',
      printers: 'Stampanti',
      ...
      skuNoFile: '— nessun file collegato',
      skuNoFileHint: 'Collega un file a uno SKU nella pagina SKU per renderlo avviabile.',
    },
    status: {
      active: 'Attiva',
      paused: 'In pausa',
    ...
    platesProgress: '{{completed}} / {{total}} piastre',
    stats: {
      units: 'Unità',
      target: 'Obiettivo',
      failed: 'Fallite',
    ...
    resume: 'Riprendi',
    abort: 'Interrompi',
    paused: 'Tiratura in pausa',
    resumed: 'Tiratura ripresa',
    aborted: 'Tiratura interrotta',
    actionFailed: 'Azione non riuscita',
    startNow: 'Avvia ora',
    startedNow: 'Esecuzione avviata',
    reschedule: 'Ripianifica',
    rescheduleTitle: 'Modifica l\'ora di inizio',
    rescheduled: 'Ora di inizio aggiornata',
    schedule: {
      sectionTitle: 'Ora di inizio',
      whenToStart: 'Quando iniziare',
      asap: 'Avvia subito',
      later: 'Pianifica per dopo',
      date: 'Data',
      time: 'Ora',
      openCalendar: 'Apri calendario',
      pastError: 'Scegli un orario futuro.',
      invalidError: 'Inserisci una data e un\'ora valide.',
      helpAsap: 'L\'esecuzione inizia appena una stampante idonea è libera.',
      helpScheduled: 'L\'esecuzione inizia all\'orario scelto se una stampante è libera, altrimenti attende finché non lo è.',
      startsIn: 'Inizia {{when}}',
    },
    viewDetails: 'Vedi dettagli della serie',
    blockedPrinters: 'Stampante bloccata',
    pauseReason: {
      operator: 'In pausa dall\'operatore',
    ...
    detail: {
      back: 'Tutte le serie di produzione',
      loadError: 'Impossibile caricare questa serie di produzione.',
      notFound: 'Serie di produzione non trovata.',
      printersTitle: 'Stampanti',
      noPrinters: 'Nessuna stampante assegnata — lo scheduler sceglie una stampante libera compatibile per unità.',
      unitsTitle: 'Unità',
      noUnits: 'Ancora nessuna unità.',
      unitCol: 'Unità',
      statusCol: 'Stato',
      ...
      retryOf: 'Nuovo tentativo n. {{count}} dell\'unità {{id}}',
      unitStatus: {
        pending: 'In attesa',
        printing: 'In stampa',
        completed: 'Completata',
      ...
      waiting: {
        ...
        visionHold: 'In pausa al controllo del piatto — sistema il piatto, poi riprendi',
        ...
        externalFeedFault: 'La bobina esterna non alimenta — controlla il supporto e il tubo PTFE, poi riprendi dalla stampante',
        pinnedTrayUnavailable: 'Lo slot fissato non è caricato su questa stampante — caricalo o rimuovi il vincolo',
        ...
        libraryFileMissing: 'File di origine mancante nella libreria — ripristina il file o ricaricalo',
      ...
      printerState: {
        ...
        modelMismatch: 'Modello non corrispondente',
        stalled: 'Offline durante la stampa',
        visionHold: 'In attesa al controllo del piatto',
        filamentShort: 'Filamento insufficiente',
        noUsbDrive: 'Nessuna chiavetta USB',
      },
      eligibility: {
        title: 'Stampanti non partecipanti',
        description: 'Queste stampanti non prenderanno unità di questa tiratura finché non si risolve:',
        offline: 'Offline',
        quarantined: 'In quarantena',
        awaitingPlateClear: 'Piatto non liberato',
        modelMismatch: 'Modello non corrispondente',
        filamentShort: 'Filamento insufficiente',
        noUsbDrive: 'Nessuna chiavetta USB',
      },
    },
    abortTitle: 'Interrompere questa tiratura?',
    abortBody: '"{{name}}" verrà annullata. Le piastre in corso vengono completate ma non ne vengono avviate di nuove. L\'operazione non può essere annullata.',
    delete: 'Elimina',
    deleted: 'Tiratura eliminata',
    ...
    firstArticle: {
      ...
      requireHelp: 'Il primo pezzo viene stampato senza espulsione automatica e la serie resta in attesa della tua approvazione.',
      retriesLabel: 'Tentativi per piano',
      escalateLabel: 'Metti in quarantena dopo guasti consecutivi',
      printing: 'Stampa del primo pezzo',
      awaitingTitle: 'Primo pezzo in attesa di approvazione',
      awaitingBody: 'Il primo pezzo è stato stampato. Ispezionalo, poi approva per continuare la serie o rifiuta per interromperla e correggerla.',
      approvePhysical: 'Approva — ho rimosso il pezzo',
      approveEject: 'Approva ed espelli da remoto',
      reject: 'Rifiuta…',
      approveConfirm: 'Approva',
      approvePhysicalTitle: 'Approvare il primo pezzo?',
      approvePhysicalBody: 'Conferma di aver rimosso il pezzo stampato dal piano. La serie proseguirà e invierà i piani rimanenti.',
      approveEjectTitle: 'Approvare ed espellere da remoto?',
      approveEjectBody: 'La testa di stampa spazzerà via il pezzo dal piano prima che la serie prosegua. Assicurati che il piano sia libero da ostacoli e che nessuno abbia le mani nella stampante.',
      rejectTitle: 'Rifiuta il primo pezzo',
      rejectBody: 'Spiega cosa non andava. Riprendendo la serie in seguito si riavvia un nuovo primo pezzo.',
      rejectReasonLabel: 'Motivo',
      rejectReasonPlaceholder: 'es. angoli deformati, scarsa adesione…',
      rejectReasonRequired: 'È richiesto un motivo.',
      rejectAction: 'Rifiuta il primo pezzo',
      rejectedBadge: 'Primo pezzo rifiutato',
      rejectedReason: 'Motivo: {{reason}}',
      rejectedHint: 'La ripresa riavvia un nuovo primo pezzo.',
      approvedBadge: 'Primo pezzo approvato',
      approved: 'Primo pezzo approvato',
      rejected: 'Primo pezzo rifiutato',
      approveFailed: 'Impossibile approvare il primo pezzo',
      rejectFailed: 'Impossibile rifiutare il primo pezzo',
      photoAlt: 'Foto finale del primo pezzo',
      photoUnavailable: 'Foto finale non disponibile',
      viewCamera: 'Mostra fotocamera',
      hideCamera: 'Nascondi fotocamera',
      printerLabel: 'Stampante: {{name}}',
    },
  },

  ejectProfiles: {
    nav: 'Profili di espulsione',
    title: 'Profili di espulsione',
    description: 'Profili di rimozione automatica che spingono i pezzi finiti fuori dal piano una volta raffreddato.',
    newProfile: 'Nuovo profilo',
    loadError: 'Impossibile caricare i profili di espulsione.',
    duplicateAction: 'Duplica',
    copyName: '{{name}} (copia)',
    empty: {
      title: 'Ancora nessun profilo di espulsione',
      body: 'Crea il tuo primo profilo per rimuovere automaticamente i pezzi finiti dal piano.',
    },
    columns: {
      passes: 'Passaggi',
      ejectSpeed: 'Velocità di espulsione',
      maxHeight: 'Altezza max.',
    },
    createTitle: 'Crea profilo di espulsione',
    editTitle: 'Modifica profilo di espulsione',
    fields: {
      name: 'Nome',
      clearance: 'Distanza (mm)',
      zOffset: 'Offset Z (mm)',
      descentSteps: 'Passi di discesa',
      xPasses: 'Passaggi X',
      xMargin: 'Margine X (mm)',
      frontOverhang: 'Sporgenza anteriore (mm)',
      backOverhang: 'Sporgenza posteriore (mm)',
      ejectSpeed: 'Velocità di espulsione (mm/min)',
      skimSpeed: 'Velocità di sfioramento (mm/min)',
      finalSkim: 'Passata di rasatura finale',
      finalSkimHelp: 'Aggiunge una passata di rasatura lenta appena sopra il piatto dopo le spazzate per rimuovere i residui sottili. Disattiva per spingere esattamente una volta.',
      maxPartHeight: 'Altezza max. pezzo (mm)',
      sweepStartHeight: 'Altezza di inizio spazzata (%)',
      sweepStartHeightHelp: 'Avvia la spazzata discendente a questa percentuale dell\'altezza del pezzo (100% = sommità del pezzo).',
      sweepBand: 'Limita la banda X della spazzata',
      sweepBandHelp: 'Spazza solo una sottobanda della larghezza del piano invece dell\'intera larghezza. Lascia disattivato per l\'intera larghezza.',
      sweepXMin: 'Min. banda X (mm)',
      sweepXMax: 'Max. banda X (mm)',
      bedDrop: 'Assistenza al distacco tramite abbassamento del piatto',
      bedDropHelp: 'Il piatto scende quasi fino al fondo della macchina e risale alla quota di sollevamento; lo scossone stacca un pezzo incollato prima della spazzata.',
      bedDropClearance: 'Distanza dal fondo (mm)',
      bedDropDwell: 'Attesa al punto basso (s)',
      bedDropDwellHelp: 'Il piatto resta al punto basso della discesa per questi secondi prima di tornare alla quota di sollevamento.',
      bedDropJitter: 'Scossoni al punto basso',
      bedDropJitterHelp: 'Al punto basso della discesa il piatto sale e ritorna della distanza impostata, per il numero di cicli impostato.',
      bedDropJitterCycles: 'Cicli di scossone',
      bedDropJitterMm: 'Corsa dello scossone (mm)',
    },
    tooltips: {
      name: 'Una breve etichetta per riconoscere questo profilo – mostrata nell\'elenco dei profili e nei selettori.',
      clearance: 'Quanto in alto sopra il pezzo resta la testa mentre si porta in posizione, così da non toccarlo prima della spazzata.',
      zOffset: 'Piccola regolazione dell\'altezza della spazzata – aumentala se l\'ugello striscia, riducila se il pezzo non viene preso.',
      descentSteps: 'Numero di piccole discese che la testa compie per portarsi dietro il pezzo prima di spingerlo via.',
      xPasses: 'Quante passate di spazzata laterali effettuare sul piatto per rimuovere il pezzo.',
      xMargin: 'Margine mantenuto dai bordi sinistro e destro del piatto affinché la testa non urti mai il telaio.',
      frontOverhang: 'Quanto la spazzata si spinge oltre la parte anteriore del pezzo per spingerlo via completamente.',
      backOverhang: 'Quanto dietro il pezzo inizia la spazzata, così che la testa si porti del tutto dietro di esso prima di spingere.',
      ejectSpeed: 'Quanto velocemente si muove la testa durante le passate di spinta che spingono il pezzo fuori dal piatto.',
      skimSpeed: 'Quanto velocemente si muove la testa durante le passate di sfioramento più leggere che rimuovono i residui.',
      finalSkim: 'Esegue una passata lenta aggiuntiva appena sopra il piatto dopo le spazzate principali per rimuovere i piccoli residui. Disattiva per una singola spinta (ad es. una sola corsia a metà altezza per un pezzo alto).',
      maxPartHeight: 'Pezzo più alto che questo profilo può espellere – l\'invio viene bloccato se il pezzo elaborato è più alto.',
      sweepStartHeight: 'Altezza sul pezzo dove inizia la spazzata discendente, in percentuale (valido 1-100%; 100% = la cima del pezzo).',
      sweepBand: 'Spazza solo una striscia del piatto anziché tutta la larghezza – utile quando i pezzi stanno sempre nello stesso punto.',
      sweepXMin: 'Bordo sinistro della striscia di spazzata, in mm dall\'origine del piatto. Valido 0-340 mm (larghezza piatto H2S); deve essere minore del massimo e lasciare una striscia larga almeno 10 mm.',
      sweepXMax: 'Bordo destro della striscia di spazzata, in mm dall\'origine del piatto. Valido 0-340 mm (larghezza piatto H2S); deve essere maggiore del minimo e lasciare una striscia larga almeno 10 mm.',
      bedDrop: 'Il piatto riscaldato scende quasi fino al punto più basso e risale alla quota di sollevamento; lo scossone stacca un pezzo incollato prima della spazzata. Richiede una corsa Z registrata per il modello.',
      bedDropClearance: 'Distanza mantenuta dalla posizione più bassa del piatto durante la discesa — 50 mm = fermarsi 5 cm sopra il fondo.',
      bedDropDwell: 'Qualche secondo in più al punto basso dà a un pezzo incollato il tempo di staccarsi del tutto prima della spazzata.',
      bedDropJitter: 'Brevi movimenti su e giù al punto basso staccano un pezzo che il singolo scossone lascia attaccato.',
    },
    nameRequired: 'Il nome è obbligatorio.',
    created: 'Profilo di espulsione creato',
    updated: 'Profilo di espulsione aggiornato',
    deleted: 'Profilo di espulsione eliminato',
    ...
    deleteBody: '«{{name}}» verrà rimosso definitivamente. L\'operazione non può essere annullata.',
    preview: {
      title: 'Anteprima e convalida',
      description: 'Genera il G-code di espulsione per un file della libreria e un piano per convalidarlo prima dell\'uso.',
      file: 'File della libreria',
      filePlaceholder: 'Seleziona un file…',
      plate: 'Piano',
      run: 'Genera anteprima',
      running: 'Generazione…',
      noFiles: 'Nessun file della libreria disponibile per l\'anteprima.',
      ok: 'Convalida superata',
      errors: 'Errori',
      warnings: 'Avvisi',
      maxZ: 'Altezza Z max.: {{value}} mm',
      showGcode: 'Mostra G-code',
      hideGcode: 'Nascondi G-code',
      gcodeLabel: 'G-code generato',
      failed: 'Anteprima non riuscita',
    },
    dryRun: {
      action: 'Prova a vuoto',
      title: 'Prova di espulsione a vuoto',
      description: 'Invia una prova solo geometrica di questo profilo a una stampante, oppure scarica il file di prova per ispezionarlo.',
      printer: 'Stampante',
      printerPlaceholder: 'Seleziona una stampante connessa…',
      loadingPrinters: 'Verifica delle connessioni delle stampanti…',
      noPrinters: 'Nessuna stampante connessa disponibile.',
      warningTitle: 'Piatto vuoto richiesto',
      warning: 'Questa prova esegue l\'azzeramento al centro del piatto e lo spazza, quindi il piatto deve essere VUOTO. Dopo l\'invio il lavoro attende finché non liberi il blocco del piatto sulla stampante.',
      dispatch: 'Invia prova',
      dispatching: 'Invio in corso…',
      download: 'Scarica file',
      downloading: 'Preparazione…',
      dispatchFailed: 'Impossibile inviare la prova.',
      downloadFailed: 'Impossibile creare il file della prova a vuoto.',
      allowUnvalidated: 'Consenti geometria non validata (solo per la scala hardware)',
      allowUnvalidatedWarning: "L'inviluppo di questo modello NON è stato validato a livello hardware. Invia solo alla scala, sotto supervisione e con il piano VUOTO.",
    },
    geometry: {
      model: 'Modello di stampante',
      noModels: 'Nessuna voce nel registro delle geometrie',
      unvalidated: 'non validato a livello hardware',
      warningsTitle: 'Avvisi di geometria',
      downloadModel: 'Modello di geometria per il download',
      downloadModelPlaceholder: 'Usa il modello della stampante selezionata',
      bandInverted: 'Il minimo della banda X deve essere inferiore al massimo della banda X.',
      bandTooNarrow: 'La banda di spazzata deve essere larga almeno {{min}} mm.',
      bandExceedsBed: 'Il massimo della banda X supera il piano registrato più largo ({{max}} mm).',
      heightExceedsCeiling: "Oltre il limite di altezza di tutti i modelli registrati (max {{max}} mm) — l'invio dell'espulsione verrebbe rifiutato.",
      bedDropNoTravel: 'I modelli senza una corsa Z registrata ({{models}}) non possono generare questo profilo — imposta z_travel_mm nel registro delle geometrie.',
      bedDropBedslinger: "L'assistenza di abbassamento del piano non è disponibile sui modelli a piano mobile ({{models}}) — il loro piano non si muove in Z.",
    },
    geometryManager: {
      title: 'Registro delle geometrie dei modelli',
      description: "Dimensioni del piano, inviluppo di spostamento e stato di validazione hardware per ogni modello di stampante. Le righe provengono dai seed del server — non c'è un pulsante per aggiungere; modifica un modello per correggerne la geometria o cambiarne la validazione.",
      edit: 'Modifica geometria',
      editTitle: 'Modifica la geometria di {{model}}',
      saved: 'Geometria del modello salvata',
      saveFailed: 'Impossibile salvare la geometria del modello',
      zTravelUnset: "Nessuna corsa Z registrata — l'assistenza di abbassamento del piano fallisce in sicurezza su questo modello.",
      validatedBadge: 'Validato',
      notValidatedBadge: 'Non validato',
      confirmValidateTitle: 'Segnare il modello come validato?',
      ...
      columns: {
        model: 'Modello',
        bed: 'Piano (L×A mm)',
        envelope: 'Inviluppo (mm)',
        zTravel: 'Corsa Z',
        maxPartHeight: 'Altezza max pezzo',
        motion: 'Movimento',
        validated: 'Validato',
        notes: 'Note',
        updated: 'Aggiornato',
      ...
      motion: {
        bedZ: 'Piano su Z',
        bedslinger: 'Piano mobile',
      },
      fields: {
        bedX: 'Larghezza piano X (mm)',
        bedY: 'Profondità piano Y (mm)',
        envXMin: 'Inviluppo X min (mm)',
        envXMax: 'Inviluppo X max (mm)',
        envYMin: 'Inviluppo Y min (mm)',
        envYMax: 'Inviluppo Y max (mm)',
        maxPartHeight: 'Altezza max pezzo (mm)',
        zTravel: 'Corsa Z (mm)',
    ...
    queueLabel: 'Profilo di espulsione (rimozione automatica del pezzo)',
    queueHelp: 'Il pezzo viene spinto via quando il piano si raffredda fino alla linea di espulsione.',
  },
  // Navigation
  nav: {
    printers: 'Stampanti',
  ...
  printers: {
    ...
    deactivated: {
      ...
      panelState: 'Disattivata — nessuna connessione a questa stampante.',
      activate: 'Attiva',
      toastActivated: '{{name}} attivata',
      editFieldLabel: 'Disattivata',
      editFieldHelp: 'Nessuna sessione MQTT; invisibile a questa istanza (installazioni parallele, dismissione).',
    },
    // Chamber light
    ...
    toast: {
      ...
      recheckUnchanged: 'Slot {{slot}} invariato. Nessun movimento di bobina registrato dall’ultimo controllo.',
      recheckMinted: 'Slot {{slot}}: nuova bobina registrata. {{grams}} g presunti.',
      recheckIdentified: 'Slot {{slot}}: {{identity}} registrato dal suo tag.',
      recheckIdentifiedUnnamed: 'Slot {{slot}}: tag letto.',
      recheckIdentifiedNoRead: 'Slot {{slot}}: {{identity}} registrato. Rilettura del tag rinviata.',
      recheckQueued: 'Controllo dello slot {{slot}} in coda. La farm leggerà il tag alla prossima finestra di inattività e registrerà la bobina allora.',
      recheckEmpty: 'Lo slot {{slot}} è vuoto. Carica una bobina, poi ricontrolla.',
      recheckRestored: 'Slot {{slot}}: bobina precedente ripristinata.',
      recheckFailed: 'Slot {{slot}}: controllo non riuscito.',
      recheckUndoNoOffer: 'Slot {{slot}}: nessun controllo da annullare.',
      recheckUndoNoPredecessor: 'Slot {{slot}}: nessuna bobina precedente registrata per questo slot.',
      recheckUndoMintGone: 'Slot {{slot}}: la bobina registrata non esiste più.',
      recheckUndoBoundElsewhere: 'Slot {{slot}}: la bobina precedente si trova in un altro vassoio. Nessun ripristino.',
      recheckUndoFailed: 'Slot {{slot}}: ripristino non riuscito. {{detail}}',
    ...
    quarantine: {
      badge: 'In quarantena',
      recover: 'Ripristina e riprendi',
      recoverSuccess: 'Stampante ripristinata — {{count}} serie riprese.',
      recoverError: 'Impossibile ripristinare la stampante',
      recoverTitle: 'Ripristinare e riprendere?',
      recoverMessage: 'Ripristinare "{{name}}"? È una forzatura esplicita che:',
    ...
    phase: {
      ...
      coolingToPlateau: 'Raffreddamento fino al plateau',
      coolingToPlateauHeld: 'Raffreddamento fino al plateau · piatto sollevato',
    ...
    ejectPhase: {
      ...
      uploading: 'Espulsione: caricamento {{pct}} %',
      uploadingNoPct: 'Espulsione: caricamento…',
      sent: 'Espulsione: inviata',
      sweeping: 'Espulsione: rimozione…',
      failed: 'Espulsione non riuscita',
    },
    ...
    ejectNotQualified: "L'espulsione automatica non è ancora qualificata a livello hardware per questo modello — esegui la scala hardware prima dell'uso non presidiato.",
    plateStatus: {
      markCleared: 'Segna il piatto come liberato',
      cleared: 'Piatto libero',
      notCleared: 'Piatto non libero',
      inUse: 'Piatto in uso',
      markClearedCancelsEject: 'Segnare il piatto come liberato annulla l\'espulsione automatica in sospeso.',
      ejectInFlight: 'Espulsione in corso. Usa Ripristina per forzare.',
      markOccupied: 'Segna il piatto come occupato',
      markOccupiedSuccess: 'Piatto segnato come occupato — invio bloccato finché non viene liberato',
      ejectInProgress: 'Espulsione in corso · {{age}}',
      ejectStalled: 'Espulsione bloccata · {{age}} — la farm ha perso traccia della spazzata',
      refusal: 'Controllo del piatto: {{message}}',
    ...
    eject: {
      action: 'Espelli piatto',
      dispatched: 'Espulsione avviata',
      confirmTitle: 'Espellere con il piatto caldo?',
      confirmBodyNoLine: 'Il piatto è a {{bed}} °C, senza lettura dell\'aria dell\'officina né della camera con cui confrontarlo. Espellere ora spazza via il pezzo a questa temperatura. Continuare?',
      confirmBody: 'Il piatto è a {{bed}} °C, oltre la soglia di rilascio di {{threshold}} °C. Espellere ora spazza via il pezzo mentre il piatto è ancora caldo. Continuare?',
      confirm: 'Espelli piatto',
      cancel: 'Annulla',
      foreignPrintNameLabel: 'Stampa',
      foreignUnknownPrint: 'Sconosciuta',
      foreignPartHeightEditLabel: 'Altezza pezzo (mm)',
      foreignProfileLabel: 'Profilo di espulsione',
      foreignSuggested: 'suggerito',
      foreignNoProfiles: 'Nessun profilo di espulsione disponibile',
      foreignConfirm: 'Espelli piatto',
      dialog: {
        foreignTitle: 'Espelli piatto — stampa non avviata dalla farm',
        farmUnitTitle: 'Espelli piatto — {{name}}',
        declaredTitle: 'Espelli piatto',
        body: 'Lo spazzamento viene costruito dall\'altezza pezzo e dal profilo di espulsione qui sotto. Verifica entrambi rispetto al piatto prima di avviare.',
        heightRequired: 'Altezza pezzo sconosciuta. Inserisci il punto più alto del pezzo sul piatto.',
      },
      error: {
        jobActive: 'La stampante sta eseguendo un lavoro. Attendi che finisca o interrompilo, poi espelli.',
        dispatchInFlight: 'Un\'unità in coda è in invio verso questa stampante. Riprova tra qualche secondo.',
        ejectInFlightPending: 'Espulsione inviata {{age}} s fa; in attesa che la stampante la avvii.',
        ejectInFlightPendingNoAge: 'Espulsione già inviata; in attesa che la stampante la avvii.',
        ejectInFlightStarted: 'Espulsione in corso da {{age}} s.',
        ejectInFlightStartedNoAge: 'Espulsione in corso.',
        bedUnreadable: 'Temperatura del piatto non disponibile. Riprova tra qualche secondo.',
        noDonor: 'Nessun file disponibile per costruire l\'espulsione. Segna il piatto come liberato e rimuovi il pezzo a mano.',
        firstArticle: 'Primo pezzo in attesa di approvazione. Approvalo o rifiutalo dalla serie.',
    ...
    rfid: {
      ...
      recheck: 'Ricontrolla slot',
      recheckPending: 'Ricontrollo in sospeso. Si conclude al termine della stampa.',
      recheckQueuedTooltip: 'In coda fino al termine della stampa.',
      restorePreviousRoll: 'Ripristina bobina precedente',
    },
    // AMS load/unload (#891)
    ams: {
      load: 'Carica',
    ...
    permission: {
      ...
      noAmsRfid: 'Non hai il permesso di ricontrollare gli slot AMS',
    ...
    incidentAction: {
      ...
      plate_vision: 'Sistema il piatto, poi riprendi la stampa',
  ...
  archives: {
    ...
    modal: {
      ...
      deleteBlockedByLivePrint: 'Impossibile eliminare — questo archivio registra una stampa in corso. Interrompi la stampa, poi riprova.',
  ...
  queue: {
    ...
    phase: {
      assigned: 'Assegnato',
      uploading: 'Caricamento {{pct}} %',
      uploadingNoPct: 'Caricamento…',
      sent: 'Inviato',
    ...
    permissions: {
      ...
      noReleaseStaged: 'Chiedi a un amministratore della coda di rilasciare questi elementi',
  ...
  settings: {
    ...
    spoolSelectionPolicy: 'Criterio di selezione bobina',
    spoolSelectionPolicyDesc: 'Come il dispatcher e le stampe manuali scelgono una bobina quando corrispondono più slot AMS.',
    spoolPolicyFirstLoaded: 'Caricato per primo (FIFO)',
    spoolPolicyLowestRemaining: 'Minor residuo',
    spoolPolicySlotOrder: 'Ordine slot AMS',
    spoolPolicyBackupNote: 'Minor residuo ha effetto solo se AMS Filament Backup è abilitato sulla stampante — altrimenti la stampante non può passare a una seconda bobina quando quella scelta finisce.',
    minStartSpool: 'Peso minimo bobina per avvio (g)',
    minStartSpoolDesc: 'Una bobina con meno grammi residui di questo valore non può mai AVVIARE una stampa (può comunque completarne una in corso). 0 disabilita la soglia.',
    spoolRecoveryEnabled: 'Recupero automatico degli inceppamenti bobina',
    spoolRecoveryEnabledDesc: 'Quando un errore di alimentazione dell\'AMS (aggrovigliamento) mette in pausa una stampa della farm, passa automaticamente alla bobina idonea successiva e riprende. La bobina inceppata resta fuori rotazione finché non viene reinserita.',
    runoutAutoResumeEnabled: 'Ripresa automatica dopo un rifornimento di filamento',
    runoutAutoResumeEnabledDesc: 'Quando una stampa è in pausa in attesa di filamento in uno slot AMS specifico, riprende automaticamente non appena quello slot viene rifornito. Disattivato = la stampa attende una ripresa manuale.',
    spoolRecoveryMaxAttempts: 'Tentativi di recupero max',
    spoolRecoveryMaxAttemptsDesc: 'Quante bobine provare prima di lasciare la stampa in pausa per una persona (1-5).',
    spoolRecoveryStepTimeout: 'Timeout per passo (secondi)',
    ...
    taglessBrand: 'Marca',
    taglessMaterial: 'Materiale',
    taglessSubtype: 'Sottotipo',
    taglessSubtypeHint: 'Il codice variante Bambu del materiale, ad es. HF = High Flow. Mostrato sull\'etichetta della bobina.',
    taglessColor: 'Colore',
    taglessSlicerFilament: 'Filamento dello slicer (opzionale)',
    taglessSlicerFilamentHint: 'Il nome esatto del preset di filamento usato dal tuo slicer, così le stampe corrispondono al profilo giusto.',
    ...
    deleteUserChecking: 'Verifica di ciò che questa eliminazione rimuoverebbe...',
    deleteUserImpactUnavailable: 'Non è stato possibile verificare cosa rimuoverebbe questa eliminazione. Se elimini comunque, gli elementi di questo utente verranno rimossi senza anteprima.',
    deleteUserArchives_one: '{{count}} archivio di stampa',
    deleteUserArchives_other: '{{count}} archivi di stampa',
    deleteUserLibraryFiles_one: '{{count}} file della libreria',
    deleteUserLibraryFiles_other: '{{count}} file della libreria',
    deleteUserQueueItems_one: '{{count}} elemento in coda',
    deleteUserQueueItems_other: '{{count}} elementi in coda',
    deleteUserProductionRuns_one: '{{count}} tiratura di produzione',
    deleteUserProductionRuns_other: '{{count}} tirature di produzione',
    deleteUserDependentSkus_one: '{{count}} SKU usa un file caricato da questo utente. Quello SKU perderà il file e non potrà essere stampato finché non lo riassegni.',
    deleteUserDependentSkus_other: '{{count}} SKU usano file caricati da questo utente. Quegli SKU perderanno i file e non potranno essere stampati finché non li riassegni.',
    deleteUserPrintingNow_one: '{{count}} unità è in stampa in questo momento. L\'eliminazione verrà rifiutata finché non termina o viene interrotta.',
    deleteUserPrintingNow_other: '{{count}} unità sono in stampa in questo momento. L\'eliminazione verrà rifiutata finché non terminano o vengono interrotte.',
    deleteUserStillPrinting: 'Stampa ancora in corso su {{printers}}. Interrompi quelle stampe o attendi che finiscano, poi elimina.',
    // Smart plugs
    ...
    farmProduction: 'Produzione in farm',
    farmProductionDescription: 'Criteri predefiniti di tentativi e quarantena precompilati nella finestra Avvia serie. Possono essere sovrascritti per ogni serie.',
    farmEjectCooldown: 'Raffreddamento espulsione',
    farmEjectCooldownDescription: 'Come la farm attende che il piatto si raffreddi prima di spazzare via una piastra completata, e quando si arrende o mette in quarantena una stampante che non si raffredda.',
    farmRetryMaxPerUnit: 'Tentativi per piano',
    farmRetryMaxPerUnitHelp: 'Tentativi automatici prima che un piano sia contrassegnato come fallito (0–10)',
    farmEscalateConsecutiveFailures: 'Quarantena dopo i guasti',
    farmEscalateConsecutiveFailuresHelp: 'Guasti consecutivi su una stampante che attivano una quarantena (1–20)',
    farmCooldownMargin: 'Margine sull\'aria dell\'officina (°C)',
    farmCooldownMarginHelp: 'La linea di espulsione e la riduzione della ventola della camera stanno a questo margine sopra l\'aria dell\'officina.',
    shopAir: {
      label: 'Aria dell\'officina',
      ejectLine: 'Linea di espulsione',
      noReading: 'nessuna lettura',
      atPlateau: 'al plateau',
      fresh_one: 'Misurata in {{count}} stampante a riposo, {{minutes}} min fa — leggermente sopra l\'aria ambiente.',
      fresh_other: 'Misurata in {{count}} stampanti a riposo, {{minutes}} min fa — leggermente sopra l\'aria ambiente.',
      carried: 'Riportata dalle {{time}} lungo la curva giornaliera.',
      unknown: 'Nessuna lettura ancora — ogni raffreddamento si sblocca quando il piatto smette di raffreddarsi.',
      readFailed: 'Lettura dell\'aria dell\'officina non riuscita — nuovo tentativo ogni minuto.',
    },
    farmOfflineStallMinutes: 'Stallo offline (min)',
    farmOfflineStallMinutesHelp: 'Segnala un\'unità ancora in stampa la cui stampante è offline da questo tempo — non viene mai terminata, solo segnalata (5–720)',
    farmPauseStallMinutes: 'Stallo in pausa (min)',
    farmPauseStallMinutesHelp: 'Segnala e notifica quando un\'unità in stampa resta in pausa per questo tempo senza ripristino automatico attivo — non annulla mai nulla (5–720)',
    farmCooldownStallWindow: 'Intervallo di controllo raffreddamento (min)',
    farmCooldownStallWindowHelp: 'Ogni quanto verificare che il piatto stia ancora raffreddando prima di un\'espulsione. Due controlli falliti di fila mettono la stampante in quarantena. 0 disattiva il controllo.',
    farmCooldownStallEpsilon: 'Raffreddamento minimo per controllo (°C)',
    farmCooldownStallEpsilonHelp: 'Il piatto deve scendere di almeno questo valore tra un controllo e l\'altro per contare come ancora in raffreddamento.',
    farmCooldownMaxHold: 'Timer di resa (min)',
    ...
    farmCooldownPlateauMarginHelp: 'Se il raffreddamento si blocca ma il piatto è entro questi gradi dall\'aria della sua camera, trattalo come raffreddato ed espelli; se resta più caldo, la stampante va in quarantena.',
    farmCooldownAuxFanEnabled: 'Ventola ausiliaria durante il raffreddamento',
    farmCooldownAuxFanEnabledHelp: 'Fa girare la ventola ausiliaria dalla fine della stampa fino all\'invio dell\'espulsione.',
    farmCooldownAuxFan: 'Velocità della ventola ausiliaria (%)',
    farmCooldownAuxFanHelp: 'Una sola velocità per tutto il raffreddamento (1–100).',
    farmCooldownChamberFanEnabled: 'Ventola della camera durante il raffreddamento',
    farmCooldownChamberFanEnabledHelp: 'Imposta il condotto dell\'aria su raffreddamento e fa girare la ventola di estrazione della camera dalla fine della stampa fino all\'invio dell\'espulsione. I modelli di stampante senza ventola della camera la saltano.',
    farmCooldownChamberFan: 'Velocità di spinta della ventola della camera (%)',
    farmCooldownChamberFanHelp: 'Velocità finché l\'aria della camera resta sopra la temperatura di espulsione (1–100).',
    farmCooldownChamberFanSustain: 'Velocità della ventola della camera dopo la spinta (%)',
    farmCooldownChamberFanSustainHelp: 'Velocità una volta che la camera ha raggiunto la temperatura di espulsione, fino all\'invio dell\'espulsione. 0 ferma lì la ventola. La velocità di raffreddamento camera propria della stampante è 50.',
    ...
    farmIdlePark: 'Parcheggio del piano in inattività',
    ...
    farmPlateBlowoffEnabled: 'Soffiatura del piatto a inizio stampa',
    farmPlateBlowoffEnabledHelp: 'Ventola ausiliaria alla massima velocità sul piatto prima del livellamento del piano.',
    farmPlateBlowoffSeconds: 'Durata della soffiatura (s)',
    farmPlateBlowoffSecondsHelp: 'Tempo di funzionamento della ventola ausiliaria prima del livellamento del piano (3–60).',
    ...
    queueCheckIntervalHelp: 'Con quale frequenza la farm ricontrolla la coda anche quando non è successo nulla. Una rete di sicurezza nel caso in cui un evento in tempo reale venga perso: più basso reagisce prima ma interroga di più (5–300).',
    dispatchKickDebounce: 'Ritardo di raggruppamento raffiche (sec)',
    dispatchKickDebounceHelp: 'Quando accadono più cose contemporaneamente, attendi questo breve momento per raggrupparle in un unico passaggio di invio anziché molti. Più alto raggruppa di più; più basso reagisce più velocemente (0.2–10).',
    usbPreflightFreshWindow: 'Freschezza del controllo USB (sec)',
    usbPreflightFreshWindowHelp: 'Fidati di un recente rapporto "unità USB presente" vecchio fino a questo numero di secondi prima di ricontrollare. Più alto salta i controlli ridondanti; 0 ricontrolla sempre (0–120).',
    usbPreflightMaxWait: 'Attesa massima controllo USB (sec)',
    usbPreflightMaxWaitHelp: 'Quanto attendere un recente rapporto "USB presente" prima di avviare comunque una stampa. Più alto è più prudente; più basso invia prima (0–10).',
    dispatchParallelLimit: 'Avvii stampante simultanei',
    dispatchParallelLimitHelp: 'Quante stampanti possono caricare e avviare contemporaneamente in un passaggio. Più alto svuota una coda grande più velocemente; più basso è più delicato sulla rete (1–10).',
    powerStagger: 'Scaglionamento dell\'alimentazione',
    powerStaggerDescription: 'Libera uno slot di scaglionamento nel momento in cui una stampante smette di assorbire potenza di riscaldamento, invece di attendere sempre l\'intero intervallo. Consente alla stampante successiva di avviarsi prima limitando comunque l\'assorbimento simultaneo.',
    staggerDynamicRelease: 'Libera uno slot quando il piano è caldo',
    staggerDynamicReleaseHelp: 'Quando attivo, la stampante successiva può avviarsi appena l\'attuale finisce di riscaldare il piano, anziché attendere il passaggio dell\'intero intervallo. Quando disattivo, ogni slot attende l\'intero intervallo.',
    staggerReleaseEpsilon: 'Margine a temperatura (°C)',
    staggerReleaseEpsilonHelp: 'Quanto vicino alla temperatura target del piano conta come "abbastanza caldo" per liberare lo slot in anticipo. Più grande libera prima la stampante successiva.',
    staggerHeatupGrace: 'Tolleranza di riscaldamento (secondi)',
    staggerHeatupGraceHelp: 'Se una stampante non ha ancora iniziato a riscaldare il piano, attendi questo tempo prima di liberare comunque il suo slot, così una stampante inattiva non blocca il lotto.',
    ...
    erp: {
      title: 'Accesso alla directory ERP',
      statusActive: 'Accesso ERP: attivo',
      statusInactive: 'Accesso ERP: non configurato',
      activeDesc: 'Gli operatori possono accedere con le loro credenziali della directory ERP.',
      inactiveDesc: 'Aggiungi e salva i dettagli di connessione qui sotto per attivare l’accesso ERP.',
      disableHint: 'Per disattivare l’accesso ERP, cancella l’host e il nome del database qui sotto, quindi salva.',
      connectionConfig: 'Connessione alla directory ERP',
      ...
      ssl: 'Connetti tramite TLS',
      sslHint: 'Richiedi una connessione crittografata al database ERP.',
      roleMapping: 'Mappatura dei ruoli',
      roleMappingHint: 'Assegna un gruppo BamBuddy a ogni ruolo ERP.',
      roleMappingNoGroup: '— Nessun gruppo —',
      roleMappingGroupFor: 'Gruppo BamBuddy per {{role}}',
      settingsSaved: 'Impostazioni della directory ERP salvate',
      errors: {
        hostRequired: 'L’host del database è obbligatorio',
        databaseRequired: 'Il nome del database è obbligatorio',
      },
    },
    oidc: {
      ...
      form: {
        ...
        groupsClaim: 'Claim dei gruppi',
        groupsClaimDesc: 'Claim del token che contiene i valori di gruppo o ruolo dell’utente. Lascia vuoto per disattivare la sincronizzazione dei gruppi di questo provider.',
        groupsClaimPlaceholder: 'gruppi',
        groupMapping: 'Mappatura dei gruppi',
        groupMappingDesc: 'Associa ogni valore del claim a un gruppo BamBuddy. Gli utenti corrispondenti ricevono il gruppo associato all’accesso.',
        groupMappingNone: 'Nessuna mappatura configurata.',
        groupMappingClaimValue: 'Valore del claim',
        groupMappingGroup: 'Gruppo BamBuddy',
        groupMappingSelectGroup: 'Seleziona gruppo',
        groupMappingRemove: 'Rimuovi mappatura',
        groupMappingAdd: 'Aggiungi mappatura',
  ...
  hmsErrors: {
    ...
    unknownDescription: 'Errore stampante sconosciuto — non presente nel database dei codici noti. Controlla questo codice sulla wiki Bambu.',
    severity: {
      fatal: 'Critico',
      serious: 'Grave',
      warning: 'Avviso',
  ...
  fileManager: {
    ...
    createSkuFromUploadToast: '{{filename}} caricato — creare una SKU da esso?',
    createSkuFromUploadAction: 'Crea SKU da questo file',
    ...
    deleteFolderConfirm: 'Sei sicuro di voler eliminare questa cartella? I file al suo interno vengono spostati nel cestino e possono essere ripristinati nella root; la cartella viene eliminata definitivamente.',
    deleteFileConfirm: 'Sei sicuro di voler eliminare questo file?',
    deleteFilesConfirm: 'Sei sicuro di voler eliminare {{count}} file selezionati? Vengono spostati nel cestino e possono essere ripristinati.',
  ...
  inventory: {
    ...
    freshRoll: {
      ...
      reviewAction: 'Rivedi…',
      title: 'Nuova bobina su questo slot?',
      message: 'La bobina senza tag in {{location}} è stata usata per la maggior parte del suo peso nominale. Se ora è caricata una bobina nuova, registrala così il tracciamento del filamento resta preciso.',
      confirm: 'Nuova bobina',
      pending: 'Registrazione…',
      success: 'Nuova bobina registrata',
      failed: 'Impossibile registrare la nuova bobina',
      dismissFailed: 'Impossibile chiudere la richiesta di nuova bobina',
      remaining: '{{grams}} g registrati come rimanenti',
      brandLabel: 'Marca',
      brandPlaceholder: 'es. Overture',
      weightLabel: 'Peso nominale (g)',
      weightPlaceholder: 'es. 1000',
      costLabel: 'Costo / kg',
      costPlaceholder: 'Opzionale',
      noteLabel: 'Nota',
      notePlaceholder: 'Opzionale',
      manualDesc: 'Chiudere questa scheda e aprirne una nuova',
      manualTitle: 'Contrassegnare come bobina nuova?',
      manualMessage: 'Chiude la scheda di {{location}} ({{grams}} g consumati) e ne apre una nuova e piena per questo slot. Farlo solo dopo aver sostituito fisicamente la bobina.',
      manualConfirm: 'Contrassegna come bobina nuova',
    },
    respool: {
      title: 'Riassegnare questo tag?',
      manualTitle: 'Spostare questo tag su una bobina nuova?',
      manualMessage: 'Ritira il record in {{location}} ({{grams}} g usati) e sposta il suo tag Bambu su una bobina nuova piena. Fallo solo dopo aver sostituito fisicamente la bobina.',
      message: 'È stato rilevato un tag Bambu riutilizzato in {{location}}. Se ora si trova su una bobina di terze parti nuova, riassegnalo a una scheda piena.',
      confirm: 'Riassegnata — bobina nuova',
      pending: 'Riassegnazione…',
      success: 'Riassegnata a una nuova bobina {{brand}}',
      failed: 'Impossibile riassegnare il tag',
      autoToast: '{{brand}} riassegnata automaticamente su {{printer}} slot {{slot}}',
      reusedTagToast: 'Possibile bobina nuova su un tag riutilizzato — {{printer}} slot {{slot}}',
      ...
      triggerSpent: 'Questa bobina ha segnalato la fine del filamento e da allora lo slot è stato gestito.',
      triggerRemainJump: 'L\'AMS segnala molto più filamento di quanto risulti da questa scheda — sembra che il tag sia passato su una bobina ricaricata.',
      sameSpoolAction: 'Stessa bobina',
      reviewAction: 'Rivedi…',
      dismissFailed: 'Impossibile chiudere la richiesta di riassegnazione',
      donorLine: 'Sostituisce la bobina tracciata (rimangono {{grams}} g); il vecchio record viene archiviato',
      donorRecordTitle: 'Scheda n. {{id}}',
      detailsLabel: 'Dettagli',
      tagIdLabel: 'ID tag',
      warning: 'Usa un SOLO tag per bobina di origine — scarta il secondo tag.',
      brandLabel: 'Marca',
      brandPlaceholder: 'es. Overture',
      weightLabel: 'Peso nominale (g)',
      weightPlaceholder: 'es. 1000',
    ...
    returnToRotation: 'Rimetti in rotazione',
    returnToRotationDone: 'Bobina rimessa in rotazione',
    returnToRotationFailed: 'Impossibile rimettere la bobina in rotazione',
  ...
  ams: {
    ...
    slotDialogLabel: 'Slot {{slot}} di {{ams}}: {{content}}',
    slotBoundPresenceUnknown: '{{printer}}: lo slot {{slot}} di {{ams}} non risponde — impossibile confermare che la bobina associata sia ancora presente. Controlla lo slot.',
    slotSpentSwapPark: '{{printer}}: lo slot {{slot}} di {{ams}} è occupato da una bobina esaurita e nulla può liberarlo. Ricontrolla lo slot oppure sostituisci la bobina.',
    ...
    emptySlotBinding: {
      ...
      unassignAria: 'Scollega {{spool}} da questo slot',
      unassignTitle: 'Annullare l’assegnazione di questa bobina?',
      unassignMessage: 'Libera {{spool}} da questo slot. La bobina torna in inventario con il consumo registrato intatto: non viene eliminato nulla.',
    },
    unknown: 'Sconosciuto',
    humidity: 'Umidità',
    temperature: 'Temperatura',
  ...
  printModal: {
    ...
    customSlotMapping: 'Mappatura slot personalizzata',
    reread: 'Rileggi',
    requiredTooltip: 'Richiesto: {{type}} - {{color}}',
    manuallySelected: 'Selezionato manualmente',
    autoMatched: 'Abbinato automaticamente',
    externalSlotNote: 'Bobina esterna: nessun monitoraggio del peso; la stampante chiederà filamento sul supporto.',
    selectSlot: '-- Seleziona slot --',
    noActivePrintersAvailable: 'Nessuna stampante attiva disponibile',
    specificPrinter: 'Stampante specifica',
    anyModel: 'Qualsiasi {{model}}',
    modelFallback: 'Modello',
    targetModelLabel: 'Modello di destinazione',
    selectModelPlaceholder: 'Seleziona un modello...',
    locationFilter: 'Filtro posizione (opzionale)',
    anyLocation: 'Qualsiasi posizione',
    schedulerAssignHint: 'Lo scheduler assegnerà alla prima stampante {{model}} inattiva disponibile',
    schedulerAssignHintLocation: 'Lo scheduler assegnerà alla prima stampante {{model}} inattiva disponibile in {{location}}',
    selectPrinters: 'Seleziona stampanti',
    printersSelected_one: '{{count}} stampante selezionata',
    printersSelected_other: '{{count}} stampanti selezionate',
    selectAll: 'Seleziona tutto',
    inactive: '(inattiva)',
    unknownModel: 'Modello sconosciuto',
    customMapping: 'Mappatura personalizzata',
    matchedCount: '({{matched}}/{{total}} abbinati)',
    autoButton: 'Auto',
    hiddenPrinters_one: '{{count}} altra stampante nascosta (modello diverso) —',
    hiddenPrinters_other: '{{count}} altre stampanti nascoste (modello diverso) —',
    showAll: 'mostra tutto',
    showOnlyModelPrinters: 'Mostra solo stampanti {{model}}',
    selectAtLeastOnePrinter: 'Seleziona almeno una stampante',
    selectTargetModel: 'Seleziona un modello di stampante di destinazione',
    typeNotFound: '(Tipo non trovato)',
    colorMismatch: '(Colore non corrispondente)',
    ready: '(Pronto)',
    clickToChangeSlot: 'Fai clic per cambiare l\'assegnazione degli slot',
    costNotAvailable: 'N/D',
    requiredTypeNotFound: 'Tipo di filamento richiesto non trovato nella stampante.',
    printJob: 'Lavoro di stampa',
    slicedModelMismatch: 'Il file è stato slicato per {{slicedModel}}, ma stampato su {{printerModel}}',
    archiveDataUnavailable: 'Dati dell\'archivio non disponibili. Il file di origine potrebbe essere stato eliminato. La mappatura dei filamenti è disattivata.',
    failedToComplete: 'Impossibile completare l\'operazione',
    toastQueueItemUpdated: 'Elemento della coda aggiornato',
    toastUpdateFailed: 'Impossibile aggiornare l\'elemento della coda',
    toastSelectPrinter: 'Seleziona almeno una stampante',
    toastSelectModel: 'Seleziona un modello di stampante di destinazione',
    toastQueuedForModel: 'In coda per qualsiasi {{model}}',
    ejectFromSku: 'Predefinito da SKU {{code}}',
    partialFailureTitle: '{{failed}} invii su {{total}} non riusciti:',
    toastPartialSuccess: '{{success}} riuscite, {{failed}} non riuscite',
    printerFallback: 'Stampante {{id}}',
    slotFallback: 'Alloggiamento {{id}}',
    plateFallback: 'Piatto {{index}}',
  },
  ...
  uploadModal: {
    ...
    libraryHint: 'Per gli SKU e i cicli di produzione, carica invece nel Gestore file.',
    libraryHintLink: 'Vai al Gestore file →',
    uploaded: 'caricati',
    failed: 'falliti',
    uploading: 'Caricamento...',
    upload: 'Carica',
  ...
  notifications: {
    ...
    events: {
      farm: {
        sectionTitle: 'Produzione della farm',
      },
    },
    firstArticlePending: 'Primo articolo in attesa',
    firstArticleApproved: 'Primo articolo approvato',
    runPaused: 'Serie in pausa',
    runResumed: 'Serie ripresa',
    runCompleted: 'Serie completata',
    runAborted: 'Serie annullata',
    printerQuarantined: 'Stampante in quarantena',
    foreignJobDetected: 'Lavoro esterno rilevato',
    modelMismatch: 'Modello non corrispondente',
    runUnitStopped: 'Unità arrestata',
    printStalled: 'Stampa bloccata',
    storageLow: 'Spazio USB quasi esaurito',
    cooldownEscalation: 'Raffreddamento prolungato',
    // Quiet hours
    quietHours: 'Ore silenziose',
  ...
  fleetMetrics: {
    tabs: {
      ariaLabel: 'Viste delle statistiche',
      prints: 'Stampe',
      fleet: 'Parco',
    },
    sections: {
      fleet: 'Parco',
      matrix: 'Matrice del parco',
      stateOverTime: 'Stato delle stampanti nel tempo',
      printsPerDay: 'Stampe al giorno',
      downtimeByCause: 'Fermo macchina per causa',
      coolingAndEject: 'Raffreddamento ed espulsione',
      recovery: 'Ripristino',
      partsBySku: 'Pezzi per SKU',
    },
    summary: {
      now: 'Adesso',
      trend: 'Andamento',
      trendOf: 'Andamento: {{metric}}',
      ...
      period: {
        ...
        thisYear: 'Quest’anno',
        allTime: 'Dall’inizio',
        custom: 'Intervallo selezionato',
      },
      rows: {
        avg_printing: 'In stampa',
        avg_cycle_overhead: 'Fra una stampa e l’altra',
        avg_idle: 'Inattive',
        avg_down: 'Ferme',
        avg_planned: 'Manutenzione',
        peak_down: 'Picco di ferme',
        printers_in_fleet: 'Nel parco',
        prints_per_day: 'Stampe',
        prints_per_printer_per_day: 'Stampe per stampante',
        uptime: 'Tempo operativo',
        time_printing: 'Tempo di stampa',
      },
      peak: 'picco {{count}}',
      downNow: 'Ferme adesso',
      nothingDown: 'Nessuna ferma',
      showFewer: 'Mostra meno',
      updated: 'Aggiornato {{time}}',
      stale: 'Stato vecchio di {{age}}',
      openPrinter: 'Apri stampante',
    },
    class: {
      cycle_overhead: 'Fra una stampa e l’altra',
      cooling: 'Raffreddamento',
      ejecting: 'Espulsione',
      down: 'Ferma',
      planned: 'Manutenzione',
      out_of_fleet: 'Disattivata',
    ...
    matrix: {
      ...
      lens: {
        ...
        timeSplit: 'Ripartizione del tempo',
      },
      columns: {
        printer: 'Stampante',
        total: 'Totale',
      ...
      showDays: 'Mostra i giorni',
      hideDays: 'Nascondi i giorni',
      sortBy: 'Ordina per {{column}}',
      caption: '{{lens}} in base alla stampante, dal {{from}} al {{to}}',
      captionDay: '{{lens}} in base alla stampante, {{date}}',
      details: 'Dettagli',
    ...
    detail: {
      ...
      timeSplit: 'Ripartizione del tempo',
      classes: 'Impiego del tempo',
      printsByOutcome: 'Stampe per esito',
      outcome: {
      ...
      incidents: 'Eventi',
      openPrinter: 'Apri stampante',
      noIntervals: 'Nessun intervallo registrato per questo periodo.',
      noIncidents: 'Nessun evento in questo periodo.',
      noPrints: 'Nessuna stampa in questo periodo.',
      ongoing: 'In corso',
    },
    widgets: {
      showData: 'Mostra i dati',
      showChart: 'Mostra il grafico',
      showDataFor: 'Mostra i dati di {{chart}}',
      showChartFor: 'Mostra il grafico di {{chart}}',
      median: 'Mediana',
      p90: 'P90',
      overExpected: 'oltre il previsto',
      count: 'Conteggio',
      variant: {
      ...
      clearedNoPerson: 'Risolto senza intervento',
      inFleetLine: 'Nel parco',
      peakDownLine: 'Picco di ferme',
      sku: 'SKU',
      units: 'Unità',
      plates: 'Piani',
    ...
    states: {
      loading: 'Caricamento…',
      loadFailed: 'Impossibile caricare lo storico del parco.',
      retry: 'Riprova',
      empty: 'Nessun dato per questo intervallo.',
      recordingGap: 'Registrazione dello stato delle stampanti dal {{date}}. Storico di guasti e manutenzione dal {{earliest}}.',
    },
    header: {
    ...
    hints: {
      ...
      cycle_overhead: 'Il lavoro proprio della farm fra una stampa e l’altra: raffreddare il piano, poi spazzare via il pezzo.',
      planned: 'Modalità manutenzione: una persona ha tolto la stampante dai flussi automatici.',
      uptime: 'Quota del tempo conteggiato in cui la stampante poteva accettare lavoro.',
      time_printing: 'Quota del tempo conteggiato in cui la stampante stava stampando.',
      prints_per_printer: 'Stampe completate divise per i giorni conteggiati di ciascuna stampante. I giorni conteggiati provengono solo dagli intervalli registrati, quindi il valore non è confrontabile con «Stampe» finché una parte del periodo non è registrata.',
      unobserved: 'Per questo tratto non è stato registrato nulla: si conoscono solo guasti e fermi dichiarati.',
      not_recorded: 'Precedente al primo stato mai registrato per questa stampante.',
      incidents_only: 'Qui non è stato registrato alcuno stato: il periodo è coperto solo dal registro di guasti e manutenzione.',
      whileRecorded: 'I valori del periodo coprono solo il tempo registrato.',
      timeframeFleet: 'I giorni vanno da mezzanotte a mezzanotte in {{tz}}.',
      timeframePrints: 'I giorni vanno da mezzanotte a mezzanotte UTC.',
    },
  },
};
