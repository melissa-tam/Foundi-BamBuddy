export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      cooldownRetries: 'Tentativi di raffreddamento',
    ...
    tooltips: {
      ...
      cooldownRetries: 'Quante volte ricontrollare la temperatura del piatto mentre si attende che raggiunga il valore obiettivo prima di rinunciare.',
  ...
  printers: {
    ...
    phase: {
      printing: 'In stampa',
      cooling: 'Raffreddamento fino a {{threshold}}°C (piatto {{bed}}°C) — la spazzata è nel file',
  ...
  settings: {
    ...
    farmRetryMaxPerUnitHelp: 'Tentativi automatici prima che un piano sia contrassegnato come fallito (0–5)',
    farmEscalateConsecutiveFailures: 'Quarantena dopo i guasti',
    farmEscalateConsecutiveFailuresHelp: 'Guasti consecutivi su una stampante che attivano una quarantena (1–10)',
