export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      bedDropHelp: 'Dopo che la testa si è sollevata sopra il pezzo, il piatto si abbassa quasi fino al fondo della macchina e risale per staccare il pezzo con uno scossone prima della spazzata.',
    ...
    tooltips: {
      ...
      bedDrop: 'Dopo che il sollevamento ha liberato il pezzo, il piatto riscaldato scende quasi fino al punto più basso e risale; lo scossone stacca un pezzo incollato prima della spazzata. Richiede una corsa Z registrata per il modello.',
