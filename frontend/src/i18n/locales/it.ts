export default {
  ...
  fleetMetrics: {
    ...
    matrix: {
      ...
      caption: '{{lens}} per stampante, dal {{from}} al {{to}}',
      details: 'Dettagli',
    ...
    states: {
      ...
      firstRun: 'Registrazione dello stato delle stampanti dal {{date}}. Storico di guasti e manutenzione dal {{earliest}}.',
    },
    header: {
    ...
    hints: {
      ...
      prints_per_printer: 'Stampe completate divise per i giorni conteggiati di ciascuna stampante.',
