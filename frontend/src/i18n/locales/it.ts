export default {
  ...
  printers: {
    ...
    eject: {
      ...
      foreignTitle: 'Espellere una stampa esterna?',
      foreignBody: 'Questa stampa non è stata avviata dalla farm. Lo spazzamento usa il profilo di espulsione selezionato qui sotto — correggi l\'altezza del pezzo se il valore rilevato è errato.',
