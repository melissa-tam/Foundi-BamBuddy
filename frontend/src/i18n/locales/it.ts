export default {
  ...
  printers: {
    ...
    quarantine: {
      badge: 'In quarantena',
      clear: 'Rimuovi quarantena',
      cleared: 'Quarantena rimossa',
      clearTitle: 'Rimuovere la quarantena?',
      clearMessage: 'Revocare la quarantena di "{{name}}"? Lo scheduler riprenderà a inviare stampe a questa stampante.',
      clearMessageWithReason: 'Revocare la quarantena di "{{name}}"? Motivo: {{reason}}. Lo scheduler riprenderà a inviare stampe a questa stampante.',
    },
    plateStatus: {
