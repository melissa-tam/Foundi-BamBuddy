export default {
  ...
  settings: {
    ...
    ejectUploadSkipIdentical: 'Riutilizza i file di espulsione già presenti sull\'unità USB',
    ejectUploadSkipIdenticalHelp: 'Salta il ricaricamento di un file di espulsione quando quello identico è già sull\'unità USB della stampante, risparmiando qualche secondo per espulsione.',
    ejectUploadSkipIdenticalWarning: 'Attiva solo dopo che la sonda di espulsione dal vivo ha confermato che il file sull\'unità viene riutilizzato correttamente. In caso di dubbio, lascia disattivato: un nuovo caricamento garantisce sempre il file giusto.',
    ejectSlim3mf: 'Snellisci i file di espulsione',
    ejectSlim3mfHelp: 'Rimuovi il modello 3D e l\'immagine di anteprima dai file di espulsione così da caricarli più velocemente: il movimento di espulsione stesso resta invariato.',
    ejectSlim3mfWarning: 'Vincolato all\'hardware: esegui l\'intera scala hardware di espulsione con i file snelliti prima di attivarlo per la produzione non presidiata. Lascia disattivato finché quella scala non è superata.',
