export default {
  ...
  productionRuns: {
    ...
    fields: {
      ...
      cooldownOverride: 'Override raffreddamento (°C)',
      cooldownPlaceholder: 'Usa predefinito del profilo',
      cooldownProfileDefault: 'Sostituisce il valore del profilo: {{value}}°C',
  ...
  ejectProfiles: {
    ...
    fields: {
      name: 'Nome',
      cooldownTemp: 'Temperatura di raffreddamento (°C)',
    ...
    tooltips: {
      ...
      cooldownTemp: 'Temperatura del piatto a cui la stampa deve raffreddarsi prima della spazzata – i pezzi si staccano dal piatto quando sono freddi.',
    ...
    geometry: {
      ...
      cooldownAmbientTrap: "Sotto la soglia di avviso di raffreddamento ({{floor}} °C). Una soglia pari o inferiore alla temperatura ambiente dell'officina non può mai essere raggiunta e l'attesa di espulsione resterebbe bloccata per sempre — impostala un paio di gradi sopra l'ambiente.",
    ...
    queueHelp: 'Il pezzo viene spinto via dopo che il piano si raffredda sotto la soglia del profilo.',
  },
  // Navigation
  nav: {
    printers: 'Stampanti',
  ...
  settings: {
    ...
    farmCooldownWarnFloor: 'Soglia di avviso raffreddamento (°C)',
    farmCooldownWarnFloorHelp: "Avvisa quando la soglia di raffreddamento di un profilo di espulsione è inferiore — una soglia pari o inferiore all'ambiente dell'officina non si completa mai (15–50)",
