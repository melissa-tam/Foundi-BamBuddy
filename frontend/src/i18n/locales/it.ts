export default {
  ...
  skus: {
    ...
    suggest: {
      title: 'Suggerisci da file',
      description: 'Scegli un file elaborato per precompilare codice, numero parte e nome dai suoi metadati.',
      file: 'File della libreria',
      filePlaceholder: 'Seleziona un file…',
      action: 'Suggerisci',
      applied: 'Dati compilati da {{source}}',
  ...
  settings: {
    ...
    autoAddUntaggedDesc: 'Crea automaticamente una bobina di inventario per i vassoi AMS privi di tag RFID. Disattiva se preregistri le bobine manualmente per evitare duplicati.',
    ...
    farmCooldownStallWindow: 'Finestra di stallo raffreddamento (min)',
    farmCooldownStallWindowHelp: 'Durante il raffreddamento di espulsione il piatto deve continuare a raffreddarsi; due finestre consecutive senza progresso mettono la stampante in quarantena (0 disattiva)',
    farmCooldownStallEpsilon: 'Raffreddamento min. per finestra (°C)',
    farmCooldownStallEpsilonHelp: 'Raffreddamento minimo (°C) per finestra che conta come progresso',
    farmCooldownMaxHold: 'Attesa max. raffreddamento (min)',
    farmCooldownMaxHoldHelp: 'Dopo questi minuti sopra la soglia di rilascio l\'espulsione parte comunque (0 = attendi la soglia indefinitamente)',
    farmCooldownPlateauMargin: 'Margine di espulsione plateau (°C)',
    farmCooldownPlateauMarginHelp: 'Se il raffreddamento si stabilizza entro questi °C dalla soglia di rilascio, espelli (il piano è a temperatura ambiente) invece di mettere in quarantena. Oltre soglia + margine il piano è davvero bloccato caldo e la stampante viene messa in quarantena',
  ...
  inventory: {
    ...
    respool: {
      ...
      donorLine: 'Scheda attuale n. {{id}} — {{grams}} g rimasti — verrà archiviata',
