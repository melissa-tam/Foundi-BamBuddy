export default {
  ...
  printers: {
    ...
    eject: {
      ...
      foreignBody: 'Questa stampa non è stata avviata dalla farm (è stata inviata manualmente da Bambu Studio). Lo spazzamento userà il profilo di espulsione selezionato qui sotto — verifica prima che l\'altezza del pezzo rilevata sia corretta.',
      foreignPrintNameLabel: 'Stampa',
      foreignUnknownPrint: 'Sconosciuta',
      foreignPartHeightLabel: 'Altezza pezzo rilevata',
