export default {
  ...
  productionRuns: {
    ...
    fields: {
      ...
      cooldownOverride: 'Anular enfriamiento (°C)',
      cooldownPlaceholder: 'Usar predeterminado del perfil',
      cooldownProfileDefault: 'Anula el valor del perfil: {{value}}°C',
  ...
  ejectProfiles: {
    ...
    fields: {
      name: 'Nombre',
      cooldownTemp: 'Temperatura de enfriamiento (°C)',
    ...
    tooltips: {
      ...
      cooldownTemp: 'Temperatura de la cama a la que debe enfriarse la impresión antes del barrido – las piezas se sueltan de la placa al enfriarse.',
    ...
    geometry: {
      ...
      cooldownAmbientTrap: 'Por debajo del umbral de aviso de enfriamiento ({{floor}} °C). Un umbral igual o inferior a la temperatura ambiente del taller nunca puede alcanzarse y la espera de expulsión se bloquearía para siempre — configúralo un par de grados por encima del ambiente.',
    ...
    queueHelp: 'La pieza se barre después de que la cama se enfríe por debajo del umbral del perfil.',
  },
  // Navigation
  nav: {
    printers: 'Impresoras',
  ...
  settings: {
    ...
    farmCooldownWarnFloor: 'Umbral de aviso de enfriamiento (°C)',
    farmCooldownWarnFloorHelp: 'Avisar cuando el umbral de enfriamiento de un perfil de expulsión esté por debajo — un umbral igual o inferior al ambiente del taller nunca se completa (15–50)',
