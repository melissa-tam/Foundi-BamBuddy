export default {
  ...
  printers: {
    ...
    eject: {
      ...
      foreignTitle: '¿Expulsar una impresión externa?',
      foreignBody: 'Esta impresión no fue enviada por la granja. El barrido usa el perfil de expulsión que selecciones abajo — corrige la altura de pieza si el valor detectado es incorrecto.',
