export default {
  ...
  printers: {
    ...
    eject: {
      ...
      foreignBody: 'Esta impresión no fue enviada por la granja (se envió manualmente desde Bambu Studio). El barrido usará el perfil de expulsión que selecciones abajo; comprueba primero que la altura de pieza detectada sea correcta.',
      foreignPrintNameLabel: 'Impresión',
      foreignUnknownPrint: 'Desconocida',
      foreignPartHeightLabel: 'Altura de pieza detectada',
