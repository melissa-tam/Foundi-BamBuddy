export default {
  // Catálogo de SKU (producción de granja, fase 2)
  skus: {
    nav: 'Referencias',
    title: 'Catálogo de SKU',
    description: 'Códigos de piezas vendibles, cada uno vinculando una o más placas de archivos de biblioteca más un perfil de expulsión predeterminado para las tandas de producción.',
    newSku: 'Nuevo SKU',
    loadError: 'No se pudieron cargar los SKU.',
    empty: {
      title: 'Aún no hay SKU',
      body: 'Cree su primer SKU para vincular archivos imprimibles y seguir la producción.',
    },
    columns: {
      files: 'Archivos',
      unitsCompleted: 'Unidades totales',
      successRate: 'Éxito',
    },
    createTitle: 'Crear SKU',
    editTitle: 'Editar SKU',
    fields: {
      code: 'Código',
      name: 'Nombre',
      partNumber: 'Número de pieza',
      notes: 'Notas',
      defaultEjectProfile: 'Perfil de expulsión predeterminado',
      noEjectProfile: 'Ninguno',
    },
    codeRequired: 'El código es obligatorio.',
    nameRequired: 'El nombre es obligatorio.',
    created: 'SKU creado',
    updated: 'SKU actualizado',
    deleted: 'SKU eliminado',
    saveFailed: 'No se pudo guardar el SKU',
    deleteFailed: 'No se pudo eliminar el SKU',
    deleteTitle: '¿Eliminar este SKU?',
    deleteBody: '"{{code}}" se eliminará permanentemente. Esto no se puede deshacer.',
    suggest: {
      appliedFromObjectName: 'Datos rellenados a partir de los nombres de las piezas del archivo',
      appliedFromFilename: 'Datos rellenados a partir del nombre del archivo',
      appliedGeneric: 'Datos rellenados desde el archivo',
      failed: 'No se pudieron sugerir los datos',
    },
    files: {
      title: 'Archivos vinculados',
      empty: 'Aún no hay archivos vinculados.',
      willLinkOnSave: 'El archivo se vinculará cuando cree el SKU.',
      file: 'Archivo',
      filePlaceholder: 'Seleccione un archivo…',
      plate: 'Placa',
      unitsPerPlate: 'Unidades por placa',
      plateUnits: 'Placa {{plate}} · {{units}} por placa',
      add: 'Añadir archivo',
      added: 'Archivo vinculado',
      addFailed: 'No se pudo vincular el archivo',
      savedButLinkFailed: 'El SKU se guardó, pero no se pudo vincular el archivo: {{reason}}',
      remove: 'Quitar',
      removed: 'Archivo desvinculado',
      removeFailed: 'No se pudo desvincular el archivo',
      removeTitle: '¿Desvincular este archivo?',
      removeBody: '"{{name}}" se desvinculará de este SKU.',
    },
  },

  // Tandas de producción (producción de granja, fase 2)
  productionRuns: {
    nav: 'Producción',
    title: 'Tandas de producción',
    description: 'Distribuya copias de un SKU entre las impresoras hasta alcanzar un número objetivo de unidades, con progreso en vivo.',
    loadError: 'No se pudieron cargar las tandas de producción.',
    empty: {
      title: 'Aún no hay tandas de producción',
      body: 'Inicie una tanda para imprimir un SKU hasta un número objetivo de unidades.',
      noSkus: 'Añada un SKU con al menos un archivo vinculado antes de iniciar una tanda.',
    },
    startTitle: 'Iniciar tanda de producción',
    startAction: 'Iniciar tanda',
    runAgain: 'Ejecutar de nuevo',
    advanced: 'Avanzado',
    starting: 'Iniciando…',
    started: 'Tanda de producción iniciada',
    startFailed: 'No se pudo iniciar la tanda',
    noFiles: 'Este SKU no tiene archivos vinculados para imprimir.',
    fileRequired: 'Seleccione un archivo para imprimir.',
    targetRequired: 'Introduzca un objetivo de al menos 1 unidad.',
    printerRequired: 'Seleccione al menos una impresora.',
    overProduction: 'Producirá {{planned}} unidades ({{plates}} placas): {{extra}} más que el objetivo de {{target}}.',
    fields: {
      sku: 'SKU',
      file: 'Archivo / placa',
      filePlaceholder: 'Seleccione un archivo…',
      plateUnits: 'placa {{plate}}, {{units}}/placa',
      ...
      skuNoFile: '— sin archivo vinculado',
      skuNoFileHint: 'Vincula un archivo a un SKU en la página de SKU para poder iniciarlo.',
    },
    status: {
      active: 'Activa',
      paused: 'En pausa',
    ...
    platesProgress: '{{completed}} / {{total}} placas',
    stats: {
      units: 'Unidades',
      target: 'Objetivo',
      failed: 'Fallidas',
    ...
    resume: 'Reanudar',
    abort: 'Cancelar',
    paused: 'Tanda en pausa',
    resumed: 'Tanda reanudada',
    aborted: 'Tanda cancelada',
    actionFailed: 'La acción falló',
    startNow: 'Iniciar ahora',
    startedNow: 'Ejecución iniciada',
    reschedule: 'Reprogramar',
    rescheduleTitle: 'Reprogramar hora de inicio',
    rescheduled: 'Hora de inicio actualizada',
    schedule: {
      sectionTitle: 'Hora de inicio',
      whenToStart: 'Cuándo iniciar',
      asap: 'Iniciar cuanto antes',
      later: 'Programar para más tarde',
      date: 'Fecha',
      time: 'Hora',
      openCalendar: 'Abrir calendario',
      pastError: 'Elige una hora futura.',
      invalidError: 'Introduce una fecha y hora válidas.',
      helpAsap: 'La ejecución comienza en cuanto haya una impresora disponible.',
      helpScheduled: 'La ejecución comienza a la hora elegida si hay una impresora libre; de lo contrario, espera hasta que una lo esté.',
      startsIn: 'Comienza {{when}}',
    },
    viewDetails: 'Ver detalles de la serie',
    blockedPrinters: 'Impresora bloqueada',
    pauseReason: {
      operator: 'Pausada por el operador',
    ...
    detail: {
      back: 'Todas las series de producción',
      loadError: 'No se pudo cargar esta serie de producción.',
      notFound: 'Serie de producción no encontrada.',
      printersTitle: 'Impresoras',
      noPrinters: 'Aún no hay impresoras asignadas — el planificador elige una impresora libre compatible por unidad.',
      unitsTitle: 'Unidades',
      ...
      retryOf: 'Reintento n.º {{count}} de la unidad {{id}}',
      unitStatus: {
        pending: 'Pendiente',
      ...
      waiting: {
        ...
        visionHold: 'En pausa en la comprobación de la cama — corrija la cama y luego reanude',
        ...
        externalFeedFault: 'La bobina externa no avanza — revisa el soporte y el tubo PTFE, luego reanuda en la impresora',
        pinnedTrayUnavailable: 'La ranura fijada no está cargada en esta impresora — cárgala o quita la fijación',
        startSpoolBelowMinimum: 'La bobina asignada está por debajo del peso mínimo de inicio',
        filamentUnreadPending: 'Filamento sin leer: leyendo la bobina colocada',
        no_usb_drive: 'No hay unidad USB en la impresora — inserte una unidad USB-A (FAT32/exFAT)',
        libraryFileMissing: 'Falta el archivo de origen en la biblioteca — restaure el archivo o vuelva a subirlo',
      ...
      printerState: {
        ...
        stalled: 'Sin conexión a mitad de impresión',
        visionHold: 'Retenida en la comprobación de la cama',
        filamentShort: 'Filamento insuficiente',
        noUsbDrive: 'Sin unidad USB',
      },
      eligibility: {
        title: 'Impresoras que no participan',
        description: 'Estas impresoras no tomarán unidades de esta tanda hasta que se resuelva:',
        offline: 'Sin conexión',
        quarantined: 'En cuarentena',
        awaitingPlateClear: 'Cama sin despejar',
        modelMismatch: 'Modelo no coincide',
        filamentShort: 'Filamento insuficiente',
        noUsbDrive: 'Sin unidad USB',
      },
    },
    abortTitle: '¿Cancelar esta tanda?',
    abortBody: '"{{name}}" se cancelará. Las placas en curso terminan pero no se inician nuevas placas. Esto no se puede deshacer.',
    delete: 'Eliminar',
    deleted: 'Tanda eliminada',
    ...
    firstArticle: {
      ...
      requireHelp: 'La primera pieza se imprime sin expulsión automática y la serie queda a la espera de tu aprobación.',
      retriesLabel: 'Reintentos por placa',
      escalateLabel: 'Poner en cuarentena tras fallos consecutivos',
      printing: 'Imprimiendo la primera pieza',
      awaitingTitle: 'Primera pieza pendiente de aprobación',
      awaitingBody: 'La primera pieza ya se imprimió. Inspecciónala y luego apruébala para continuar la serie o recházala para detenerla y revisarla.',
      approvePhysical: 'Aprobar: retiré la pieza',
      approveEject: 'Aprobar y expulsar de forma remota',
      reject: 'Rechazar…',
      approveConfirm: 'Aprobar',
      approvePhysicalTitle: '¿Aprobar la primera pieza?',
      approvePhysicalBody: 'Confirma que has retirado la pieza impresa de la placa. La serie continuará y despachará las placas restantes.',
      approveEjectTitle: '¿Aprobar y expulsar de forma remota?',
      approveEjectBody: 'El cabezal barrerá la pieza fuera de la placa antes de continuar la serie. Asegúrate de que la placa esté libre de obstáculos y de que nadie tenga las manos dentro de la impresora.',
      rejectTitle: 'Rechazar la primera pieza',
      rejectBody: 'Explica qué salió mal. Al reanudar la serie después se reinicia una nueva primera pieza.',
      rejectReasonLabel: 'Motivo',
      rejectReasonPlaceholder: 'p. ej., esquinas deformadas, mala adherencia…',
      rejectReasonRequired: 'Se requiere un motivo.',
      rejectAction: 'Rechazar la primera pieza',
      rejectedBadge: 'Primera pieza rechazada',
      rejectedReason: 'Motivo: {{reason}}',
      rejectedHint: 'Reanudar reinicia una nueva primera pieza.',
      approvedBadge: 'Primera pieza aprobada',
      approved: 'Primera pieza aprobada',
      rejected: 'Primera pieza rechazada',
      approveFailed: 'No se pudo aprobar la primera pieza',
      rejectFailed: 'No se pudo rechazar la primera pieza',
      photoAlt: 'Foto final de la primera pieza',
      photoUnavailable: 'Foto final no disponible',
      viewCamera: 'Ver cámara',
      hideCamera: 'Ocultar cámara',
      printerLabel: 'Impresora: {{name}}',
    },
  },

  ejectProfiles: {
    nav: 'Perfiles de expulsión',
    title: 'Perfiles de expulsión',
    description: 'Perfiles de retirada automática de piezas que barren las piezas terminadas de la cama una vez que se ha enfriado.',
    newProfile: 'Nuevo perfil',
    loadError: 'No se pudieron cargar los perfiles de expulsión.',
    duplicateAction: 'Duplicar',
    copyName: '{{name}} (copia)',
    empty: {
      title: 'Aún no hay perfiles de expulsión',
      body: 'Cree su primer perfil para retirar automáticamente las piezas terminadas de la cama.',
    },
    columns: {
      passes: 'Pasadas',
      ejectSpeed: 'Velocidad de expulsión',
      maxHeight: 'Altura máx.',
    },
    createTitle: 'Crear perfil de expulsión',
    editTitle: 'Editar perfil de expulsión',
    fields: {
      name: 'Nombre',
      clearance: 'Holgura (mm)',
      zOffset: 'Desfase Z (mm)',
      descentSteps: 'Pasos de descenso',
      xPasses: 'Pasadas en X',
      xMargin: 'Margen X (mm)',
      frontOverhang: 'Voladizo frontal (mm)',
      backOverhang: 'Voladizo trasero (mm)',
      ejectSpeed: 'Velocidad de expulsión (mm/min)',
      skimSpeed: 'Velocidad de rasado (mm/min)',
      finalSkim: 'Pasada de rasado final',
      finalSkimHelp: 'Añade una pasada de rasado lenta justo por encima de la placa después de los barridos para eliminar los restos finos. Desactiva para empujar exactamente una vez.',
      maxPartHeight: 'Altura máx. de pieza (mm)',
      sweepStartHeight: 'Altura de inicio del barrido (%)',
      sweepStartHeightHelp: 'Comenzar el barrido descendente en este porcentaje de la altura de la pieza (100 % = parte superior de la pieza).',
      sweepBand: 'Restringir la banda X del barrido',
      sweepBandHelp: 'Barrer solo una subbanda del ancho de la cama en lugar del ancho completo. Déjelo desactivado para el ancho completo.',
      sweepXMin: 'Mín. de banda X (mm)',
      sweepXMax: 'Máx. de banda X (mm)',
      bedDrop: 'Asistencia de liberación por descenso de cama',
      bedDropHelp: 'La cama baja casi hasta el fondo de la máquina y vuelve a la altura de elevación; la sacudida suelta una pieza pegada antes del barrido.',
      bedDropClearance: 'Holgura inferior (mm)',
      bedDropDwell: 'Espera en el punto bajo (s)',
      bedDropDwellHelp: 'La cama se mantiene en el punto bajo del descenso durante estos segundos antes de volver a la altura de elevación.',
      bedDropJitter: 'Sacudida en el punto bajo',
      bedDropJitterHelp: 'En el punto bajo del descenso, la cama sube y vuelve la distancia indicada tantas veces como ciclos se indiquen.',
      bedDropJitterCycles: 'Ciclos de sacudida',
      bedDropJitterMm: 'Recorrido de sacudida (mm)',
    },
    tooltips: {
      name: 'Una etiqueta corta para reconocer este perfil – se muestra en la lista de perfiles y los selectores.',
      clearance: 'Cuánto se mantiene el cabezal por encima de la pieza al colocarse, para no tocarla antes del barrido.',
      zOffset: 'Ajuste fino de la altura del barrido – súbelo si la boquilla roza, bájalo si no atrapa la pieza.',
      descentSteps: 'Número de pequeños descensos que hace el cabezal para colocarse detrás de la pieza antes de empujarla.',
      xPasses: 'Cuántas pasadas de barrido laterales se hacen sobre la cama para retirar la pieza.',
      xMargin: 'Margen que se mantiene respecto a los bordes izquierdo y derecho de la cama para que el cabezal nunca golpee el bastidor.',
      frontOverhang: 'Cuánto sobrepasa el barrido la parte delantera de la pieza para empujarla del todo.',
      backOverhang: 'A qué distancia detrás de la pieza empieza el barrido, para que el cabezal quede totalmente detrás antes de empujar.',
      ejectSpeed: 'Con qué rapidez se mueve el cabezal durante las pasadas de empuje que sacan la pieza de la placa.',
      skimSpeed: 'Con qué rapidez se mueve el cabezal durante las pasadas de rasado más suaves que retiran los restos.',
      finalSkim: 'Realiza una pasada lenta adicional justo por encima de la placa después de los barridos principales para eliminar los restos finos. Desactiva para un solo empuje (p. ej. un único carril a media altura para una pieza alta).',
      maxPartHeight: 'Pieza más alta que este perfil puede expulsar – el envío se bloquea si la pieza laminada es más alta.',
      sweepStartHeight: 'Altura en la pieza donde comienza el barrido descendente, en porcentaje (válido 1-100%; 100% = la parte superior de la pieza).',
      sweepBand: 'Barrer solo una franja de la cama en lugar de todo el ancho – útil cuando las piezas están siempre en el mismo sitio.',
      sweepXMin: 'Borde izquierdo de la franja de barrido, en mm desde el origen de la cama. Válido 0-340 mm (ancho de cama H2S); debe ser menor que el máximo y dejar una franja de al menos 10 mm de ancho.',
      sweepXMax: 'Borde derecho de la franja de barrido, en mm desde el origen de la cama. Válido 0-340 mm (ancho de cama H2S); debe ser mayor que el mínimo y dejar una franja de al menos 10 mm de ancho.',
      bedDrop: 'La cama caliente baja casi hasta su punto más bajo y vuelve a la altura de elevación; la sacudida suelta una pieza pegada antes del barrido. Requiere un recorrido Z registrado para el modelo.',
      bedDropClearance: 'Distancia que se mantiene respecto a la posición más baja de la cama durante el descenso: 50 mm = detenerse 5 cm por encima del fondo.',
      bedDropDwell: 'Unos segundos de más en el punto bajo dan tiempo a que una pieza pegada termine de despegarse antes del barrido.',
      bedDropJitter: 'Movimientos cortos de subida y bajada en el punto bajo sueltan una pieza que el tirón único deja pegada.',
    },
    nameRequired: 'El nombre es obligatorio.',
    created: 'Perfil de expulsión creado',
    updated: 'Perfil de expulsión actualizado',
    deleted: 'Perfil de expulsión eliminado',
    saveFailed: 'No se pudo guardar el perfil',
    deleteFailed: 'No se pudo eliminar el perfil',
    deleteTitle: '¿Eliminar este perfil?',
    deleteBody: '«{{name}}» se eliminará de forma permanente. Esto no se puede deshacer.',
    preview: {
      title: 'Vista previa y validación',
      description: 'Genere el G-code de expulsión para un archivo de la biblioteca y una placa para validarlo antes de usarlo.',
      file: 'Archivo de la biblioteca',
      filePlaceholder: 'Seleccione un archivo…',
      plate: 'Placa',
      run: 'Generar vista previa',
      running: 'Generando…',
      noFiles: 'No hay archivos de la biblioteca disponibles para la vista previa.',
      ok: 'Validación superada',
      errors: 'Errores',
      warnings: 'Advertencias',
      maxZ: 'Altura Z máx.: {{value}} mm',
      showGcode: 'Mostrar G-code',
      hideGcode: 'Ocultar G-code',
      gcodeLabel: 'G-code generado',
      failed: 'La vista previa falló',
    },
    dryRun: {
      action: 'Prueba en vacío',
      title: 'Prueba de expulsión en vacío',
      description: 'Envía una prueba solo de geometría de este perfil a una impresora, o descarga el archivo de prueba para inspeccionarlo.',
      printer: 'Impresora',
      printerPlaceholder: 'Selecciona una impresora conectada…',
      loadingPrinters: 'Comprobando las conexiones de las impresoras…',
      noPrinters: 'No hay impresoras conectadas disponibles.',
      warningTitle: 'Se requiere cama vacía',
      warning: 'Esta prueba hace el origen en el centro de la cama y barre sobre ella, así que la placa debe estar VACÍA. Tras el envío, el trabajo espera hasta que liberes la retención de placa en la impresora.',
      dispatch: 'Enviar prueba',
      dispatching: 'Enviando…',
      download: 'Descargar archivo',
      downloading: 'Preparando…',
      dispatchFailed: 'No se pudo enviar la prueba.',
      downloadFailed: 'No se pudo generar el archivo de prueba en vacío.',
      allowUnvalidated: 'Permitir geometría no validada (solo para la escalera de hardware)',
      allowUnvalidatedWarning: 'La envolvente de este modelo NO se ha validado con hardware. Envía solo en la escalera, supervisado y con la cama VACÍA.',
    },
    geometry: {
      model: 'Modelo de impresora',
      noModels: 'No hay entradas en el registro de geometría',
      unvalidated: 'sin validación de hardware',
      warningsTitle: 'Avisos de geometría',
      downloadModel: 'Modelo de geometría para la descarga',
      downloadModelPlaceholder: 'Usar el modelo de la impresora seleccionada',
      bandInverted: 'El mínimo de la banda X debe ser menor que el máximo de la banda X.',
      bandTooNarrow: 'La banda de barrido debe tener al menos {{min}} mm de ancho.',
      bandExceedsBed: 'El máximo de la banda X supera la cama registrada más ancha ({{max}} mm).',
      heightExceedsCeiling: 'Por encima del límite de altura de todos los modelos registrados (máx. {{max}} mm) — el envío de expulsión sería rechazado.',
      bedDropNoTravel: 'Los modelos sin un recorrido Z registrado ({{models}}) no pueden generar este perfil: define z_travel_mm en el registro de geometría.',
      bedDropBedslinger: 'La asistencia de bajada de cama no está disponible en modelos de cama móvil ({{models}}): su cama no se mueve en Z.',
    },
    geometryManager: {
      title: 'Registro de geometría de modelos',
      description: 'Tamaño de la cama, envolvente de desplazamiento y estado de validación de hardware de cada modelo de impresora. Las filas provienen de las semillas del servidor: no hay botón para añadir; edita un modelo para corregir su geometría o cambiar su validación.',
      edit: 'Editar geometría',
      editTitle: 'Editar la geometría de {{model}}',
      saved: 'Geometría del modelo guardada',
      saveFailed: 'No se pudo guardar la geometría del modelo',
      zTravelUnset: 'No hay recorrido Z registrado: la asistencia de bajada de cama falla de forma segura en este modelo.',
      validatedBadge: 'Validado',
      notValidatedBadge: 'Sin validar',
      confirmValidateTitle: '¿Marcar el modelo como validado?',
      ...
      columns: {
        model: 'Modelo',
        bed: 'Cama (An×Al mm)',
        envelope: 'Envolvente (mm)',
        zTravel: 'Recorrido Z',
        maxPartHeight: 'Altura máx. de pieza',
        motion: 'Movimiento',
        validated: 'Validado',
        notes: 'Notas',
        updated: 'Actualizado',
      ...
      motion: {
        bedZ: 'Cama en Z',
        bedslinger: 'Cama móvil',
      },
      fields: {
        bedX: 'Ancho de cama X (mm)',
        bedY: 'Profundidad de cama Y (mm)',
        envXMin: 'Envolvente X mín (mm)',
        envXMax: 'Envolvente X máx (mm)',
        envYMin: 'Envolvente Y mín (mm)',
        envYMax: 'Envolvente Y máx (mm)',
        maxPartHeight: 'Altura máx. de pieza (mm)',
    ...
    queueLabel: 'Perfil de expulsión (retirada automática de piezas)',
    queueHelp: 'La pieza se barre cuando la cama se enfría hasta la línea de expulsión.',
  },
  // Navigation
  nav: {
    printers: 'Impresoras',
  ...
  printers: {
    ...
    maintenance: {
      ...
      toastExited: '{{name}} fuera del modo mantenimiento',
    ...
    deactivated: {
      ...
      panelState: 'Desactivada — sin conexión con esta impresora.',
      activate: 'Activar',
      toastActivated: '{{name}} activada',
      editFieldLabel: 'Desactivada',
      editFieldHelp: 'Sin sesión MQTT; invisible para esta instancia (instalaciones paralelas, retirada de servicio).',
    },
    // Chamber light
    ...
    toast: {
      ...
      recheckUnchanged: 'Ranura {{slot}} sin cambios. No se registró movimiento de bobina desde la última comprobación.',
      recheckMinted: 'Ranura {{slot}}: nueva bobina registrada. {{grams}} g asumidos.',
      recheckIdentified: 'Ranura {{slot}}: {{identity}} registrado desde su etiqueta.',
      recheckIdentifiedUnnamed: 'Ranura {{slot}}: etiqueta leída.',
      recheckIdentifiedNoRead: 'Ranura {{slot}}: {{identity}} registrado. Nueva lectura de la etiqueta aplazada.',
      recheckQueued: 'Comprobación de la ranura {{slot}} en cola. La granja leerá la etiqueta en la próxima ventana inactiva y registrará la bobina entonces.',
      recheckEmpty: 'La ranura {{slot}} está vacía. Cargue una bobina y vuelva a comprobar.',
      recheckRestored: 'Ranura {{slot}}: bobina anterior restaurada.',
      recheckFailed: 'Ranura {{slot}}: la comprobación falló.',
      recheckUndoNoOffer: 'Ranura {{slot}}: no hay comprobación que deshacer.',
      recheckUndoNoPredecessor: 'Ranura {{slot}}: no hay bobina anterior registrada para esta ranura.',
      recheckUndoMintGone: 'Ranura {{slot}}: la bobina registrada ya no existe.',
      recheckUndoBoundElsewhere: 'Ranura {{slot}}: la bobina anterior está colocada en otra bandeja. No se restauró nada.',
      recheckUndoFailed: 'Ranura {{slot}}: restauración fallida. {{detail}}',
    ...
    quarantine: {
      badge: 'En cuarentena',
      recover: 'Recuperar y reanudar',
      recoverSuccess: 'Impresora recuperada — {{count}} serie(s) reanudada(s).',
      recoverError: 'No se pudo recuperar la impresora',
      recoverTitle: '¿Recuperar y reanudar?',
      recoverMessage: '¿Recuperar "{{name}}"? Es una anulación explícita que:',
    ...
    phase: {
      ...
      coolingToPlateau: 'Enfriando hasta la meseta',
      coolingToPlateauHeld: 'Enfriando hasta la meseta · placa elevada',
    ...
    farm: {
      run: 'Serie: {{name}}',
      printingUnit: 'Imprimiendo unidad n.º {{id}}',
      stagedLowSpool: 'Unidad retenida: filamento insuficiente — cambia la bobina o libérala desde la cola',
      staged: 'Unidad retenida — reanuda la serie para liberarla',
      lastUnitFailed: 'Última unidad fallida: {{error}}',
    },
    modelMismatch: {
      badge: 'Modelo no coincide',
      blocked: 'El envío está bloqueado hasta corregir el modelo declarado.',
    },
    ejectNotQualified: 'La expulsión automática aún no está cualificada por hardware para este modelo — ejecuta la escalera de hardware antes de usarla sin supervisión.',
    plateStatus: {
      markCleared: 'Marcar cama como despejada',
      cleared: 'Cama despejada',
      notCleared: 'Cama no despejada',
      inUse: 'Cama en uso',
      markClearedCancelsEject: 'Marcar la cama como despejada cancela la expulsión automática pendiente.',
      ejectInFlight: 'Expulsión en curso. Usa Recuperar para anularla.',
      markOccupied: 'Marcar cama como ocupada',
      markOccupiedSuccess: 'Cama marcada como ocupada — envío bloqueado hasta despejarla',
      ejectInProgress: 'Expulsión en curso · {{age}}',
      ejectStalled: 'Expulsión atascada · {{age}} — la granja perdió el rastro del barrido',
      refusal: 'Comprobación de la cama: {{message}}',
      menuRecover: 'Recuperar impresora',
      clearedClosedFault: 'Avería de equipo cerrada',
    },
    // Expulsión manual (W2) + aviso de nueva bobina (W6)
    eject: {
      action: 'Expulsar cama',
      dispatched: 'Expulsión iniciada',
      confirmTitle: '¿Expulsar con la cama caliente?',
      confirmBodyNoLine: 'La cama está a {{bed}} °C, sin lectura del aire del taller ni de la cámara para compararla. Expulsar ahora barre la pieza a esa temperatura. ¿Continuar?',
      confirmBody: 'La cama está a {{bed}} °C, por encima del umbral de liberación de {{threshold}} °C. Expulsar ahora barre la pieza con la cama aún caliente. ¿Continuar?',
      confirm: 'Expulsar cama',
      cancel: 'Cancelar',
      foreignPrintNameLabel: 'Impresión',
      foreignUnknownPrint: 'Desconocida',
      foreignPartHeightEditLabel: 'Altura de pieza (mm)',
      foreignProfileLabel: 'Perfil de expulsión',
      foreignSuggested: 'sugerido',
      foreignNoProfiles: 'No hay perfiles de expulsión disponibles',
      foreignConfirm: 'Expulsar cama',
      dialog: {
        foreignTitle: 'Expulsar cama — impresión no enviada por la granja',
        farmUnitTitle: 'Expulsar cama — {{name}}',
        declaredTitle: 'Expulsar cama',
        body: 'El barrido se construye con la altura de pieza y el perfil de expulsión de abajo. Comprueba ambos contra la cama antes de iniciar.',
        heightRequired: 'Altura de pieza desconocida. Introduce el punto más alto de la pieza sobre la cama.',
      },
      error: {
        jobActive: 'La impresora está ejecutando un trabajo. Espera a que termine o detenlo, y luego expulsa.',
        dispatchInFlight: 'Se está enviando una unidad en cola a esta impresora. Reintenta en unos segundos.',
        ejectInFlightPending: 'Expulsión enviada hace {{age}} s; esperando a que la impresora la inicie.',
        ejectInFlightPendingNoAge: 'Expulsión ya enviada; esperando a que la impresora la inicie.',
        ejectInFlightStarted: 'Expulsión en curso desde hace {{age}} s.',
        ejectInFlightStartedNoAge: 'Expulsión en curso.',
        bedUnreadable: 'Temperatura de la cama no disponible. Reintenta en unos segundos.',
        noDonor: 'No hay ningún archivo para construir la expulsión. Marca la cama como despejada y retira la pieza a mano.',
        firstArticle: 'Primera pieza pendiente de aprobación. Apruébala o recházala desde la serie.',
    ...
    // RFID
    rfid: {
      disabledWhileDrying: 'No disponible mientras el AMS está secando',
      recheck: 'Volver a comprobar ranura',
      recheckPending: 'Comprobación pendiente. Concluye cuando termine la impresión.',
      recheckQueuedTooltip: 'En cola hasta que termine la impresión.',
      restorePreviousRoll: 'Restaurar bobina anterior',
    },
    // AMS load/unload (#891)
    ams: {
      load: 'Cargar',
    ...
    permission: {
      ...
      noAmsRfid: 'No tiene permiso para volver a comprobar ranuras del AMS',
    ...
    confirm: {
      ...
      amsRecoveryTitle: 'Recuperación en curso',
      amsRecoveryMessage: '{{name}}: recuperación en curso. Enviar este comando la finaliza.',
    ...
    incidentAction: {
      ...
      plate_vision: 'Corrija la cama y luego reanude la impresión',
  ...
  archives: {
    ...
    modal: {
      ...
      deleteBlockedByLivePrint: 'No se puede eliminar — este archivo registra una impresión en curso. Detén la impresión primero y vuelve a intentarlo.',
  ...
  queue: {
    ...
    startBelowMin: {
      confirmTitle: '¿Iniciar con una bobina baja?',
      confirmIntro: 'La bobina asignada puede cubrir esta impresión, pero está por debajo del peso mínimo de inicio. ¿Iniciar de todos modos?',
      slots: 'Ranuras afectadas: {{slots}}',
      unknownGramsTitle: '¿Iniciar con una bobina sin pesar?',
      unknownGramsIntro: 'No hay peso registrado para la bobina correspondiente, así que no se puede demostrar que la impresión termine. Pesa o asigna la bobina, o inicia de todos modos.',
      printAnyway: 'Iniciar de todos modos',
    },
    farm: {
      runBadge: 'Serie',
    ...
    filter: {
      ...
      any: 'Cualquiera',
      anyOf: 'Cualquiera de',
      emptyTitle: 'Ningún elemento coincide con los filtros',
    ...
    reorder: {
      requiresPositionSort: 'Reordenar requiere el orden por posición, ascendente y con SJF desactivado',
    },
    // Badges
    badges: {
      staged: 'Preparado',
    ...
    permissions: {
      ...
      noReleaseStaged: 'Pide a un administrador de la cola que libere estos elementos',
  ...
  settings: {
    ...
    spoolSelectionPolicy: 'Política de selección de bobina',
    spoolSelectionPolicyDesc: 'Cómo el despachador y las impresiones manuales eligen una bobina cuando coinciden varias ranuras AMS.',
    spoolPolicyFirstLoaded: 'Primero cargado (FIFO)',
    spoolPolicyLowestRemaining: 'Menor restante',
    spoolPolicySlotOrder: 'Orden de ranuras AMS',
    spoolPolicyBackupNote: 'Menor restante solo surte efecto cuando AMS Filament Backup está activado en la impresora — de lo contrario, la impresora no puede cambiar a una segunda bobina cuando la elegida se acaba.',
    minStartSpool: 'Peso mínimo de bobina para iniciar (g)',
    minStartSpoolDesc: 'Una bobina con menos gramos restantes que este valor nunca puede INICIAR una impresión (pero puede terminar una en curso). 0 desactiva el límite.',
    spoolRecoveryEnabled: 'Recuperación automática de atascos de bobina',
    spoolRecoveryEnabledDesc: 'Cuando un fallo de alimentación del AMS (enredo) pausa una impresión de la granja, cambia automáticamente a la siguiente bobina apta y reanuda. La bobina atascada queda fuera de rotación hasta volver a insertarla.',
    runoutAutoResumeEnabled: 'Reanudar automáticamente tras recargar filamento',
    runoutAutoResumeEnabledDesc: 'Cuando una impresión está en pausa esperando filamento en una ranura AMS concreta, se reanuda automáticamente en cuanto se recarga esa ranura. Desactivado = la impresión espera una reanudación manual.',
    spoolRecoveryMaxAttempts: 'Máx. intentos de recuperación',
    spoolRecoveryMaxAttemptsDesc: 'Cuántas bobinas probar antes de dejar la impresión en pausa para una persona (1-5).',
    spoolRecoveryStepTimeout: 'Tiempo de espera por paso (segundos)',
    spoolRecoveryStepTimeoutDesc: 'Cuánto puede durar cada paso de recuperación antes de considerarse fallido (15-600 s).',
    spoolRecoveryProtectLayers: 'Proteger primeras capas',
    spoolRecoveryProtectLayersDesc: 'Durante las primeras N capas, las bobinas por debajo del peso mínimo de inicio no pueden usarse como reemplazo; después de eso, sí. 0 = las bobinas con poco material siempre pueden usarse.',
    taglessDefaultFilament: 'Filamento predeterminado para bandejas sin etiqueta',
    taglessDefaultFilamentDesc: 'Configurar automáticamente las bandejas AMS sin etiqueta y sin configurar con este filamento para que puedan imprimir sin ajustes manuales.',
    taglessBrand: 'Marca',
    taglessMaterial: 'Material',
    taglessSubtype: 'Subtipo',
    taglessSubtypeHint: 'El código de variante de Bambu para el material, p. ej. HF = High Flow. Se muestra en la etiqueta de la bobina.',
    taglessColor: 'Color',
    taglessSlicerFilament: 'Filamento del slicer (opcional)',
    taglessSlicerFilamentHint: 'El nombre exacto del preajuste de filamento que usa tu slicer, para que las impresiones coincidan con el perfil correcto.',
    ...
    deleteUserChecking: 'Comprobando qué eliminaría esta acción...',
    deleteUserImpactUnavailable: 'No se pudo comprobar qué eliminaría esta acción. Si elimina de todos modos, los elementos de este usuario se borrarán sin vista previa.',
    deleteUserArchives_one: '{{count}} archivo de impresión',
    deleteUserArchives_other: '{{count}} archivos de impresión',
    deleteUserLibraryFiles_one: '{{count}} archivo de biblioteca',
    deleteUserLibraryFiles_other: '{{count}} archivos de biblioteca',
    deleteUserQueueItems_one: '{{count}} elemento de la cola',
    deleteUserQueueItems_other: '{{count}} elementos de la cola',
    deleteUserProductionRuns_one: '{{count}} tanda de producción',
    deleteUserProductionRuns_other: '{{count}} tandas de producción',
    deleteUserDependentSkus_one: '{{count}} SKU usa un archivo subido por este usuario. Ese SKU perderá el archivo y no se podrá imprimir hasta que lo reasigne.',
    deleteUserDependentSkus_other: '{{count}} SKU usan archivos subidos por este usuario. Esos SKU perderán los archivos y no se podrán imprimir hasta que los reasigne.',
    deleteUserPrintingNow_one: '{{count}} unidad se está imprimiendo ahora. La eliminación se rechazará hasta que termine o se detenga.',
    deleteUserPrintingNow_other: '{{count}} unidades se están imprimiendo ahora. La eliminación se rechazará hasta que terminen o se detengan.',
    deleteUserStillPrinting: 'Todavía imprimiendo en {{printers}}. Detenga esas impresiones o espere a que terminen y luego elimine.',
    // Smart plugs
    ...
    farmProduction: 'Producción en granja',
    farmProductionDescription: 'Política predeterminada de reintentos y cuarentena que se rellena en el diálogo Iniciar serie. Se puede anular en cada serie.',
    farmEjectCooldown: 'Enfriamiento de expulsión',
    farmEjectCooldownDescription: 'Cómo espera la granja a que la cama se enfríe antes de barrer una placa terminada, y cuándo se rinde o pone en cuarentena una impresora que no se enfría.',
    farmRetryMaxPerUnit: 'Reintentos por placa',
    farmRetryMaxPerUnitHelp: 'Reintentos automáticos antes de marcar una placa como fallida (0–10)',
    farmEscalateConsecutiveFailures: 'Cuarentena tras fallos',
    farmEscalateConsecutiveFailuresHelp: 'Fallos consecutivos en una impresora que activan una cuarentena (1–20)',
    farmCooldownMargin: 'Margen sobre el aire del taller (°C)',
    farmCooldownMarginHelp: 'La línea de expulsión y la bajada del ventilador de cámara quedan este margen por encima del aire del taller.',
    shopAir: {
      label: 'Aire del taller',
      ejectLine: 'Línea de expulsión',
      noReading: 'sin lectura',
      atPlateau: 'en meseta',
      fresh_one: 'Medido dentro de {{count}} impresora en reposo, hace {{minutes}} min — marca algo por encima del aire de la sala.',
      fresh_other: 'Medido dentro de {{count}} impresoras en reposo, hace {{minutes}} min — marca algo por encima del aire de la sala.',
      carried: 'Trasladado desde las {{time}} según la curva diaria.',
      unknown: 'Aún sin lectura — cada enfriamiento se libera cuando la cama deja de enfriarse.',
      readFailed: 'Lectura del aire del taller fallida — reintento cada minuto.',
    },
    farmOfflineStallMinutes: 'Bloqueo por desconexión (min)',
    farmOfflineStallMinutesHelp: 'Marca una unidad aún imprimiendo cuya impresora lleva desconectada este tiempo — nunca se termina, solo muestra el bloqueo (5–720)',
    farmPauseStallMinutes: 'Bloqueo por pausa (min)',
    farmPauseStallMinutesHelp: 'Marca y notifica cuando una unidad en impresión lleva pausada este tiempo sin recuperación automática en curso — nunca cancela nada (5–720)',
    farmCooldownStallWindow: 'Intervalo de comprobación de enfriamiento (min)',
    farmCooldownStallWindowHelp: 'Con qué frecuencia se confirma que la cama sigue enfriándose antes de expulsar. Dos comprobaciones fallidas seguidas ponen la impresora en cuarentena. 0 desactiva la comprobación.',
    farmCooldownStallEpsilon: 'Enfriamiento mínimo por comprobación (°C)',
    farmCooldownStallEpsilonHelp: 'La cama debe bajar al menos esto entre comprobaciones para contar como que sigue enfriándose.',
    farmCooldownMaxHold: 'Temporizador de rendición (min)',
    ...
    farmCooldownPlateauMarginHelp: 'Si el enfriamiento se estanca pero la cama está dentro de estos grados del aire de su propia cámara, se trata como enfriada y se expulsa; si queda más caliente que eso, la impresora se pone en cuarentena.',
    farmCooldownAuxFanEnabled: 'Ventilador auxiliar durante el enfriamiento',
    farmCooldownAuxFanEnabledHelp: 'Hace funcionar el ventilador auxiliar desde el final de la impresión hasta que se envía la expulsión.',
    farmCooldownAuxFan: 'Velocidad del ventilador auxiliar (%)',
    farmCooldownAuxFanHelp: 'Una sola velocidad para todo el enfriamiento (1–100).',
    farmCooldownChamberFanEnabled: 'Ventilador de cámara durante el enfriamiento',
    farmCooldownChamberFanEnabledHelp: 'Pone el conducto de aire en modo enfriamiento y hace funcionar el ventilador de extracción de la cámara desde el final de la impresión hasta que se envía la expulsión. Los modelos de impresora sin ventilador de cámara lo omiten.',
    farmCooldownChamberFan: 'Velocidad de refuerzo del ventilador de cámara (%)',
    farmCooldownChamberFanHelp: 'Velocidad mientras el aire de la cámara sigue por encima de la temperatura de expulsión (1–100).',
    farmCooldownChamberFanSustain: 'Velocidad del ventilador de cámara tras el refuerzo (%)',
    farmCooldownChamberFanSustainHelp: 'Velocidad una vez que la cámara alcanza la temperatura de expulsión, hasta que se envía la expulsión. 0 detiene el ventilador ahí. La velocidad de enfriamiento de cámara propia de la impresora es 50.',
    farmCooldownHoldEnabled: 'Mantener la placa junto al ventilador durante el enfriamiento',
    farmCooldownHoldEnabledHelp: 'Eleva la placa hacia el plano de la boquilla con el cabezal aparcado en la rampa mientras la pieza se enfría. Desactivado deja la placa donde terminó la impresión.',
    farmCooldownHoldPartTop: 'Parte superior de la pieza sobre el plano de la boquilla (mm)',
    farmCooldownHoldPartTopHelp: 'Define dónde se mantiene la placa mientras la pieza se enfría, como la altura de la parte superior de la pieza sobre el flujo del ventilador auxiliar en el plano de la boquilla. 100 mantiene la placa junto al ventilador con la pieza elevándose hacia la zona libre sobre la boquilla. 0 sitúa la parte superior de la pieza al nivel del ventilador. Por debajo de 0 mantiene la pieza esa distancia bajo el ventilador para que el aire pase por encima. Limitado a la altura libre medida del modelo de impresora.',
    ...
    farmIdlePark: 'Aparcado de la cama en reposo',
    ...
    farmPlateBlowoffEnabled: 'Soplado de la placa al iniciar la impresión',
    farmPlateBlowoffEnabledHelp: 'Ventilador auxiliar a máxima velocidad sobre la placa antes de la nivelación de la cama.',
    farmPlateBlowoffSeconds: 'Tiempo de soplado (s)',
    farmPlateBlowoffSecondsHelp: 'Tiempo de marcha del ventilador auxiliar antes de la nivelación de la cama (3–60).',
    ...
    queueCheckIntervalHelp: 'Con qué frecuencia la granja vuelve a revisar la cola aunque no haya pasado nada. Una red de seguridad por si se pierde un evento en vivo: más bajo reacciona antes pero sondea más (5–300).',
    dispatchKickDebounce: 'Retardo de agrupación de ráfagas (seg)',
    dispatchKickDebounceHelp: 'Cuando varias cosas ocurren a la vez, espera este breve momento para agruparlas en un solo pase de despacho en lugar de muchos. Más alto agrupa más; más bajo reacciona más rápido (0.2–10).',
    usbPreflightFreshWindow: 'Vigencia de la comprobación USB (seg)',
    usbPreflightFreshWindowHelp: 'Confía en un informe reciente de "unidad USB presente" con esta antigüedad en segundos antes de volver a comprobar. Más alto omite comprobaciones redundantes; 0 siempre vuelve a comprobar (0–120).',
    usbPreflightMaxWait: 'Espera máxima de comprobación USB (seg)',
    usbPreflightMaxWaitHelp: 'Cuánto esperar un informe reciente de "USB presente" antes de iniciar una impresión de todos modos. Más alto es más cauteloso; más bajo despacha antes (0–10).',
    dispatchParallelLimit: 'Inicios de impresora simultáneos',
    dispatchParallelLimitHelp: 'Cuántas impresoras pueden subir e iniciar al mismo tiempo en un pase. Más alto vacía una cola grande más rápido; más bajo es más suave con la red (1–10).',
    powerStagger: 'Escalonamiento de energía',
    powerStaggerDescription: 'Libera una ranura de escalonamiento en cuanto una impresora deja de consumir energía de calentamiento, en lugar de esperar siempre todo el intervalo. Permite que la siguiente impresora inicie antes sin dejar de limitar el consumo de energía simultáneo.',
    staggerDynamicRelease: 'Liberar una ranura cuando la cama esté caliente',
    staggerDynamicReleaseHelp: 'Cuando está activado, la siguiente impresora puede iniciar en cuanto la actual termina de calentar su cama, en lugar de esperar a que pase todo el intervalo. Cuando está desactivado, cada ranura espera todo el intervalo.',
    staggerReleaseEpsilon: 'Margen a temperatura (°C)',
    staggerReleaseEpsilonHelp: 'Cuán cerca de la temperatura objetivo de la cama cuenta como "suficientemente caliente" para liberar la ranura antes. Más grande libera la siguiente impresora antes.',
    staggerHeatupGrace: 'Margen de calentamiento (segundos)',
    staggerHeatupGraceHelp: 'Si una impresora aún no ha comenzado a calentar su cama, espera este tiempo antes de liberar su ranura de todos modos, para que una impresora inactiva no retenga el lote.',
    ...
    erp: {
      title: 'Inicio de sesión del directorio ERP',
      statusActive: 'Inicio de sesión ERP: activo',
      statusInactive: 'Inicio de sesión ERP: sin configurar',
      activeDesc: 'Los operadores pueden iniciar sesión con sus credenciales del directorio ERP.',
      inactiveDesc: 'Agregue y guarde los datos de conexión a continuación para activar el inicio de sesión ERP.',
      disableHint: 'Para desactivar el inicio de sesión ERP, borre el host y el nombre de la base de datos a continuación y guarde.',
      connectionConfig: 'Conexión al directorio ERP',
      host: 'Host de la base de datos',
      port: 'Puerto',
      database: 'Nombre de la base de datos',
      user: 'Usuario de la base de datos',
      password: 'Contraseña de la base de datos',
      passwordHint: 'Déjelo vacío para mantener la contraseña guardada.',
      ssl: 'Conectar mediante TLS',
      sslHint: 'Exigir una conexión cifrada a la base de datos ERP.',
      roleMapping: 'Asignación de roles',
      roleMappingHint: 'Asigne un grupo de BamBuddy a cada rol de ERP.',
      roleMappingNoGroup: '— Sin grupo —',
      roleMappingGroupFor: 'Grupo de BamBuddy para {{role}}',
      settingsSaved: 'Configuración del directorio ERP guardada',
      errors: {
        hostRequired: 'El host de la base de datos es obligatorio',
        databaseRequired: 'El nombre de la base de datos es obligatorio',
      },
    },
    oidc: {
      ...
      form: {
        ...
        groupsClaimDesc: 'Claim del token que contiene los valores de grupo o rol del usuario. Déjelo vacío para desactivar la sincronización de grupos de este proveedor.',
        groupsClaimPlaceholder: 'grupos',
        groupMapping: 'Asignación de grupos',
        groupMappingDesc: 'Asigne cada valor del claim a un grupo de BamBuddy. Los usuarios coincidentes reciben el grupo asignado al iniciar sesión.',
        groupMappingNone: 'No hay asignaciones configuradas.',
        groupMappingClaimValue: 'Valor del claim',
        groupMappingGroup: 'Grupo de BamBuddy',
        groupMappingSelectGroup: 'Seleccionar grupo',
        groupMappingRemove: 'Eliminar asignación',
        groupMappingAdd: 'Añadir asignación',
  ...
  fileManager: {
    ...
    createSkuFromUploadToast: '{{filename}} subido: ¿crear una SKU a partir de él?',
    createSkuFromUploadAction: 'Crear SKU a partir de este archivo',
    ...
    deleteFolderConfirm: '¿Está seguro de que desea eliminar esta carpeta? Los archivos que contiene se mueven a la papelera y se pueden restaurar en la raíz; la carpeta se elimina definitivamente.',
    deleteFileConfirm: '¿Está seguro de que desea eliminar este archivo?',
    deleteFilesConfirm: '¿Está seguro de que desea eliminar {{count}} archivos seleccionados? Se mueven a la papelera y se pueden restaurar.',
    deleting: 'Eliminando...',
  ...
  inventory: {
    ...
    unknownSpoolToast: 'Filamento desconocido {{material}} en {{printer}} ranura {{slot}} — ¿añadirlo al inventario?',
    unknownSpoolSlot: 'Ranura',
    freshRoll: {
      promptToast: '¿Rollo nuevo en {{printer}} ranura {{slot}}?',
      sameRoll: 'Mismo rollo',
      reviewAction: 'Revisar…',
      title: '¿Rollo nuevo en esta ranura?',
      message: 'La bobina sin etiqueta en {{location}} se ha usado la mayor parte de su peso nominal. Si ahora hay un rollo nuevo cargado, regístralo para que el seguimiento de filamento siga siendo preciso.',
      confirm: 'Rollo nuevo',
      pending: 'Registrando…',
      success: 'Rollo nuevo registrado',
      failed: 'No se pudo registrar el rollo nuevo',
      dismissFailed: 'No se pudo descartar el aviso de rollo nuevo',
      remaining: '{{grams}} g registrados como restantes',
      brandLabel: 'Marca',
      brandPlaceholder: 'p. ej. Overture',
      weightLabel: 'Peso nominal (g)',
      weightPlaceholder: 'p. ej. 1000',
      costLabel: 'Coste / kg',
      costPlaceholder: 'Opcional',
      noteLabel: 'Nota',
      notePlaceholder: 'Opcional',
      manualDesc: 'Cerrar este registro y empezar uno nuevo',
      manualTitle: '¿Marcar como bobina nueva?',
      manualMessage: 'Cierra el registro de {{location}} ({{grams}} g usados) y crea uno nuevo y completo para esta ranura. Hazlo solo después de haber cambiado físicamente la bobina.',
      manualConfirm: 'Marcar como bobina nueva',
    },
    respool: {
      title: '¿Reasignar esta etiqueta?',
      manualTitle: '¿Pasar esta etiqueta a una bobina nueva?',
      manualMessage: 'Retira el registro de {{location}} ({{grams}} g usados) y pasa su etiqueta Bambu a una bobina nueva completa. Hazlo solo después de cambiar físicamente la bobina.',
      message: 'Se detectó una etiqueta Bambu reutilizada en {{location}}. Si ahora está en una bobina nueva de otra marca, reasígnala a un registro lleno.',
      confirm: 'Reasignada — bobina nueva',
      pending: 'Reasignando…',
      success: 'Reasignada a una bobina {{brand}} nueva',
      failed: 'No se pudo reasignar la etiqueta',
      autoToast: '{{brand}} reasignada automáticamente en {{printer}} ranura {{slot}}',
      reusedTagToast: 'Posible rollo nuevo en una etiqueta reutilizada — {{printer}} ranura {{slot}}',
      ...
      triggerSpent: 'Este rollo informó de que se quedó sin filamento y la ranura se ha manipulado desde entonces.',
      triggerRemainJump: 'El AMS informa de mucho más filamento del que refleja este registro — parece que la etiqueta pasó a un rollo rellenado.',
      sameSpoolAction: 'Misma bobina',
      reviewAction: 'Revisar…',
      dismissFailed: 'No se pudo descartar el aviso de reasignación',
      donorLine: 'Reemplaza la bobina registrada (quedan {{grams}} g); el registro anterior se archiva',
      donorRecordTitle: 'Registro n.º {{id}}',
      detailsLabel: 'Detalles',
      tagIdLabel: 'ID de etiqueta',
      warning: 'Usa solo UNA etiqueta por rollo de origen — descarta la segunda etiqueta.',
      brandLabel: 'Marca',
      brandPlaceholder: 'p. ej. Overture',
      weightLabel: 'Peso nominal (g)',
      weightPlaceholder: 'p. ej. 1000',
    ...
    returnToRotation: 'Devolver a rotación',
    returnToRotationDone: 'Bobina devuelta a rotación',
    returnToRotationFailed: 'No se pudo devolver la bobina a rotación',
  ...
  ams: {
    ...
    slotDialogLabel: '{{ams}} ranura {{slot}}: {{content}}',
    ...
    slotSpentSwapPark: '{{printer}}: la ranura {{slot}} de {{ams}} está ocupada por una bobina agotada y nada puede liberarla. Vuelve a comprobar la ranura o cambia el rollo.',
    ...
    emptySlotBinding: {
      title: 'Sigue asignada',
      used: '{{grams}} g usados',
      ranOut: 'se agotó — esperando bobina nueva',
      awaitingInsert: 'esperando inserción (preconfigurada)',
      seatedUnread: 'insertada — pendiente de identificación',
      presenceUnknown: 'no confirmada en la ranura',
      notInserted: 'no insertada',
      elsewhereHint: '(no insertada — asignada a {{location}})',
      unassignAria: 'Desasignar {{spool}} de esta ranura',
      unassignTitle: '¿Desasignar esta bobina?',
      unassignMessage: 'Libera {{spool}} de esta ranura. La bobina vuelve al inventario con su consumo registrado intacto: no se borra nada.',
    },
    unknown: 'Desconocido',
    humidity: 'Humedad',
    temperature: 'Temperatura',
  ...
  printModal: {
    ...
    customSlotMapping: 'Asignación de ranuras personalizada',
    reread: 'Releer',
    requiredTooltip: 'Requerido: {{type}} - {{color}}',
    manuallySelected: 'Seleccionado manualmente',
    autoMatched: 'Emparejado automáticamente',
    externalSlotNote: 'Bobina externa: sin seguimiento de peso; la impresora pedirá filamento en el soporte.',
    selectSlot: '-- Seleccionar ranura --',
    noActivePrintersAvailable: 'No hay impresoras activas disponibles',
    specificPrinter: 'Impresora específica',
    anyModel: 'Cualquier {{model}}',
    modelFallback: 'Modelo',
    targetModelLabel: 'Modelo objetivo',
    selectModelPlaceholder: 'Seleccionar un modelo...',
    locationFilter: 'Filtro de ubicación (opcional)',
    anyLocation: 'Cualquier ubicación',
    schedulerAssignHint: 'El planificador asignará a la primera impresora {{model}} inactiva disponible',
    schedulerAssignHintLocation: 'El planificador asignará a la primera impresora {{model}} inactiva disponible en {{location}}',
    selectPrinters: 'Seleccionar impresoras',
    printersSelected_one: '{{count}} impresora seleccionada',
    printersSelected_other: '{{count}} impresoras seleccionadas',
    selectAll: 'Seleccionar todo',
    inactive: '(inactiva)',
    unknownModel: 'Modelo desconocido',
    customMapping: 'Asignación personalizada',
    matchedCount: '({{matched}}/{{total}} coincidencias)',
    autoButton: 'Automático',
    hiddenPrinters_one: '{{count}} otra impresora oculta (modelo diferente) —',
    hiddenPrinters_other: '{{count}} otras impresoras ocultas (modelo diferente) —',
    showAll: 'mostrar todo',
    showOnlyModelPrinters: 'Mostrar solo impresoras {{model}}',
    selectAtLeastOnePrinter: 'Seleccione al menos una impresora',
    selectTargetModel: 'Seleccione un modelo de impresora objetivo',
    typeNotFound: '(Tipo no encontrado)',
    colorMismatch: '(Color no coincide)',
    ready: '(Listo)',
    clickToChangeSlot: 'Haga clic para cambiar la asignación de ranuras',
    costNotAvailable: 'N/D',
    requiredTypeNotFound: 'El tipo de filamento requerido no se encuentra en la impresora.',
    printJob: 'Trabajo de impresión',
    slicedModelMismatch: 'El archivo se laminó para {{slicedModel}}, pero se imprime en {{printerModel}}',
    archiveDataUnavailable: 'Datos del archivo no disponibles. Es posible que el archivo de origen se haya eliminado. El mapeo de filamentos está desactivado.',
    failedToComplete: 'No se pudo completar la operación',
    toastQueueItemUpdated: 'Elemento de la cola actualizado',
    toastUpdateFailed: 'No se pudo actualizar el elemento de la cola',
    toastSelectPrinter: 'Seleccione al menos una impresora',
    toastSelectModel: 'Seleccione un modelo de impresora objetivo',
    toastQueuedForModel: 'En cola para cualquier {{model}}',
    ejectFromSku: 'Predeterminado del SKU {{code}}',
    partialFailureTitle: '{{failed}} de {{total}} envíos fallaron:',
    toastPartialSuccess: '{{success}} correctas, {{failed}} fallidas',
    printerFallback: 'Impresora {{id}}',
    slotFallback: 'Ranura {{id}}',
    plateFallback: 'Cama {{index}}',
  },
  ...
  uploadModal: {
    ...
    libraryHint: 'Para SKU y series de producción, súbelos en el Gestor de archivos.',
    libraryHintLink: 'Ir al Gestor de archivos →',
    uploaded: 'subidos',
    failed: 'fallidos',
    uploading: 'Subiendo...',
    upload: 'Subir',
  ...
  notifications: {
    ...
    storageLow: 'Almacenamiento USB casi lleno',
    cooldownEscalation: 'Enfriamiento prolongado',
    // Quiet hours
    quietHours: 'Horas de silencio',
  ...
  fleetMetrics: {
    ...
    sections: {
      fleet: 'Flota',
      matrix: 'Matriz de la flota',
      stateOverTime: 'Estado de las impresoras a lo largo del tiempo',
      printsPerDay: 'Impresiones por día',
      downtimeByCause: 'Tiempo parado por causa',
      coolingAndEject: 'Enfriamiento y expulsión',
      recovery: 'Recuperación',
      partsBySku: 'Piezas por SKU',
    },
    summary: {
      now: 'Ahora',
      trend: 'Evolución',
      trendOf: 'Evolución: {{metric}}',
      ...
      period: {
        ...
        custom: 'Rango seleccionado',
      },
      rows: {
        avg_printing: 'Imprimiendo',
        avg_cycle_overhead: 'Entre impresiones',
        avg_idle: 'En reposo',
        avg_down: 'Paradas',
        avg_planned: 'Mantenimiento',
        peak_down: 'Pico de paradas',
        printers_in_fleet: 'En la flota',
        prints_per_day: 'Impresiones',
        prints_per_printer_per_day: 'Impresiones por impresora',
        uptime: 'Tiempo operativo',
        time_printing: 'Tiempo imprimiendo',
      },
      peak: 'pico {{count}}',
      downNow: 'Paradas ahora',
      nothingDown: 'Nada parado',
      showFewer: 'Mostrar menos',
      updated: 'Actualizado {{time}}',
      stale: 'Estado de hace {{age}}',
      openPrinter: 'Abrir impresora',
    },
    class: {
      cycle_overhead: 'Entre impresiones',
      cooling: 'Enfriando',
      ejecting: 'Expulsando',
      down: 'Parada',
      planned: 'Mantenimiento',
      out_of_fleet: 'Desactivada',
      not_recorded: 'Antes del registro',
      unobserved: 'Sin datos',
      incidents_only: 'Solo averías y retenciones',
      upcoming: 'Aún no transcurrido',
    },
    units: {
      perDay: '/ día',
      hours: 'h',
    ...
    matrix: {
      ...
      showDays: 'Mostrar los días',
      hideDays: 'Ocultar los días',
      sortBy: 'Ordenar por {{column}}',
      caption: '{{lens}} según la impresora, del {{from}} al {{to}}',
      captionDay: '{{lens}} según la impresora, {{date}}',
      details: 'Detalles',
      deletedPrinter: 'Impresora {{id}}',
      deactivated: 'Desactivada',
      fleetRow: 'Flota',
      fleetAvgMean: 'Media por impresora, sobre las impresoras listadas.',
      fleetAvgSum: 'Toda la flota sumada.',
      ...
      legend: {
        ...
        over: '{{hours}} h+',
        scale: 'de 0 a {{max}}',
        printingBand: 'Imprimiendo',
        otherBand: 'Otro',
        downBand: 'Parada',
      },
    },
    detail: {
      title: '{{printer}} · {{bucket}}',
      timeSplit: 'Reparto del tiempo',
      classes: 'Uso del tiempo',
      printsByOutcome: 'Impresiones por resultado',
      outcome: {
        completed: 'Completadas',
        failed: 'Fallidas',
        cancelled: 'Canceladas',
      ...
      openPrinter: 'Abrir impresora',
      noIntervals: 'No se registraron intervalos en este periodo.',
      noIncidents: 'Sin incidencias en este periodo.',
      noPrints: 'Sin impresiones en este periodo.',
      ongoing: 'En curso',
    },
    widgets: {
      showData: 'Mostrar los datos',
      showChart: 'Mostrar el gráfico',
      showDataFor: 'Mostrar los datos de {{chart}}',
      showChartFor: 'Mostrar el gráfico de {{chart}}',
      median: 'Mediana',
      p90: 'P90',
      overExpected: 'por encima de lo previsto',
      count: 'Recuento',
      variant: {
      ...
      clearedNoPerson: 'Resuelto sin intervención',
      inFleetLine: 'En la flota',
      peakDownLine: 'Pico de paradas',
      sku: 'SKU',
      units: 'Unidades',
      plates: 'Bandejas',
      successRate: 'Éxito',
    ...
    states: {
      loading: 'Cargando…',
      loadFailed: 'No se pudo cargar el historial de la flota.',
      retry: 'Reintentar',
      empty: 'Sin datos para este rango.',
      recordingGap: 'Registro del estado de las impresoras desde el {{date}}. Historial de averías y mantenimiento desde el {{earliest}}.',
    },
    header: {
    ...
    hints: {
      ...
      cycle_overhead: 'El trabajo propio de la granja entre impresiones: enfriar la cama y barrer la pieza.',
      planned: 'Modo mantenimiento: una persona sacó la impresora de los flujos automáticos.',
      uptime: 'Proporción del tiempo contabilizado en que la impresora podía aceptar trabajo.',
      time_printing: 'Proporción del tiempo contabilizado en que la impresora estuvo imprimiendo.',
      prints_per_printer: 'Impresiones completadas divididas entre los días contabilizados de cada impresora. Los días contabilizados proceden solo de los intervalos registrados, por lo que no es comparable con «Impresiones» mientras parte del periodo no esté registrada.',
      unobserved: 'No se registró nada en este tramo; solo se conocen averías y retenciones.',
      not_recorded: 'Anterior al primer estado registrado para esta impresora.',
      incidents_only: 'Aquí no se registró el estado de la impresora; solo lo cubre el registro de averías y mantenimiento.',
      whileRecorded: 'Las cifras del periodo abarcan solo el tiempo registrado.',
      timeframeFleet: 'Los días van de medianoche a medianoche en {{tz}}.',
      timeframePrints: 'Los días van de medianoche a medianoche UTC.',
    },
  },
};
