export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      bedDropHelp: 'Tras elevarse por encima de la pieza, baja la cama casi hasta el fondo de la máquina y vuelve a subirla para sacudir la pieza y soltarla antes del barrido.',
    ...
    tooltips: {
      ...
      bedDrop: 'Después de que la elevación libera la pieza, la cama caliente baja casi hasta su punto más bajo y vuelve a subir; la sacudida suelta una pieza pegada antes del barrido. Requiere un recorrido Z registrado para el modelo.',
