export default {
  ...
  skus: {
    ...
    suggest: {
      title: 'Sugerir desde archivo',
      description: 'Elija un archivo laminado para rellenar el código, el número de pieza y el nombre a partir de sus metadatos.',
      file: 'Archivo de biblioteca',
      filePlaceholder: 'Seleccione un archivo…',
      action: 'Sugerir',
      applied: 'Datos rellenados desde {{source}}',
  ...
  settings: {
    ...
    autoAddUntaggedDesc: 'Crear silenciosamente una bobina de inventario para las bandejas AMS que no tienen etiqueta RFID. Desactívalo si registras las bobinas manualmente de antemano para evitar duplicados.',
    ...
    farmCooldownStallWindow: 'Ventana de estancamiento de enfriamiento (min)',
    farmCooldownStallWindowHelp: 'Durante el enfriamiento de expulsión la cama debe seguir enfriándose; dos ventanas consecutivas sin progreso ponen la impresora en cuarentena (0 desactiva)',
    farmCooldownStallEpsilon: 'Enfriamiento mín. por ventana (°C)',
    farmCooldownStallEpsilonHelp: 'Enfriamiento mínimo (°C) por ventana que cuenta como progreso',
    farmCooldownMaxHold: 'Espera máx. de enfriamiento (min)',
    farmCooldownMaxHoldHelp: 'Tras estos minutos por encima del umbral de liberación, la expulsión se ejecuta de todos modos (0 = esperar el umbral indefinidamente)',
    farmCooldownPlateauMargin: 'Margen de expulsión en meseta (°C)',
    farmCooldownPlateauMarginHelp: 'Si el enfriamiento se estanca dentro de estos °C del umbral de liberación, expulsar (la cama se estabilizó a temperatura ambiente) en lugar de poner en cuarentena. Por encima del umbral + margen la cama sigue realmente caliente y la impresora se pone en cuarentena',
  ...
  inventory: {
    ...
    respool: {
      ...
      donorLine: 'Registro actual n.º {{id}} — quedan {{grams}} g — se archivará',
