export default {
  ...
  printers: {
    ...
    quarantine: {
      badge: 'En cuarentena',
      clear: 'Quitar cuarentena',
      cleared: 'Cuarentena retirada',
      clearTitle: '¿Quitar la cuarentena?',
      clearMessage: '¿Levantar la cuarentena de "{{name}}"? El planificador reanudará el envío de impresiones a esta impresora.',
      clearMessageWithReason: '¿Levantar la cuarentena de "{{name}}"? Motivo: {{reason}}. El planificador reanudará el envío de impresiones a esta impresora.',
    },
    plateStatus: {
