export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      coolingFanAssist: 'Asistencia del ventilador de refrigeración',
    ...
    tooltips: {
      ...
      coolingFanAssist: 'Hace funcionar el ventilador de pieza durante el barrido para ayudar a que una pieza pegada se suelte de la placa.',
