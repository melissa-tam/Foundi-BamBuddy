export default {
  ...
  skus: {
    ...
    files: {
      ...
      createFirst: 'Guarde primero el SKU y luego vincule archivos imprimibles.',
      file: 'Archivo',
      filePlaceholder: 'Seleccione un archivo…',
      plate: 'Placa',
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      cooldownRetries: 'Reintentos de enfriamiento',
    ...
    tooltips: {
      ...
      cooldownRetries: 'Cuántas veces se vuelve a comprobar la temperatura de la cama mientras se espera a que alcance el objetivo antes de rendirse.',
  ...
  printers: {
    ...
    phase: {
      printing: 'Imprimiendo',
      cooling: 'Enfriando hasta {{threshold}}°C (cama {{bed}}°C) — el barrido se ejecuta en el archivo',
      coolingNoBed: 'Enfriando hasta {{threshold}}°C — el barrido se ejecuta en el archivo',
  ...
  settings: {
    ...
    farmRetryMaxPerUnitHelp: 'Reintentos automáticos antes de marcar una placa como fallida (0–5)',
    farmEscalateConsecutiveFailures: 'Cuarentena tras fallos',
    farmEscalateConsecutiveFailuresHelp: 'Fallos consecutivos en una impresora que activan una cuarentena (1–10)',
