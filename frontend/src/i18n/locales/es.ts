export default {
  ...
  settings: {
    ...
    autoAddUntagged: 'Añadir automáticamente bandejas sin etiqueta',
    autoAddUntaggedDesc: 'Crear silenciosamente una bobina de inventario para las bandejas AMS que no tienen etiqueta RFID. Desactívalo si registras las bobinas manualmente de antemano para evitar duplicados. Las bobinas con etiqueta RFID tienen su propio interruptor de adición automática en los ajustes de Spoolman.',
    ...
    ejectUploadSkipIdentical: 'Reutilizar archivos de expulsión que ya están en la unidad USB',
    ejectUploadSkipIdenticalHelp: 'Omite volver a subir un archivo de expulsión cuando el idéntico ya está en la unidad USB de la impresora, ahorrando unos segundos por expulsión.',
    ejectUploadSkipIdenticalWarning: 'Actívalo solo después de que la prueba de expulsión en vivo confirme que el archivo de la unidad se reutiliza correctamente. En caso de duda, déjalo desactivado: volver a subirlo siempre garantiza el archivo correcto.',
    ejectSlim3mf: 'Adelgazar los archivos de expulsión',
    ejectSlim3mfHelp: 'Elimina el modelo 3D y la imagen de vista previa de los archivos de expulsión para que se suban más rápido; el movimiento de expulsión en sí no cambia.',
    ejectSlim3mfWarning: 'Restringido por hardware: ejecuta la escalera de hardware de expulsión completa con archivos adelgazados antes de activarlo para producción desatendida. Déjalo desactivado hasta que esa escalera se supere.',
  ...
  inventory: {
    ...
    taglessMintToast: 'Se empezó a rastrear una bobina sin etiqueta en {{printer}} ranura {{slot}}',
    freshRoll: {
