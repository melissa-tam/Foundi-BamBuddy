export default {
  ...
  inventory: {
    ...
    freshRoll: {
      ...
      message: 'La bobina sin etiqueta en {{location}} se ha usado más de la mitad de su peso nominal. Si ahora hay un rollo nuevo cargado, regístralo para que el seguimiento de filamento siga siendo preciso.',
      confirm: 'Rollo nuevo',
      pending: 'Registrando…',
    ...
    respool: {
      ...
      promptToast: 'Bobina casi vacía en {{printer}} ranura {{slot}} — ¿nuevo rollo en esta etiqueta?',
