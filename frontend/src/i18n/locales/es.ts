export default {
  ...
  fleetMetrics: {
    ...
    matrix: {
      ...
      caption: '{{lens}} por impresora, del {{from}} al {{to}}',
      details: 'Detalles',
    ...
    states: {
      ...
      firstRun: 'Registro del estado de las impresoras desde el {{date}}. Historial de averías y mantenimiento desde el {{earliest}}.',
    },
    header: {
    ...
    hints: {
      ...
      prints_per_printer: 'Impresiones completadas divididas entre los días contabilizados de cada impresora.',
