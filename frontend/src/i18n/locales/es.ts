export default {
  ...
  printers: {
    ...
    toast: {
      ...
      recheckFailed: 'Comprobación fallida',
    ...
    // RFID
    rfid: {
      disabledFilamentEngaged: 'Descarga primero el filamento — el AMS no puede leer una etiqueta mientras hay filamento cargado',
  ...
  inventory: {
    ...
    respool: {
      ...
      noteLabel: 'Nota',
      notePlaceholder: 'Opcional',
      actionDesc: 'Pasar esta etiqueta Bambu a una bobina nueva',
    },
    bulk: {
  ...
  ams: {
    ...
    emptySlotBinding: {
      ...
      clearMessage: 'Libera {{spool}} de esta ranura. La bobina vuelve al inventario con su consumo registrado intacto: no se borra nada.',
    },
    unknown: 'Desconocido',
    humidity: 'Humedad',
    temperature: 'Temperatura',
