export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      coolingFanAssist: 'Soğutma fanı desteği',
    ...
    tooltips: {
      ...
      coolingFanAssist: 'İnatçı bir parçanın tabladan ayrılmasına yardımcı olmak için süpürme sırasında parça soğutma fanını çalıştırır.',
