export default {
  ...
  fleetMetrics: {
    ...
    matrix: {
      ...
      caption: 'Yazıcı başına {{lens}}, {{from}} – {{to}}',
      details: 'Ayrıntılar',
    ...
    states: {
      ...
      firstRun: 'Yazıcı durumu kaydı {{date}} tarihinde başladı. Arıza ve bakım geçmişi {{earliest}} tarihinden itibaren.',
    },
    header: {
    ...
    hints: {
      ...
      prints_per_printer: 'Tamamlanan baskıların, her yazıcı için sayılan gün sayısına bölümü.',
