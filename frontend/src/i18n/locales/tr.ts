export default {
  ...
  printers: {
    ...
    eject: {
      ...
      foreignBody: 'Bu baskı çiftlik tarafından gönderilmedi (Bambu Studio\'dan elle gönderildi). Süpürme, aşağıda seçtiğiniz çıkarma profilini kullanır — önce algılanan parça yüksekliğinin doğru göründüğünü onaylayın.',
      foreignPrintNameLabel: 'Baskı',
      foreignUnknownPrint: 'Bilinmiyor',
      foreignPartHeightLabel: 'Algılanan parça yüksekliği',
