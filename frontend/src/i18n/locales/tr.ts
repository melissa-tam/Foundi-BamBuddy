export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      cooldownRetries: 'Soğutma yeniden denemeleri',
      clearance: 'Boşluk (mm)',
      zOffset: 'Z ofseti (mm)',
    ...
    tooltips: {
      ...
      cooldownRetries: 'Hedefe ulaşması beklenirken tabla sıcaklığının, vazgeçmeden önce kaç kez yeniden kontrol edileceği.',
  ...
  printers: {
    ...
    phase: {
      printing: 'Yazdırılıyor',
      cooling: '{{threshold}}°C\'ye soğutuluyor (yatak {{bed}}°C) — süpürme dosya içinde çalışır',
  ...
  settings: {
    ...
    farmRetryMaxPerUnitHelp: 'Bir tabla başarısız olarak işaretlenmeden önceki otomatik yeniden denemeler (0–5)',
    farmEscalateConsecutiveFailures: 'Hatalardan sonra karantina',
    farmEscalateConsecutiveFailuresHelp: 'Bir yazıcıda karantinayı tetikleyen ardışık hata sayısı (1–10)',
