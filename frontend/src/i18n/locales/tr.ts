export default {
  ...
  settings: {
    ...
    ejectUploadSkipIdentical: 'USB sürücüde zaten bulunan çıkarma dosyalarını yeniden kullan',
    ejectUploadSkipIdenticalHelp: 'Aynı çıkarma dosyası yazıcının USB sürücüsünde zaten varsa yeniden yüklemeyi atlar ve her çıkarmada birkaç saniye kazandırır.',
    ejectUploadSkipIdenticalWarning: 'Yalnızca canlı çıkarma probu, sürücüdeki dosyanın doğru şekilde yeniden kullanıldığını doğruladıktan sonra etkinleştirin. Emin değilseniz kapalı bırakın; yeniden yükleme her zaman doğru dosyayı garanti eder.',
    ejectSlim3mf: 'Çıkarma dosyalarını inceltin',
    ejectSlim3mfHelp: 'Daha hızlı yüklenmeleri için çıkarma dosyalarından 3D modeli ve önizleme görüntüsünü çıkarır; çıkarma hareketinin kendisi değişmez.',
    ejectSlim3mfWarning: 'Donanım kilitli: gözetimsiz üretim için etkinleştirmeden önce inceltilmiş dosyalarla tam çıkarma donanım merdivenini çalıştırın. O merdiven geçene kadar kapalı bırakın.',
