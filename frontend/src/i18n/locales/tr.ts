export default {
  ...
  printers: {
    ...
    toast: {
      ...
      recheckFailed: 'Denetim başarısız',
  ...
  inventory: {
    ...
    respool: {
      action: 'Etiketi yeniden makaraya al…',
      ...
      noteLabel: 'Not',
      notePlaceholder: 'İsteğe bağlı',
      actionDesc: 'Bu Bambu etiketini yeni bir makaraya taşı',
    },
    bulk: {
  ...
  ams: {
    ...
    emptySlotBinding: {
      ...
      clearMessage: '{{spool}} bu yuvadan serbest bırakılır. Makara, kayıtlı kullanımı korunarak envantere döner — hiçbir şey silinmez.',
    },
    unknown: 'Bilinmiyor',
    humidity: 'Nem',
    temperature: 'Sıcaklık',
