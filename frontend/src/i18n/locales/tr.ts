export default {
  // SKU Kataloğu (çiftlik üretimi, aşama 2)
  skus: {
    nav: 'Ürün kodları',
    title: 'SKU Kataloğu',
    description: 'Satılabilir parça kodları; her biri bir veya daha fazla kitaplık dosyası plakasını ve üretim çalışmaları için varsayılan bir çıkarma profilini ilişkilendirir.',
    newSku: 'Yeni SKU',
    loadError: 'SKU’lar yüklenemedi.',
    empty: {
      title: 'Henüz SKU yok',
      body: 'Yazdırılabilir dosyaları ilişkilendirmek ve üretimi izlemek için ilk SKU’nuzu oluşturun.',
    },
    columns: {
      files: 'Dosyalar',
      unitsCompleted: 'Toplam birim',
      successRate: 'Başarı',
    },
    createTitle: 'SKU oluştur',
    editTitle: 'SKU düzenle',
    fields: {
      code: 'Kod',
      name: 'Ad',
      partNumber: 'Parça numarası',
      notes: 'Notlar',
      defaultEjectProfile: 'Varsayılan çıkarma profili',
      noEjectProfile: 'Yok',
    },
    codeRequired: 'Kod gereklidir.',
    nameRequired: 'Ad gereklidir.',
    created: 'SKU oluşturuldu',
    updated: 'SKU güncellendi',
    deleted: 'SKU silindi',
    saveFailed: 'SKU kaydedilemedi',
    deleteFailed: 'SKU silinemedi',
    deleteTitle: 'Bu SKU silinsin mi?',
    deleteBody: '"{{code}}" kalıcı olarak kaldırılacak. Bu işlem geri alınamaz.',
    suggest: {
      appliedFromObjectName: 'Ayrıntılar dosyadaki parça adlarından dolduruldu',
      appliedFromFilename: 'Ayrıntılar dosya adından dolduruldu',
      appliedGeneric: 'Bilgiler dosyadan dolduruldu',
      failed: 'Ayrıntılar önerilemedi',
    },
    files: {
      ...
      plate: 'Plaka',
      unitsPerPlate: 'Plaka başına birim',
      plateUnits: 'Plaka {{plate}} · plaka başına {{units}}',
      add: 'Dosya ekle',
      added: 'Dosya bağlandı',
      addFailed: 'Dosya bağlanamadı',
      savedButLinkFailed: 'SKU kaydedildi, ancak dosya bağlanamadı: {{reason}}',
      remove: 'Kaldır',
      removed: 'Dosya bağlantısı kaldırıldı',
      removeFailed: 'Bağlantı kaldırılamadı',
      removeTitle: 'Bu dosyanın bağlantısı kaldırılsın mı?',
      removeBody: '"{{name}}" bu SKU’dan bağlantısı kaldırılacak.',
    },
  },

  // Üretim çalışmaları (çiftlik üretimi, aşama 2)
  productionRuns: {
    nav: 'Üretim',
    title: 'Üretim çalışmaları',
    description: 'Bir SKU’nun kopyalarını, hedef birim sayısına ulaşılana kadar yazıcılara dağıtın; ilerlemeyi canlı olarak görün.',
    loadError: 'Üretim çalışmaları yüklenemedi.',
    empty: {
      title: 'Henüz üretim çalışması yok',
      body: 'Bir SKU’yu hedef birim sayısına kadar yazdırmak için bir çalışma başlatın.',
      noSkus: 'Bir çalışma başlatmadan önce en az bir bağlı dosyası olan bir SKU ekleyin.',
    },
    startTitle: 'Üretim çalışması başlat',
    startAction: 'Çalışmayı başlat',
    runAgain: 'Tekrar çalıştır',
    advanced: 'Gelişmiş',
    starting: 'Başlatılıyor…',
    started: 'Üretim çalışması başlatıldı',
    startFailed: 'Çalışma başlatılamadı',
    noFiles: 'Bu SKU’nun yazdırılacak bağlı dosyası yok.',
    fileRequired: 'Yazdırılacak bir dosya seçin.',
    targetRequired: 'En az 1 birimlik bir hedef girin.',
    printerRequired: 'En az bir yazıcı seçin.',
    overProduction: '{{planned}} birim ({{plates}} plaka) üretecek — {{target}} hedefinden {{extra}} fazla.',
    fields: {
      sku: 'SKU',
      file: 'Dosya / plaka',
      filePlaceholder: 'Bir dosya seçin…',
      plateUnits: 'plaka {{plate}}, {{units}}/plaka',
      targetUnits: 'Hedef birim',
      printers: 'Yazıcılar',
      ...
      skuNoFile: '— dosya bağlı değil',
      skuNoFileHint: 'Başlatılabilir hale getirmek için SKU sayfasında bir SKU’ya dosya bağlayın.',
    },
    status: {
      active: 'Etkin',
      paused: 'Duraklatıldı',
    ...
    platesProgress: '{{completed}} / {{total}} plaka',
    stats: {
      units: 'Birim',
      target: 'Hedef',
      failed: 'Başarısız',
    ...
    resume: 'Sürdür',
    abort: 'İptal et',
    paused: 'Çalışma duraklatıldı',
    resumed: 'Çalışma sürdürüldü',
    aborted: 'Çalışma iptal edildi',
    actionFailed: 'İşlem başarısız oldu',
    startNow: 'Şimdi başlat',
    startedNow: 'Çalışma başlatıldı',
    reschedule: 'Yeniden zamanla',
    rescheduleTitle: 'Başlangıç saatini değiştir',
    rescheduled: 'Başlangıç saati güncellendi',
    schedule: {
      sectionTitle: 'Başlangıç zamanı',
      whenToStart: 'Ne zaman başlasın',
      asap: 'Hemen başlat',
      later: 'Sonrası için zamanla',
      date: 'Tarih',
      time: 'Saat',
      openCalendar: 'Takvimi aç',
      pastError: 'Gelecekte bir zaman seçin.',
      invalidError: 'Geçerli bir tarih ve saat girin.',
      helpAsap: 'Uygun bir yazıcı boşalır boşalmaz çalışma başlar.',
      helpScheduled: 'Yazıcı boşsa çalışma seçilen saatte başlar; meşgulse biri boşalana kadar bekler.',
      startsIn: '{{when}} başlar',
    },
    viewDetails: 'Çalışma ayrıntılarını görüntüle',
    blockedPrinters: 'Yazıcı engellendi',
    pauseReason: {
      operator: 'Operatör tarafından duraklatıldı',
    ...
    detail: {
      back: 'Tüm üretim çalışmaları',
      loadError: 'Bu üretim çalışması yüklenemedi.',
      notFound: 'Üretim çalışması bulunamadı.',
      printersTitle: 'Yazıcılar',
      noPrinters: 'Henüz yazıcı atanmadı — zamanlayıcı her ünite için boşta uyumlu bir yazıcı seçer.',
      unitsTitle: 'Üniteler',
      noUnits: 'Henüz ünite yok.',
      unitCol: 'Ünite',
      statusCol: 'Durum',
      printerCol: 'Yazıcı',
      ...
      retryOf: 'Ünite {{id}} için {{count}}. yeniden deneme',
      unitStatus: {
        pending: 'Beklemede',
      ...
      waiting: {
        ...
        visionHold: 'Plaka kontrolünde duraklatıldı — plakayı düzeltin, sonra sürdürün',
        ...
        externalFeedFault: 'Harici makara beslenmedi — tutucuyu ve PTFE borusunu kontrol edin, sonra yazıcıdan devam ettirin',
        pinnedTrayUnavailable: 'Sabitlenen yuva bu yazıcıda yüklü değil — yükleyin ya da sabitlemeyi kaldırın',
        ...
        libraryFileMissing: 'Kaynak dosya kitaplıkta yok — dosyayı geri yükleyin veya yeniden yükleyin',
      ...
      printerState: {
        ...
        stalled: 'Baskı sırasında çevrimdışı takıldı',
        visionHold: 'Plaka kontrolünde bekletiliyor',
        filamentShort: 'Filament az',
        noUsbDrive: 'USB sürücü yok',
      },
      eligibility: {
        title: 'Katılmayan yazıcılar',
        description: 'Bu yazıcılar sorun giderilene kadar bu turdan birim almayacak:',
        offline: 'Çevrimdışı',
        quarantined: 'Karantinada',
        awaitingPlateClear: 'Yatak temizlenmedi',
        modelMismatch: 'Model uyuşmazlığı',
        filamentShort: 'Filament az',
        noUsbDrive: 'USB sürücü yok',
      },
    },
    abortTitle: 'Bu çalışma iptal edilsin mi?',
    abortBody: '"{{name}}" iptal edilecek. Devam eden plakalar tamamlanır ancak yeni plaka başlatılmaz. Bu işlem geri alınamaz.',
    delete: 'Sil',
    deleted: 'Çalışma silindi',
    ...
    firstArticle: {
      ...
      requireHelp: 'İlk parça otomatik çıkarma olmadan basılır ve seri onayınız için beklemede tutulur.',
      retriesLabel: 'Tabla başına yeniden deneme',
      escalateLabel: 'Ardışık hatalardan sonra karantinaya al',
      printing: 'İlk parça basılıyor',
      awaitingTitle: 'İlk parça onay bekliyor',
      awaitingBody: 'İlk parça basıldı. İnceleyin, ardından seriyi sürdürmek için onaylayın ya da durdurup düzeltmek için reddedin.',
      approvePhysical: 'Onayla — parçayı çıkardım',
      approveEject: 'Onayla ve uzaktan çıkar',
      reject: 'Reddet…',
      approveConfirm: 'Onayla',
      approvePhysicalTitle: 'İlk parça onaylansın mı?',
      approvePhysicalBody: 'Basılan parçayı tabladan çıkardığınızı onaylayın. Seri devam edecek ve kalan tablaları gönderecek.',
      approveEjectTitle: 'Onaylanıp uzaktan çıkarılsın mı?',
      approveEjectBody: 'Seri devam etmeden önce baskı kafası parçayı tabladan süpürecek. Tablanın engellerden arınmış olduğundan ve kimsenin elini yazıcının içine sokmadığından emin olun.',
      rejectTitle: 'İlk parçayı reddet',
      rejectBody: 'Neyin yanlış olduğunu açıklayın. Seriyi daha sonra sürdürmek yeni bir ilk parçayı baştan başlatır.',
      rejectReasonLabel: 'Neden',
      rejectReasonPlaceholder: 'örn. çarpık köşeler, zayıf yapışma…',
      rejectReasonRequired: 'Bir neden gereklidir.',
      rejectAction: 'İlk parçayı reddet',
      rejectedBadge: 'İlk parça reddedildi',
      rejectedReason: 'Neden: {{reason}}',
      rejectedHint: 'Sürdürmek yeni bir ilk parça başlatır.',
      approvedBadge: 'İlk parça onaylandı',
      approved: 'İlk parça onaylandı',
  ...
  ejectProfiles: {
    nav: 'Çıkarma profilleri',
    title: 'Çıkarma profilleri',
    description: 'Tabla soğuduğunda biten parçaları tabladan süpüren otomatik parça çıkarma profilleri.',
    newProfile: 'Yeni profil',
    loadError: 'Çıkarma profilleri yüklenemedi.',
    duplicateAction: 'Çoğalt',
    copyName: '{{name}} (kopya)',
    empty: {
      title: 'Henüz çıkarma profili yok',
      body: 'Biten parçaları tabladan otomatik olarak temizlemek için ilk profilinizi oluşturun.',
    },
    columns: {
      passes: 'Geçişler',
      ejectSpeed: 'Çıkarma hızı',
      maxHeight: 'Maks. yükseklik',
    },
    createTitle: 'Çıkarma profili oluştur',
    editTitle: 'Çıkarma profilini düzenle',
    fields: {
      name: 'Ad',
      clearance: 'Boşluk (mm)',
      zOffset: 'Z ofseti (mm)',
      descentSteps: 'İniş adımları',
      xPasses: 'X geçişleri',
      xMargin: 'X kenar payı (mm)',
      frontOverhang: 'Ön çıkıntı (mm)',
      backOverhang: 'Arka çıkıntı (mm)',
      ejectSpeed: 'Çıkarma hızı (mm/min)',
      skimSpeed: 'Sıyırma hızı (mm/min)',
      finalSkim: 'Son sıyırma geçişi',
      finalSkimHelp: 'Süpürmelerden sonra ince kalıntıları temizlemek için tablanın hemen üzerinde yavaş bir sıyırma geçişi ekler. Tam olarak bir kez itmek için kapatın.',
      maxPartHeight: 'Maks. parça yüksekliği (mm)',
      sweepStartHeight: 'Süpürme başlangıç yüksekliği (%)',
      sweepStartHeightHelp: 'Alçalan süpürmeyi parça yüksekliğinin bu yüzdesinde başlat (%100 = parça üstü).',
      sweepBand: 'X süpürme bandını sınırla',
      sweepBandHelp: 'Tam genişlik yerine tabla genişliğinin yalnızca bir alt bandını süpür. Tam genişlik için kapalı bırakın.',
      sweepXMin: 'X bandı min. (mm)',
      sweepXMax: 'X bandı maks. (mm)',
      bedDrop: 'Tabla indirmeli ayırma desteği',
      bedDropHelp: 'Tabla neredeyse makine tabanına kadar iner ve kaldırma yüksekliğine döner; bu sarsıntı, süpürmeden önce yapışmış bir parçayı gevşetir.',
      bedDropClearance: 'Alt boşluk (mm)',
      bedDropDwell: 'En alt noktada bekleme (sn)',
      bedDropDwellHelp: 'Tabla, kaldırma yüksekliğine dönmeden önce iniş sonundaki en alt noktada bu kadar saniye bekler.',
      bedDropJitter: 'En alt noktada sarsma',
      bedDropJitterHelp: 'Tabla en alt noktada, belirlenen mesafe kadar yükselip geri döner ve bunu belirlenen çevrim sayısı kadar yineler.',
      bedDropJitterCycles: 'Sarsma çevrimi',
      bedDropJitterMm: 'Sarsma mesafesi (mm)',
    },
    tooltips: {
      name: 'Bu profili tanımak için kısa bir etiket – profil listesinde ve seçicilerde gösterilir.',
      clearance: 'Baskı kafasının konuma geçerken parçanın ne kadar üzerinde kaldığı; böylece süpürmeden önce parçaya değmez.',
      zOffset: 'Süpürme geçişi yüksekliğinde ince ayar – nozul sürtüyorsa artırın, parça kaçırılıyorsa azaltın.',
      descentSteps: 'Baskı kafasının parçayı itmeden önce arkasına geçmek için yaptığı küçük iniş adımlarının sayısı.',
      xPasses: 'Parçayı temizlemek için tabla üzerinde yapılacak yanal süpürme geçişi sayısı.',
      xMargin: 'Baskı kafasının çerçeveye çarpmaması için tablanın sol ve sağ kenarlarından bırakılan boşluk.',
      frontOverhang: 'Parçanın tamamen itilmesi için süpürmenin parçanın önünden ne kadar ileriye uzandığı.',
      backOverhang: 'Baskı kafasının itmeden önce parçanın tamamen arkasına geçebilmesi için süpürmenin parçanın ne kadar arkasından başladığı.',
      ejectSpeed: 'Parçayı tabladan iten itme geçişleri sırasında baskı kafasının ne kadar hızlı hareket ettiği.',
      skimSpeed: 'Kalıntıları temizleyen daha hafif sıyırma geçişleri sırasında baskı kafasının ne kadar hızlı hareket ettiği.',
      finalSkim: 'Ana süpürmelerden sonra ince kalıntıları temizlemek için tablanın hemen üzerinde ek bir yavaş geçiş yapar. Tek bir itme için kapatın (ör. uzun bir parça için orta yükseklikte tek bir şerit).',
      maxPartHeight: 'Bu profilin çıkarabileceği en yüksek parça – dilimlenmiş parça daha yüksekse gönderim engellenir.',
      sweepStartHeight: 'Alçalan süpürmenin parçada başladığı yükseklik, yüzde olarak (geçerli 1-100%; 100% = parçanın en üstü).',
      sweepBand: 'Tüm genişlik yerine tablanın yalnızca bir şeridini süpür – parçalar hep aynı yerde duruyorsa kullanışlıdır.',
      sweepXMin: 'Süpürme şeridinin sol kenarı, tabla başlangıcından mm cinsinden. Geçerli 0-340 mm (H2S tabla genişliği); maksimumdan küçük olmalı ve en az 10 mm genişliğinde bir şerit bırakmalı.',
      sweepXMax: 'Süpürme şeridinin sağ kenarı, tabla başlangıcından mm cinsinden. Geçerli 0-340 mm (H2S tabla genişliği); minimumdan büyük olmalı ve en az 10 mm genişliğinde bir şerit bırakmalı.',
      bedDrop: 'Isıtmalı tabla neredeyse en alt noktasına iner ve kaldırma yüksekliğine döner; bu sarsıntı, süpürmeden önce yapışmış bir parçayı gevşetir. Model için kayıtlı bir Z hareketi gerektirir.',
      bedDropClearance: 'İniş sırasında tablanın en alt konumundan korunan boşluk — 50 mm = tabandan 5 cm yukarıda dur.',
      bedDropDwell: 'En alt noktadaki fazladan saniyeler, yapışmış bir parçanın süpürmeden önce tamamen ayrılmasına zaman tanır.',
      bedDropJitter: 'En alt noktadaki kısa aşağı-yukarı hareketler, tek sarsıntının söküp alamadığı bir parçayı gevşetir.',
    },
    nameRequired: 'Ad gereklidir.',
    created: 'Çıkarma profili oluşturuldu',
    updated: 'Çıkarma profili güncellendi',
    deleted: 'Çıkarma profili silindi',
    saveFailed: 'Profil kaydedilemedi',
    deleteFailed: 'Profil silinemedi',
    deleteTitle: 'Bu profil silinsin mi?',
    deleteBody: '"{{name}}" kalıcı olarak kaldırılacak. Bu geri alınamaz.',
    preview: {
      title: 'Önizleme ve doğrulama',
      description: 'Kullanmadan önce doğrulamak için bir kitaplık dosyası ve tablası için çıkarma G-code\'unu oluşturun.',
      file: 'Kitaplık dosyası',
      filePlaceholder: 'Bir dosya seçin…',
      plate: 'Tabla',
      run: 'Önizleme oluştur',
      running: 'Oluşturuluyor…',
      noFiles: 'Önizlenecek kitaplık dosyası yok.',
      ok: 'Doğrulama başarılı',
      errors: 'Hatalar',
      warnings: 'Uyarılar',
      maxZ: 'Maks. Z yüksekliği: {{value}} mm',
      showGcode: 'G-code\'u göster',
      hideGcode: 'G-code\'u gizle',
      gcodeLabel: 'Oluşturulan G-code',
      failed: 'Önizleme başarısız',
    },
    dryRun: {
      action: 'Kuru çalışma',
      title: 'Kuru çalışma testi',
      description: 'Bu profilin yalnızca geometri testini bir yazıcıya gönderin veya incelemek için test dosyasını indirin.',
      printer: 'Yazıcı',
      printerPlaceholder: 'Bağlı bir yazıcı seçin…',
      loadingPrinters: 'Yazıcı bağlantıları kontrol ediliyor…',
      noPrinters: 'Kullanılabilir bağlı yazıcı yok.',
      warningTitle: 'Boş tabla gerekli',
      warning: 'Bu test tablanın merkezine referans alır ve üzerinden süpürür, bu yüzden tabla BOŞ olmalıdır. Gönderimden sonra iş, yazıcıdaki tabla tutmasını temizleyene kadar bekler.',
      dispatch: 'Testi gönder',
      dispatching: 'Gönderiliyor…',
      download: 'Dosyayı indir',
      downloading: 'Hazırlanıyor…',
      dispatchFailed: 'Test gönderilemedi.',
      downloadFailed: 'Kuru çalışma dosyası oluşturulamadı.',
      allowUnvalidated: 'Doğrulanmamış geometriye izin ver (yalnızca donanım merdiveni için)',
      allowUnvalidatedWarning: 'Bu modelin hareket zarfı donanımla DOĞRULANMADI. Yalnızca merdivende, gözetim altında ve BOŞ tablada gönderin.',
    },
    geometry: {
      model: 'Yazıcı modeli',
      noModels: 'Geometri kayıt defterinde giriş yok',
      unvalidated: 'donanım doğrulaması yapılmamış',
      warningsTitle: 'Geometri uyarıları',
      downloadModel: 'İndirme için geometri modeli',
      downloadModelPlaceholder: 'Seçilen yazıcının modelini kullan',
      bandInverted: 'X bandı minimumu, X bandı maksimumundan küçük olmalıdır.',
      bandTooNarrow: 'Süpürme bandı en az {{min}} mm genişliğinde olmalıdır.',
      bandExceedsBed: 'X bandı maksimumu, kayıtlı en geniş tablayı ({{max}} mm) aşıyor.',
      heightExceedsCeiling: 'Kayıtlı tüm modellerin yükseklik sınırının üzerinde (en fazla {{max}} mm) — çıkarma gönderimi reddedilir.',
      bedDropNoTravel: 'Kayıtlı Z hareketi olmayan modeller ({{models}}) bu profili oluşturamaz — geometri kayıt defterinde z_travel_mm değerini ayarlayın.',
      bedDropBedslinger: 'Tabla indirme yardımı, hareketli tablalı modellerde ({{models}}) kullanılamaz — bu modellerin tablası Z ekseninde hareket etmez.',
    },
    geometryManager: {
      title: 'Model geometri kayıt defteri',
      description: 'Her yazıcı modeli için tabla boyutu, hareket zarfı ve donanım doğrulama durumu. Satırlar sunucu tohumlarından gelir — ekleme düğmesi yoktur; geometriyi düzeltmek veya doğrulamasını değiştirmek için bir modeli düzenleyin.',
      edit: 'Geometriyi düzenle',
      editTitle: '{{model}} geometrisini düzenle',
      saved: 'Model geometrisi kaydedildi',
      saveFailed: 'Model geometrisi kaydedilemedi',
      zTravelUnset: 'Kayıtlı Z hareketi yok — bu modelde tabla indirme yardımı güvenli şekilde devre dışı kalır.',
      validatedBadge: 'Doğrulandı',
      notValidatedBadge: 'Doğrulanmadı',
      confirmValidateTitle: 'Model doğrulandı olarak işaretlensin mi?',
      ...
      columns: {
        ...
        envelope: 'Zarf (mm)',
        zTravel: 'Z hareketi',
        maxPartHeight: 'Maks. parça yüksekliği',
        motion: 'Hareket',
      ...
      motion: {
        bedZ: 'Z eksenli tabla',
        bedslinger: 'Hareketli tabla',
      },
      fields: {
        bedX: 'Tabla genişliği X (mm)',
        bedY: 'Tabla derinliği Y (mm)',
        envXMin: 'Zarf X min (mm)',
        envXMax: 'Zarf X maks (mm)',
        envYMin: 'Zarf Y min (mm)',
        envYMax: 'Zarf Y maks (mm)',
        maxPartHeight: 'Maks. parça yüksekliği (mm)',
    ...
    queueLabel: 'Çıkarma profili (otomatik parça çıkarma)',
    queueHelp: 'Tabla çıkarma çizgisine kadar soğuduğunda parça süpürülür.',
  },
  // Navigasyon
  nav: {
    printers: 'Yazıcılar',
  ...
  printers: {
    ...
    deactivated: {
      ...
      panelState: 'Devre dışı — bu yazıcıyla bağlantı yok.',
      activate: 'Etkinleştir',
      toastActivated: '{{name}} etkinleştirildi',
      editFieldLabel: 'Devre dışı',
      editFieldHelp: 'MQTT oturumu yok; bu örnek için görünmez (paralel kurulumlar, hizmetten çıkarma).',
    },
    // Hazne ışığı
    ...
    toast: {
      ...
      recheckUnchanged: 'Yuva {{slot}} değişmedi. Son denetimden bu yana makara hareketi kaydedilmedi.',
      recheckMinted: 'Yuva {{slot}}: yeni makara kaydedildi. {{grams}} g varsayıldı.',
      recheckIdentified: 'Yuva {{slot}}: {{identity}} etiketinden kaydedildi.',
      recheckIdentifiedUnnamed: 'Yuva {{slot}}: etiket okundu.',
      recheckIdentifiedNoRead: 'Yuva {{slot}}: {{identity}} kayıtlı. Etiketin yeniden okunması ertelendi.',
      recheckQueued: 'Yuva {{slot}} denetimi kuyruğa alındı. Çiftlik etiketi bir sonraki boşta penceresinde okuyacak ve makarayı o zaman kaydedecek.',
      recheckEmpty: 'Yuva {{slot}} boş. Bir makara takın, sonra yeniden denetleyin.',
      recheckRestored: 'Yuva {{slot}}: önceki makara geri yüklendi.',
      recheckFailed: 'Yuva {{slot}}: denetim başarısız.',
      recheckUndoNoOffer: 'Yuva {{slot}}: geri alınacak denetim yok.',
      recheckUndoNoPredecessor: 'Yuva {{slot}}: bu yuva için kayıtlı önceki makara yok.',
      recheckUndoMintGone: 'Yuva {{slot}}: kaydedilen makara artık yok.',
      recheckUndoBoundElsewhere: 'Yuva {{slot}}: önceki makara başka bir tepside takılı. Hiçbir şey geri yüklenmedi.',
      recheckUndoFailed: 'Yuva {{slot}}: geri yükleme başarısız. {{detail}}',
    ...
    quarantine: {
      badge: 'Karantinada',
      recover: 'Kurtar ve sürdür',
      recoverSuccess: 'Yazıcı kurtarıldı — {{count}} çalışma sürdürüldü.',
      recoverError: 'Yazıcı kurtarılamadı',
      recoverTitle: 'Kurtarılsın ve sürdürülsün mü?',
      recoverMessage: '"{{name}}" kurtarılsın mı? Bu, şunları yapan açık bir geçersiz kılmadır:',
    ...
    phase: {
      ...
      coolingToPlateau: 'Platoya kadar soğutuluyor',
      coolingToPlateauHeld: 'Platoya kadar soğutuluyor · plaka yukarıda',
    ...
    ejectNotQualified: 'Bu model için otomatik çıkarma henüz donanım onaylı değil — gözetimsiz kullanımdan önce donanım merdivenini çalıştırın.',
    plateStatus: {
      markCleared: 'Plakayı temizlendi olarak işaretle',
      cleared: 'Plaka Temiz',
      notCleared: 'Plaka Temiz Değil',
      inUse: 'Plaka Kullanımda',
      markClearedCancelsEject: 'Plakayı temizlendi olarak işaretlemek, bekleyen otomatik çıkarmayı iptal eder.',
      ejectInFlight: 'Çıkarma sürüyor. Geçersiz kılmak için Kurtar ve sürdür\'ü kullanın.',
      markOccupied: 'Plakayı dolu olarak işaretle',
      markOccupiedSuccess: 'Plaka dolu olarak işaretlendi — temizlenene kadar gönderim engellendi',
      ejectInProgress: 'Çıkarma sürüyor · {{age}}',
      ejectStalled: 'Çıkarma takıldı · {{age}} — çiftlik süpürmenin izini kaybetti',
      refusal: 'Plaka kontrolü: {{message}}',
      menuRecover: 'Yazıcıyı kurtar',
      clearedClosedFault: 'Ekipman arızası kapatıldı',
    },
    // Manuel çıkarma (W2) + yeni makara istemi (W6)
    eject: {
      action: 'Plakayı çıkar',
      dispatched: 'Çıkarma başlatıldı',
      confirmTitle: 'Plaka sıcakken çıkarılsın mı?',
      confirmBodyNoLine: 'Plaka {{bed}} °C — karşılaştırılacak atölye havası veya hazne ölçümü yok. Şimdi çıkarmak parçayı bu sıcaklıkta süpürür. Devam edilsin mi?',
      confirmBody: 'Plaka {{bed}} °C — {{threshold}} °C bırakma eşiğinin üzerinde. Şimdi çıkarmak, plaka hâlâ sıcakken parçayı süpürür. Devam edilsin mi?',
      confirm: 'Plakayı çıkar',
      cancel: 'İptal',
      foreignPrintNameLabel: 'Baskı',
      foreignUnknownPrint: 'Bilinmiyor',
      foreignPartHeightEditLabel: 'Parça yüksekliği (mm)',
      foreignProfileLabel: 'Çıkarma profili',
      foreignSuggested: 'önerilen',
      foreignNoProfiles: 'Kullanılabilir çıkarma profili yok',
      foreignConfirm: 'Plakayı çıkar',
      dialog: {
        foreignTitle: 'Plakayı çıkar — baskı çiftlik tarafından gönderilmedi',
        farmUnitTitle: 'Plakayı çıkar — {{name}}',
        declaredTitle: 'Plakayı çıkar',
        body: 'Süpürme, aşağıdaki parça yüksekliği ve çıkarma profilinden oluşturulur. Başlatmadan önce ikisini de plakayla karşılaştırın.',
        heightRequired: 'Parça yüksekliği bilinmiyor. Plakadaki parçanın en yüksek noktasını girin.',
      },
      error: {
        jobActive: 'Yazıcı bir iş yürütüyor. Bitmesini bekleyin ya da durdurun, sonra çıkarın.',
        dispatchInFlight: 'Kuyruktaki bir ünite bu yazıcıya gönderiliyor. Birkaç saniye sonra yeniden deneyin.',
        ejectInFlightPending: 'Çıkarma {{age}} sn önce gönderildi; yazıcının başlatması bekleniyor.',
        ejectInFlightPendingNoAge: 'Çıkarma zaten gönderildi; yazıcının başlatması bekleniyor.',
        ejectInFlightStarted: 'Çıkarma {{age}} saniyedir çalışıyor.',
        ejectInFlightStartedNoAge: 'Çıkarma çalışıyor.',
        bedUnreadable: 'Plaka sıcaklığı okunamıyor. Birkaç saniye sonra yeniden deneyin.',
        noDonor: 'Çıkarmayı oluşturacak dosya yok. Plakayı temizlendi olarak işaretleyin ve parçayı elle alın.',
        firstArticle: 'İlk parça onay bekliyor. Seriden onaylayın ya da reddedin.',
    ...
    rfid: {
      ...
      recheck: 'Yuvayı yeniden denetle',
      recheckPending: 'Yeniden denetim bekliyor. Baskı bittiğinde tamamlanır.',
      recheckQueuedTooltip: 'Baskı bitene kadar kuyrukta.',
      restorePreviousRoll: 'Önceki makarayı geri yükle',
    },
    // AMS yükle/çıkar (#891)
    ams: {
      load: 'Yükle',
    ...
    permission: {
      ...
      noAmsRfid: 'AMS yuvalarını yeniden denetleme izniniz yok',
    ...
    incidentAction: {
      ...
      plate_vision: 'Plakayı düzeltin, sonra baskıyı sürdürün',
  ...
  archives: {
    ...
    modal: {
      ...
      deleteBlockedByLivePrint: 'Silinemiyor — bu arşiv devam eden bir baskıyı kaydediyor. Önce yazdırmayı durdurun, ardından tekrar deneyin.',
  ...
  queue: {
    ...
    permissions: {
      ...
      noReleaseStaged: 'Bu öğeleri serbest bırakması için bir kuyruk yöneticisine başvurun',
  ...
  settings: {
    ...
    spoolSelectionPolicy: 'Makara seçim ilkesi',
    spoolSelectionPolicyDesc: 'Birden fazla AMS yuvası eşleştiğinde dağıtıcının ve manuel baskıların bir makarayı nasıl seçeceği.',
    spoolPolicyFirstLoaded: 'İlk yüklenen (FIFO)',
    spoolPolicyLowestRemaining: 'En az kalan',
    spoolPolicySlotOrder: 'AMS yuva sırası',
    spoolPolicyBackupNote: 'En az kalan yalnızca yazıcıda AMS Filament Backup etkinleştirildiğinde uygulanır — aksi takdirde seçilen makara bittiğinde yazıcı ikinci bir makaraya geçemez.',
    minStartSpool: 'Minimum başlangıç makara ağırlığı (g)',
    ...
    taglessBrand: 'Marka',
    taglessMaterial: 'Malzeme',
    taglessSubtype: 'Alt tür',
    taglessSubtypeHint: 'Malzeme için Bambu\'nun varyant kodu, örn. HF = High Flow. Makara etiketinde gösterilir.',
    taglessColor: 'Renk',
    taglessSlicerFilament: 'Dilimleyici filamenti (isteğe bağlı)',
    taglessSlicerFilamentHint: 'Dilimleyicinizin kullandığı tam filament ön ayarının adı; böylece baskılar doğru profile uyar.',
    ...
    deleteUserChecking: 'Bu silmenin neleri kaldıracağı kontrol ediliyor...',
    deleteUserImpactUnavailable: 'Bu silmenin neleri kaldıracağı kontrol edilemedi. Yine de silerseniz, bu kullanıcının öğeleri önizleme olmadan kaldırılır.',
    deleteUserArchives_one: '{{count}} baskı arşivi',
    deleteUserArchives_other: '{{count}} baskı arşivi',
    deleteUserLibraryFiles_one: '{{count}} kütüphane dosyası',
    deleteUserLibraryFiles_other: '{{count}} kütüphane dosyası',
    deleteUserQueueItems_one: '{{count}} kuyruk öğesi',
    deleteUserQueueItems_other: '{{count}} kuyruk öğesi',
    deleteUserProductionRuns_one: '{{count}} üretim çalışması',
    deleteUserProductionRuns_other: '{{count}} üretim çalışması',
    deleteUserDependentSkus_one: '{{count}} SKU bu kullanıcının yüklediği bir dosyayı kullanıyor. Bu SKU dosyayı kaybeder ve siz yeniden eşleyene kadar basılamaz.',
    deleteUserDependentSkus_other: '{{count}} SKU bu kullanıcının yüklediği dosyaları kullanıyor. Bu SKU\'lar dosyaları kaybeder ve siz yeniden eşleyene kadar basılamaz.',
    deleteUserPrintingNow_one: '{{count}} birim şu anda basılıyor. Bitene veya durdurulana kadar silme reddedilecek.',
    deleteUserPrintingNow_other: '{{count}} birim şu anda basılıyor. Bitene veya durdurulana kadar silme reddedilecek.',
    deleteUserStillPrinting: '{{printers}} üzerinde hâlâ baskı var. Bu baskıları durdurun veya bitmelerini bekleyin, sonra silin.',
    // Akıllı prizler
    ...
    farmProduction: 'Çiftlik üretimi',
    farmProductionDescription: 'Seri Başlat penceresine önceden doldurulan varsayılan yeniden deneme ve karantina ilkesi. Her seri için geçersiz kılınabilir.',
    farmEjectCooldown: 'Çıkarma soğuması',
    farmEjectCooldownDescription: 'Çiftliğin, tamamlanan bir plakayı süpürmeden önce tablanın soğumasını nasıl beklediğini ve soğumayan bir yazıcıyı ne zaman bırakıp karantinaya aldığını belirler.',
    farmRetryMaxPerUnit: 'Tabla başına yeniden deneme',
    farmRetryMaxPerUnitHelp: 'Bir tabla başarısız olarak işaretlenmeden önceki otomatik yeniden denemeler (0–10)',
    farmEscalateConsecutiveFailures: 'Hatalardan sonra karantina',
    farmEscalateConsecutiveFailuresHelp: 'Bir yazıcıda karantinayı tetikleyen ardışık hata sayısı (1–20)',
    farmCooldownMargin: 'Atölye havasının üstündeki pay (°C)',
    farmCooldownMarginHelp: 'Çıkarma çizgisi ve hazne fanının düşüş noktası atölye havasının bu kadar üstünde yer alır.',
    shopAir: {
      label: 'Atölye havası',
      ejectLine: 'Çıkarma çizgisi',
      noReading: 'ölçüm yok',
      atPlateau: 'platoda',
      fresh_one: 'Beklemedeki {{count}} yazıcının içinde {{minutes}} dk önce ölçüldü — oda havasının biraz üstünde okur.',
      fresh_other: 'Beklemedeki {{count}} yazıcının içinde {{minutes}} dk önce ölçüldü — oda havasının biraz üstünde okur.',
      carried: '{{time}} değerinden gün eğrisi boyunca taşındı.',
      unknown: 'Henüz ölçüm yok — her soğuma, tabla soğumayı bıraktığında serbest kalır.',
      readFailed: 'Atölye havası okunamadı — her dakika yeniden denenir.',
    },
    farmOfflineStallMinutes: 'Çevrimdışı takılma (dk)',
    farmOfflineStallMinutesHelp: 'Yazıcısı bu süredir çevrimdışı olan hâlâ yazdıran bir birimi işaretle — asla sonlandırılmaz, yalnızca takılmayı gösterir (5–720)',
    farmPauseStallMinutes: 'Duraklatma takılması (dk)',
    farmPauseStallMinutesHelp: 'Yazdıran bir birim, otomatik kurtarma çalışmadan bu süre boyunca duraklatılmış kalırsa işaretle ve bildir — hiçbir şeyi iptal etmez (5–720)',
    farmCooldownStallWindow: 'Soğuma kontrol aralığı (dk)',
    farmCooldownStallWindowHelp: 'Çıkarmadan önce tablanın hâlâ soğuduğunu ne sıklıkla doğrulayacağı. Arka arkaya iki başarısız kontrol yazıcıyı karantinaya alır. 0 kontrolü kapatır.',
    farmCooldownStallEpsilon: 'Kontrol başına min. soğuma (°C)',
    farmCooldownStallEpsilonHelp: 'Hâlâ soğuyor sayılması için tabla iki kontrol arasında en az bu kadar düşmelidir.',
    farmCooldownMaxHold: 'Vazgeçme zamanlayıcısı (dk)',
    ...
    farmCooldownPlateauMarginHelp: 'Soğuma durursa ancak tabla kendi hazne havasının bu kadar derece içindeyse, soğumuş kabul edilip çıkarılır; bundan daha sıcak takılı kalırsa yazıcı karantinaya alınır.',
    farmCooldownAuxFanEnabled: 'Soğuma sırasında yardımcı fan',
    farmCooldownAuxFanEnabledHelp: 'Baskı bittiğinden çıkarma gönderilene kadar yardımcı fanı çalıştırır.',
    farmCooldownAuxFan: 'Yardımcı fan hızı (%)',
    farmCooldownAuxFanHelp: 'Soğumanın tamamı için tek hız (1–100).',
    farmCooldownChamberFanEnabled: 'Soğuma sırasında hazne fanı',
    farmCooldownChamberFanEnabledHelp: 'Hava kanalını soğutma moduna alır ve baskı bittiğinden çıkarma gönderilene kadar hazne egzoz fanını çalıştırır. Hazne fanı olmayan yazıcı modelleri bunu atlar.',
    farmCooldownChamberFan: 'Hazne fanı güçlendirme hızı (%)',
    farmCooldownChamberFanHelp: 'Hazne havası hâlâ çıkarma sıcaklığının üzerindeyken kullanılan hız (1–100).',
    farmCooldownChamberFanSustain: 'Güçlendirmeden sonra hazne fanı hızı (%)',
    farmCooldownChamberFanSustainHelp: 'Hazne çıkarma sıcaklığına ulaştıktan sonra çıkarma gönderilene kadar kullanılan hız. 0 fanı orada durdurur. Yazıcının kendi hazne soğutma hızı 50\'dir.',
    ...
    farmIdlePark: 'Boştayken tabla park etme',
    ...
    farmPlateBlowoffEnabled: 'Baskı başında plaka üfleme',
    farmPlateBlowoffEnabledHelp: 'Tabla seviyelemeden önce yardımcı fan tam hızda plakanın üzerine üfler.',
    farmPlateBlowoffSeconds: 'Üfleme süresi (s)',
    farmPlateBlowoffSecondsHelp: 'Tabla seviyelemeden önce yardımcı fanın çalışma süresi (3–60).',
    ...
    queueCheckIntervalHelp: 'Hiçbir şey olmasa bile çiftliğin kuyruğu ne sıklıkla yeniden kontrol ettiği. Canlı bir olay kaçırılırsa diye bir emniyet; düşük değer daha erken tepki verir ama daha sık yoklar (5–300).',
    dispatchKickDebounce: 'Yığın toplama gecikmesi (sn)',
    dispatchKickDebounceHelp: 'Aynı anda birkaç şey olduğunda, bunları çok sayıda yerine tek bir gönderim geçişinde toplamak için bu kısa anı bekleyin. Yüksek daha çok toplar; düşük daha hızlı tepki verir (0.2–10).',
    usbPreflightFreshWindow: 'USB kontrolü tazeliği (sn)',
    usbPreflightFreshWindowHelp: 'Yeniden kontrol etmeden önce yakın tarihli bir "USB sürücü mevcut" raporuna bu kadar saniye boyunca güvenin. Yüksek gereksiz kontrolleri atlar; 0 her zaman yeniden kontrol eder (0–120).',
    usbPreflightMaxWait: 'USB kontrolü azami bekleme (sn)',
    usbPreflightMaxWaitHelp: 'Yine de bir baskı başlatmadan önce yeni bir "USB mevcut" raporunun ne kadar bekleneceği. Yüksek daha temkinli; düşük daha erken gönderir (0–10).',
    dispatchParallelLimit: 'Eşzamanlı yazıcı başlatma',
    dispatchParallelLimitHelp: 'Bir geçişte kaç yazıcının aynı anda yükleyip başlatabileceği. Yüksek büyük bir kuyruğu daha hızlı boşaltır; düşük ağa daha naziktir (1–10).',
    powerStagger: 'Güç kademelendirme',
    powerStaggerDescription: 'Her zaman tüm aralığı beklemek yerine, bir yazıcı ısınma gücü çekmeyi bıraktığı anda bir kademelendirme yuvasını serbest bırakın. Eşzamanlı güç çekişini sınırlarken bir sonraki yazıcının daha erken başlamasını sağlar.',
    staggerDynamicRelease: 'Tabla ısındığında bir yuvayı serbest bırak',
    staggerDynamicReleaseHelp: 'Açıkken, tüm aralığın geçmesini beklemek yerine mevcut yazıcı tablasını ısıtmayı bitirir bitirmez bir sonraki yazıcı başlayabilir. Kapalıyken her yuva tüm aralığı bekler.',
    staggerReleaseEpsilon: 'Sıcaklık payı (°C)',
    staggerReleaseEpsilonHelp: 'Yuvayı erken serbest bırakmak için hedef tabla sıcaklığına ne kadar yakınlığın "yeterince sıcak" sayıldığı. Daha büyük bir sonraki yazıcıyı daha erken serbest bırakır.',
    staggerHeatupGrace: 'Isınma toleransı (saniye)',
    staggerHeatupGraceHelp: 'Bir yazıcı tablasını ısıtmaya henüz başlamadıysa, boşta bir yazıcının partiyi tutmaması için yuvasını yine de serbest bırakmadan önce bu kadar bekleyin.',
    ...
    erp: {
      title: 'ERP Dizini Girişi',
      statusActive: 'ERP girişi: etkin',
      statusInactive: 'ERP girişi: yapılandırılmadı',
      activeDesc: 'Operatörler ERP dizini kimlik bilgileriyle oturum açabilir.',
      inactiveDesc: 'ERP girişini etkinleştirmek için aşağıdaki bağlantı bilgilerini ekleyip kaydedin.',
      disableHint: 'ERP girişini kapatmak için aşağıdaki sunucu ve veritabanı adını temizleyip kaydedin.',
      connectionConfig: 'ERP Dizini Bağlantısı',
      host: 'Veritabanı Sunucusu',
      port: 'Bağlantı Noktası',
      database: 'Veritabanı Adı',
      user: 'Veritabanı Kullanıcısı',
      password: 'Veritabanı Parolası',
      passwordHint: 'Kayıtlı parolayı korumak için boş bırakın.',
      ssl: 'TLS ile bağlan',
      sslHint: 'ERP veritabanına şifreli bir bağlantı zorunlu kılın.',
      roleMapping: 'Rol Eşleme',
      roleMappingHint: 'Her ERP rolüne bir BamBuddy grubu atayın.',
      roleMappingNoGroup: '— Grup yok —',
      roleMappingGroupFor: '{{role}} için BamBuddy grubu',
      settingsSaved: 'ERP dizini ayarları kaydedildi',
      errors: {
        hostRequired: 'Veritabanı sunucusu gereklidir',
        databaseRequired: 'Veritabanı adı gereklidir',
      },
    },
    oidc: {
      ...
      form: {
        ...
        groupsClaim: 'Grup Talebi',
        groupsClaimDesc: 'Kullanıcının grup veya rol değerlerini taşıyan belirteç talebi. Bu sağlayıcının grup eşitlemesini devre dışı bırakmak için boş bırakın.',
        groupsClaimPlaceholder: 'gruplar',
        groupMapping: 'Grup Eşleme',
        groupMappingDesc: 'Her talep değerini bir BamBuddy grubuyla eşleyin. Eşleşen kullanıcılar oturum açtığında eşlenen grubu alır.',
        groupMappingNone: 'Yapılandırılmış eşleme yok.',
        groupMappingClaimValue: 'Talep değeri',
        groupMappingGroup: 'BamBuddy grubu',
        groupMappingSelectGroup: 'Grup seçin',
        groupMappingRemove: 'Eşlemeyi kaldır',
        groupMappingAdd: 'Eşleme ekle',
  ...
  fileManager: {
    ...
    createSkuFromUploadToast: '{{filename}} yüklendi — bundan bir SKU oluşturulsun mu?',
    createSkuFromUploadAction: 'Bu dosyadan SKU oluştur',
    ...
    deleteFolderConfirm: 'Bu klasörü silmek istediğinizden emin misiniz? İçindeki dosyalar çöp kutusuna taşınır ve köke geri yüklenebilir; klasörün kendisi kalıcı olarak silinir.',
    deleteFileConfirm: 'Bu dosyayı silmek istediğinizden emin misiniz?',
    deleteFilesConfirm: '{{count}} seçili dosyayı silmek istediğinizden emin misiniz? Dosyalar çöp kutusuna taşınır ve geri yüklenebilir.',
    deleting: 'Siliniyor...',
  ...
  inventory: {
    ...
    freshRoll: {
      ...
      sameRoll: 'Aynı rulo',
      reviewAction: 'İncele…',
      title: 'Bu yuvada yeni rulo mu?',
      message: '{{location}} konumundaki etiketsiz makara, etiket ağırlığının büyük bölümü kullanıldı. Şimdi yeni bir rulo takılıysa, filament takibinin doğru kalması için kaydedin.',
      confirm: 'Yeni rulo',
      pending: 'Kaydediliyor…',
      success: 'Yeni rulo kaydedildi',
      failed: 'Yeni rulo kaydedilemedi',
      dismissFailed: 'Yeni rulo istemi kapatılamadı',
      remaining: 'Kalan olarak {{grams}} g kaydedildi',
      brandLabel: 'Marka',
      brandPlaceholder: 'örn. Overture',
      weightLabel: 'Etiket ağırlığı (g)',
      weightPlaceholder: 'örn. 1000',
      costLabel: 'Maliyet / kg',
      costPlaceholder: 'İsteğe bağlı',
      noteLabel: 'Not',
      notePlaceholder: 'İsteğe bağlı',
      manualDesc: 'Bu kaydı kapatıp yeni bir kayıt başlat',
      manualTitle: 'Yeni makara olarak işaretlensin mi?',
      manualMessage: '{{location}} konumundaki kaydı ({{grams}} g kullanıldı) kapatır ve bu yuva için yeni, dolu bir kayıt açar. Bunu yalnızca makarayı fiziksel olarak değiştirdikten sonra yapın.',
      manualConfirm: 'Yeni makara olarak işaretle',
    },
    respool: {
      title: 'Bu etiket yeniden makaraya alınsın mı?',
      manualTitle: 'Bu etiket yeni bir makaraya taşınsın mı?',
      manualMessage: '{{location}} konumundaki kaydı kapatın ({{grams}} g kullanıldı) ve Bambu etiketini yeni dolu bir makaraya taşıyın. Bunu yalnızca makarayı fiziksel olarak değiştirdikten sonra yapın.',
      message: '{{location}} konumunda yeniden kullanılan bir Bambu etiketi algılandı. Şu anda yeni bir üçüncü taraf makarasındaysa, dolu bir kayda yeniden makaraya alın.',
      confirm: 'Yeniden makaraya alındı — yeni makara',
      pending: 'Yeniden makaraya alınıyor…',
      success: 'Yeni bir {{brand}} makarasına yeniden makaraya alındı',
      failed: 'Etiket yeniden makaraya alınamadı',
      autoToast: '{{brand}}, {{printer}} yuva {{slot}} konumunda otomatik olarak yeniden makaraya alındı',
      reusedTagToast: 'Yeniden kullanılan bir etikette yeni rulo olabilir — {{printer}} yuva {{slot}}',
      ...
      triggerSpent: 'Bu rulo filamentin bittiğini bildirdi ve o zamandan beri yuvaya müdahale edildi.',
      triggerRemainJump: 'AMS, bu kayıtta görünenden çok daha fazla filament bildiriyor — etiket, yeniden doldurulmuş bir ruloya geçmiş görünüyor.',
      sameSpoolAction: 'Aynı makara',
      reviewAction: 'İncele…',
      dismissFailed: 'Yeniden makara istemi kapatılamadı',
      donorLine: 'İzlenen makarayı değiştirir (kalan {{grams}} g); eski kayıt arşivlenir',
      donorRecordTitle: 'Kayıt #{{id}}',
      detailsLabel: 'Ayrıntılar',
      tagIdLabel: 'Etiket kimliği',
      warning: 'Her kaynak rulo için yalnızca BİR etiket kullanın — ikinci etiketi atın.',
      brandLabel: 'Marka',
      brandPlaceholder: 'örn. Overture',
      weightLabel: 'Etiket ağırlığı (g)',
      weightPlaceholder: 'örn. 1000',
    ...
    returnToRotation: 'Rotasyona geri al',
    returnToRotationDone: 'Makara rotasyona geri alındı',
    returnToRotationFailed: 'Makara rotasyona geri alınamadı',
  ...
  ams: {
    ...
    slotDialogLabel: '{{ams}} yuva {{slot}}: {{content}}',
    ...
    slotSpentSwapPark: '{{printer}}: {{ams}} {{slot}} numaralı yuvayı tükenmiş bir makara tutuyor ve serbest bırakacak bir kanıt yok. Yuvayı yeniden denetleyin veya makarayı değiştirin.',
    ...
    emptySlotBinding: {
      ...
      unassignAria: 'Atamayı Kaldır: {{spool}}, bu yuvadan',
      unassignTitle: 'Bu makaranın ataması kaldırılsın mı?',
      unassignMessage: '{{spool}} bu yuvadan serbest bırakılır. Makara, kayıtlı kullanımı korunarak envantere döner — hiçbir şey silinmez.',
    },
    unknown: 'Bilinmiyor',
    humidity: 'Nem',
    temperature: 'Sıcaklık',
  ...
  printModal: {
    ...
    customSlotMapping: 'Özel yuva eşlemesi',
    reread: 'Yeniden oku',
    requiredTooltip: 'Gerekli: {{type}} - {{color}}',
    manuallySelected: 'Elle seçildi',
    autoMatched: 'Otomatik eşleşti',
    externalSlotNote: 'Harici makara — ağırlık takibi yok; yazıcı filamanı tutucudan isteyecek.',
    selectSlot: '-- Yuva seç --',
    noActivePrintersAvailable: 'Kullanılabilir etkin yazıcı yok',
    specificPrinter: 'Belirli yazıcı',
    anyModel: 'Herhangi bir {{model}}',
    modelFallback: 'Model',
    targetModelLabel: 'Hedef model',
    selectModelPlaceholder: 'Bir model seçin...',
    locationFilter: 'Konum filtresi (isteğe bağlı)',
    anyLocation: 'Herhangi bir konum',
    schedulerAssignHint: 'Zamanlayıcı, kullanılabilir ilk boştaki {{model}} yazıcıya atayacak',
    schedulerAssignHintLocation: 'Zamanlayıcı, {{location}} konumundaki kullanılabilir ilk boştaki {{model}} yazıcıya atayacak',
    selectPrinters: 'Yazıcıları seç',
    printersSelected_one: '{{count}} yazıcı seçildi',
    printersSelected_other: '{{count}} yazıcı seçildi',
    selectAll: 'Tümünü seç',
    inactive: '(etkin değil)',
    unknownModel: 'Bilinmeyen model',
    customMapping: 'Özel eşleme',
    matchedCount: '({{matched}}/{{total}} eşleşti)',
    autoButton: 'Otomatik',
    hiddenPrinters_one: '{{count}} başka yazıcı gizli (farklı model) —',
    hiddenPrinters_other: '{{count}} başka yazıcı gizli (farklı model) —',
    showAll: 'tümünü göster',
    showOnlyModelPrinters: 'Yalnızca {{model}} yazıcıları göster',
    selectAtLeastOnePrinter: 'En az bir yazıcı seçin',
    selectTargetModel: 'Bir hedef yazıcı modeli seçin',
    typeNotFound: '(Tür bulunamadı)',
    colorMismatch: '(Renk uyuşmuyor)',
    ready: '(Hazır)',
    clickToChangeSlot: 'Yuva atamasını değiştirmek için tıklayın',
    costNotAvailable: 'Yok',
    requiredTypeNotFound: 'Gerekli filament türü yazıcıda bulunamadı.',
    printJob: 'Yazdırma işi',
    slicedModelMismatch: 'Dosya {{slicedModel}} için dilimlendi, ancak {{printerModel}} üzerinde yazdırılıyor',
    archiveDataUnavailable: 'Arşiv verileri kullanılamıyor. Kaynak dosya silinmiş olabilir. Filament eşlemesi devre dışı.',
    failedToComplete: 'İşlem tamamlanamadı',
    toastQueueItemUpdated: 'Kuyruk öğesi güncellendi',
    toastUpdateFailed: 'Kuyruk öğesi güncellenemedi',
    toastSelectPrinter: 'Lütfen en az bir yazıcı seçin',
    toastSelectModel: 'Lütfen bir hedef yazıcı modeli seçin',
    toastQueuedForModel: 'Herhangi bir {{model}} için kuyruğa alındı',
    ejectFromSku: 'SKU {{code}} varsayılanı',
    partialFailureTitle: '{{total}} gönderimden {{failed}} tanesi başarısız oldu:',
    toastPartialSuccess: '{{success}} başarılı, {{failed}} başarısız',
    printerFallback: 'Yazıcı {{id}}',
    slotFallback: 'Yuva {{id}}',
    plateFallback: 'Tabla {{index}}',
  },
  ...
  uploadModal: {
    ...
    libraryHint: 'SKU’lar ve üretim çalışmaları için bunun yerine Dosya Yöneticisi’nden yükleyin.',
    libraryHintLink: 'Dosya Yöneticisi’ne git →',
    uploaded: 'yüklendi',
    failed: 'başarısız',
    uploading: 'Yükleniyor...',
    upload: 'Yükle',
  ...
  notifications: {
    ...
    storageLow: 'USB depolama alanı azaldı',
    cooldownEscalation: 'Soğuma uzun sürüyor',
    quietHours: 'Sessiz Saatler',
  ...
  fleetMetrics: {
    tabs: {
      ariaLabel: 'İstatistik görünümleri',
      prints: 'Baskılar',
      fleet: 'Filo',
    },
    sections: {
      fleet: 'Filo',
      matrix: 'Filo matrisi',
      stateOverTime: 'Zaman içinde yazıcı durumları',
      printsPerDay: 'Günlük baskı',
      downtimeByCause: 'Nedene göre duruş',
      coolingAndEject: 'Soğutma ve çıkarma',
      recovery: 'Toparlanma',
      partsBySku: 'SKU bazında parça',
    },
    summary: {
      now: 'Şu an',
      trend: 'Eğilim',
      ...
      rows: {
        avg_printing: 'Baskıda',
        avg_cycle_overhead: 'Baskılar arası',
        avg_idle: 'Boşta',
        avg_down: 'Duruşta',
        avg_planned: 'Bakım',
        peak_down: 'Duruş zirvesi',
        printers_in_fleet: 'Filoda',
        prints_per_day: 'Baskı',
        prints_per_printer_per_day: 'Yazıcı başına baskı',
        uptime: 'Çalışır süre',
        time_printing: 'Baskı süresi',
      },
      peak: 'zirve {{count}}',
    ...
    class: {
      cycle_overhead: 'Baskılar arası',
      cooling: 'Soğuyor',
      ejecting: 'Çıkarıyor',
      down: 'Duruşta',
      planned: 'Bakım',
      out_of_fleet: 'Devre dışı',
    ...
    matrix: {
      ...
      showDays: 'Günleri göster',
      hideDays: 'Günleri gizle',
      sortBy: '{{column}} sütununa göre sırala',
      caption: 'Yazıcılara göre {{lens}}, {{from}} – {{to}}',
      captionDay: 'Yazıcılara göre {{lens}}, {{date}}',
      details: 'Ayrıntılar',
    ...
    detail: {
      ...
      timeSplit: 'Zaman dağılımı',
      classes: 'Zamanın kullanımı',
      printsByOutcome: 'Sonuca göre baskılar',
      outcome: {
        completed: 'Tamamlandı',
        failed: 'Başarısız',
        cancelled: 'İptal edildi',
      ...
      incidents: 'Olaylar',
      openPrinter: 'Yazıcıyı aç',
      noIntervals: 'Bu dönem için kayıtlı aralık yok.',
      noIncidents: 'Bu dönemde olay yok.',
      noPrints: 'Bu dönemde baskı yok.',
      ongoing: 'Sürüyor',
    },
    widgets: {
      showData: 'Verileri göster',
      showChart: 'Grafiği göster',
      showDataFor: '{{chart}} verilerini göster',
      showChartFor: '{{chart}} grafiğini göster',
      median: 'Ortanca',
      p90: 'P90',
      overExpected: 'beklenenin üzerinde',
      count: 'Sayı',
      variant: {
      ...
      clearedNoPerson: 'Müdahalesiz çözüldü',
      inFleetLine: 'Filoda',
      peakDownLine: 'Duruş zirvesi',
      sku: 'SKU',
      units: 'Adet',
      plates: 'Tablalar',
      successRate: 'Başarı',
    ...
    states: {
      loading: 'Yükleniyor…',
      loadFailed: 'Filo geçmişi yüklenemedi.',
      retry: 'Yeniden dene',
      empty: 'Bu aralık için veri yok.',
      recordingGap: 'Yazıcı durumu kaydı {{date}} tarihinde başladı. Arıza ve bakım geçmişi {{earliest}} tarihinden itibaren.',
    },
    header: {
    ...
    hints: {
      ...
      cycle_overhead: 'Çiftliğin baskılar arasındaki kendi işi: tablayı soğutmak, sonra parçayı süpürmek.',
      planned: 'Bakım modu: bir kişi yazıcıyı otomatik akışların dışına aldı.',
      uptime: 'Sayılan sürenin, yazıcının iş alabildiği payı.',
      time_printing: 'Sayılan sürenin, yazıcının baskı yaptığı payı.',
      prints_per_printer: 'Tamamlanan baskıların, her yazıcı için sayılan gün sayısına bölümü. Sayılan günler yalnızca kaydedilen aralıklardan gelir; dönemin bir bölümü kaydedilmemişken «Baskı» ile karşılaştırılamaz.',
      unobserved: 'Bu aralıkta hiçbir şey kaydedilmedi; yalnızca arızalar ve beklemeler biliniyor.',
      not_recorded: 'Bu yazıcı için kaydedilmiş ilk durumdan öncesi.',
      incidents_only: 'Burada yazıcı durumu kaydedilmedi; dönemi yalnızca arıza ve bakım kaydı kapsıyor.',
      whileRecorded: 'Dönem değerleri yalnızca kaydedilen süreyi kapsar.',
      timeframeFleet: 'Günler {{tz}} saatine göre gece yarısından gece yarısına sürer.',
      timeframePrints: 'Günler UTC gece yarısından gece yarısına sürer.',
    },
  },
};
