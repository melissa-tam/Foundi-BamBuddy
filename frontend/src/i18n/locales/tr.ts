export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      bedDropHelp: 'Parçanın üzerinden kalktıktan sonra tabla neredeyse makine tabanına kadar iner ve geri yükselerek süpürmeden önce parçayı sarsıp gevşetir.',
    ...
    tooltips: {
      ...
      bedDrop: 'Kaldırma parçadan uzaklaştıktan sonra ısıtmalı tabla neredeyse en alt noktasına iner ve geri döner; bu sarsıntı, süpürmeden önce yapışmış bir parçayı gevşetir. Model için kayıtlı bir Z hareketi gerektirir.',
