export default {
  ...
  printers: {
    ...
    eject: {
      ...
      foreignTitle: 'Yabancı bir baskı çıkarılsın mı?',
      foreignBody: 'Bu baskı çiftlik tarafından gönderilmedi. Süpürme, aşağıda seçtiğiniz çıkarma profilini kullanır — algılanan değer yanlışsa parça yüksekliğini düzeltin.',
