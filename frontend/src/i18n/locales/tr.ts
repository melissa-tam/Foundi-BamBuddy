export default {
  ...
  inventory: {
    ...
    freshRoll: {
      ...
      message: '{{location}} konumundaki etiketsiz makara, etiket ağırlığının yarısından fazlası kullanıldı. Şimdi yeni bir rulo takılıysa, filament takibinin doğru kalması için kaydedin.',
      confirm: 'Yeni rulo',
    ...
    respool: {
      ...
      promptToast: '{{printer}} yuva {{slot}} makarası neredeyse boş — bu etikette yeni rulo mu?',
