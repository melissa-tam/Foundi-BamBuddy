export default {
  ...
  printers: {
    ...
    quarantine: {
      badge: 'Karantinada',
      clear: 'Karantinayı kaldır',
      cleared: 'Karantina kaldırıldı',
      clearTitle: 'Karantina kaldırılsın mı?',
      clearMessage: '"{{name}}" için karantina kaldırılsın mı? Zamanlayıcı bu yazıcıya baskı göndermeyi sürdürecek.',
      clearMessageWithReason: '"{{name}}" için karantina kaldırılsın mı? Neden: {{reason}}. Zamanlayıcı bu yazıcıya baskı göndermeyi sürdürecek.',
    },
    plateStatus: {
