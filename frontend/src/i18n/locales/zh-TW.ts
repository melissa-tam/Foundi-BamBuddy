export default {
  ...
  skus: {
    nav: 'SKU 清單',
    title: 'SKU 目錄',
    description: '可銷售的零件編碼，每個編碼關聯一個或多個庫檔案盤板，以及用於生產執行的預設取件設定檔。',
    newSku: '新增 SKU',
    loadError: '無法載入 SKU。',
    empty: {
      title: '尚無 SKU',
      body: '建立您的第一個 SKU，以關聯可列印檔案並追蹤生產。',
    },
    columns: {
      files: '檔案',
      unitsCompleted: '累計件數',
    ...
    fields: {
      ...
      partNumber: '零件編號',
      notes: '備註',
      defaultEjectProfile: '預設取件設定檔',
      noEjectProfile: '無',
    },
    codeRequired: '編碼為必填欄位。',
    nameRequired: '名稱為必填欄位。',
    created: '已建立 SKU',
    updated: '已更新 SKU',
    deleted: '已刪除 SKU',
    saveFailed: '無法儲存 SKU',
    deleteFailed: '無法刪除 SKU',
    deleteTitle: '刪除此 SKU？',
    deleteBody: '「{{code}}」將被永久刪除。此操作無法復原。',
    suggest: {
      appliedFromObjectName: '已根據檔案中的零件名稱填入資訊',
      appliedFromFilename: '已根據檔名填入資訊',
      appliedGeneric: '已從檔案填入資訊',
      failed: '無法建議詳細資訊',
    },
    files: {
      title: '已關聯檔案',
      ...
      plate: '盤板',
      unitsPerPlate: '每盤板件數',
      plateUnits: '盤板 {{plate}} · 每盤板 {{units}} 件',
      add: '新增檔案',
      added: '已關聯檔案',
      addFailed: '無法關聯檔案',
      savedButLinkFailed: 'SKU 已儲存，但檔案關聯失敗：{{reason}}',
      remove: '移除',
      removed: '已取消關聯檔案',
      removeFailed: '無法取消關聯檔案',
      removeTitle: '取消關聯此檔案？',
      removeBody: '「{{name}}」將從此 SKU 取消關聯。',
    },
  },
  ...
  productionRuns: {
    nav: '生產',
    title: '生產執行',
    description: '將 SKU 的副本分配到多台印表機，直到達到目標件數，並即時顯示進度。',
    loadError: '無法載入生產執行。',
    empty: {
      title: '尚無生產執行',
      body: '啟動一個執行，將 SKU 列印到目標件數。',
      noSkus: '啟動執行前，請新增一個至少關聯一個檔案的 SKU。',
    },
    startTitle: '啟動生產執行',
    startAction: '啟動執行',
    runAgain: '再次執行',
    ...
    started: '已啟動生產執行',
    startFailed: '無法啟動執行',
    noFiles: '此 SKU 沒有可列印的關聯檔案。',
    fileRequired: '請選擇要列印的檔案。',
    targetRequired: '請輸入至少 1 件的目標。',
    printerRequired: '請至少選擇一台印表機。',
    overProduction: '將生產 {{planned}} 件（{{plates}} 盤板）——比目標 {{target}} 多 {{extra}} 件。',
    fields: {
      sku: 'SKU',
      file: '檔案 / 盤板',
      filePlaceholder: '選擇一個檔案…',
      plateUnits: '盤板 {{plate}}，{{units}}/盤板',
      targetUnits: '目標件數',
      printers: '印表機',
      ...
      skuDefault: 'SKU 預設',
      skuNoFile: '— 未連結檔案',
      skuNoFileHint: '在 SKU 頁面為該 SKU 連結一個檔案後即可啟動生產。',
    },
    status: {
      active: '進行中',
      paused: '已暫停',
    ...
    platesProgress: '{{completed}} / {{total}} 盤板',
    stats: {
      units: '件數',
      target: '目標',
      failed: '失敗',
    ...
    schedule: {
      ...
      openCalendar: '開啟行事曆',
      pastError: '請選擇未來的時間。',
      invalidError: '請輸入有效的日期和時間。',
      helpAsap: '一旦有合適的印表機空閒，執行即開始。',
      helpScheduled: '若印表機空閒，執行將在所選時間開始；否則會等待直到有印表機空閒。',
      startsIn: '{{when}}開始',
    },
    viewDetails: '檢視執行詳情',
    blockedPrinters: '印表機被阻擋',
    pauseReason: {
      operator: '已由操作員暫停',
    ...
    detail: {
      ...
      notFound: '找不到生產執行。',
      printersTitle: '印表機',
      noPrinters: '尚未指派印表機 — 排程器會為每個單元挑選閒置的相符印表機。',
      unitsTitle: '單元',
      noUnits: '尚無單元。',
      unitCol: '單元',
      statusCol: '狀態',
      ...
      waiting: {
        ...
        externalFeedFault: '外接料卷未能進料 — 請檢查料架與 PTFE 導管，然後在印表機上恢復',
        pinnedTrayUnavailable: '固定的料槽在這台印表機上未裝載 — 請裝載該料槽或取消固定',
        ...
        libraryFileMissing: '庫中缺少來源檔案 — 請還原該檔案或重新上傳',
      ...
      printerState: {
        ...
        visionHold: '列印板偵測暫停',
        filamentShort: '線材不足',
        noUsbDrive: '無 USB 隨身碟',
      },
      eligibility: {
        title: '未參與的印表機',
        description: '在解決之前，這些印表機不會接受本次執行的單元：',
        offline: '離線',
        quarantined: '已隔離',
        awaitingPlateClear: '熱床未清理',
        modelMismatch: '型號不符',
        filamentShort: '線材不足',
        noUsbDrive: '無 USB 隨身碟',
      },
    ...
    abortTitle: '中止此執行？',
    abortBody: '「{{name}}」將被取消。進行中的盤板會完成，但不會啟動新盤板。此操作無法復原。',
    delete: '刪除',
    deleted: '已刪除執行',
    deleteTitle: '刪除此執行？',
    ...
    firstArticle: {
      sectionTitle: '首件核准',
      requireLabel: '要求首件核准',
      requireHelp: '首個零件會在不自動彈出的情況下列印，工作將暫停以等待你的核准。',
      retriesLabel: '每片板的重試次數',
      escalateLabel: '連續失敗後隔離',
      printing: '正在列印首件',
      awaitingTitle: '首件等待核准',
      awaitingBody: '首個零件已列印完成。請檢查後核准以繼續工作，或拒絕以停止並修改。',
      approvePhysical: '核准 — 我已取下零件',
      approveEject: '核准並遠端彈出',
      reject: '拒絕…',
      approveConfirm: '核准',
      approvePhysicalTitle: '核准首件？',
      approvePhysicalBody: '請確認你已將列印好的零件從列印板上取下。工作將繼續並派發其餘列印板。',
      approveEjectTitle: '核准並遠端彈出？',
      approveEjectBody: '在工作繼續前，工具頭會將零件從列印板上掃落。請確保列印板上沒有障礙物，且無人將手伸入印表機。',
      rejectTitle: '拒絕首件',
      rejectBody: '請說明哪裡出了問題。之後恢復工作將重新開始一個新的首件。',
      rejectReasonLabel: '原因',
      rejectReasonPlaceholder: '例如：翹邊、附著不良…',
      rejectReasonRequired: '需要填寫原因。',
      rejectAction: '拒絕首件',
      rejectedBadge: '首件已拒絕',
      rejectedReason: '原因：{{reason}}',
      rejectedHint: '恢復將重新開始一個新的首件。',
      approvedBadge: '首件已核准',
      approved: '首件已核准',
      rejected: '首件已拒絕',
  ...
  ejectProfiles: {
    nav: '取件設定檔',
    title: '取件設定檔',
    description: '自動取件設定檔，在熱床冷卻後將完成的零件從熱床上掃下。',
    newProfile: '新增設定檔',
    loadError: '無法載入取件設定檔。',
    duplicateAction: '複製',
    copyName: '{{name}}（副本）',
    empty: {
      title: '尚無取件設定檔',
      body: '建立您的第一個設定檔，以自動將完成的零件從熱床上清除。',
    },
    columns: {
      passes: '行程次數',
      ejectSpeed: '取件速度',
    ...
    fields: {
      ...
      backOverhang: '後伸出量 (mm)',
      ejectSpeed: '取件速度 (mm/min)',
      skimSpeed: '掠過速度 (mm/min)',
      finalSkim: '最終掠掃行程',
      finalSkimHelp: '在清掃後於列印板正上方增加一次緩慢的掠掃行程，以清除薄殘留物。若只想推動一次，請關閉。',
      maxPartHeight: '最大零件高度 (mm)',
      sweepStartHeight: '清掃起始高度 (%)',
      sweepStartHeightHelp: '從零件高度的此百分比處開始下降清掃（100% = 零件頂部）。',
      sweepBand: '限制 X 清掃帶',
      sweepBandHelp: '僅清掃熱床寬度的一個子區間，而非整個寬度。若需整個寬度請關閉。',
      sweepXMin: 'X 區間最小值 (mm)',
      sweepXMax: 'X 區間最大值 (mm)',
      bedDrop: '熱床下降脫離輔助',
      bedDropHelp: '熱床下降到接近機器底部再返回抬升高度，藉由震動在清掃前使黏住的零件脫離。',
      bedDropClearance: '底部間隙 (mm)',
      bedDropDwell: '在下降最低點停留 (秒)',
      bedDropDwellHelp: '熱床在返回抬升高度之前，先在下降最低點停留設定的秒數。',
      bedDropJitter: '在下降最低點抖動',
      bedDropJitterHelp: '熱床在下降最低點依設定距離上下往復，往復次數為設定的次數。',
      bedDropJitterCycles: '抖動次數',
      bedDropJitterMm: '抖動行程 (mm)',
    },
    tooltips: {
      name: '用於辨識此設定檔的簡短標籤 – 顯示在設定檔清單與選擇器中。',
      clearance: '工具頭移動就位時保持在零件上方的高度，以便在清掃前不會碰到列印件。',
      zOffset: '清掃路徑高度的微調 – 噴嘴刮到時調高，未掃到零件時調低。',
      descentSteps: '工具頭在推開零件前，為繞到其後方而執行的小幅下降步數。',
      xPasses: '為清除零件而在列印板上進行的左右清掃次數。',
      xMargin: '與列印板左右邊緣保持的間距，使工具頭不會撞到機架。',
      frontOverhang: '清掃超出零件前方的距離，以確保將其完全推開。',
      backOverhang: '清掃在零件後方多遠處開始，以便工具頭在推動前完全繞到其後方。',
      ejectSpeed: '將零件推離列印板的推動行程中，工具頭的移動速度。',
      skimSpeed: '清除殘餘碎屑的較輕掠過行程中，工具頭的移動速度。',
      finalSkim: '在主清掃之後於列印板正上方執行一次額外的緩慢行程，以清除薄殘留物。若只需推動一次請關閉（例如為高零件設定一條中間高度的通道）。',
      maxPartHeight: '此設定檔可彈出的最高零件 – 若切片零件較高，將阻擋派發。',
      sweepStartHeight: '下降清掃在零件上開始的高度，以百分比表示（有效範圍 1-100%，100% 表示零件頂部）。',
      sweepBand: '僅清掃列印板的一條區帶而非整個寬度 – 當零件總在同一位置時很有用。',
      sweepXMin: '清掃區帶的左邊緣，從列印板原點起算，單位 mm。有效範圍 0-340 mm（H2S 列印板寬度）；必須小於最大值，並留出至少 10 mm 寬的區帶。',
      sweepXMax: '清掃區帶的右邊緣，從列印板原點起算，單位 mm。有效範圍 0-340 mm（H2S 列印板寬度）；必須大於最小值，並留出至少 10 mm 寬的區帶。',
      bedDrop: '熱床下降到接近最低點再返回抬升高度，藉由震動在清掃前使黏住的零件脫離。需要為該型號登錄 Z 行程。',
      bedDropClearance: '下降過程中與熱床最低位置保持的間隙 — 50 mm = 在底部上方 5 cm 處停止。',
      bedDropDwell: '在下降最低點多停留幾秒，可讓黏住的零件在清掃前有時間完全剝離。',
      bedDropJitter: '在下降最低點做短距離上下往復，可讓單次震動未能震落的零件脫離。',
    },
    nameRequired: '名稱為必填項。',
    created: '取件設定檔已建立',
    updated: '取件設定檔已更新',
    ...
    deleteTitle: '刪除此設定檔？',
    deleteBody: '"{{name}}" 將被永久刪除。此操作無法復原。',
    preview: {
      title: '預覽與驗證',
      description: '為庫檔案和盤面產生取件 G-code，以便在使用前進行驗證。',
      file: '庫檔案',
      filePlaceholder: '選擇檔案…',
      plate: '盤面',
      run: '產生預覽',
      running: '正在產生…',
      noFiles: '沒有可預覽的庫檔案。',
      ...
      showGcode: '顯示 G-code',
      hideGcode: '隱藏 G-code',
      gcodeLabel: '產生的 G-code',
      failed: '預覽失敗',
    },
    dryRun: {
      action: '空跑',
      title: '空跑測試',
      description: '將此設定檔的僅幾何測試傳送到印表機，或下載測試檔以進行檢查。',
      printer: '印表機',
      printerPlaceholder: '選擇已連線的印表機…',
      loadingPrinters: '正在檢查印表機連線…',
      noPrinters: '沒有可用的已連線印表機。',
      warningTitle: '需要空列印板',
      warning: '此測試會歸位到列印板中心並在其上掃過，因此列印板必須為空。派發後，工作會等待，直到您在印表機上解除列印板保持。',
      dispatch: '傳送測試',
      dispatching: '正在傳送…',
      download: '下載檔案',
      downloading: '正在準備…',
      dispatchFailed: '無法傳送測試。',
      downloadFailed: '無法產生空跑檔案。',
      allowUnvalidated: '允許未驗證的幾何（僅用於硬體階梯）',
      allowUnvalidatedWarning: '此型號的運動範圍尚未經過硬體驗證。僅可在階梯上、有人監督且列印板為空時派送。',
    },
    geometry: {
      model: '印表機型號',
      noModels: '幾何登錄表中沒有項目',
      unvalidated: '未經硬體驗證',
      warningsTitle: '幾何警告',
      downloadModel: '下載用幾何型號',
      downloadModelPlaceholder: '使用所選印表機的型號',
      bandInverted: 'X 區間最小值必須小於最大值。',
      bandTooNarrow: '掃掠區間寬度至少需 {{min}} mm。',
      bandExceedsBed: 'X 區間最大值超出已註冊的最寬熱床（{{max}} mm）。',
      heightExceedsCeiling: '超過所有已註冊型號的高度上限（最大 {{max}} mm）— 取件派送將被拒絕。',
      bedDropNoTravel: '未登錄 Z 行程的型號（{{models}}）無法產生此設定檔 — 請在幾何登錄表中設定 z_travel_mm。',
      bedDropBedslinger: '熱床下降輔助在動床型號（{{models}}）上無法使用 — 它們的熱床不沿 Z 方向移動。',
    },
    geometryManager: {
      title: '型號幾何登錄表',
      description: '每個印表機型號的熱床尺寸、運動範圍和硬體驗證狀態。列由伺服器種子建立 — 沒有新增按鈕；編輯某個型號以更正其幾何或變更其驗證狀態。',
      edit: '編輯幾何',
      editTitle: '編輯 {{model}} 的幾何',
      saved: '型號幾何已儲存',
      saveFailed: '無法儲存型號幾何',
      zTravelUnset: '未登錄 Z 行程 — 此型號的熱床下降輔助將安全失效。',
      validatedBadge: '已驗證',
      notValidatedBadge: '未驗證',
      confirmValidateTitle: '將型號標記為已驗證？',
      ...
      fields: {
        bedX: '熱床寬度 X（mm）',
        bedY: '熱床深度 Y（mm）',
        envXMin: '運動範圍 X 最小（mm）',
        envXMax: '運動範圍 X 最大（mm）',
        envYMin: '運動範圍 Y 最小（mm）',
        envYMax: '運動範圍 Y 最大（mm）',
        maxPartHeight: '最大零件高度（mm）',
        zTravel: 'Z 行程（mm）',
    ...
    queueLabel: '取件設定檔（自動取件）',
    queueHelp: '當熱床冷卻至取件線後，零件將被掃下。',
  },
  // Navigation
  nav: {
    printers: '印表機',
  ...
  printers: {
    ...
    deactivated: {
      pillLabel: '已停用',
      panelState: '已停用 — 與此印表機無連線。',
      activate: '啟用',
      toastActivated: '{{name}} 已啟用',
      editFieldLabel: '已停用',
      editFieldHelp: '無 MQTT 工作階段；對此執行個體不可見（並行安裝、停止使用）。',
    },
    // Chamber light
    ...
    toast: {
      ...
      recheckUnchanged: '插槽 {{slot}} 無變化。自上次檢查以來未記錄到換捲。',
      recheckMinted: '插槽 {{slot}}：已記錄新捲。以 {{grams}} g 計。',
      recheckIdentified: '插槽 {{slot}}：已從標籤記錄 {{identity}}。',
      recheckIdentifiedUnnamed: '插槽 {{slot}}：已讀取標籤。',
      recheckIdentifiedNoRead: '插槽 {{slot}}：已記錄 {{identity}}。標籤重讀已延後。',
      recheckQueued: '插槽 {{slot}} 的檢查已排入佇列。農場將在下一個閒置時段讀取標籤並記錄該捲。',
      recheckEmpty: '插槽 {{slot}} 是空的。裝入一捲後重新檢查。',
      recheckRestored: '插槽 {{slot}}：已還原上一捲。',
      recheckFailed: '插槽 {{slot}}：檢查失敗。',
      recheckUndoNoOffer: '插槽 {{slot}}：沒有可復原的檢查。',
      recheckUndoNoPredecessor: '插槽 {{slot}}：此插槽沒有記錄上一捲。',
      recheckUndoMintGone: '插槽 {{slot}}：所記錄的捲已不存在。',
      recheckUndoBoundElsewhere: '插槽 {{slot}}：上一卷料已裝入其他料盤。未還原任何內容。',
      recheckUndoFailed: '插槽 {{slot}}：還原失敗。{{detail}}',
      loadInitiated: '載入耗材中…',
    ...
    quarantine: {
      badge: '已隔離',
      recover: '復原並繼續',
      recoverSuccess: '印表機已復原 — 已繼續 {{count}} 個執行。',
      recoverError: '復原印表機失敗',
      recoverTitle: '復原並繼續？',
      recoverMessage: '復原 "{{name}}"？這是一次明確的覆寫操作，將會：',
      recoverMessageWithReason: '復原 "{{name}}"？原因：{{reason}}。這是一次明確的覆寫操作，將會：',
      recoverEffectPlate: '• 解除板料保持',
      recoverEffectQuarantine: '• 解除隔離',
      recoverEffectLease: '• 釋放派發佔用',
      recoverEffectEject: '• 放棄進行中的彈出',
      recoverEffectFault: '• 關閉未結的設備故障',
      recoverEffectResume: '• 繼續已暫停的執行',
      recoverClosedFault: '設備故障已關閉',
      markPlateCleared: '將列印板標記為已清理',
      actionsHelp: '復原並繼續會解除此印表機的所有保持（列印板、派發佔用、彈出、隔離、設備故障）並繼續已暫停的執行。將列印板標記為已清理僅解除列印板鎖定。',
    },
    phase: {
      printing: '列印中',
      cooling: '正在冷卻至 {{threshold}}°C',
      coolingHeld: '正在冷卻至 {{threshold}}°C · 列印板已抬升',
      coolingToPlateau: '正在冷卻至平台期',
      coolingToPlateauHeld: '正在冷卻至平台期 · 列印板已抬升',
    ...
    ejectPhase: {
      building: '彈出：正在產生…',
      uploading: '彈出：上傳中 {{pct}} %',
      uploadingNoPct: '彈出：上傳中…',
      sent: '彈出：已傳送',
      sweeping: '彈出：清掃中…',
      failed: '彈出失敗',
    },
    ...
    farm: {
      run: '執行：{{name}}',
      printingUnit: '正在列印第 {{id}} 號單元',
      stagedLowSpool: '單元已擱置：線材不足 — 請更換線材卷或在佇列中釋放',
      staged: '單元已暫存 — 恢復執行以釋放',
      lastUnitFailed: '上一單元失敗：{{error}}',
    },
    modelMismatch: {
      badge: '型號不符',
      blocked: '在修正宣告的型號之前，派送已被封鎖。',
    },
    ejectNotQualified: '此型號的自動取件尚未通過硬體認證 — 無人值守使用前請先執行硬體階梯測試。',
    plateStatus: {
      markCleared: '將列印板標記為已清理',
      cleared: '列印板已清理',
      notCleared: '列印板未清理',
      inUse: '列印板使用中',
      markClearedCancelsEject: '將列印板標記為已清理會取消待處理的自動彈出。',
      ejectInFlight: '彈出進行中。使用復原並繼續可強制覆蓋。',
      markOccupied: '將列印板標記為已佔用',
      markOccupiedSuccess: '列印板已標記為已佔用 — 在清理之前派送將被封鎖',
      ejectInProgress: '彈出進行中 · {{age}}',
      ejectStalled: '彈出停滯 · {{age}} — 農場已失去對清掃的追蹤',
      refusal: '列印板偵測：{{message}}',
      menuRecover: '復原印表機',
      clearedClosedFault: '設備故障已關閉',
    },
    // 手動彈出（W2）+ 新料卷提示（W6）
    eject: {
      action: '彈出列印板',
      dispatched: '已開始彈出',
      confirmTitle: '在熱板狀態下彈出？',
      confirmBodyNoLine: '列印板為 {{bed}}°C，沒有可用於判斷的工作間氣溫或腔室讀數。現在彈出會在此溫度下掃落零件。是否繼續？',
      confirmBody: '列印板為 {{bed}}°C，高於 {{threshold}}°C 的釋放閾值。現在彈出會在列印板仍然很熱時掃落零件。是否繼續？',
      confirm: '彈出列印板',
      cancel: '取消',
      foreignPrintNameLabel: '列印',
      foreignUnknownPrint: '未知',
      foreignPartHeightEditLabel: '零件高度 (mm)',
      foreignProfileLabel: '彈出設定檔',
      foreignSuggested: '建議',
      foreignNoProfiles: '沒有可用的彈出設定檔',
      foreignConfirm: '彈出列印板',
      dialog: {
        foreignTitle: '彈出列印板 — 該列印不是由農場派發的',
        farmUnitTitle: '彈出列印板 — {{name}}',
        declaredTitle: '彈出列印板',
        body: '掃落動作依據下面的零件高度和彈出設定檔產生。開始前請對照列印板核對兩者。',
        heightRequired: '零件高度未知。請輸入列印板上零件的最高點。',
      },
      error: {
        jobActive: '印表機正在執行工作。等待其完成或將其停止，然後再彈出。',
        dispatchInFlight: '正在向該印表機傳送佇列中的單元。請在幾秒後重試。',
        ejectInFlightPending: '彈出已於 {{age}} 秒前傳送，正在等待印表機啟動。',
        ejectInFlightPendingNoAge: '彈出已傳送，正在等待印表機啟動。',
        ejectInFlightStarted: '彈出已執行 {{age}} 秒。',
        ejectInFlightStartedNoAge: '彈出正在執行。',
        bedUnreadable: '無法讀取列印板溫度。請在幾秒後重試。',
        noDonor: '沒有可用於產生彈出的檔案。請將列印板標記為已清理，並手動取下零件。',
        firstArticle: '首件等待核准。請在該執行中核准或拒絕。',
    ...
    rfid: {
      ...
      recheck: '重新檢查插槽',
      recheckPending: '重新檢查待處理。列印結束後完成。',
      recheckQueuedTooltip: '已排入佇列，等待列印結束。',
      restorePreviousRoll: '還原上一捲',
    },
    // AMS load/unload (#891)
    ams: {
      load: '載入',
    ...
    incidentAction: {
      ...
      physical: '耗材通道受阻。載入槽位、被中斷的列印經該通道完成，或執行復原後解除。',
      power_loss: '請在印表機上繼續',
      plate_vision: '修正列印板後繼續列印',
  ...
  archives: {
    ...
    modal: {
      ...
      deleteBlockedByLivePrint: '無法刪除 — 此歸檔記錄著一個正在進行的列印。請先停止列印再重試。',
  ...
  settings: {
    ...
    spoolSelectionPolicy: '料卷選擇策略',
    spoolSelectionPolicyDesc: '當多個 AMS 槽位匹配時，排程器和手動列印如何選擇料卷。',
    spoolPolicyFirstLoaded: '最先裝載 (FIFO)',
    spoolPolicyLowestRemaining: '剩餘最少',
    spoolPolicySlotOrder: 'AMS 槽位順序',
    spoolPolicyBackupNote: '「剩餘最少」僅當印表機端啟用了 AMS Filament Backup 時才生效——否則當選中的料卷耗盡時，印表機無法切換到第二個料卷。',
    ...
    taglessMaterial: '材料',
    taglessSubtype: '子類型',
    taglessSubtypeHint: 'Bambu 對該材料的變體代碼，例如 HF = High Flow。顯示在料卷標籤上。',
    taglessColor: '顏色',
    taglessSlicerFilament: '切片軟體線材（可選）',
    taglessSlicerFilamentHint: '切片軟體所用線材預設的準確名稱，讓列印符合正確的設定檔。',
    ...
    deleteUserChecking: '正在檢查此刪除會移除哪些內容...',
    deleteUserImpactUnavailable: '無法檢查此刪除會移除哪些內容。若仍然刪除，該使用者的項目將在沒有預覽的情況下被移除。',
    deleteUserArchives_one: '{{count}} 個列印歸檔',
    deleteUserArchives_other: '{{count}} 個列印歸檔',
    deleteUserLibraryFiles_one: '{{count}} 個資料庫檔案',
    deleteUserLibraryFiles_other: '{{count}} 個資料庫檔案',
    deleteUserQueueItems_one: '{{count}} 個佇列項目',
    deleteUserQueueItems_other: '{{count}} 個佇列項目',
    deleteUserProductionRuns_one: '{{count}} 個生產執行',
    deleteUserProductionRuns_other: '{{count}} 個生產執行',
    deleteUserDependentSkus_one: '{{count}} 個 SKU 使用該使用者上傳的檔案。這些 SKU 將失去檔案，在重新指向之前無法列印。',
    deleteUserDependentSkus_other: '{{count}} 個 SKU 使用該使用者上傳的檔案。這些 SKU 將失去檔案，在重新指向之前無法列印。',
    deleteUserPrintingNow_one: '{{count}} 個單元正在列印。刪除將被拒絕，直到其完成或被停止。',
    deleteUserPrintingNow_other: '{{count}} 個單元正在列印。刪除將被拒絕，直到其完成或被停止。',
    deleteUserStillPrinting: '{{printers}} 上仍在列印。請停止這些列印或等待其完成，然後再刪除。',
    // Smart plugs
    ...
    farmProduction: '農場生產',
    farmProductionDescription: '在「開始工作」對話框中預先填入的預設重試與隔離原則。可依工作覆寫。',
    farmEjectCooldown: '取件冷卻',
    farmEjectCooldownDescription: '農場在掃走已完成板件前如何等待熱床冷卻，以及何時放棄或隔離無法冷卻的印表機。',
    farmRetryMaxPerUnit: '每片板的重試次數',
    farmRetryMaxPerUnitHelp: '在列印板被標記為失敗前的自動重試次數（0–10）',
    farmEscalateConsecutiveFailures: '失敗後隔離',
    farmEscalateConsecutiveFailuresHelp: '觸發隔離的印表機連續失敗次數（1–20）',
    farmCooldownMargin: '高於工作間氣溫的餘量 (°C)',
    farmCooldownMarginHelp: '取件線與腔室風扇降速點比工作間氣溫高出這一餘量。',
    shopAir: {
      label: '工作間氣溫',
      ejectLine: '取件線',
      noReading: '無讀數',
      atPlateau: '至平台期',
      fresh_one: '於 {{minutes}} 分鐘前在 {{count}} 台靜置的印表機內測得 — 讀數略高於室溫。',
      fresh_other: '於 {{minutes}} 分鐘前在 {{count}} 台靜置的印表機內測得 — 讀數略高於室溫。',
      carried: '沿日內曲線由 {{time}} 的讀數推算。',
      unknown: '尚無讀數 — 每次冷卻在熱床不再降溫時釋放。',
      readFailed: '工作間氣溫讀取失敗 — 每分鐘重試。',
    },
    farmOfflineStallMinutes: '離線停滯（分鐘）',
    farmOfflineStallMinutesHelp: '標記印表機已離線這麼久但仍在列印的單元 — 不會終止，只顯示停滯（5–720）',
    farmPauseStallMinutes: '暫停停滯（分鐘）',
    farmPauseStallMinutesHelp: '當正在列印的單元在沒有自動復原執行的情況下暫停這麼久時，標記並通知 — 絕不會取消任何內容（5–720）',
    farmCooldownStallWindow: '冷卻檢查間隔（分鐘）',
    farmCooldownStallWindowHelp: '在取件前多久確認一次熱床仍在降溫。連續兩次檢查失敗會將印表機隔離。0 關閉檢查。',
    farmCooldownStallEpsilon: '每次檢查的最小降溫（°C）',
    farmCooldownStallEpsilonHelp: '兩次檢查之間熱床至少要下降這麼多，才算仍在降溫。',
    farmCooldownMaxHold: '放棄計時器（分鐘）',
    farmCooldownMaxHoldHelp: '超過這段時間後熱床仍高於取件溫度，則照常取件。0 = 一直等待。',
    farmCooldownPlateauMargin: '足夠接近餘量（°C）',
    farmCooldownPlateauMarginHelp: '若降溫停滯但熱床處於自身腔室空氣的該溫差範圍內，則視為已冷卻並取件；若卡在更高溫度，則將印表機隔離。',
    farmCooldownAuxFanEnabled: '冷卻期間的輔助風扇',
    farmCooldownAuxFanEnabledHelp: '從列印結束到取件下發期間運行輔助風扇。',
    farmCooldownAuxFan: '輔助風扇轉速 (%)',
    farmCooldownAuxFanHelp: '整個冷卻過程使用同一轉速 (1–100)。',
    farmCooldownChamberFanEnabled: '冷卻期間的腔室風扇',
    farmCooldownChamberFanEnabledHelp: '將風道設為冷卻模式，並從列印結束到取件下發期間運行腔室排氣風扇。沒有腔室風扇的列印機型號會跳過。',
    farmCooldownChamberFan: '腔室風扇強冷轉速 (%)',
    farmCooldownChamberFanHelp: '腔室空氣仍高於取件溫度時使用的轉速 (1–100)。',
    farmCooldownChamberFanSustain: '強冷之後的腔室風扇轉速 (%)',
    farmCooldownChamberFanSustainHelp: '腔室達到取件溫度後直到取件下發期間使用的轉速。0 表示此時停止風扇。列印機自身的腔室冷卻轉速為 50。',
    farmCooldownHoldEnabled: '冷卻期間將熱床保持在風扇處',
    farmCooldownHoldEnabledHelp: '在零件冷卻期間，將工具頭停靠在落料口，並把熱床抬升至噴嘴平面。關閉時熱床停在列印結束的位置。',
    farmCooldownHoldPartTop: '零件頂部高於噴嘴平面的高度 (mm)',
    farmCooldownHoldPartTopHelp: '設定零件冷卻期間熱床的保持位置，即零件頂部高於噴嘴平面處輔助風扇氣流的高度。100 表示熱床停在風扇處，零件伸入噴嘴上方的空隙區。0 表示零件頂部與風扇齊平。低於 0 表示零件頂部位於風扇下方該距離處，氣流從其上方經過。上限為該印表機型號實測的空隙高度。',
    respoolPromptThreshold: '重新綁定觀察閾值 (g)',
    respoolPromptThresholdHelp: '當重複使用的 Bambu 標籤出現、來源線軸剩餘不超過這麼多克且沒有硬體確認的用盡標記時，記錄一筆重新綁定觀察日誌（0–1000）。',
    farmUsbAutoCleanup: '儲存滿時自動清理 USB',
    farmUsbAutoCleanupHelp: '當 USB 儲存空間不足發生錯誤時，先自動刪除舊的攝影機錄影，再刪除最早的未使用列印檔案，以確保派發持續進行',
    farmIdlePark: '閒置時熱床下降',
    ...
    farmPlateBlowoffEnabled: '開始列印時吹掃列印板',
    farmPlateBlowoffEnabledHelp: '熱床調平前以全速輔助風扇吹掃列印板。',
    farmPlateBlowoffSeconds: '吹掃時間 (s)',
    farmPlateBlowoffSecondsHelp: '熱床調平前輔助風扇的運轉時間 (3–60)。',
    ...
    queueCheckIntervalHelp: '即使沒有任何變化，農場重新檢查佇列的頻率。這是萬一漏掉即時事件時的備援——數值越低回應越快，但輪詢越頻繁（5–300）。',
    dispatchKickDebounce: '突發合併延遲（秒）',
    dispatchKickDebounceHelp: '當多件事同時發生時，等待這短暫的片刻，將它們合併為一次派發而非多次。數值越高合併越多；越低回應越快（0.2–10）。',
    usbPreflightFreshWindow: 'USB 檢查有效期（秒）',
    usbPreflightFreshWindowHelp: '在重新檢查之前，信任這麼多秒內的近期"USB 隨身碟存在"報告。數值越高越能略過多餘檢查；0 則一律重新檢查（0–120）。',
    usbPreflightMaxWait: 'USB 檢查最長等待（秒）',
    usbPreflightMaxWaitHelp: '在無論如何開始列印之前，等待新的"USB 存在"報告多長時間。數值越高越謹慎；越低派發越早（0–10）。',
    dispatchParallelLimit: '同時啟動的印表機數',
    dispatchParallelLimitHelp: '一次派發中可同時上傳並啟動的印表機數量。數值越高清空大佇列越快；越低對網路越溫和（1–10）。',
    powerStagger: '功率錯峰',
    powerStaggerDescription: '在印表機不再消耗加熱功率的那一刻即釋放一個錯峰名額，而不是始終等滿整個間隔。讓下一台印表機更早啟動，同時仍限制同時的功率消耗。',
    staggerDynamicRelease: '熱床變熱後即釋放名額',
    staggerDynamicReleaseHelp: '啟用時，下一台印表機可在目前印表機完成熱床加熱後立即啟動，而不必等待整個間隔過去。關閉時，每個名額都等滿整個間隔。',
    staggerReleaseEpsilon: '到溫餘量（°C）',
    staggerReleaseEpsilonHelp: '距離目標熱床溫度多近才算"足夠熱"，可提前釋放名額。數值越大，越早釋放下一台印表機。',
    staggerHeatupGrace: '加熱寬限（秒）',
    staggerHeatupGraceHelp: '如果印表機尚未開始加熱熱床，則在此時間後仍釋放其名額，以免閒置的印表機拖住整批。',
    ...
    erp: {
      title: 'ERP 目錄登入',
      statusActive: 'ERP 登入：已啟用',
      statusInactive: 'ERP 登入：未設定',
      activeDesc: '操作員可以使用其 ERP 目錄認證登入。',
      inactiveDesc: '在下方新增並儲存連線資訊以啟用 ERP 登入。',
      disableHint: '若要關閉 ERP 登入，請清除下方的主機和資料庫名稱，然後儲存。',
      connectionConfig: 'ERP 目錄連線',
      host: '資料庫主機',
      port: '連接埠',
      database: '資料庫名稱',
      user: '資料庫使用者',
      password: '資料庫密碼',
      passwordHint: '留空以保留已儲存的密碼。',
      ssl: '透過 TLS 連線',
      sslHint: '要求與 ERP 資料庫建立加密連線。',
      roleMapping: '角色對應',
      roleMappingHint: '為每個 ERP 角色指派一個 BamBuddy 群組。',
      roleMappingNoGroup: '— 無群組 —',
      roleMappingGroupFor: '{{role}} 的 BamBuddy 群組',
      settingsSaved: '已儲存 ERP 目錄設定',
      errors: {
        hostRequired: '資料庫主機為必填',
        databaseRequired: '資料庫名稱為必填',
      },
    },
    oidc: {
      title: 'SSO / OIDC 提供者',
      ...
      form: {
        ...
        groupsClaim: '群組宣告',
        groupsClaimDesc: '包含使用者群組或角色值的權杖宣告。留空可停用來自此提供者的群組同步。',
        groupsClaimPlaceholder: '群組',
        groupMapping: '群組對應',
        groupMappingDesc: '將每個宣告值對應到一個 BamBuddy 群組。相符的使用者在登入時會取得對應的群組。',
        groupMappingNone: '未設定對應。',
        groupMappingClaimValue: '宣告值',
        groupMappingGroup: 'BamBuddy 群組',
        groupMappingSelectGroup: '選擇群組',
        groupMappingRemove: '移除對應',
        groupMappingAdd: '新增對應',
        autologin: '自動登入',
  ...
  hmsErrors: {
    title: '錯誤 - {{name}}',
    noErrors: '無錯誤',
    unknownDescription: '未知印表機錯誤 — 不在已知代碼資料庫中。請在拓竹 Wiki 上檢視此代碼。',
    severity: {
      fatal: '致命',
      serious: '嚴重',
      warning: '警告',
  ...
  fileManager: {
    ...
    createSkuFromUploadToast: '已上傳 {{filename}} — 用它建立 SKU 嗎？',
    createSkuFromUploadAction: '用此檔案建立 SKU',
    ...
    deleteFolderConfirm: '確定要刪除此資料夾嗎？其中的檔案將移至資源回收筒，可還原到根目錄；資料夾本身將被永久刪除。',
    deleteFileConfirm: '確定要刪除此檔案嗎？',
    deleteFilesConfirm: '確定要刪除 {{count}} 個選中的檔案嗎？檔案將移至資源回收筒，可以還原。',
    deleting: '刪除中...',
  ...
  inventory: {
    ...
    freshRoll: {
      ...
      reviewAction: '檢視…',
      title: '此插槽上是新卷嗎？',
      message: '{{location}} 的無標籤料卷已用掉標稱重量的大部分。如果現在裝的是新卷，請記錄以保持耗材追蹤準確。',
      confirm: '新卷',
      pending: '正在記錄…',
      success: '已記錄新卷',
      failed: '記錄新卷失敗',
      dismissFailed: '無法關閉新卷提示',
      remaining: '已記錄剩餘 {{grams}} g',
      brandLabel: '品牌',
      ...
      noteLabel: '備註',
      notePlaceholder: '選填',
      manualDesc: '結束目前紀錄並建立新紀錄',
      manualTitle: '標記為新線材卷？',
      manualMessage: '結束 {{location}} 的紀錄（已用 {{grams}} g），並為此插槽建立一筆全新的滿卷紀錄。請僅在實際更換線材卷之後執行。',
      manualConfirm: '標記為新線材卷',
    },
    respool: {
      title: '重新綁定此標籤？',
      manualTitle: '將此標籤轉移到新線材卷？',
      manualMessage: '停用 {{location}} 的紀錄（已用 {{grams}} g），並將其 Bambu 標籤轉移到一卷全新的線材。請在實際更換線材卷後再執行。',
      message: '在 {{location}} 偵測到重複使用的 Bambu 標籤。如果它現在裝在全新的第三方線軸上，請將其重新綁定到滿軸記錄。',
      confirm: '已重新綁定 — 全新線軸',
      pending: '正在重新綁定…',
      success: '已重新綁定到全新的 {{brand}} 線軸',
      failed: '標籤重新綁定失敗',
      autoToast: '已在 {{printer}} 插槽 {{slot}} 自動重新綁定 {{brand}}',
      reusedTagToast: '重複使用的標籤上可能是新卷——{{printer}} 插槽 {{slot}}',
      ...
      triggerSpent: '此卷回報已用盡，此後插槽已被操作過。',
      triggerRemainJump: 'AMS 回報的耗材量遠多於此記錄——該標籤似乎已換到重新裝填的線軸上。',
      sameSpoolAction: '同一線軸',
      reviewAction: '檢視…',
      dismissFailed: '無法關閉重新綁定提示',
      donorLine: '取代已追蹤的線軸（剩餘 {{grams}} g）；舊記錄將被封存',
      donorRecordTitle: '記錄 #{{id}}',
      detailsLabel: '詳細資訊',
      tagIdLabel: '標籤 ID',
      warning: '每個來源線軸只使用一個標籤 — 丟棄第二個標籤。',
      brandLabel: '品牌',
      brandPlaceholder: '例如 Overture',
      weightLabel: '標稱重量 (g)',
      weightPlaceholder: '例如 1000',
    ...
    spoolArchived: '耗材已歸檔',
    spoolRestored: '耗材已恢復',
    returnToRotation: '恢復輪替',
    returnToRotationDone: '料卷已恢復輪替',
    returnToRotationFailed: '無法將料卷恢復輪替',
  ...
  ams: {
    ...
    slotDialogLabel: '{{ams}} 插槽 {{slot}}：{{content}}',
    slotBoundPresenceUnknown: '{{printer}}: {{ams}} 槽位 {{slot}} 無回應 — 無法確認已綁定的料卷是否仍在其中，請檢查該槽位',
    slotSpentSwapPark: '{{printer}}: {{ams}} 槽位 {{slot}} 被用盡的料卷佔用，沒有可解除的依據。請重新檢查該槽位或更換料卷',
    ...
    emptySlotBinding: {
      ...
      unassignAria: '取消分配 {{spool}}（此插槽）',
      unassignTitle: '取消指派此線材卷？',
      unassignMessage: '將 {{spool}} 從此插槽釋放。線材卷會保留已記錄的用量回到庫存，不會刪除任何資料。',
    },
    unknown: '未知',
    humidity: '濕度',
    temperature: '溫度',
  ...
  printModal: {
    ...
    customSlotMapping: '自訂槽位對應',
    reread: '重新讀取',
    requiredTooltip: '需要：{{type}} - {{color}}',
    manuallySelected: '手動選擇',
    autoMatched: '自動比對',
    externalSlotNote: '外接料卷 — 不統計用量；印表機會要求在料架上補料。',
    selectSlot: '-- 選擇槽位 --',
    noActivePrintersAvailable: '沒有可用的作用中印表機',
    specificPrinter: '指定印表機',
    anyModel: '任意 {{model}}',
    modelFallback: '型號',
    targetModelLabel: '目標型號',
    selectModelPlaceholder: '選擇型號...',
    locationFilter: '位置篩選（選填）',
    anyLocation: '任意位置',
    schedulerAssignHint: '排程器將指派給第一台可用的空閒 {{model}} 印表機',
    schedulerAssignHintLocation: '排程器將指派給 {{location}} 中第一台可用的空閒 {{model}} 印表機',
    selectPrinters: '選擇印表機',
    printersSelected_one: '已選擇 {{count}} 台印表機',
    printersSelected_other: '已選擇 {{count}} 台印表機',
    selectAll: '全選',
    inactive: '(未啟用)',
    unknownModel: '未知型號',
    customMapping: '自訂對應',
    matchedCount: '（已比對 {{matched}}/{{total}}）',
    autoButton: '自動',
    hiddenPrinters_one: '還有 {{count}} 台其他印表機被隱藏（不同型號）—',
    hiddenPrinters_other: '還有 {{count}} 台其他印表機被隱藏（不同型號）—',
    showAll: '顯示全部',
    showOnlyModelPrinters: '僅顯示 {{model}} 印表機',
    selectAtLeastOnePrinter: '請至少選擇一台印表機',
    selectTargetModel: '請選擇目標印表機型號',
    typeNotFound: '（找不到類型）',
    colorMismatch: '（顏色不符）',
    ready: '（就緒）',
    clickToChangeSlot: '點擊以變更槽位分配',
    costNotAvailable: '不適用',
    requiredTypeNotFound: '印表機中找不到所需的耗材類型。',
    printJob: '列印工作',
    slicedModelMismatch: '檔案是為 {{slicedModel}} 切片的，但正在 {{printerModel}} 上列印',
    archiveDataUnavailable: '封存資料無法使用。來源檔案可能已被刪除。耗材對應已停用。',
    failedToComplete: '無法完成操作',
    toastQueueItemUpdated: '佇列項目已更新',
    toastUpdateFailed: '無法更新佇列項目',
    toastSelectPrinter: '請至少選擇一台印表機',
    toastSelectModel: '請選擇目標印表機型號',
    toastQueuedForModel: '已加入任意 {{model}} 的佇列',
    ejectFromSku: '來自 SKU {{code}} 的預設值',
    partialFailureTitle: '{{total}} 個調度中有 {{failed}} 個失敗：',
    toastPartialSuccess: '{{success}} 個成功，{{failed}} 個失敗',
    printerFallback: '印表機 {{id}}',
    slotFallback: '槽位 {{id}}',
    plateFallback: '列印板 {{index}}',
  },
  ...
  uploadModal: {
    ...
    libraryHint: '對於 SKU 和生產批次，請改用檔案管理器上傳。',
    libraryHintLink: '前往檔案管理器 →',
    uploaded: '已上傳',
    failed: '失敗',
    uploading: '上傳中...',
    upload: '上傳',
  ...
  notifications: {
    ...
    printStalled: '列印停滯',
    storageLow: 'USB 儲存空間不足',
    cooldownEscalation: '冷却時間過長',
    // Quiet hours
    quietHours: '免打擾時段',
  ...
  fleetMetrics: {
    ...
    sections: {
      fleet: '機群',
      matrix: '機群矩陣',
      stateOverTime: '印表機狀態隨時間變化',
      printsPerDay: '每日列印數',
      downtimeByCause: '依原因區分的停機時間',
      coolingAndEject: '冷卻與推件',
      recovery: '復原',
      partsBySku: '依 SKU 統計零件',
    },
    summary: {
      now: '目前',
      trend: '走勢',
      ...
      rows: {
        avg_printing: '列印中',
        avg_cycle_overhead: '列印間隙',
        avg_idle: '閒置',
        avg_down: '停機',
        avg_planned: '維護',
        peak_down: '停機尖峰',
        printers_in_fleet: '在機群內',
        prints_per_day: '列印數',
        prints_per_printer_per_day: '每臺列印數',
        uptime: '正常運行率',
        time_printing: '列印時間占比',
      },
      peak: '尖峰 {{count}}',
      downNow: '目前停機',
      nothingDown: '無停機',
    ...
    matrix: {
      ...
      hideDays: '隱藏日期',
      sortBy: '依{{column}}排序',
      caption: '各印表機的{{lens}}，{{from}} 至 {{to}}',
      captionDay: '各印表機的{{lens}}，{{date}}',
      details: '詳情',
    ...
    widgets: {
      showData: '顯示資料',
      showChart: '顯示圖表',
      showDataFor: '顯示{{chart}}的資料',
      showChartFor: '顯示{{chart}}的圖表',
      median: '中位數',
      p90: 'P90',
      overExpected: '超出預期',
      count: '數量',
    ...
    states: {
      ...
      retry: '重試',
      empty: '此區間沒有資料。',
      recordingGap: '印表機狀態記錄自 {{date}} 開始。故障與維護歷史自 {{earliest}} 起。',
    },
    header: {
    ...
    hints: {
      ...
      cycle_overhead: '農場在兩次列印之間自己做的事：替熱床降溫，然後把零件掃下去。',
      planned: '維護模式：有人把這臺印表機移出了自動流程。',
      uptime: '計入時間中印表機能夠接單的比例。',
      time_printing: '計入時間中印表機正在列印的比例。',
      prints_per_printer: '已完成列印數除以每臺印表機計入的天數。計入天數僅來自已記錄的區間，因此在期間仍有部分未記錄時無法與「列印數」相比。',
      unobserved: '這段時間沒有任何記錄，只知道故障與暫停。',
      not_recorded: '早於這臺印表機最早記錄到的狀態。',
      incidents_only: '此處沒有記錄印表機狀態，只有故障與維護紀錄涵蓋該期間。',
      whileRecorded: '週期數值僅涵蓋已記錄的時間。',
      timeframeFleet: '一天以 {{tz}} 的零時到零時計算。',
      timeframePrints: '一天以 UTC 零時到零時計算。',
    },
  },
};
