export default {
  ...
  ejectProfiles: {
    ...
    fields: {
      ...
      bedDrop: '熱床下降脫離輔助',
      bedDropHelp: '在抬升到零件上方後，將熱床下降到接近機器底部再抬回，以在清掃前將零件震鬆脫離。',
    ...
    tooltips: {
      ...
      bedDrop: '抬升脫離零件後，熱床下降到接近最低點再返回，藉由震動在清掃前使黏住的零件脫離。需要為該型號登錄 Z 行程。',
  ...
  printers: {
    ...
    quarantine: {
      ...
      actionsHelp: '恢復並繼續會解除隔離並繼續已暫停的執行。將列印板標記為已清理僅解除列印板鎖定。',
    },
    phase: {
      printing: '列印中',
