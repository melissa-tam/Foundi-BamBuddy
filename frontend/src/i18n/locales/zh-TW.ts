export default {
  ...
  ejectProfiles: {
    ...
    tooltips: {
      ...
      cooldownRetries: '在等待熱床達到目標溫度期間，放棄前重新檢查溫度的次數。',
  ...
  printers: {
    ...
    phase: {
      printing: '列印中',
      cooling: '正在冷卻至 {{threshold}}°C（熱床 {{bed}}°C）— 掃除在檔案內執行',
      coolingNoBed: '正在冷卻至 {{threshold}}°C — 掃除在檔案內執行',
  ...
  settings: {
    ...
    farmRetryMaxPerUnitHelp: '在列印板被標記為失敗前的自動重試次數（0–5）',
    farmEscalateConsecutiveFailures: '失敗後隔離',
    farmEscalateConsecutiveFailuresHelp: '觸發隔離的印表機連續失敗次數（1–10）',
