export default {
  ...
  settings: {
    ...
    ejectUploadSkipIdentical: '重複使用 USB 隨身碟上已有的退料檔案',
    ejectUploadSkipIdenticalHelp: '當相同的退料檔案已在印表機的 USB 隨身碟上時，略過重新上傳，每次退料可節省幾秒。',
    ejectUploadSkipIdenticalWarning: '僅在即時退料探測確認隨身碟上的檔案被正確重複使用後才啟用。若不確定，請保持關閉——重新上傳始終能保證使用正確的檔案。',
    ejectSlim3mf: '精簡退料檔案',
    ejectSlim3mfHelp: '從退料檔案中移除 3D 模型與預覽圖，使其上傳更快——退料動作本身保持不變。',
    ejectSlim3mfWarning: '受硬體限制：在為無人值守生產啟用之前，請使用精簡檔案完整跑一遍退料硬體階梯測試。在通過該階梯測試之前請保持關閉。',
    powerStagger: '功率錯峰',
