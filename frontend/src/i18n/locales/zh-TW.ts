export default {
  ...
  ejectProfiles: {
    ...
    tooltips: {
      ...
      coolingFanAssist: '在清掃期間開啟零件冷卻風扇，協助頑固的零件從列印板脫離。',
  ...
  settings: {
    ...
    farmCooldownAuxFan: '冷卻期間的輔助風扇 (%)',
    farmCooldownAuxFanHelp: '從列印結束到取件下發期間，以此轉速運行列印機的輔助風扇。0 表示關閉。',
